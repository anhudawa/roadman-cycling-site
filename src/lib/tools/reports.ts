...
function softCoachingCta(): string {
  return `<div style="margin-top:32px;padding:20px;background:rgba(241,99,99,0.06);border:1px solid rgba(241,99,99,0.2);border-radius:12px;">
    ...
    <p style="color:#9ca3af;font-size:13px;margin:0 0 14px;">Not Done Yet group coaching runs a coached five-pillar system. Personalised plan, weekly review, live group coaching, expert masterclasses. 7-day free trial, $195/mo.</p>
