...
export const PROBLEM_PAGES: ProblemPage[] = [
  ...
  },
  {
    ...
    causes: [
      ...
      "Under-recovery or illness — repeated resting-rate change can add context, but no universal bpm or day threshold diagnoses the cause",
    ...
    solutions: [
      ...
      { title: "Interpret resting HR", description: "Use a consistent personal pattern beside symptoms, load and performance", href: "/blog/resting-heart-rate-masters-cyclists" },
  ...
  },
  {
    ...
    seoTitle: "Cycling Cramps on Long Rides — Find Your Pattern",
    seoDescription: "A long-ride cycling cramp does not diagnose one deficiency. Audit the muscle, timing, demand, pacing, conditions, fluid, food and warning signs.",
    pillar: "nutrition",
    problem: "Every ride over 3–4 hours ends with the same quad, hamstring or calf cramp. Salt tablets and forum remedies have not solved it. This page helps you reconstruct the long-ride pattern; the broad evidence and immediate response live in the main cycling cramp guide.",
    causes: [
      "A demand-preparation gap: duration, climbing torque, cadence or intensity exceeded what recent training rehearsed",
      "Accumulated local fatigue and altered neuromuscular control — plausible contributors, not a diagnosis from the cramp alone",
      "Early pacing or repeated surges that increased the later muscular demand",
      "A food or fluid plan that did not support the ride, without proving one nutrient caused the cramp",
      "Substantial sweat and sodium loss in some long or hot contexts, alongside the separate risk of forced overdrinking",
      "A position, cleat, shoe, saddle or gearing change that repeatedly loads the same muscle",
      "Illness, medication, poor recovery or a non-exercise condition when the pattern is new, changing or accompanied by other symptoms",
    ],
    solutions: [
      { title: "Start with the evidence guide", description: "Use the immediate response, red flags and complete cramp-audit framework", href: "/blog/cycling-cramp-prevention" },
      { title: "Rehearse long-ride demand", description: "Build duration, terrain and gearing progressively while keeping recovery intact", href: "/blog/aerobic-decoupling-cycling-cardiac-drift" },
      { title: "Plan fuelling for the ride", description: "Choose a tolerable event-specific range without calling it a guaranteed cramp cure", href: "/tools/fuelling" },
      { title: "Measure hydration separately", description: "Use representative losses, conditions and tolerance; avoid a universal fluid or sodium dose", href: "/tools/hydration" },
    ],
    toolHref: "/blog/cycling-cramp-prevention",
    toolLabel: "Read the complete cycling cramp guide",
  },
  {
