...
export const PROBLEM_PAGES: ProblemPage[] = [
  ...
  },
  {
    ...
    solutions: [
      ...
      { title: "Add low-cadence torque work", description: "The 2024 Habis study showed 40-60 RPM intervals on a climb produced near-double the VO2max gains of self-selected cadence.", href: "/blog/low-cadence-training-cycling-torque-intervals" },
