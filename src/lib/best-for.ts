...
export const BEST_FOR_PAGES: BestForPage[] = [
  ...
  },
  {
    ...
    picks: [
      { name: "Roadman Cycling (Not Done Yet)", verdict: "Best for event-specific periodised plans", bestFor: "Riders targeting Wicklow 200, Ride London, Ã‰tape, or any specific sportive", href: "/coaching" },
