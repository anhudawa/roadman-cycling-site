...
export const BEST_FOR_PAGES: BestForPage[] = [
  ...
  },
  {
    ...
    related: [
      ...
      { title: "Cycling recovery guide", href: "/blog/cycling-recovery-tips", description: "Understand sleep, load, soreness and recovery methods before buying a score." },
    ],
