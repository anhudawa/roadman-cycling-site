...
export const BEST_FOR_PAGES: BestForPage[] = [
  {
    ...
    pillar: "coaching",
    intro: "The right training app depends on what you need: structured plans, social motivation, analytics depth, or coach integration. Here are the best options for each use case. Over 40? The trade-offs shift — recovery-aware picks live on the [Best Cycling Training Apps for Masters Cyclists](/best/best-cycling-apps-structured-training) page.",
    picks: [
  ...
  },
  {
    ...
    title: "Best Cycling Training Apps for Masters Cyclists",
    seoTitle: "Best Cycling Training Apps for Masters Cyclists (40+, 50+)",
    seoDescription: "The best cycling training apps for masters cyclists. Recovery-aware, time-efficient, TrainingPeaks-friendly — picked for riders over 40 with limited hours and longer recovery.",
    pillar: "coaching",
    intro: "Most training apps were built around 25-year-olds with eight free hours an evening. After 40, recovery takes longer, the easy days have to be genuinely easy, and a 90-minute window has to do real work. These are the apps that respect that — picked for masters cyclists who need recovery-aware, time-efficient training that talks to a coach when you want one. Sister piece: the broader [Best Cycling Training Apps](/best/best-cycling-training-apps) guide compares the same tools without the masters-specific lens.",
    picks: [
      { name: "TrainingPeaks", verdict: "Best for working with a coach who respects your recovery", bestFor: "Masters riders who want their plan built around their week, their FTP, and their TSB — not a generic template. Where Roadman coaching delivers", href: "/compare/trainerroad-vs-trainingpeaks" },
      { name: "TrainerRoad (Adaptive Training)", verdict: "Best self-coached app for masters", bestFor: "40+ riders who train alone and want the plan to back off when you score a workout poorly — no ego, no junk-mile guilt", href: "/blog/zwift-vs-trainerroad" },
      { name: "Intervals.icu", verdict: "Best free analytics for tracking the long game", bestFor: "Masters riders who want CTL/ATL/TSB and HRV trends without a subscription — particularly useful for tracking the year-on-year drift the under-40s ignore", href: "/compare/heart-rate-vs-power" },
      { name: "Zwift", verdict: "Best for the dark months when you'd otherwise skip", bestFor: "Masters riders who need a reason to turn the trainer on in January — workouts and pace partners are fine, but you'll need discipline to use it as more than a Saturday social", href: "/blog/zwift-vs-trainerroad" },
    ],
    faq: [
      { question: "Why not a generic 'best apps' list for masters?", answer: "Because the trade-offs are different after 40. A 25-year-old can absorb a missed recovery day. A 50-year-old who ignores fatigue scores ends up sick or injured three weeks later. Recovery-awareness, gentle ramp rates, and easy integration with a coach who can adjust the plan are the masters-specific picks." },
      { question: "Is TrainerRoad's adaptive training masters-friendly?", answer: "It's the best self-coached option for masters because the algorithm adjusts intensity based on workout completion rate. You ride a poor session, the next one drops. That's exactly the recovery feedback loop a 50-year-old training alone needs." },
      { question: "Do I need a coach if I'm using one of these apps?", answer: "Apps deliver workouts; coaches make judgement calls. After 40, when life stress, sleep debt, and slower recovery start interacting, the judgement calls matter more than the workouts. Roadman coaching is delivered through TrainingPeaks for exactly this reason." },
