...
function isLikelyPersonName(name: string): boolean {
  ...
  if (!/^[A-Z√Ä-√ñ√ò-√ù]/.test(words[0])) return false;
 ...
 * "Dr Stephen Seiler" and "Professor Stephen Seiler" $Üí "Stephen Seiler"
 */
...
const KNOWN_CREDENTIALS: Record<string, string> = {
  ...
  "Andr√© Greipel": "Grand Tour sprint legend, 22 Grand Tour stage wins",
  ...
  "Dan Lorang": "Head of Performance, Red Bull$ÄìBora$ÄìHansgrohe",
  ...
  "Genevi√®ve Jeanson": "Former pro cyclist",
  ...
  "John Wakefield": "Director of Coaching & Sports Science, Red Bull$ÄìBora$ÄìHansgrohe",
  ...
  "Rosa Kl√∂ser": "Professional gravel racer, Unbound 200 winner",
...
const GUEST_PILLAR_MAP: Record<string, ContentPillar> = {
  // Coaching $Äî coaches, exercise physiologists, sports scientists
  ...
  // Nutrition $Äî nutritionists, chefs, diet experts
  ...
  // Strength $Äî S&C, physio, bike fitting
  "Derek Teel": "strength",
  "Courtney Conley": "strength",
  "Dr Andy Pruitt": "strength",

  // Recovery $Äî psychology, mindset, wellness, hormones
  "Chris Voss": "recovery",
  "Dr Michael Gervais": "recovery",
  "Erin Ayala": "recovery",
  "Dr Mark Gordon": "recovery",

  // Community $Äî pro riders, journalists, ultra-endurance, culture, crossover athletes
  "Greg LeMond": "community",
  "Lachlan Morton": "community",
  "Alex Dowsett": "community",
  "Alex Howes": "community",
  "Andr√© Greipel": "community",
  "George Hincapie": "community",
  "Ed Clancy": "community",
  "Eddie Dunbar": "community",
  "Dan Bigham": "community",
  "Jonas Abrahamsen": "community",
  "Michael Matthews": "community",
  "John Archibald": "community",
  "Laurens Ten Dam": "community",
  "Brian Smith": "community",
  "Genevi√®ve Jeanson": "community",
  "Shannon Malseed": "community",
  "Rosa Kl√∂ser": "community",
  "Mads Wurtz Schmidt": "community",
  "Cory Williams": "community",
  "Alexey Vermeulen": "community",
  "Tayler Wiles": "community",
  "Hannah Otto": "community",
  "Sofiane Sehili": "community",
  "Colin O Brady": "community",
  "Mark Beaumont": "community",
  "Matt Beers": "community",
  "Jack Burke": "community",
  "Jack Thompson": "community",
  "James Golding": "community",
  "Owen Vermeulen": "community",
  "Sean Landers": "community",
  "Andy McGrath": "community",
  "Yanto Barker": "community",
  "Uli Schoberer": "community",
  "Gareth Joyce": "community",
  "Aron D'Souza": "community",
  "Alistair Brownlee": "community",
  "Valtteri Bottas": "community",
  "David Gillick": "community",
  "Ben Hoffman": "community",
  "Mick Clohisey": "community",
  "Josh Amberger": "community",
};
...
const GUEST_PROMINENCE: Record<string, number> = {
  // Tier 1 $Äî Household names, Tour winners, Olympic champions
  "Greg LeMond": 100,
  "Stephen Seiler": 95,
  "Dan Lorang": 90,
  "Lachlan Morton": 88,
  ...
  // Tier 2 $Äî Well-known in cycling world
  "John Wakefield": 60,
  "Olav Bu": 58,
  "Hannah Grant": 56,
  "Mark Beaumont": 55,
...
function slugify(name: string): string {
  return name
    .toLowerCase()
    .replace(/['$Äô$Äò]/g, "")
    // Normalise diacritics so "Rosa Kl√∂ser" $Üí "rosa-kloser", matching the
