...
const KNOWN_CREDENTIALS: Record<string, string> = {
  ...
  "Chris Harper": "Professional road cyclist",
  ...
  "Sarah Berry": "Professor of Nutritional Sciences at King's College London, Chief Scientist at ZOE",
  ...
  "Ger Remond": "Irish Ironman triathlete, sub-9:30 self-coached pro",
  ...
  "Sebastian Breuer": "Badlands winner and ultra-endurance cyclist",
...
const GUEST_PILLAR_MAP: Record<string, ContentPillar> = {
  ...
  "Geneviève Jeanson": "community",
  "Shannon Malseed": "community",
  "Rosa Klöser": "community",
