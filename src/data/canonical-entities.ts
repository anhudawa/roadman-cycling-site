...
export const CANONICAL_ENTITIES: CanonicalEntity[] = [
  ...
  },
  {
    ...
    title: "Former professional cyclist; author of The Secret Race",
    affiliation: "Retired professional cyclist",
    affiliationVerified: true,
    sameAs: [],
    sameAsVerified: false,
    topics: ["pro cycling ethics and doping", "US Postal era", "Tour de France history", "cycling memoirs"],
    episodes: [],
    kind: "pro-cyclist",
    notes: "Subject, not a guest. Co-authored 'The Secret Race' (2012); referenced in doping-era episodes.",
  },
  {
    slug: "tom-simpson",
