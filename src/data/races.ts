...
export const RACES: Race[] = [
  ...
  },
  {
    ...
    difficulty: 4,
    description:
      "The amateur version of cycling's youngest classic. Strade Bianche Gran Fondo rolls out from Siena and threads together the white gravel sectors of Tuscany with sharp climbs, exposed ridgelines and a spectacular finish back toward the city. The numbers look manageable until the gravel, ramps and repeated accelerations start taxing every bit of traction and pacing discipline.",
    key_climbs: [
      { name: "Colle Pinzuto", elevation_m: 347, length_km: 2.4, avg_gradient: 6.7 },
      { name: "Le Tolfe", elevation_m: 311, length_km: 1.1, avg_gradient: 10.0 },
      { name: "Via Santa Caterina", elevation_m: 320, length_km: 0.5, avg_gradient: 12.4 },
    ],
    typical_finish_times: {
      beginner: "7–10h",
      intermediate: "5–7h",
    ...
    similar_races: ["leroica", "tour-of-flanders-cyclo", "belgian-waffle-ride"],
    month: "March",
    website: "https://gfstradebianche.it",
    tags: ["gran fondo", "gravel", "italy", "tuscany", "strade bianche", "classic"],
    predictor_slug: "strade-bianche-gran-fondo",
  },
  {
  ...
  },
  {
    ...
    key_climbs: [
      { name: "Trouée d'Arenberg sector", elevation_m: 55, length_km: 2.3, avg_gradient: 0.4 },
      { name: "Mons-en-Pévèle sector", elevation_m: 60, length_km: 3.0, avg_gradient: 0.5 },
      { name: "Carrefour de l'Arbre sector", elevation_m: 45, length_km: 2.1, avg_gradient: 0.3 },
    ],
    typical_finish_times: {
      beginner: "8–11h",
      intermediate: "6–8h",
    ...
    similar_races: ["tour-of-flanders-cyclo", "strade-bianche-gran-fondo", "liege-bastogne-liege"],
    month: "April",
    website: "https://www.parisroubaixchallenge.com",
    tags: ["cobbles", "classics", "france", "paris roubaix", "sportive", "iconic"],
    predictor_slug: "paris-roubaix-challenge",
  },
  {
    ...
    difficulty: 4,
    description:
      "A long mixed-surface race that sits somewhere between road race, gravel race and survival puzzle. Belgian Waffle Ride rewards riders who can hold aero road speed, handle dirt sectors, fuel for a very long day and keep equipment intact when the route gets loose, steep or technical.",
    key_climbs: [
      { name: "Double Peak", elevation_m: 500, length_km: 5.0, avg_gradient: 7.0 },
      { name: "Highland Valley rollers", elevation_m: 430, length_km: 16.0, avg_gradient: 2.8 },
      { name: "Black Canyon dirt climb", elevation_m: 620, length_km: 8.0, avg_gradient: 5.6 },
    ],
    typical_finish_times: {
      beginner: "10–13h",
      intermediate: "8–10h",
    ...
    similar_races: ["unbound-gravel", "strade-bianche-gran-fondo", "leadville-trail-100-mtb"],
    month: "April",
    website: "https://belgianwaffleride.bike",
    tags: ["gravel", "mixed surface", "usa", "california", "race", "endurance"],
    predictor_slug: "belgian-waffle-ride-california",
  },
  {
    ...
    difficulty: 5,
    description:
      "The defining American gravel race. Unbound is not about one climb or one sector; it is about relentless Flint Hills gravel, heat, wind, self-sufficiency and staying calm when the day goes sideways. Finish time depends heavily on weather, tyre choice, pacing discipline and how well a rider handles mechanical risk.",
    key_climbs: [
      { name: "Texaco Hill", elevation_m: 460, length_km: 3.0, avg_gradient: 5.5 },
      { name: "Little Egypt rollers", elevation_m: 430, length_km: 20.0, avg_gradient: 2.0 },
      { name: "Flint Hills late rollers", elevation_m: 420, length_km: 35.0, avg_gradient: 1.6 },
    ],
    typical_finish_times: {
      beginner: "16–20h",
      intermediate: "13–16h",
    ...
    similar_races: ["belgian-waffle-ride", "leadville-trail-100-mtb", "strade-bianche-gran-fondo"],
    month: "May",
    website: "https://www.unboundgravel.com",
    tags: ["gravel", "usa", "kansas", "ultra endurance", "flint hills", "race"],
    predictor_slug: "unbound-gravel-200",
  },
  {
    ...
    difficulty: 5,
    description:
      "A high-altitude mountain bike classic where the course profile only tells half the story. Leadville starts above 3,000m and repeatedly asks riders to climb while oxygen is scarce. The Columbine Mine climb, Powerline and long dirt-road sections make pacing, gearing, hydration and altitude management decisive.",
    key_climbs: [
      { name: "Columbine Mine", elevation_m: 3810, length_km: 15.0, avg_gradient: 6.0 },
      { name: "Powerline", elevation_m: 3400, length_km: 5.5, avg_gradient: 8.0 },
      { name: "St Kevins", elevation_m: 3300, length_km: 4.5, avg_gradient: 7.5 },
    ],
    typical_finish_times: {
      beginner: "11–12h cutoff fight",
      intermediate: "9–11h",
      advanced: "7:30–9h",
      elite: "6–7:30h",
    },
    similar_races: ["unbound-gravel", "belgian-waffle-ride", "haute-route-alps"],
    month: "August",
    website: "https://www.leadvilleraceseries.com",
    tags: ["mtb", "usa", "colorado", "altitude", "ultra endurance", "race"],
    predictor_slug: "leadville-trail-100-mtb",
  },
  {
    name: "Raid Pyrénéen",
    slug: "raid-pyreneen",
