  ...
  return (
    <div className="rounded-xl border border-coral/30 bg-coral/[0.06] p-5 mt-4">
      ...
      <a
        ...
        onClick={onClick}
        className="inline-flex items-center justify-center whitespace-nowrap font-heading tracking-wider uppercase bg-coral hover:bg-coral-hover text-off-white text-sm leading-none min-h-[44px] px-6 py-3 rounded-md transition-colors"
      >
        Go there
      </a>
    </div>
