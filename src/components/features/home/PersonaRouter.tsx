            ...
            >
              ...
              <div
                className="
                  ...
                  border border-white/5 hover:border-coral/40 focus:border-coral/40
                  p-6 md:p-7
              ...
              >
                ...
                >
                  <p className="font-heading text-lg md:text-xl text-off-white leading-tight mb-3 transition-colors group-hover:text-coral">
                ...
                <Link
                  href="/apply"
                  className="mt-3 pt-3 border-t border-white/5 text-xs font-body text-foreground-muted hover:text-coral transition-colors flex items-center min-h-[40px]"
                >
