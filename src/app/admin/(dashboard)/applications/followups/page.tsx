...
export default async function NdyFollowupsPage() {
  ...
  return <div className="mx-auto max-w-6xl p-6">
    ...
    <p className="mt-3 text-base text-foreground-muted">Application emails, checkout interest and Sarah’s daily question-review queue. Operational alerts go to Anthony; Beehiiv acceptance confirms enrollment in the automation, with delivery and opens available in Beehiiv.</p>
