...
export default async function NdyFollowupsPage() {
  ...
  return <div className="mx-auto max-w-6xl p-6">
    ...
    <p className="mt-3 text-base text-foreground-muted">Application decisions, trial interest and questions for Sarah. Beehiiv acceptance confirms enrollment in the automation; delivery and opens remain in Beehiiv. Direct inbox replies are not synced here.</p>
