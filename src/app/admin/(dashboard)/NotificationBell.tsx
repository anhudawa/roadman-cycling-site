  ...
  return (
    <div ref={wrapRef} className="relative">
      ...
      >
        ...
        {unread > 0 && (
          <span className="absolute -top-0.5 -right-0.5 flex items-center justify-center min-w-[18px] h-[18px] px-1 text-[10px] font-bold text-white bg-[var(--color-coral)] rounded-full">
            {unread > 99 ? "99+" : unread}
          </span>
        )}
      </button>
                    ...
                    <li key={n.id}>
                      ...
                      >
                        <div className="flex items-start gap-2">
                          {isUnread && (
                            <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[var(--color-coral)] shrink-0" />
                          )}
