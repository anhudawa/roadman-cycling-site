...
export async function GET() {
  const data = {
    ...
    podcastDownloads: `${BRAND_STATS.podcastDownloads}+`,
    podcastDownloadsLabel: BRAND_STATS.podcastDownloadsLabel,
    youtubeSubscribers: `${BRAND_STATS.youtubeSubscribers}+`,
    youtubeSubscribersLabel: BRAND_STATS.youtubeSubscribersLabel,
    instagramFollowers: `${BRAND_STATS.instagramFollowers}+`,
    instagramFollowersLabel: BRAND_STATS.instagramFollowersLabel,
    ...
    communityMembers: `${BRAND_STATS.communityMembers}+`,
    communityMembersLabel: BRAND_STATS.communityMembersLabel,
