...
/**
 * INTERNAL PREVIEW of the full sales page. Not linked from anywhere public.
 *
 * This is the page we'll swap in as `/blood-engine` when the product launches.
 * For now /blood-engine is a waiting-list landing (see ../page.tsx).
 *
 * `noindex` keeps this out of Google. Anyone with the URL can see it —
 * acceptable as "behind the scenes" security. If we need stricter gating
 * later we'll add a token-cookie check in this file.
 */
export const metadata: Metadata = {
  title: "Blood Engine — Preview (internal)",
  description:
    "Internal preview of the Blood Engine launch page. Not public.",
  robots: {
    index: false,
    follow: false,
