...
export const metadata: Metadata = {
  ...
  description:
    "The weekly training breakdown 30,000+ serious cyclists read on Saturday. What's working, what the pros do, how to apply it this week. From Anthony. Free.",
  alternates: {
  ...
  openGraph: {
    title: "The Saturday Spin — Weekly Cycling Newsletter",
    description:
      "The weekly training breakdown 30,000+ serious cyclists read on Saturday. What's working, what the pros do, how to apply it this week.",
    type: "website",
          ...
          <Container width="narrow" className="text-center">
            ...
            <ScrollReveal direction="up" delay={0.3}>
              <p className="text-foreground-subtle text-sm mt-6">
                Join 30,000+ cyclists. One email a week. Unsubscribe anytime.
              </p>
            </ScrollReveal>
          </Container>
        </Section>
