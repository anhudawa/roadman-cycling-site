...
const audienceStats = [
  { value: "1,400+", label: "Podcast Episodes" },
  { value: "29,000+", label: "Newsletter Subscribers" },
  { value: "2,100+", label: "Community Members" },
  { value: "500+", label: "YouTube Videos" },
];
...
const partnershipOptions = [
  ...
  },
  {
    ...
    description:
      "The Saturday Spin lands in 29,000+ inboxes every week. Dedicated sends or banner placements — your brand in front of cyclists who actually open, read, and click.",
    features: [
      "29,000+ engaged subscribers",
          ...
          <Container className="text-center">
            <ScrollReveal direction="up">
              ...
              <p className="text-foreground-muted text-xl max-w-3xl mx-auto leading-relaxed mb-8">
                Your brand in front of serious cyclists who buy gear, follow
                training plans, and invest in performance. Not casual listeners
                — committed athletes with disposable income and purchase intent.
              </p>
