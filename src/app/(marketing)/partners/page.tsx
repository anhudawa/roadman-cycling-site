...
const partnershipOptions = [
  ...
  },
  {
    ...
    badge: "Highest ROI",
    description:
      "The Saturday Spin Newsletter lands in 29,000+ inboxes every week with a 65%+ open rate. Dedicated sends or banner placements — your brand in front of cyclists who actually open, read, and click.",
    features: [
          ...
          <Container className="text-center relative z-10">
            ...
            <ScrollReveal direction="up" delay={0.2}>
              <p className="text-foreground-muted text-lg md:text-xl max-w-3xl mx-auto leading-relaxed mb-4">
                1 million monthly listeners. 29,000+ newsletter subscribers.
