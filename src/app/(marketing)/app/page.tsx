      ...
      <Section background="charcoal">
        <Container>
          <figure className="mb-14 overflow-hidden rounded-2xl bg-[#f4efe6]">
            <Image src="https://getgoodlegs.com/assets/mascot/scene-strength-960.webp" alt="The Good Legs coach character in a strength-training scene" width={960} height={640} unoptimized className="mx-auto h-auto max-h-[420px] w-full object-contain" />
