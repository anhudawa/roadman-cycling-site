...
export const metadata: Metadata = {
  title: "About $Äî Anthony Walsh & Roadman Cycling",
  description:
...
const expertNetwork: { name: string; role: string; category: ExpertCategory; highlight?: string; slug?: string }[] = [
  ...
  { name: "Dan Lorang", role: "Head of Performance, Red Bull$ÄìBora$ÄìHansgrohe", category: "coach", highlight: "World Tour training methodology" },
  { name: "Greg LeMond", role: "3√ó Tour de France winner", category: "athlete", highlight: "American cycling legend" },
  ...
  { name: "John Wakefield", role: "Red Bull$ÄìBora$ÄìHansgrohe coach", category: "coach", highlight: "World Tour performance" },
  { name: "Michael Matthews", role: "15+ year World Tour pro", category: "athlete", highlight: "Grand Tour stage winner" },
  { name: "Dan Bigham", role: "Head of Engineering, Red Bull$ÄìBora$ÄìHansgrohe", category: "athlete", highlight: "Former UCI Hour Record holder" },
...
const milestones = [
  { year: "2021", event: "Roadman Cycling Podcast launches", icon: "üéôÔ∏è" },
  { year: "2022", event: "1 million downloads", icon: "üìà" },
  { year: "2023", event: "Sarah joins the podcast team", icon: "ü§ù" },
  { year: "2024", event: "Greg LeMond interview $Äî a career highlight", icon: "üèÜ" },
  { year: "2025", event: "1 million monthly listeners", icon: "üîä" },
  { year: "2026", event: "Not Done Yet coaching community launches", icon: "üí™" },
  { year: "NOW", event: "New site. New era. We're just getting started.", icon: "üöÄ" },
];

export default function AboutPage() {
  return (
    <>
      {/* Full Person entity for Anthony Walsh $Äî supports Google Knowledge Panel
      ...
      <JsonLd
        data={{
          ...
          description:
            "Cycling coach and founder of Roadman Cycling. Host of the Roadman Cycling Podcast, with over 1,400 conversations with World Tour coaches, sports scientists, and professional riders $Äî including Prof. Stephen Seiler, Dan Lorang, Greg LeMond, and Lachlan Morton.",
      ...
      <main id="main-content">
          ...
          <Container className="text-center">
            <ScrollReveal direction="up">
              ...
              <p className="text-foreground-muted text-xl max-w-3xl mx-auto leading-relaxed">
                The best information in sport $Äî the stuff that actually moves
                the needle $Äî reaches elite athletes first, then the mega-rich,
                and takes years to filter down to the rest of us. I set out to
                short-circuit that. To connect you directly with the coaches,
                scientists, and riders at the tip of the spear $Äî so you get
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="relative aspect-[4/3] md:aspect-[9/16] rounded-xl overflow-hidden">
                  <Image
                    ...
                    alt="Anthony Walsh $Äî close-up profile after a ride"
                    fill
            ...
            <div className="space-y-6 text-foreground-muted leading-relaxed">
              <ScrollReveal direction="up" delay={0.1}>
                <p>
                  ...
                  strategies $Äî they stay behind closed doors. Roadman Cycling
              ...
              <ScrollReveal direction="up" delay={0.15}>
                <p>
                  ...
                  picked up a microphone and went straight to the source $Äî
              ...
              <ScrollReveal direction="up" delay={0.25}>
                <p>
                  Today, 1 million monthly listeners tune in $Äî not casual fans,
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      {/* Content card $Äî mobile: always right of line, desktop: alternating */}
        ...
        {/* Coaching CTA $Äî caught mid-story, highest-intent moment */}
            ...
            <ScrollReveal direction="up">
              <div className="rounded-2xl border border-coral/20 bg-gradient-to-br from-coral/10 via-deep-purple/40 to-charcoal p-8 md:p-12 text-center">
                ...
                <p className="text-foreground-muted text-lg mb-8 max-w-xl mx-auto leading-relaxed">
                  ...
                  riders in the sport $Äî distilled into a plan built around
        ...
        <Section background="deep-purple" grain>
          <Container>
            ...
            {/* CTA $Äî apply is primary; free community + press are softer options */}
