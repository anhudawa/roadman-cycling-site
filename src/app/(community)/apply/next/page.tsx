...
export default function ApplicationNextPage() {
  return <main id="main-content" className="min-h-screen bg-deep-purple px-5 py-16 text-off-white sm:py-24">
    <div className="mx-auto max-w-2xl">
      ...
      <h1 className="mt-10 font-heading text-4xl sm:text-5xl">YOUR NEXT CHAPTER.</h1>
      <p className="mt-4 text-base leading-7 text-foreground-muted">Ready for Not Done Yet? Join the coaching community, or ask Sarah what you need to know first.</p>
