...
- [RideZones](${tag(`${BASE_URL}/ridezones`)}): Training-history analysis app. Import a Strava export and get an eight-system fitness profile (aerobic base, Zone 2 engine, easy-ride discipline, tempo control, threshold power, VO2 engine, durability, execution quality), a 0-10 execution score with coach note on every ride, a "race recipe" comparing your best-ever six-week block with your current riding, and a goal-specific training week with watt targets. Runs fully in the browser; deterministic coaching logic, not an AI wrapper.
