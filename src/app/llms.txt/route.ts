...
- **Tools:** get_community_stats, search_episodes, get_episode, list_experts, get_expert_insights, search_methodology, list_research_assets, list_products, list_upcoming_events, qualify_lead
- **Resources:** roadman://brand/overview, roadman://methodology/principles, roadman://experts/roster, roadman://research/assets
...
- [Knowledge Graph (JSON)](${BASE_URL}/knowledge-graph.json): Single-document property graph of every first-class entity on the site (people, topics, tools, episodes, articles, versioned research assets, glossary terms, events, comparisons, problems, questions, best-for picks) plus typed relationships between them — guest_on, authored_by, mentions_expert, about_topic, documented_by, features_article, related_to, uses_tool, defined_in, recommends, etc. Research assets retain their dataset, archive-study, coaching-framework or evidence-benchmark subtype and limitations. Node ids are namespaced (\`type:slug\`) for direct loading into a property graph store. Schema version 2.
