...
function buildStaticSitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${BASE_URL}/tools/ftp-test`, lastModified: new Date("2026-08-26"), changeFrequency: "weekly", priority: 0.8 },
    ...
    { url: `${BASE_URL}/tools/strength-session-planner`, lastModified: new Date("2026-08-28"), changeFrequency: "weekly", priority: 0.85 },
