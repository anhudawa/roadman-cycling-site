...
export default function PredictPage() {
  ...
  // Inline validation derived from current state. Empty strings mean the
  // field is fine. We compute these synchronously so the submit button + the
  // field decorations stay in lockstep with input.
  ...
  async function handleSubmit() {
    ...
    setSubmitting(true);
    try {
      // 12-second client-side timeout — engine should answer in well under 3s.
          ...
          <Container>
            ...
            <div className="relative">
              ...
              <GpxDropzone
                ...
                onChange={(g) => {
                  setGpx(g);
                  if (g) setCourseSlug(""); // deselect curated when uploading
                }}
              />
            </div>
          </Container>
...
interface NumberFieldProps {
  ...
  /** Inline error to surface beneath the input. Empty/undefined = field is fine. */
  error?: string;
}
