        ...
        <Section background="deep-purple" grain>
          <Container width="narrow">
            ...
            <div className="text-foreground-muted text-sm leading-relaxed space-y-3">
              <p>
                <strong className="text-off-white">Formula:</strong> W/kg = FTP (watts) Ã· Body weight (kg).
                FTP should be determined from a 20-minute all-out test (Ã—0.95) or ramp test.
              </p>
              <p>
