...
const TOPICS: TopicDef[] = [
  ...
  { slug: "cycling-beginners", title: "Getting Into Cycling", headline: "START HERE", description: "Everything a new cyclist needs to know. Group ride etiquette, bike fit, gravel cycling, tyre pressure, and the culture of the sport.", pillar: "le-metier", keywords: ["beginner cycling", "start cycling", "cycling tips beginners", "group ride etiquette"] },
  ...
  { slug: "mountain-biking", title: "Mountain Biking — Setup, Skills & Routes", headline: "DIAL IN YOUR MTB", description: "Everything you need to set up, ride, and maintain your mountain bike. Suspension setup, tyre pressure, fork tuning, trail guides.", pillar: "le-metier", keywords: ["mountain bike setup", "mtb tyre pressure", "fork setup mtb", "mountain bike suspension"] },
];
...
// ---------------------------------------------------------------------------
async function main() {
  console.log("🏔️ Topic Hub Pillar Content Generator");
  ...
  console.log(`📝 ${topics.length} hubs to generate\n`);
