...
const CURATED: string[] = [
  ...
  `https://${HOST}/podcast`,
  `https://${HOST}/research/cycling-podcast-archive-study`,
  ...
  `https://${HOST}/blog/cycling-core-workout-routine`,
  `https://${HOST}/blog/core-strength-cyclists-beyond-planks`,
  ...
  `https://${HOST}/blog/cycling-sleep-performance-guide`,
  `https://${HOST}/blog/sleep-cycling-performance-complete-guide`,
  `https://${HOST}/blog/cycling-sleep-optimisation`,
  `https://${HOST}/blog/cycling-sleep-optimisation-performance-guide`,
  `https://${HOST}/blog/cycling-hrv-training-guide`,
  `https://${HOST}/blog/cycling-heart-rate-variability-guide`,
  ...
  `https://${HOST}/blog/cold-water-immersion-cyclists`,
  `https://${HOST}/blog/cycling-foam-rolling-self-massage-guide`,
  `https://${HOST}/blog/massage-guns-cyclists-worth-it`,
  `https://${HOST}/blog/cycling-tart-cherry-juice-recovery-guide`,
  ...
  `https://${HOST}/blog/blood-testing-cyclists-what-to-check-guide`,
  `https://${HOST}/blog/iron-deficiency-cyclists-masters`,
  `https://${HOST}/blog/cycling-iron-ferritin-endurance-guide`,
  ...
  `https://${HOST}/blog/cycling-thyroid-function-performance-guide`,
  `https://${HOST}/blog/energy-availability-red-s-cyclists-guide`,
  ...
  `https://${HOST}/blog/cycling-mobility-routine`,
  `https://${HOST}/blog/glute-activation-cyclists-power-leaks`,
  `https://${HOST}/blog/cycling-glute-activation-power-guide`,
