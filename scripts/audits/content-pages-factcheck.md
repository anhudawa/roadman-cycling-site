...
Supporting data:
- `src/lib/training-plans.ts` (14 events Ã— 6 phases)
...
| **Mallorca 312** | Implied Sa Calobra is always on the 312 route and described it as the crux. Route varies year to year; some editions omit Sa Calobra entirely. | Softened: Sa Calobra described as featuring "in some editions"; the pacing-strategy crux generalised to "the final named climb". Tramuntana range (Puig Major, Coll de SÃ³ller, Coll dels Reis) retained as the reliable signature climbs. |

Events verified with **no** factual corrections needed:
- Wicklow 200 (200 km / ~3,000 m / June)
- Ã‰tape du Tour (variable route / July)
- Maratona dles Dolomites (138 km / 4,230 m / July / 7 passes: Campolongo, Pordoi, Sella, Gardena, Giau, Falzarego, Valparola $€” all correct; Passo Giau at 9.9 km Ã— 9.3 % correct)
...
- **Rosa KlÃ¶ser** $€” "2024 Unbound 200 winner." Correct; override adds 2025 German gravel national champion + CANYON//SRAM zondacrypto team (verified).
...
|---|---|---|---|
| Prof. Seiler on Polarised Training | `ep-2148-80-20-training-to-ride-faster-dr-stephen-seiler` | Stephen Seiler | $œ… Resolves; matches card |
| Dan Lorang: How RogliÄ's Coach Trains Amateurs | `ep-2134-roglics-coach-builds-a-training-plan-for-amateur-riders-dan` | Dan Lorang | $œ… Resolves; card correctly describes him as Head of Performance at Red Bull$€“Bora$€“Hansgrohe |
| Joe Friel on Structuring Training | `ep-40-how-joe-friel-structures-the-ideal-cycling-training-week` | Joe Friel | $œ… Resolves; matches card |
| Greg LeMond: My Untold Story of EPO | `ep-2210-my-untold-story-of-epo-greg-lemond` | Greg LeMond | $œ… Resolves; card correctly calls out "most-watched episode on YouTube" |
...
- Seiler @ Univ. of Agder $œ…
- Lorang @ Red Bull$€“Bora$€“Hansgrohe $œ…
- Bigham @ Red Bull$€“Bora$€“Hansgrohe $œ…
- Jeukendrup credited for nutrition alongside Impey + Larson $œ… (the fuelling tool's Jeukendrup attribution is also correct, not Tim Spector)
- Derek Teel for S&C $œ…
