...
**Issue:** Prior pass wrote "GÃ¸ran Kjerland" for Seiler's co-author. The verification brief also specified "GÃ¸ran (NOT Glenn)" $€” but the PubMed record, the Scandinavian Journal of Medicine & Science in Sports listing, Wiley's author page and Semantic Scholar all agree the co-author is **Glenn Ã˜vrevik Kjerland**. "GÃ¸ran" is the incorrect form.

**Fix:** "GÃ¸ran Kjerland" $†’ "Glenn Ã˜vrevik Kjerland"
...
### 6. Hallucinated ID $€” RÃ¸nnestad/Hansen/Raastad in masters report

**File:** `content/blog/masters-cycling-training-report-2026.mdx` line 106

**Issue:** Cited "RÃ¸nnestad, Hansen & Raastad, 2010" as **PubMed 20857298**, which resolves to "Prenatal treatment with retinoic acid activates parathyroid hormone-related protein signaling in the nitrofen-induced hypoplastic lung" (Doi et al., *Pediatr Surg Int*, 2011) $€” a paediatric surgery paper.

**Fix:** `20857298` $†’ `19903319` (RÃ¸nnestad, Hansen, Raastad, "Strength training improves 5-min all-out performance following 185 min of cycling", *Scand J Med Sci Sports*, 2011). Year also updated from 2010 $†’ 2011 to match PubMed record.
...
- **LeMond** correctly stated as three-time Tour champion in all files $€” no "2Ã— Tour" error in prose.
