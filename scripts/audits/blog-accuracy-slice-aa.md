...
**Date:** 2026-04-23
**Scope:** 32 blog posts in `content/blog/` (see list below)
...
1. `content/blog/70-3-bike-training-plan-12-weeks.mdx`
2. `content/blog/aero-position-training-for-triathletes.mdx`
3. `content/blog/aero-vs-weight-cyclist.mdx`
4. `content/blog/age-group-ftp-benchmarks-2026.mdx`
5. `content/blog/alex-larson-body-composition-cyclists.mdx`
6. `content/blog/alistair-brownlee-endurance-lessons.mdx`
7. `content/blog/badlands-800km-fuelling-strategy.mdx`
8. `content/blog/best-cycling-coach-masters-riders.mdx`
9. `content/blog/best-cycling-podcasts-for-2026-edition.mdx`
10. `content/blog/best-cycling-training-podcasts-age-groupers.mdx`
11. `content/blog/best-gravel-trails-ireland.mdx`
12. `content/blog/best-indoor-cycling-podcasts-winter.mdx`
13. `content/blog/bike-leg-of-triathlon-why-age-groupers-get-it-wrong.mdx`
14. `content/blog/breathing-techniques-cycling-performance.mdx`
15. `content/blog/brick-workouts-for-ironman.mdx`
16. `content/blog/comeback-cyclist-12-week-return-plan.mdx`
17. `content/blog/common-training-mistakes-from-1300-podcast-episodes.mdx`
18. `content/blog/courtney-conley-cycling-shoes-fit.mdx` *(reviewed, no edit needed)*
19. `content/blog/cycling-active-recovery-rides-guide.mdx`
20. `content/blog/cycling-altitude-training.mdx`
...
**Source:** Brand guardrail in the task brief. The 1,400 figure was scrubbed site-wide recently and this was a stray reintroduction.
...
**Source:** Wehrlin & Hallén (2006), PMID 16311764 — linear decrease in VO2max ~6.3%/1000m in well-trained athletes; other studies land 6–9%. 5% was too generous.
...
**File:** `age-group-ftp-benchmarks-2026.mdx`
**Before:** bare parenthetical "(Pollock, Trappe and Hagberg longitudinal data)"
**After:** linked to Rogers, Hagberg et al., J Appl Physiol 1990 (PMID 2361923), which is the canonical masters-athlete VO2max decline paper from that lineage.
...
| File | Claim | Citation |
|---|---|---|
| `70-3-bike-training-plan-12-weeks.mdx` | Seiler polarised training at University of Agder | https://pubmed.ncbi.nlm.nih.gov/20861519/ |
| `aero-position-training-for-triathletes.mdx` | Seiler polarised model | https://pubmed.ncbi.nlm.nih.gov/20861519/ |
| `aero-vs-weight-cyclist.mdx` | Seiler polarised training | https://pubmed.ncbi.nlm.nih.gov/20861519/ |
| `age-group-ftp-benchmarks-2026.mdx` | Rogers/Hagberg masters longitudinal VO2max | https://pubmed.ncbi.nlm.nih.gov/2361923/ |
| `age-group-ftp-benchmarks-2026.mdx` | Seiler on consistency vs age decline | https://pubmed.ncbi.nlm.nih.gov/20861519/ |
| `alex-larson-body-composition-cyclists.mdx` | Jeukendrup CHO availability review | https://pubmed.ncbi.nlm.nih.gov/24791914/ |
| `alex-larson-body-composition-cyclists.mdx` | Jeukendrup multiple transportable CHO | https://pubmed.ncbi.nlm.nih.gov/20574242/ |
| `alex-larson-body-composition-cyclists.mdx` | Seiler polarised distribution | https://pubmed.ncbi.nlm.nih.gov/20861519/ |
| `alistair-brownlee-endurance-lessons.mdx` | Seiler 80/20 distribution | https://pubmed.ncbi.nlm.nih.gov/20861519/ |
| `badlands-800km-fuelling-strategy.mdx` | Jeukendrup multiple transportable CHO | https://pubmed.ncbi.nlm.nih.gov/20574242/ |
| `best-cycling-coach-masters-riders.mdx` | Seiler polarised | https://pubmed.ncbi.nlm.nih.gov/20861519/ |
| `best-cycling-coach-masters-riders.mdx` | Sarcopenia review (Cruz-Jentoft & Sayer) | https://pubmed.ncbi.nlm.nih.gov/30427277/ |
| `best-cycling-training-podcasts-age-groupers.mdx` | Seiler polarised scaling | https://pubmed.ncbi.nlm.nih.gov/20861519/ |
| `best-indoor-cycling-podcasts-winter.mdx` | Seiler on low-intensity threshold | https://pubmed.ncbi.nlm.nih.gov/20861519/ |
| `bike-leg-of-triathlon-why-age-groupers-get-it-wrong.mdx` | Seiler on grey-zone/polarised | https://pubmed.ncbi.nlm.nih.gov/20861519/ |
| `bike-leg-of-triathlon-why-age-groupers-get-it-wrong.mdx` | Jeukendrup on trainable gut | https://pubmed.ncbi.nlm.nih.gov/20574242/ |
| `breathing-techniques-cycling-performance.mdx` | Romer et al., IMT / TT performance | https://pubmed.ncbi.nlm.nih.gov/17874123/ |
| `breathing-techniques-cycling-performance.mdx` | Seiler on physiological limiters | https://pubmed.ncbi.nlm.nih.gov/20861519/ |
| `brick-workouts-for-ironman.mdx` | Seiler on specificity | https://pubmed.ncbi.nlm.nih.gov/20861519/ |
| `brick-workouts-for-ironman.mdx` | Jeukendrup on CHO & gut training | https://pubmed.ncbi.nlm.nih.gov/20574242/ |
| `comeback-cyclist-12-week-return-plan.mdx` | Seiler on low-intensity adaptation | https://pubmed.ncbi.nlm.nih.gov/20861519/ |
| `common-training-mistakes-from-1300-podcast-episodes.mdx` | Seiler training distribution | https://pubmed.ncbi.nlm.nih.gov/20861519/ |
| `common-training-mistakes-from-1300-podcast-episodes.mdx` | Jeukendrup multiple CHO | https://pubmed.ncbi.nlm.nih.gov/20574242/ |
| `cycling-active-recovery-rides-guide.mdx` | Seiler on easy days being easy | https://pubmed.ncbi.nlm.nih.gov/20861519/ |
| `cycling-altitude-training.mdx` | Levine & Stray-Gundersen 1997 Live High Train Low | https://pubmed.ncbi.nlm.nih.gov/9216951/ |
| `cycling-altitude-training.mdx` | Wehrlin & Hallén 2006 VO2max ~6%/1000m | https://pubmed.ncbi.nlm.nih.gov/16311764/ |
...
- **Dan Lorang** — always paired with Frodeno / Haug / Lucy Charles-Barclay and / or described as "Head of Performance at Red Bull-Bora-Hansgrohe". No Gustav Iden / Kristian Blummenfelt attribution anywhere. ✓
- **Tim Spector** — only referenced in `best-cycling-training-podcasts-age-groupers.mdx` and `best-indoor-cycling-podcasts-winter.mdx`, correctly framed around ZOE / microbiome / personalised nutrition. ✓
- **Dan Bigham** — always "former UCI Hour Record holder" and / or "Head of Engineering at Red Bull-Bora-Hansgrohe". No "Ineos Grenadiers" attribution anywhere. ✓
- **Rosa Kloser** — no references in slice AA. ✓
- **Greg LeMond** — one reference in `best-cycling-podcasts-2026.mdx`, simply "Greg LeMond interview". No 2× claim. ✓
- **Lachlan Morton** — one reference in `best-cycling-podcasts-for-2026-edition.mdx` and one in `best-cycling-podcasts-2026.mdx`, no Tour Divide FKT numbers cited. ✓
- **Stephen Seiler** — always "University of Agder", always polarised / 80-20. ✓
- **Joe Friel** — correctly cited as author of *The Cyclist's Training Bible*. ✓
- **Anthony Walsh** — "1,300+ episodes" throughout slice AA after the one-line fix in §2.2. No "1,400+" remaining. ✓
