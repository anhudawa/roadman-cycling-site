...
**Goal:** Welcome > Build trust > Demonstrate value > Convert to Not Done Yet community
...
**CTA Button:** Listen to the Podcast
**Destination:** https://roadmancycling.com/podcast
...
The intersection of nutrition and performance that nobody talks about honestly. How to get leaner without losing power, how to fuel properly, and why most cyclists are eating wrong in both directions.
[Read it here](https://roadmancycling.com/blog/cycling-body-composition-guide)
...
**Preview text:** It's not fitness. It's the four things around your fitness that you're ignoring.
...
**CTA Button:** Check Your FTP Zones
**Destination:** https://roadmancycling.com/tools/ftp-zones-calculator
...
Brian didn't need more hours. He needed all five pillars working together for the first time. Better nutrition. Targeted strength work. Structured recovery. A coach reviewing his files. His words: "This really works. I'm training so much less than last year, at lower intensities and not getting sick."
...
**CTA Button:** Read More Member Stories
**Destination:** https://roadmancycling.com/community/not-done-yet
...
**Preview text:** Built these for you. No sign-up. No paywall. Just use them.
...
Your tyre pressure should change based on your weight, tyre width, and road surface. Most riders are running the same pressure they set when they bought the bike. This fixes that.
...
**CTA Button:** See All Free Tools
**Destination:** https://roadmancycling.com/tools
...
Professor Stephen Seiler calls it the black hole of training intensity. You're working hard enough to build fatigue but not hard enough to build fitness. Your body adapts to mediocrity and stops responding.

Here's what it looks like in practice:

- Your "easy" rides average 0.70-0.75 IF instead of 0.55-0.65
- Your "hard" sessions never truly hurt because you're always carrying fatigue from yesterday's "easy" ride that wasn't easy
...
P.S. If you want the full breakdown, read the [Polarised Training Guide](https://roadmancycling.com/blog/polarised-training-cycling-guide) on the site. It goes deep on this.

**CTA Button:** Read the Polarised Training Guide
**Destination:** https://roadmancycling.com/blog/polarised-training-cycling-guide
...
**Preview text:** This isn't a sales pitch. It's an honest look at what exists and who it's for.
...
For years, I watched podcast listeners and newsletter readers consume incredible information and get nowhere with it. They knew more about training science than most coaches. But their FTP hadn't moved. Their body composition hadn't changed. Their race results were the same.
...
The name "Not Done Yet" isn't marketing. It's a statement. Every rider inside has decided they haven't peaked. That their best performance is still ahead of them. Whether they're 25 or 55.
...
- Cyclists who are tired of self-coaching and want someone to actually look at their numbers

I'm not going to hard-sell you. You've been reading my emails for nearly two weeks now. You know whether this sounds like what you need.

If it does, have a look. There's a 7-day free trial on both tiers.

Anthony

**CTA Button:** See What's Inside Not Done Yet
**Destination:** https://roadmancycling.com/community/not-done-yet
...
**Preview text:** The free trial, the guarantee, and a straight question.
...
**Camp A:** You're in a good place. The newsletter and podcast give you plenty. The free tools are useful. You'll keep consuming and applying things at your own pace. Brilliant. I'll keep sending you the best stuff I've got every week. No hard feelings.

**Camp B:** Something in the back of your head is telling you that you've been in Camp A for too long. You know the theory. You've read the guides. But your actual training week looks the same as it did a year ago. The gap between knowing and doing is getting wider, not narrower. And you're starting to wonder what would happen if someone actually built the system around you.
...
**CTA Button:** Start Your Free 7-Day Trial
**Destination:** https://roadmancycling.com/community/not-done-yet
...
- **Automation trigger:** New subscriber (all sources)
- **Sender name:** Anthony Walsh
- **Sender email:** anthony@roadmancycling.com
- **Reply-to:** anthony@roadmancycling.com (encourage replies for deliverability)
- **Unsubscribe behaviour:** Standard Beehiiv unsubscribe (required)

### Timing Summary
| Email | Day | Subject | Goal |
|-------|-----|---------|------|
| 1 | 0 | Welcome + expectations | Deliverability, set tone, encourage reply |
| 2 | 1 | Anthony's story | Build trust and credibility |
| 3 | 3 | Best content roundup | Demonstrate value, drive site traffic |
| 4 | 5 | 5-pillar framework | Introduce core philosophy |
| 5 | 7 | Social proof / transformations | Build desire through real results |
| 6 | 8 | Free tools highlight | Drive engagement, show generosity |
| 7 | 10 | Common mistake (grey zone) | Educational value, position as expert |
| 8 | 12 | Soft CTA for Not Done Yet | Introduce offer without pressure |
| 9 | 14 | Direct CTA with trial + guarantee | Convert to community member |

### Post-Sequence
- Subscriber moves to weekly newsletter broadcast list
- Tag: `welcome-sequence-completed`
- If subscriber clicks Not Done Yet link in emails 8 or 9 but doesn't convert, consider a follow-up automation (separate sequence, not part of this one)

### A/B Testing Notes
- Test subject lines for open rate on emails 1, 4, and 7 first (highest-leverage emails)
- Run each test for minimum 48 hours before picking a winner
- Subject Line A is generally the safer, clearer option; Subject Line B is generally more curiosity-driven
- Track click-through rate on emails 3 (content links), 6 (tools), and 9 (CTA) as primary conversion metrics
