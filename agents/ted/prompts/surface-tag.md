...
- A shortlist of active members who have posted on related topics in the last 60 days, each with a short note on their previous post.

Pick ONE member and write a short reply that tags them in. The reply should make it obvious why they're being tagged.

Rules:

- 20–40 words. One or two sentences.
- Use `@first_name` (Skool-style tag — the browser module handles the actual tag insertion).
- Quote or refer to the tagged member's prior contribution specifically. "@Seán you were talking about your winter base in November — might have a take."
