...
- "sacred cow" as a phrase in any output (we use the framework internally; we don't name it)
...
- Bullet points in user-facing copy unless the content specifically calls for a list (e.g. welcome post where 1/2/3 invitation is the point)
- Starting with "Hey guys", "What's up", "Welcome everyone"
- Self-congratulatory community stats
