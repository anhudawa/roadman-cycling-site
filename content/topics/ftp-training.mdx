...
This guide explains what FTP means, how the common tests differ and what the result can and cannot tell you. The links below cover calculations, test selection, improvement and benchmarks.

**Choose the job you need:**

- [Calculate seven FTP-based power zones](/tools/ftp-zones)
- [Choose an FTP test and compare protocol limits](/answers/ftp-test-guide)
- [Convert a completed FTP test result](/tools/ftp-test)
...
The [how to improve FTP guide](/blog/how-to-improve-ftp-cycling) covers improvement tactics. The [cycling training-plan methodology](/topics/cycling-training-plans) explains how a coach turns goals, availability, training history and feedback into a week rather than prescribing one generic FTP plan.
...
| Your question                                    | Useful guide or tool                                                              |
| ------------------------------------------------ | --------------------------------------------------------------------------- |
| What is FTP in cycling, and what are its limits? | This page                                                                   |
| What are my seven FTP power zones?               | [FTP calculator](/tools/ftp-zones)                                          |
| Which FTP test should I use?                     | [FTP test selection guide](/answers/ftp-test-guide)                        |
| How do I convert a completed test result?        | [FTP test result calculator](/tools/ftp-test)                              |
