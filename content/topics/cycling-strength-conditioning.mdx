...
| Exercise | Sets Ã— Reps | Why |
|----------|-------------|-----|
| Back squat or trap-bar deadlift | 4 Ã— 4-6 | Maximum force production for the leg drive |
| Romanian deadlift | 3 Ã— 6-8 | Posterior chain $€” the muscle group most cyclists under-train |
| Bulgarian split squat | 3 Ã— 6-8/leg | Single-leg strength, transfers directly to the pedal stroke |
| Bench press or overhead press | 3 Ã— 5-8 | Upper body durability for sprints, climbing out of the saddle, crash resilience |
| Pull-up or row | 3 Ã— 6-10 | Postural strength to hold the bars under fatigue |
| Plank or weighted carry | 3 Ã— 30-60s | Core stability that keeps the pelvis stable in the saddle |
...
3 Ã— 12 with light weight is hypertrophy work, not strength. Cyclists need force production: 4-6 reps with weight that genuinely challenges you.
