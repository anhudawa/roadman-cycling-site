...
**In this guide:**
- [Why you get dropped on climbs](#why-dropped)
- [Pacing — the number one fix](#pacing)
- [Power-to-weight ratio explained](#power-to-weight)
- [Cadence on climbs](#cadence)
- [Position and bike fit for climbing](#position)
- [The mental side of climbing](#mental)
- [Descending — the other half](#descending)
