...
- **[Stephen Seiler](/guests/stephen-seiler)** — exercise physiologist — on why the polarised training model only works when recovery (especially sleep) matches the training stress. His data on how easy days must be easy to allow proper sleep-driven adaptation is central to this topic.
