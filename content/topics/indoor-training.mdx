...
|---------|----------------------|-------|-------------|
| **Primary focus** | Structured training synced to your outdoor plan | Virtual world, social riding, racing | Structured workouts, AI training plans |
| **Workout structure** | Full TrainingPeaks workout library, auto-synced | Available but secondary | Core feature — AI-driven plans |
| **Outdoor plan integration** | Native — rides sync to your TrainingPeaks calendar | Separate — workouts don't feed your outdoor plan | Standalone — separate from outdoor planning |
| **FTP detection** | TrainingPeaks performance tracking | Ramp test or manual | AI-detected FTP from ride data |
| **Social/gamification** | Minimal — built for focused work | Strong — group rides, races, routes | Minimal — it's about the work |
| **Coaching integration** | Seamless — your coach sees indoor and outdoor together | Limited coach connectivity | Basic coach features |
| **Best for** | Riders with a structured training plan who want indoor sessions to count | Riders who need motivation and variety | Riders who want standalone structured progression |
| **Monthly cost (2026)** | Included with TrainingPeaks Premium | ~$15/month | ~$20/month |

**TrainingPeaks Virtual** is what we use with our Not Done Yet athletes. The advantage is simple: your indoor rides aren't orphaned. They sit in the same training calendar as your outdoor work, your coach can see them, and your TSS and fitness tracking stay consistent across both. If you're working with a coach or following a periodised plan, this integration saves you from the fragmented data problem that plagues riders using separate platforms for indoor and outdoor.
