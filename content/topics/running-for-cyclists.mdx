...
If you're coming from the other direction — a runner adding cycling rather than a cyclist adding running — we've built an equally thorough guide at [Cycling for Runners](/topics/cycling-for-runners). Same evidence base, mirrored problem: your engine transfers, your saddle time doesn't. And whichever direction you're travelling, the [Run↔Ride Converter](/tools/run-ride-converter) translates fitness between the two sports — pace to power and back.
