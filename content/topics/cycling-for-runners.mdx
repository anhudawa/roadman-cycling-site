...
If you're coming at this from the other side — a cyclist adding running — the mirror guide is [Running for Cyclists](/topics/running-for-cyclists): same physiology, opposite risk profile. And for either direction, the [Run↔Ride Converter](/tools/run-ride-converter) translates your running fitness into cycling terms, pace to power and back.
