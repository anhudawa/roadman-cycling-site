...
**The immediate window.** Get a recovery shake in within 30 minutes of finishing a hard ride. It does not need to be expensive. Milk, a banana, and a scoop of protein powder. Or chocolate milk — the carb-to-protein ratio is surprisingly close to purpose-built recovery drinks. The point is speed: feed the recovery process while the [enzyme activity is highest](/blog/post-ride-recovery-nutrition-cyclists).
