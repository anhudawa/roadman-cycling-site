...
seoDescription: 'Knee pain from cycling is almost always fixable. The diagnostic order to follow — saddle height, cleats, Q-factor, fit, load — and the red flags.'
excerpt: >-
...
keyTakeaways:
  - "Most cycling knee pain is a bike fit problem, not a medical one, and the diagnostic order matters — saddle height first, then cleats, then fore-aft, Q-factor, crank length, and training load."
  - "Pain location is the single best diagnostic clue: front-of-knee points to saddle too low or cleat too far forward, back-of-knee to saddle too high, inside-knee to cleat rotation or Q-factor mismatch."
  - "Adjust in 5mm increments and test on the same route — change one variable at a time and give it a week before moving to the next."
  - "Shorter cranks (165mm or even 160mm) resolve persistent front-of-knee pain in some riders that no other fit change touches, following the trend seen at pro level."
  - "Red flags requiring a clinician include swelling, locking, instability, night pain, and any pain that does not respond to fit changes within a week."
  - "A genuine structural knee injury caught early is typically a 4-8 week problem; the same injury ridden through becomes a 12-26 week problem or longer."
faq:
...
whoFor:
  - "Cyclists dealing with knee pain who want a clear diagnostic order before booking expensive physio or panicking about cartilage damage"
  - "Riders who recently changed saddle height, cleats, or shoes and now have a new niggle they want to trace back to the cause"
  - "Masters cyclists whose knees complain more than they used to and who need to know the difference between a fit problem and a medical one"
  - "Anyone who has been told to stop riding because of knee pain and wants a second framework before giving up the bike"
roadmanView:
  - "Most cycling knee pain is a fit problem dressed up as a medical problem. I have seen it dozens of times in the community. Someone gets pain, assumes the worst, stops riding for months, and the actual fix was five millimetres on the saddle height."
  - "The diagnostic order matters. Saddle height first, then cleats, then fore-aft, then Q-factor. If you skip straight to an MRI you are spending a thousand pounds to find out your saddle was too high. Check the cheap, simple things first."
  - "The red flags section is the bit I want people to take seriously. Swelling, locking, giving way, pain that wakes you at night. Those are not fit problems. Those are stop-riding-and-see-someone problems. Know the difference."
---
...
The good news, the part I have repeated on the podcast more than once: most knee pain from cycling is fixable, often within days, often without seeing a clinician at all. The order in which you check things matters, and most of it comes back to the basics covered in the [complete bike fit guide](/blog/bike-fit-guide-cyclists). Most riders go straight to the head — "what is wrong with my knee?" — when the answer is almost always somewhere on the bike.

This is the diagnostic sequence used inside the [Roadman coaching programme](/coaching) and the framework [Courtney Conley](/guests/courtney-conley) walks through on the podcast. It is not a substitute for a real bike fit when something is actually off — but it does isolate the cause faster than guessing.
...
[Courtney Conley's](/guests/courtney-conley) [podcast conversation on cleat fit](/podcast/ep-2107-the-surprising-downside-of-incorrect-cycling-shoes-courtney) covers the practical setup in detail, and the [bike fit summary article](/blog/courtney-conley-cycling-shoes-fit) walks through the assessment.
