...
seoTitle: 'MTB Nutrition: How to Fuel Trail Rides Without Bonking'
seoDescription: 'Practical MTB nutrition — what to carry, when to eat, and how to fuel rough singletrack without the sugar-bonk cycle that wrecks most riders by hour three.'
...
keyTakeaways:
  - "Eat on the climbs and fire roads, never on descents — both for safety and because elevated heart rate on technical sections kills gut absorption."
  - "Pre-open every gel before you leave. One-handed access on rough terrain is the difference between fuelling and skipping."
  - "Hydration packs beat bottles on anything over two hours or remote trails. The convenience of sipping without taking a hand off the bars is what keeps fluid intake honest."
relatedEpisodes:
...
whoFor:
  - "Mountain bikers who bonk on longer rides because rough terrain makes eating difficult"
  - "Trail riders unsure how to carry and consume fuel when both hands need to stay on the bars"
  - "XC racers who need a fuelling strategy for race intensity over 90 minutes"
  - "Anyone debating hydration packs versus bottles for different ride types and durations"
roadmanView:
  - "I've bonked on enough trail rides to know exactly how it happens — MTB fuelling is properly harder than road fuelling. You can't safely take your hands off the bars on rough descents, climbs are often too intense to chew anything, and before you know it you've gone 45 minutes without eating."
  - "Here's what I tell every rider: eat on the climbs and fire roads, never on descents. I pre-open every gel before I leave the car park so I can use them one-handed, and for anything over two hours or remote trails, I always reach for the hydration pack over bottles — hands-free sipping is what keeps fluid intake honest."
  - "I always recommend 60 to 90 grams of carbs per hour on any serious MTB ride over 90 minutes. For XC races, I'd push that to 80 to 120g if your gut is trained for it. I've had this conversation with coaches on the show plenty of times — under-fuelling on the trail isn't toughness, it's just a slower ride home."
---
...
Keep it simple. The best MTB [nutrition](/topics/cycling-nutrition) is fuel you will actually eat on the trail.
...
For rides 90 minutes to 3 hours: 60-90g of carbs per hour. That's 2-3 gels per hour, or one gel plus a bar or equivalent chews. The [In-Ride Fuelling Calculator](/tools/fuelling) will set your baseline targets by ride duration and intensity, and the [Calories Burned Calculator](/tools/calories) shows the total energy cost so you can see how much of it your eating plan actually covers.
...
The short answer: it depends on ride length, remoteness, and terrain.
...
**Only drinking, not eating.** Water without carbs for a 3-hour ride is a bonk waiting to happen. [Hydration](/blog/cycling-hydration-guide) and fuelling are separate problems.
...
- Got a specific question — what to pack for a 6-hour trail epic, or how to fuel a back-to-back race weekend? [Ask Roadman](/ask) for an answer grounded in the actual nutrition conversations from the podcast
