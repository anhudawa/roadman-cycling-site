...
seoTitle: 'Triathlon Bike Pacing: FTP Percentages That Work (2026)'
seoDescription: >-
  FTP percentages that actually work for triathlon bike pacing across Sprint,
  Olympic, 70.3 and Ironman — and how to ride them so you can still run off
  the bike.
excerpt: >-
