...
roadmanView:
  - The bike leg is not about producing your biggest number. It is about producing the right number, evenly, for as long as the course demands, while leaving enough in the tank to actually run the marathon.
  - The first 30 minutes of a triathlon bike leg feels easy because you are fresh and the adrenaline is high. That is exactly when riders drift 10 to 15 watts above plan, spend the last hour decaying, and walk the run. Smooth is fast.
  - Kienle, Sanders and Brownlee have all sat on this podcast and said the same thing in different words. Err low. The run punishes every watt you steal from the bike.
---
