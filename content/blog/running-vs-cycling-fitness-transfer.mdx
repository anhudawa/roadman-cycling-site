...
whoFor:
  - Cyclists curious about how much of their bike fitness carries over to running
  - Runners considering cycling as cross-training
  - Anyone confused about why a high VO2max on the bike does not mean fast running
  - Riders planning a transition between sports or adding a second discipline
roadmanView:
  - Your heart does not care whether it is pumping blood to quads on a bike or calves on a road. The central engine transfers. The peripherals do not.
  - I had a strong VO2max on the bike and could barely run 5K without my calves seizing. That is the fitness transfer problem in one sentence.
  - The research is clear — cardiovascular fitness crosses over, musculoskeletal readiness does not. Plan accordingly or learn the hard way.
---
