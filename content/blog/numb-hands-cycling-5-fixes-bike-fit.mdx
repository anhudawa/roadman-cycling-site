...
seoDescription: >-
  Numb hands while cycling are usually nerve compression, and fixable. Five
  causes and the changes to make in order before you pay for a pro bike fit.
description: >-
...
faq:
  ...
  - question: Can numb hands cause permanent damage?
    answer: >-
      ...
      mileage.
whoFor:
  - Cyclists whose hands go numb after an hour or more in the saddle
  - Riders considering paying for a professional bike fit to fix hand pain
  - Long-distance and sportive riders with persistent comfort problems
  - Anyone who has been told to just wear thicker gloves and knows that is not the answer
roadmanView:
  - "I answered this one on the podcast because it comes up constantly and the answer is almost always the same — it is nerve compression, not circulation, and you can fix it yourself before spending money on a bike fit."
  - "The discipline is changing one thing at a time. Move your hoods, ride a week, reassess. Move your saddle, ride a week, reassess. Most riders change three things at once and learn nothing."
  - "If you have tried all five fixes and the numbness persists, then a bike fit is money well spent. But not before."
---

Numb hands are one of the most common rider support questions on the Roadman Cycling Podcast. The framing of the question almost always starts the same way — the rider has read that hand numbness is a sign of a bad bike fit, cannot afford a professional fit right now, and wants to know what to do in the meantime. The good news is that numb hands are almost always fixable through a structured sequence of self-directed changes, and that the rider does not need to wait for a bike fit to start solving the problem.
...
The fix sequence works from cheapest to most expensive. Start with tyre pressure. Most amateurs ride too hard. The [Roadman tyre pressure calculator](/tools/tyre-pressure) is the free first intervention — input rider weight, bike weight, tyre width, and surface, and the calculator returns a target pressure significantly lower than most amateurs ride. Lower pressure absorbs more vibration.
...
For gravel riders, the same logic applies but with more headroom. Tyre pressures of 30 to 35 PSI are common at gravel events. Suspension stems and carbon bars are increasingly standard. The trade-off is responsiveness — softer setups absorb more vibration but feel less precise. The practical framing is that the trade-off is worth taking on long gravel events where vibration accumulates across multiple hours.
...
For deeper context on what to expect from a bike fit and which adjustments matter most, see [the complete bike fit guide for cyclists](/blog/bike-fit-guide-cyclists) and [the bike fit one change amateurs should make piece](/blog/bike-fit-one-change-amateurs-should-make).
