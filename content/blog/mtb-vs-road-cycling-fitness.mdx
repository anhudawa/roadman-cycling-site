...
roadmanView:
  - "Here's the thing — I ride both, and the fitness they build is completely different. Road cycling is my better tool for aerobic capacity and threshold power because I can hold a target wattage for 20-60 minutes without the terrain knocking me off it. MTB builds strength endurance and punchy power that road riding simply cannot match."
  - "I see this all the time with NDY athletes who come from a mountain biking background — their FTP is 20-30 watts lower than their aerobic fitness suggests. The gap exists because you physically cannot do sustained threshold work on singletrack. If that's you, the fix is two structured indoor sessions a week."
  - "The riders I coach who progress fastest across both disciplines periodise them deliberately — one primary per training block, with the other supporting it. Do both, and be deliberate about when."
---
...
**Zone 2 volume.** Mitochondrial density, fat oxidation, and aerobic base are built through long, controlled low-intensity work. Road rides of 2-5 hours at 65-75% of max HR are the gold standard for this adaptation. On an MTB, zone 2 is almost impossible to hold — the terrain forces you above threshold every few minutes. Our [zone 2 training guide](/blog/zone-2-cycling-heart-rate-vs-power-vs-rpe) explains why this work matters and how to programme it properly.
...
- If you are serious about your numbers, read our [FTP training zones guide](/blog/ftp-training-zones-cycling-complete-guide) and [zone 2 training guide](/blog/zone-2-cycling-heart-rate-vs-power-vs-rpe)
