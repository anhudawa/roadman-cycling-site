...
roadmanView:
  - "Pantani's 37:35 in 1995 has stood for over 30 years. No one has beaten it. The doping context is inseparable from the number, but the number itself remains the benchmark — and the fact that cleaner-era riders haven't touched it tells you something about the era it came from."
  - "The 2026 Tour finishes on Alpe d'Huez on consecutive days for the first time in history. Stage 20 arrives via the Galibier at 2,642m with roughly 5,600m of total climbing. That's a queen stage by any definition, and it's the first time we'll see back-to-back finishes on the 21 hairpins."
  - "The Dutch connection is real: more Dutch stage wins on this climb than any other nation, earned it the name 'the Dutch Mountain.' The orange smoke and the roadside chaos are as much a part of Alpe d'Huez as the gradient. If you go to ride it, go when the Tour is there."
---
