...
roadmanView:
  - Tubeless is faster and more puncture-resistant, but the margins are smaller than the marketing implies. Against latex or TPU tubes the saving drops to one to three watts per tyre. That matters to racers. It is invisible to most riders.
  - The failures that do happen with tubeless are messier to fix roadside, and sealant dries out in two to four months. Running it dry is the most common reason tubeless fails to seal a puncture it should have handled. Maintain the system or stay on clinchers.
  - Getting tyre pressure right matters more than the tubeless-versus-clincher choice. A well-set-up clincher beats a poorly inflated tubeless setup every time.
---
