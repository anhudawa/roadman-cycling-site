...
answerCapsule: >-
  A power meter measures outdoor power on the bike you actually ride; a smart trainer measures and controls power indoors on a stationary setup. Both cost roughly £450–£800 at entry level in 2026. The correct first purchase depends on ride mix: if more than 60% of annual hours are outdoors, buy the power meter first. If winter weather, family logistics, or safety push you indoors for most structured sessions, buy the smart trainer. Accuracy is comparable; portability and training intent decide the order.
faq:
  - question: "Is a power meter or smart trainer more accurate?"
    answer: >-
      Both measure to roughly ±1–2% at the current generation. Direct-drive smart trainers like the Wahoo Kickr and Tacx Neo are typically ±1%. Crank and pedal-based power meters from Favero, Quarq, and 4iiii sit at ±1–2%. For training purposes the difference is meaningless. What matters is consistency — use the same device for threshold tests and zone setting, not a mix.
  - question: "Can I use one device to calibrate the other?"
    answer: >-
      Not reliably. Indoor and outdoor power often read 5–15W apart because of drivetrain losses, measurement location, and temperature. Treat them as two separate data streams with their own zones if needed. Prof. Seiler has pointed out that training stress is best tracked by consistent device use over time, not cross-device comparison. Pick one as your primary reference and stick to it.
  - question: "What's the minimum budget for either in 2026?"
    answer: >-
      Entry-level single-sided power meters from 4iiii or Stages start around £280–£350. Dual-sided pedals like Favero Assioma Duo sit at £600–£700. Smart trainers begin at £450 for wheel-on models like the Wahoo Kickr Core and reach £1,200+ for top-end direct-drive units. For a realistic first purchase with decent accuracy, budget £500–£700 either way.
  - question: "Do I need both eventually?"
    answer: >-
      Most riders training seriously for more than two years end up with both. Outdoor power validates real-world performance; indoor trainers guarantee session completion in bad weather. The question is order, not whether. Around 70% of the coached riders I work with own both within three years of starting structured training.
  - question: "Does Zwift or TrainerRoad require a smart trainer?"
    answer: >-
      No, but the experience is much worse without one. Both platforms accept power meter data from a classic trainer, but you lose ERG mode — the automatic resistance control that holds you at target watts during intervals. Without ERG, structured sessions require constant gear and cadence management. For most riders that's the difference between finishing the workout and bailing at interval four.
---
