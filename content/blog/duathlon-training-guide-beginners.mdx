...
whoFor:
  - "Runners curious about multisport who want an entry point that does not involve swimming or open water"
  - "Cyclists who also run and want a structured 12-week framework for their first run-bike-run event"
  - "Anyone deciding between a duathlon and a triathlon as their first multisport race and wanting an honest comparison"
  - "Runners who own a bike but have never trained on it with structure and need to know what the cycling leg actually demands"
roadmanView:
  - "Duathlon is the obvious entry point to multisport for runners, and I do not understand why it gets so little coverage compared to triathlon. No swimming, no wetsuit, no open-water anxiety — just run, ride, run."
  - "The mistake every runner makes in their first duathlon is going too hard on the first run. You feel strong, the legs are fresh, the adrenaline is high — and then you get on the bike with nothing left. Pace the first run conservatively and race the second one."
  - "You do not need a triathlon bike. A road bike you already own is more than enough for your first duathlon. Spend the money on a proper bike fit and some structured training rather than equipment you might not need."
---
