...
seoDescription: 'S&C coach Derek Teel on the best exercises for cyclists that actually transfer to power. The lifts to keep, the ones to drop, and how to programme them.'
excerpt: >-
...
faq:
  - question: What are the best strength exercises for cyclists?
    answer: >-
      S&C coach Derek Teel's framework leans on hip-dominant patterns —
      single-leg deadlifts, Bulgarian split squats, hip thrusts, and step-ups.
      These build the strength pattern that drives the power phase of the
      pedal stroke. Single-leg variations matter most because cycling is a
      unilateral movement. Loaded resistance work in the lower rep range is
      more effective than high-rep, low-load work — the goal is recruitment
      and force production, not muscular endurance.
  ...
  - question: Should cyclists squat or deadlift?
    answer: >-
      ...
      programmes both movements for cyclists rather than choosing one. For our
      amateur 35-55 audience the Roadman approach delivers that same stimulus
      through front-loaded and goblet squat patterns plus single-leg and
      kettlebell hinges, rather than heavy barbell back squats and conventional
      deadlifts — same demand on the muscle, far lower injury exposure. The
      split squat, which both approaches share, adds a single-leg element that
      addresses the left-right asymmetries common in cyclists after years of
      bilateral training.
  - question: Does strength training slow cyclists down?
    answer: >-
      ...
      itself. The key is managing [total training stress](/tools/training-load) across the week, not
      avoiding the gym.
...
keyTakeaways:
  - "Teel's programming targets the hip hinge, single-leg stance, and bilateral push — the exact movement patterns that produce power on the pedal stroke."
  - "High-rep, low-load gym work adds nothing the bike hasn't already given you — the gym is for heavy, low-rep compound loading that builds peak force."
  - "At least 50% of lower-body gym volume should be single-leg work to expose and correct the left-right asymmetries years of bilateral pedalling create."
  - "Anti-rotation and anti-extension core work (Pallof press, dead bug, side plank) transfers to the bike; crunches and sit-ups do not."
  - "Sunde et al. (2010) found maximal strength training improved cycling economy by roughly 5% in trained cyclists after eight weeks."
  - "For the 35-55 amateur audience, Roadman substitutes heavy bilateral barbell lifts with front-loaded, goblet, and single-leg variants — same stimulus, far lower injury exposure."
relatedEpisodes:
...
whoFor:
  - "Cyclists who want an expert's exercise shortlist rather than a generic gym programme pulled from a template"
  - "Riders confused about which strength movements actually transfer to pedalling power and which are wasted effort"
  - "Masters cyclists looking for safe, cycling-specific exercises that load the right patterns without excessive spinal compression"
  - "Home-gym athletes who need a minimal-equipment programme built around dumbbells, kettlebells, and bodyweight"
roadmanView:
  - "When I had Derek Teel on the podcast, he laid out his framework clearly: hip-dominant patterns — single-leg deadlifts, Bulgarian split squats, hip thrusts, step-ups — loaded in low rep ranges with intent. These are the movements that build the power phase of the pedal stroke."
  - "For the Roadman audience aged 35-55, I substitute the heavy bilateral barbell work with front-loaded, goblet, and single-leg variants. Same recruitment demand on the target muscles, substantially lower injury exposure at the shoulder, lower back, and knee."
  - "The 2025 meta-analysis we covered on the site confirmed what Teel told me: cycling-specific strength training improved efficiency and power in trained cyclists. When the evidence and the coaching experience point to the same exercises, I trust the answer."
---
  - cycling-deadlift-guide

Most cyclists who go to the gym follow a programme written for someone else. They pick exercises from a generic template, add some leg press because it "feels like cycling," and wonder why none of it translates to watts. The problem is not that [strength training](/blog/strength-training-cyclists-complete-guide) does not work for cyclists — the evidence is clear that it does. The problem is exercise selection and programming intent.
...
> **Roadman take:** That is Teel's prescription, and it works in supervised settings with athletes already competent under load. For our 35-55 amateur audience — most lifting unsupervised, most with the hip-flexor and pelvic-tilt limitations years of riding produce — we substitute the heavy bilateral lifts (back squat, conventional deadlift) with single-leg and front-loaded variants that deliver the same posterior-chain and quad stimulus at a fraction of the spinal compression and injury risk. The [Should Cyclists Deadlift?](/blog/cycling-deadlift-guide) post lays out the exact substitutions we use.

These three exercises form the foundation. For cyclists looking to build their programme around this logic, the [strength guide](/blog/cycling-strength-training-guide) covers how to sequence and load them across a training block, and the [best gym exercises for cyclists](/blog/cycling-gym-exercises-best) breakdown adds the supporting movements (hip thrust, single-leg variations, anti-rotation core) Teel programmes alongside the big three.
...
If you want a structured approach rather than building from scratch, the [coaching](/coaching) programme can integrate strength work with your riding schedule from the start, rather than trying to bolt it on later. If your question is narrower — what to swap, when to lift relative to a key session, how to handle race week — drop it into the [Roadman AI coach](/ask) and you'll get a direct answer.

The next step is simple: take the Roadman substitutions for Teel's big three — a front-loaded or goblet squat pattern, a single-leg or kettlebell hinge, and the Bulgarian split squat — establish your starting loads this week, and run those three movements for eight weeks with progressive overload. That single decision, made consistently, will do more for your cycling than any amount of accessory work or equipment change.
