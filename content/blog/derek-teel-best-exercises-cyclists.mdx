...
Most cyclists who go to the gym follow a programme written for someone else. They pick exercises from a generic template, add some leg press because it "feels like cycling," and wonder why none of it translates to watts. The problem is not that [strength training](/blog/cycling-strength-training-guide) does not work for cyclists — the evidence is clear that it does. The problem is exercise selection and programming intent.
