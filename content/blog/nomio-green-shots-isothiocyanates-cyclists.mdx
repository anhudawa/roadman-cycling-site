...
**Polyphenols (tart cherry, Montmorency).** Studied for selected performance and recovery outcomes. The newest meta-analysis found possible strength-recovery and C-reactive-protein benefits but no significant pooled soreness effect; cyclist trials conflict. Evidence does not establish that tart cherry suppresses cycling adaptation. See the [reviewed tart-cherry guide](/blog/cycling-tart-cherry-juice-recovery-guide) for the outcome, dose and product boundaries.
