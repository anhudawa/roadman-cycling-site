...
keyTakeaways:
  - "Phase 1 builds the aerobic chassis at 65-75% FTP across six weeks, with heart rate drift under 5% on a 3-hour ride as the benchmark for readiness."
  - "Race intensity for most age-groupers sits at 65-72% of FTP — riding above 75% almost always costs more in run time than it saves on the bike."
  - "Fuelling ramps from 60g carbs/hour in week 1 to 110-120g/hour in Phase 2, using a 1:0.8 glucose-fructose ratio to exceed the 60g single-sugar absorption ceiling."
  - "Recovery weeks at weeks 4, 10, and 13 are non-negotiable — skipping them is the most common cause of arriving at peak weeks already cooked."
  - "The bike-to-run nutrition handoff decides the marathon: 60% of an Ironman run is fuelled by what you ate on the bike."
faq:
...
whoFor:
  - Age-group triathletes 16 weeks out from a full Ironman
  - First-time Ironman athletes building a structured bike plan
  - Experienced triathletes who consistently blow up on the run
  - Time-limited athletes balancing bike and run training without burning out
roadmanView:
  - "I've spoken to enough triathlon coaches on the podcast to be very clear on this — the whole point of the Ironman bike leg is arriving at T2 with legs that can still run a marathon. Most age-groupers ride too hard and pay for it before the half-marathon mark."
  - "When I discussed pacing with Dan Lorang on the show, the numbers were obvious: race intensity for most of us sits at 65 to 72 per cent of FTP. Anything above 75 per cent almost always costs more in run time than it saves on the bike."
  - "I think the biggest thing most age-groupers miss is that 60 per cent of your Ironman run is fuelled by what you ate on the bike. Get the nutrition handoff right and the marathon becomes a different race entirely."
---
...
This plan is the one we use with age-group athletes inside our [triathlon bike coaching](/coaching/triathletes) programme, stripped down to its spine. Three phases, seven to fourteen hours a week, with explicit guardrails to keep the run alive.
...
The taper sessions in Phase 3 cover your race week. Race day itself is a pacing exercise dressed up as a power test. Most age-groupers race their Ironman bike at [65–72% of FTP](/blog/what-wattage-should-you-ride-in-an-ironman). Stronger runners who want to protect the marathon ride closer to 65%. Athletes with weaker run history or limited race experience stay under 70%. Anything above 75% almost always costs more on the run than it saves on the bike.
...
**60–140km.** Settle into goal power. Fuel every 15 minutes by the clock — a feed you have to set a timer for is a feed you actually take. 90–110g of carbohydrate per hour through this block, 600–800ml of fluid, sodium dialled to conditions. Stay aero. The biggest free time on the course is in [the position you hold](/blog/aero-position-training-for-triathletes), not the watts you push.
