...
answerCapsule: >-
  ...
  low-cadence force work at 55-65 rpm builds torque for steep climbs. Cadence
...
keyTakeaways:
  ...
  - "Low-cadence force work — 3 to 5 minutes at 55 to 65 rpm in a big gear at tempo power — builds the torque capacity you need for steep climbs and headwinds. Limit these to two sessions per week to protect your knees."
...
faq:
  ...
  - question: "Can cadence training cause knee pain?"
    answer: "Low-cadence work at high torque can aggravate knee issues if overdone. Keep low-cadence efforts to tempo power — not threshold or above — and limit them to two sessions per week. If you have a history of knee problems, start with 65 rpm rather than 55 and build gradually. High-cadence drills are generally knee-friendly because the forces per pedal stroke are lower."
...
roadmanView:
  - "Everyone argues about whether 90 rpm is the magic number. Nobody tells you how to find your number. The cadence cost test takes 40 minutes and gives you actual data instead of opinions."
  - "Your self-selected cadence is already close to your metabolic optimum — research shows trained cyclists unconsciously pick within 5 rpm of their most efficient rate. But close still leaves room for improvement."
  - "Cadence flexibility matters more than cadence optimality. The rider who can produce threshold power anywhere from 70 to 100 rpm has more tactical options than someone who falls apart outside 85-90."
---
...
- Power: tempo — 76 to 88 per cent of FTP. Not threshold. Not sweet spot. Tempo. The adaptation you want is sustained torque production under aerobic conditions, not a maximal effort that fries your legs. The [low-cadence torque research](/blog/low-cadence-training-cycling-torque-intervals) backs this up — moderate intensity at low rpm drives the best gains.
- Recovery: 4 minutes easy spinning.
- Repeats: 3 to 5, depending on your training phase.

**Frequency:** Twice per week maximum. Low-cadence work at high torque places significant load on the patellofemoral joint. If you have a history of knee issues, start at 65 rpm rather than 55, and keep to one session per week until you know how your knees respond. Check your [heart rate zones](/tools/hr-zones) to confirm you are staying in the right intensity band.
