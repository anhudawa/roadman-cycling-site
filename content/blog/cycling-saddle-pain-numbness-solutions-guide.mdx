...
roadmanView:
  - "If the saddle hurts, the ride is over -- mentally, if not physically. But most saddle problems are not actually saddle problems. Phil Burt's data shows sixty to seventy per cent of riders fix the issue through position changes alone."
  - "The diagnostic sequence matters. Check saddle height first, then setback, then tilt, then width and shape. Changing the saddle before checking position is the most expensive mistake in cycling comfort."
  - "Pain and numbness are different problems with different solutions. Pain is usually about width or position. Numbness is about pressure on soft tissue. Know which one you have before you start fixing things."
---
