...
answerCapsule: >-
  For most riders on most courses, aerodynamics matters more than bike weight. Above 25 km/h on flat or rolling terrain, roughly 80% of a cyclist's power goes to overcoming air drag, while a 1 kg weight saving yields negligible time gain. Weight only becomes decisive on sustained gradients above 6-7% where speeds drop below 18 km/h. Dan Bigham's aerodynamic work shows position and clothing deliver larger gains than frame weight. The engine — sustainable power at threshold — outweighs both equipment variables.
faq:
  - question: Is an aero bike or a lightweight bike better for climbing?
    answer: >-
      It depends on gradient. On climbs under 5-6%, aero bikes are typically faster because speeds stay above 20 km/h where drag dominates. On sustained climbs above 7% where you're riding at 12-15 km/h, a 1-1.5 kg lighter bike saves 20-40 seconds over a 10 km ascent. Most real-world climbs are mixed, which is why all-rounder frames now dominate the WorldTour.
  - question: How much time does 1 kg of bike weight cost on a climb?
    answer: >-
      On a 10 km climb at 7% gradient for a 70 kg rider at 250 W, 1 kg costs roughly 15-20 seconds. On a 5% gradient it drops to 8-12 seconds. On flat ground the difference is under 2 seconds across 40 km. This is why UCI regulations cap bikes at 6.8 kg — going lighter rarely justifies the cost in aero or stiffness compromise.
  - question: At what speed does aerodynamics start to matter?
    answer: >-
      Drag increases with the square of velocity, so it scales sharply. Below 15 km/h, rolling resistance and gravity dominate. Between 15 and 25 km/h, aero becomes significant. Above 25 km/h, roughly 75-85% of your power goes to overcoming air resistance. At 40 km/h, a 10% reduction in drag is worth about 30 W at the same speed.
  - question: Should I buy an aero bike or a climbing bike?
    answer: >-
      For 90% of riders and courses, an all-rounder is the right answer. Modern frames from Specialized, Canyon, Cervélo and Factor weigh 7.2-7.5 kg while being within 5 W of dedicated aero frames. Pure aero bikes suit flat criteriums and time trials. Pure climbing bikes suit mountain stage races. Most riders fit neither profile.
  - question: Does saving body weight matter more than bike weight?
    answer: >-
      Yes, for two reasons. Body weight can realistically drop 3-5 kg for many amateur riders, versus 0.5-1 kg from the bike. And dropping body fat improves power-to-weight without the stiffness and handling trade-offs of ultralight frames. Work out a sensible target with a race-weight calculator rather than chasing grams on components.
---
