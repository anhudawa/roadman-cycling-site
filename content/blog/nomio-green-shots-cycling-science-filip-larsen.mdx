...
The active compound in Nomio is sulforaphane, an isothiocyanate found at high concentration in broccoli sprouts. Sulforaphane's claim to relevance in sport science is what it does inside the cell — specifically what it does to a transcription factor called Nrf2. If you want the full mechanism walked through slowly, [what isothiocyanates actually do for cyclists](/blog/nomio-green-shots-isothiocyanates-cyclists) takes the compound apart step by step.
