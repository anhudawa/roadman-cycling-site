...
seoDescription: >-
  The ultra cycling fuelling strategy behind 800km across Badlands: calorie
  targets, pacing, sleep, and the real-time adjustments that kept him moving.
excerpt: >-
...
keyTakeaways:
  - "Total caloric expenditure across Badlands runs 15,000–22,000 kcal, and riders can only replace 60–75% of that during the race — the deficit is managed, not closed."
  - "Fuelling is phased: 80–90 g/h carbohydrate in the first 24 hours, dropping to 60–75 g/h in hours 24–48, then 50–60 g/h to the finish as fat oxidation covers more demand."
  - "Sleep deprivation directly degrades carbohydrate processing — insulin sensitivity drops measurably after one bad night, making late-race calories less efficient."
  - "A 90-minute sleep block timed to the 03:00–05:00 circadian trough produces more restorative sleep than two hours taken at the wrong time."
  - "When the fuelling plan breaks, the priority order is gut function first, caloric adequacy second, planned targets third — a functioning GI tract at reduced intake beats a gut shutdown every time."
  - "Savoury food after 30+ hours is a compliance strategy, not a comfort measure — flavour fatigue from sweet gels is a real performance limiter in multi-day events."
faq:
...
whoFor:
  - "Riders entering Badlands or any 500km+ ultra who need an hour-by-hour fuelling framework, not generic nutrition advice"
  - "Gravel and ultra-distance cyclists who have bonked badly in long events and want to understand phased carbohydrate strategy"
  - "Endurance riders curious about Asker Jeukendrup's multiple-transportable-carbohydrate research and how it applies to multi-day racing"
  - "Self-supported bikepacking racers planning resupply logistics around caloric targets and gut tolerance"
roadmanView:
  - "The headline number is sobering: you burn 15,000-22,000 kcal across Badlands and can only replace 60-75 per cent of it. The race is about managing a deficit, not closing it. That reframes every fuelling decision."
  - "Jeukendrup's 2:1 glucose-to-fructose research underpins the 80-90 g/h targets used by serious competitors. But the real-world limiter is gut function after 30 hours, not lab-based absorption rates."
  - "Savoury food in the second half of a multi-day event is a compliance strategy, not a comfort one. Flavour fatigue from sweet gels is a genuine performance limiter — I've seen riders DNF from it."
---
  - sofiane-sehili-ultra-endurance-mindset-bikepacking
...
If you want to build a personalised fuelling plan for your A-race — ultra or otherwise — [NDY coaching at Roadman](/coaching) works through each of the five pillars including race-day nutrition as a structured component, not an afterthought. [The application](/apply) is where the conversation starts. The principles from Badlands apply whether the event is 65 hours or six.

Got a specific question — your own per-hour target during a heat-affected ultra, how to eat when sleep-deprived, what to pack for a multi-day audax? [Ask Roadman](/ask) for an answer drawn from the actual conversations with Asker Jeukendrup, [Dr. David Dunne](/guests/david-dunne), and the rest of the nutrition guests on the podcast. Cross-link the [in-ride nutrition guide](/blog/cycling-in-ride-nutrition-guide) and the [carbs-per-hour breakdown](/blog/carbohydrate-per-hour-cyclists) for the underlying frameworks.
