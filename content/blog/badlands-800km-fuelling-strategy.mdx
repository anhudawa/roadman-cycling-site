...
Got a specific question — your own per-hour target during a heat-affected ultra, how to eat when sleep-deprived, what to pack for a multi-day audax? [Ask Roadman](/ask) for an answer drawn from the actual conversations with [Asker Jeukendrup](/guests/asker-jeukendrup), [Dr. David Dunne](/guests/david-dunne), and the rest of the nutrition guests on the podcast. Cross-link the [in-ride nutrition guide](/blog/cycling-in-ride-nutrition-guide) and the [carbs-per-hour breakdown](/blog/carbohydrate-per-hour-cyclists) for the underlying frameworks.
