...
VO2max ranges for amateur cyclists, with the caveat that these vary by age, training history, and individual genetics. If you're over 40 and worried the numbers are slipping away for good, the evidence on [how much of the decline you can actually get back](/blog/vo2max-decline-reversibility-masters-cyclists) is more encouraging than most riders assume:
