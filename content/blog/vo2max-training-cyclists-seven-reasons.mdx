...
seoTitle: "VO2max Training for Cyclists: 7 Fixable Reasons (2026)"
seoDescription: >-
  Seven reasons your VO2max is lower than it could be — aerobic base
  deficits, wrong interval formats, insufficient recovery, year-round
  intensity dilution. Plus the block protocols Dylan Johnson uses for
  concentrated VO2max gains.
excerpt: >-
...
[Professor Seiler's](/guests/stephen-seiler) framework — covered in [the cycling fast at a low heart rate guide](/blog/prof-seiler-low-heart-rate-cycling) — explains the mechanism. The aerobic base determines the capacity of the body's mitochondrial network, capillary density, and fat oxidation enzymes. These systems are the support structures for high-intensity work. Without them, VO2max intervals stress the body without producing the adaptation.
...
The 30-day fitness sprint protocol covered in [boost your cycling fitness in 30 days](/blog/cycling-fitness-30-days-protocol) is one application of a concentrated VO2max block within a longer training cycle.

## What to do next

If VO2max is your specific limiter and you haven't run a focused VO2max block in 12+ weeks, slot one into the next 4–6 weeks. Use the 4×4 minute format at 110–120% FTP, one session per week, supported by polarised base work the rest of the week.

Set your zones via the [FTP zone calculator](/tools/ftp-zones) so the 110–120% target translates to specific power numbers. Run the [training diagnostic](/diagnostic) if you're not sure which of the seven reasons is your actual limiter — for many cyclists it's the aerobic base, not the VO2max work itself.

For specific protocol coaching, the [Not Done Yet community](https://www.skool.com/roadmancycling) runs weekly sessions where VO2max-specific questions come up regularly. The most common are about format selection, block placement, and how to combine VO2max work with the rest of the training year. The [coaching pathways](/coaching) cover higher-touch options.
