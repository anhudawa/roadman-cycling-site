...
roadmanView:
  - "FTP gives you one number and a set of percentages. A lactate test gives you two thresholds, a curve, and a map of where your body actually changes gears. Once you have seen that data, you cannot go back to guessing."
  - "For a lot of riders, the maths does not line up. Your Zone 2 ceiling might be five or ten watts different from what the FTP percentages predict. That matters over a twelve-week base block."
  - "Retest every eight to twelve weeks during a structured block. You are looking for a rightward shift in the curve — more power before you hit threshold. That is the clearest sign your aerobic system is improving."
---
