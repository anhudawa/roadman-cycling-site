...
The [FTP test](/answers/ftp-test-guide) itself has multiple valid formats. The 20-minute test, the ramp test, and critical-power testing each produce slightly different numbers and have different strengths.
