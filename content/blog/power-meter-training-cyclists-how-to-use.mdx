...
seoDescription: >-
  Power meter training for cycling done right: the three metrics Pogacar's team
  tracks beyond FTP, Matt Bottrill on TT pacing, and a framework for amateurs.
excerpt: >-
...
whoFor:
  - "Cyclists who bought a power meter but are still riding by feel because nobody taught them how to use the data"
  - "Riders staring at watts on their head unit mid-ride without knowing which number matters for which session"
  - "Self-coached athletes who want a framework for using power on hard days and heart rate on easy days"
  - "Time trialists and pacing-sensitive riders who need the discipline of riding to prescribed watts"
roadmanView:
  - "When I had Uli Schoberer on the podcast, the thing that stuck with me was that he built the SRM to measure power during racing — the training applications came later, almost by accident. I think we've lost that somewhere. Power is a measurement tool, not something that should give you anxiety on every ride."
  - "Here's the thing I tell every coached rider: use power for hard sessions where precision matters, and use heart rate for easy days. I've seen strong riders sitting well inside Zone 2 while pushing 200 watts — power alone would have them panicking about going too easy."
  - "Matt Bottrill's TT pacing advice, when he was on the show, was simple and brutal: hold the prescribed watts and trust the maths, even when the legs disagree in the first five minutes. I've seen it work time and again. The discipline is what wins time trials."
---
...
**Level 2: Session discipline.** Use the zones to execute sessions cleanly — easy rides stay in Zone 2, threshold work hits Zone 4 exactly, VO2max work pushes into Zone 5. The [interval builder](/tools/interval-builder) structures the reps and recovery around those zones so you're not guessing mid-session.
...
The [FTP test](/answers/20-minute-ftp-test) itself has multiple valid formats. The 20-minute test, the ramp test, and critical-power testing each produce slightly different numbers and have different strengths.
...
Once FTP is set, the zones derive from standard Coggan ranges: Zone 1 (under 55% FTP), Zone 2 (56–75%), Zone 3 (76–90%), Zone 4 (91–105%), Zone 5 (106–120%), Zone 6 (121–150%), Zone 7 (over 150%). The [FTP zone calculator](/tools/ftp-zones) does the math. Plug in your number and the boundaries are set.
...
The detail is in [3 training metrics Pogacar uses](/podcast/ep-26-3-training-metrics-that-pogacar-uses-that-you-don-t). The headline: World Tour teams track multiple power-related metrics, not just FTP. Three of the most useful for amateurs:
...
These three metrics plus FTP give a more complete picture than FTP alone. The cyclist who tracks all four sees the actual training adaptations across blocks rather than guessing from a single FTP number. Log your tests in [TrainingPeaks](https://www.trainingpeaks.com) across a season and you can see the trend on each one — a stable FTP with rising 5-minute power reads as progress, not a plateau, which is the kind of thing a single screen number hides.
...
The kit pays back its cost in better-targeted sessions across the year. For amateurs serious about training, the power meter is one of the best-value equipment investments. For amateurs riding casually or training by heart rate already, the upgrade is less critical.
...
**Monthly.** Rolling 7-day HRV average direction, body composition direction, sleep quality trend, peak power numbers (5-minute, 1-minute, 5-second) across the month. The load trend matters as much as the peaks here — watching CTL climb while ATL stays in check on the TrainingPeaks PMC tells you the block is building fitness faster than it's digging a fatigue hole. Identify which trends are moving and which are stuck.
