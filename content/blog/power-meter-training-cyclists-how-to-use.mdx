...
roadmanView:
  - "Uli Schoberer built the SRM because he wanted to know his actual power during racing. The training applications came later. That origin story matters — power is a measurement tool, not a source of anxiety."
  - "Use power for hard sessions where precision matters. Use heart rate for easy days where power can mislead — strong riders produce 200 watts while sitting well inside Zone 2."
  - "Matt Bottrill's TT pacing advice is simple and brutal: hold the prescribed watts and trust the maths, even when the legs disagree in the first five minutes. The discipline is what wins time trials."
---
