...
answerCapsule: >-
  Beta-alanine increases muscle carnosine, which buffers hydrogen ions during
  efforts lasting 1-10 minutes. Meta-analyses show a median 2-3% improvement in
  exercise capacity for 1-4 minute efforts. Loading requires 3.2-6.4 g per day
  for 4-6 weeks. The tingling (paraesthesia) is harmless and dose-dependent —
  split doses into 0.8-1.6 g servings to eliminate it. Criterium racers, hill
  climbers, and VO2max interval sessions benefit most. Pure endurance riders see
  minimal return.
keyTakeaways:
...
This is the complete breakdown, sitting alongside our wider [cycling nutrition](/topics/cycling-nutrition) guides. The mechanism, the dose, the evidence, the tingling, and — critically — who should bother and who should not.
