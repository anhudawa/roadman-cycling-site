...
seoDescription: >-
  Strength training for cyclists: Art O'Connor on why legs aren't the limiter,
  Derek Teel on the four movements that earn the time, and the 2025 meta-analysis.
excerpt: >-
...
experts:
  - name: Art O'Connor
    ...
    href: /podcast/ep-2054-i-tried-keegan-swensons-insane-strength-routine-heres-what-n
  - name: Derek Teel
...
whoFor:
  - Cyclists who know they should lift but aren't sure what to do once they walk into the gym
  - Riders over 40 who've been putting off strength work and need the evidence to finally start
  - Anyone running circuit-style gym sessions that aren't transferring to the bike
  - Cyclists who want the protocol backed by the 2025 meta-analysis, not bodybuilding noise
roadmanView:
  - "Art O'Connor's line about legs never being the limiter changed how I think about this. Your legs have the power. Your core, hips and trunk are what's stopping you from using it."
  - "The 2025 meta-analysis settled it. Seventeen trials, 262 cyclists, no negative effect on VO2max. The argument is over. Now it's about the protocol."
  - "If you're over 40 and not lifting, you're leaving watts on the table and accelerating the decline you're trying to fight. Two sessions a week. Non-negotiable."
---

When Art O'Connor — the coach who designed Keegan Swenson's strength routine and who's been coaching cyclists for over 30 years — was on the podcast, he said something that reframed how I think about [strength training](/blog/art-oconnor-strength-training-cyclists) entirely. Leg strength, he said, is almost never the limiter. He has yet to see a cyclist whose legs were the bottleneck. What he sees consistently is core weakness, hip instability, and upper-body deficits preventing riders from accessing the power their legs already have.
...
The 2025 meta-analysis on cycling-specific strength training — 17 trials, 262 trained cyclists — closes the door on the question of [whether it works](/answers/does-strength-training-increase-ftp). The work now is doing it properly.
...
When I ran my own 30-day test stacking gym work alongside the bike work — the protocol is covered in [the gym and bike for 30 days episode](/podcast/ep-2045-i-tried-gym-and-bike-for-30-days-the-results-shocked-me) — the headline result was that sprint power went up 4–6% over the month. Short-effort durability improved more than I expected: 30-second power held longer across repeated efforts at the end of the test compared to the start.

The on-bike vs gym specificity finding surprised me. The gym work transferred well to short hard efforts and sustainable power at threshold. It didn't replace on-bike sprint work — for the very top-end explosive output, you still need to do the sprints on the bike. The gym builds the strength foundation; the bike turns it into cycling-specific power. Understanding [which gym gains actually carry over to cycling performance](/blog/cycling-strength-training-what-transfers-guide) is what separates a productive strength block from wasted hours under a bar.

The other finding was the recovery cost. [Two sessions a week](/answers/how-often-should-cyclists-strength-train) was sustainable. Three sessions started competing with the rides for adaptation. The riders I see falling off strength programs are usually doing too much, not too little.
