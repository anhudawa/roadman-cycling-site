...
roadmanView:
  - "The dominance had made every race feel like the same race. Roubaix 2026 was the first time in years it felt like an actual contest — two riders, one cobbled velodrome, and a sprint that could have gone either way."
  - "What van Aert came back from — a broken collarbone, broken ribs, a knee injury that could have ended his career — that is the Not Done Yet story in its purest form. The best version of you is not defined by what has happened to you."
  - "Cycling needed this. The sport needs unpredictability to hold its audience. Van Aert winning on the cobbles, after everything, reminded us why we watch in the first place."
---
