...
faq:
  - question: What is sprint interval training in cycling?
    answer: >-
      ...
      easy spinning between. The intensity is genuinely all-out — well above
  ...
  - question: How is SIT different from HIIT?
    answer: >-
      ...
      shorter (20–30 second) genuinely all-out efforts well above VO2max,
...
keyTakeaways:
  - SIT is genuinely all-out — 20–30 second efforts well above VO2max with full recovery between repeats. The intensity is the entire point.
...
This is one of the things the [Plateau Diagnostic](/plateau) is designed to surface — whether the issue is genuinely a need for new stimulus, or whether something underneath needs sorting first. Adding SIT to the wrong problem won't fix it.
