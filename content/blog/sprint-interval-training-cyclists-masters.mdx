...
seoDescription: >-
  Sprint interval training in cycling is the most time-efficient stimulus around.
  Why 30-second maximal efforts move FTP for masters riders — and how to add SIT.
excerpt: >-
...
whoFor:
  - "Masters cyclists whose FTP has plateaued despite consistent threshold and sweet-spot work"
  - "Time-pressed riders who need a high-return training stimulus they can fit into 25 minutes"
  - "Cyclists over 40 who have never included genuine sprint work and want to know whether it is safe and effective"
  - "Riders looking for a different stimulus to break through a performance ceiling that traditional intervals have not shifted"
roadmanView:
  - "I've been reading the research on SIT for years — the protocol the research community has been quietly endorsing for a decade while the rest of us argued about sweet spot versus threshold. Six all-out 30-second sprints with full recovery. The whole session takes 25 minutes."
  - "I see this constantly in the community: masters cyclists fighting a flat FTP, and this is often the missing stimulus. The aerobic base is in, the threshold work is in, but nobody has asked the neuromuscular system to fire at maximum for a long time. I think that matters more than most coaches admit."
  - "I prescribe one session a week, and that is plenty. This is not about volume — it is about a specific, intense signal that your body has not received recently. Add it, do not replace what is already working."
---
...
You still have one steady-state hard session a week (Thursday) and one neuromuscular hard session (Tuesday, the SIT). The total weekly TSS doesn't go up dramatically; the stimulus mix changes. Use the [interval session builder](/tools/interval-builder) to structure the reps and recovery for whichever format you run.
...
Week 8 or 9: take a recovery week, then retest FTP. [Estimate your current VO2max](/tools/vo2max) before and after the block to see the ceiling shift alongside the threshold change. Most masters cyclists who haven't moved their FTP in 6+ months see a 5–15 watt jump after a proper SIT block. Some see more. The reason is mostly that the engine has been pulled up at the top end and the threshold has followed.
...
**Related reading:** [A 30-Day Sprint Power Block: How I Structure the First Month of Training](/blog/30-day-sprint-power-cycling-plan)
