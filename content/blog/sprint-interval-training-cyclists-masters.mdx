...
roadmanView:
  - "SIT is the protocol the research community has been quietly endorsing for a decade while the rest of us argued about sweet spot versus threshold. Six all-out 30-second sprints with full recovery. The whole session takes 25 minutes."
  - "For masters cyclists fighting a flat FTP, this is often the missing stimulus. The aerobic base is in, the threshold work is in, but nobody has asked the neuromuscular system to fire at maximum for a long time. That matters."
  - "One session a week is plenty. This is not about volume — it is about a specific, intense signal that your body has not received recently. Add it, do not replace what is already working."
---
