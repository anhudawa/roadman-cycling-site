...
seoDescription: >-
  Cycling coaching testimonials from Not Done Yet: members average +28 watts FTP
  in 16 weeks, plus Cat upgrades and 4-9kg lost. Named riders, real numbers.
excerpt: >-
...
keyTakeaways:
  - "Average FTP gain across NDY members is 28 watts in the first 16 weeks, with individual gains ranging from 25w to 55w."
  - "Under-fuelling during rides and compensating afterwards is the most common nutrition error — fixing the timing drives both performance and body composition change."
  - "Category upgrades require race intelligence alongside fitness: structured race simulations and pacing analysis in training produced Cat 4 to Cat 3 and Cat 3 to Cat 2 transitions."
  - "Comeback athletes often progress faster than first-time builders because neural efficiency and structural foundations persist through deconditioning."
  - "Riders who engage all five coaching pillars — training, nutrition, strength, recovery, accountability — consistently progress faster than those using training alone."
faq:
  ...
  - question: What is the Not Done Yet coaching programme?
    answer: >-
      Not Done Yet is Roadman's $195/month group-coaching programme. It combines
      a personalised TrainingPeaks plan reviewed weekly by the Roadman coaching
      team with live group coaching led by Anthony, plus nutrition, strength,
      recovery, and accountability. Roadman Inner Circle is the separate
      $525/month service for direct 1:1 coaching.
...
whoFor:
  - "A cyclist seriously considering coaching who wants to see real results from real people before committing"
  - "A rider who has been burned by vague testimonials elsewhere and wants named riders with actual numbers"
  - "A comeback athlete wondering whether coaching can actually accelerate the return to previous fitness"
  - "A plateau-stuck racer looking for evidence that structured coaching produces category upgrades, not just marginal watts"
roadmanView:
  - "Every result on this page is from a named rider. No anonymous quotes, no stock photos, no 'Client A gained 30 watts.' If someone put their name to it, I will put it on the page. If they would not, it does not belong here."
  - "The pattern I see most often is riders who were doing the work but doing it wrong. Too much time in the grey zone, under-fuelling on the bike, no strength work. Fix those three things and the watts come."
  - "Comeback athletes are some of my favourite riders to coach. The neural pathways and muscle nuclei are still there. They just need the right stimulus and someone to hold them back in the first month."
---
...
**Tom Riordan, 47, Galway:** "I thought 50 was going to be the end of competitive cycling for me. Gained 38 watts in 18 weeks at age 47. Age is real, but it's not the ceiling most people think it is." Tom's gain is the kind of trajectory the [Cat-3 to Cat-1 case study](/blog/is-a-cycling-coach-worth-it-case-study) walks through in finer detail.

If you want to understand what's possible before you [apply for coaching](/apply), [check where your FTP sits against your training zones](/tools/ftp-zones) — it gives you a clear picture of where your current training is leaving watts on the table.
...
Declan's 8 kg loss combined with his FTP increase moved his [w/kg by 0.9](/tools/wkg) — a performance shift that would take years of training-only approaches to replicate. This is why nutrition is a pillar of the programme rather than an optional extra.
...
Claire's pattern — underfuelling during training, overeating after — is extremely common among endurance athletes. [Asker Jeukendrup's research on training the gut](https://pubmed.ncbi.nlm.nih.gov/28332114/) (Jeukendrup, 2017, Sports Medicine) is relevant here: athletes who fuel properly during sessions not only perform better in those sessions, they train the gut to tolerate higher intake rates, which supports a more stable energy balance across the day. The fix is not discipline. It's timing.
...
Fiona's 55-watt gain reflects a pattern: returning athletes often have better neural efficiency and structural foundations from their previous training, even after significant deconditioning. The comeback often moves faster than the original build — if it's managed correctly.
...
If you already know coaching is the right move, [apply for Not Done Yet coaching](/apply). Places are limited so the Roadman team can review every personalised plan properly; there is no point coaching athletes who do not receive genuine individual attention. Riders seeking direct 1:1 access can apply separately through the [Roadman Inner Circle](/inner-circle/apply).
