...
roadmanView:
  - TrainingPeaks throws a wall of numbers at you and most riders either ignore them or obsess over the wrong ones. Read the workout description first — that's where the intent lives.
  - Stop trying to beat your own plan. Going 40 watts above target borrows from tomorrow's recovery and wrecks the next key session. Consistency over heroics.
  - If your coach prescribes an endurance ride and your IF comes back at 0.82, you rode it too hard. The training effect changes even if the ride felt fine.
---
