...
answerCapsule: >-
  Non-displaced clavicle fractures heal in a simple sling over 6-8 weeks;
  displaced fractures with more than 2 cm shortening typically need plate
  fixation. A sling is preferred over a figure-of-eight brace. Most cyclists
  can return to the turbo at 2-4 weeks and road riding at 6-12 weeks with
  radiographic confirmation. Sleep reclined at 30-45 degrees for the first
  two weeks. Psychological recovery via graded exposure -- turbo, quiet roads,
  then group rides -- often takes longer than the bone.
keyTakeaways:
