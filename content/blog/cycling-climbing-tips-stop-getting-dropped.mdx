...
The part nobody talks about: climbing slow is almost always fixable. Not with more volume, not with lighter wheels, but with five specific changes that most cyclists overlook.
...
That said, there's a place for [low-cadence work](/blog/low-cadence-training-cycling-torque-intervals) in training — John Wakefield prescribes torque intervals at 40-60 RPM specifically to build climbing strength. But in a race or group ride, you want to be spinning efficiently.
