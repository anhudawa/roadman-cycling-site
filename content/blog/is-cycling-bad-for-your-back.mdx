...
roadmanView:
  - "I've spoken to Phil Burt about this on the podcast and I feel strongly that cycling gets blamed unfairly for back pain. It's a low-impact sport — the problem is almost always the fit, the position, or a weak midsection, and I've seen those fixes sort the issue for the vast majority of riders."
  - "I always tell people the order matters: bike fit first, then hip and core strength, then mobility. Most riders I talk to skip straight to stretching and wonder why nothing changes."
  - "Let me be really clear — if the pain radiates down a leg or persists off the bike, stop adjusting your saddle and go see a professional. That's a medical question, not a bike-fit question."
---
