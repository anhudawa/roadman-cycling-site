...
seoTitle: 'Masters Cycling Training Report 2026: 10-Part Guide'
seoDescription: "The 2026 guide to training as a masters cyclist. What actually declines after 40, what doesn't, and the training that holds up — a 10-part report."
excerpt: >-
  The 2026 guide to training as a masters cyclist. What changes after 40, what
  doesn't, the training that holds up, and a 12-week block you can run on
  Monday. 18 sections, 40+ citations, 5 named case studies.
pillar: coaching
...
answerCapsule: >-
  Masters cyclists lose roughly 0.5–1% of VO2max per year after 40 if training
  is maintained, closer to 1–1.5% if it isn't. Power at threshold, economy and
  durability decline more slowly — and that's where most of the masters-specific
  training opportunity sits. Heavy resistance training (70–85% of 1RM, 2–3
  sessions per week) attenuates muscle loss and preserves power. Protein rises
  to 1.6–2.2 g/kg/day across four feedings. Recovery between hard sessions
  extends to 72 hours. Female masters cyclists need different sections of this
  report in different places — perimenopause and menopause change the answers on
  strength, protein, sleep, and intensity tolerance.
keyTakeaways:
  - "Power at threshold, economy and durability decline more slowly than VO2 max. Most masters-specific training opportunity sits in those three, not in the chase for raw aerobic ceiling."
  - "Protein rises to 1.6-2.2 g/kg/day across four feedings to protect muscle mass through hard training blocks. Three big meals isn't enough — distribution matters as much as total."
  - "Female masters cyclists need different answers in different sections. Perimenopause and menopause shift the prescriptions on strength, protein, sleep and intensity tolerance — and most generic plans miss this entirely."
faq:
  - question: How much does VO2max actually decline for a masters cyclist?
    answer: >-
      Roughly 0.5% per year after 40 if training is maintained, closer to 1% per
      year if it isn't. Over 20 years that compounds to about 10% in trained
      masters versus 20% in those who stop. Tanaka and Seals (2008) remains the
      canonical reference. Lactate threshold and exercise economy decline more
      slowly than VO2max, which is where most of the masters-specific training
      opportunity sits.
  - question: How many hard sessions per week should a masters cyclist do?
    answer: >-
      ...
      masters athletes. One when life stress is high or recovery indicators are
      poor. Three is not sustainable on a 45-year-old's recovery rate and will
      accumulate fatigue. Protect the two you plan by making the rest of the
      week genuinely easy.
  - question: Is strength training really non-negotiable for masters cyclists?
    answer: >-
      ...
      cycling economy and time-trial performance, and supports bone density. It
      is the single most under-used tool in the masters cyclist's training and
      the one with the largest evidence base.
  - question: What protein intake do masters cyclists actually need?
    answer: >-
      ...
      athletes show anabolic resistance and need roughly 40–50% more protein per
      meal than younger athletes to hit the same muscle protein synthesis
      response.
  - question: >-
    ...
    answer: >-
      ...
      perimenopause as a baseline shift, and sleep architecture changes in ways
      that affect recovery. Fasted riding is a particularly poor fit for women
      in this life stage. The research base is still smaller than for male
      masters, and individualised coaching has higher value.
relatedEpisodes:
...
**Coaching roster observation.** The case studies in Section 12 are real members of the Not Done Yet coaching community, named with consent and with results published on our [coaching testimonials](/blog/cycling-coaching-testimonials) and [results](/blog/cycling-coaching-results-before-and-after) pages. The 12-week sample block in Section 15 is the structure we use as a starting point with masters athletes inside the community before individualising — not a generic plan we drafted for the report.
...
The long-form version: [common training mistakes from 1,400 podcast episodes](/blog/common-training-mistakes-from-1300-podcast-episodes).
...
<DownloadCSVButton
  href="/data/masters-cycling-12-week-block-2026.csv"
  filename="masters-cycling-12-week-block-2026.csv"
  description="The 12-week sample block above as a clean CSV — week, phase, daily session, total weekly hours. Drop it into your training spreadsheet of choice. Free to use with attribution."
/>

You can also download the [supporting research-summary table (CSV)](/data/masters-cycling-training-report-2026.csv) — the headline numbers across VO2max decline, protein, recovery, sleep, intensity dose, and zone allocation, with sources noted on each row.
...
- **Next planned update — April 2027.** Will incorporate new RCTs published in the intervening 12 months (we are tracking the 2026 polarised-vs-pyramidal landscape closely), updated female masters case studies once the dedicated follow-up post is published, and any updates to the durability literature.
...
<CiteBlock
  ...
  author="Walsh, A."
  year="2026"
  url="https://roadmancycling.com/blog/masters-cycling-training-report-2026"
/>

## Related tools and next steps

- **[FTP Zones calculator](/tools/ftp-zones)** — convert your current FTP into the seven training zones referenced throughout the intensity sections.
- **[W/kg calculator](/tools/wkg)** — turn FTP and body weight into the climbing-relevant ratio.
- **[HR Zones calculator](/tools/hr-zones)** — for masters athletes who train more by heart rate than by power.
- **[Carbs-per-hour calculator](/tools/fuelling)** — fuel the long Sunday rides described in Section 9.
- **[Age-Group FTP Benchmarks 2026](/blog/age-group-ftp-benchmarks-2026)** — companion report. Locate yourself against the W/kg bands.
- **[Plateau Diagnostic](/plateau)** — four-minute audit of your current training that returns a specific prescription. Free.
- **[NDY coaching at Roadman](/coaching)** — what's inside the masters-specific coaching: training, strength, recovery, nutrition, and accountability. Geographic pages: [UK](/coaching/uk), [Ireland](/coaching/ireland), [USA](/coaching/usa). Specifically for [masters riders](/coaching/masters), the [over-50](/coaching/over-50) brief, or [post-injury](/coaching/post-injury) returns.
- **[Apply for coaching](/apply)** — the Not Done Yet coaching community. 7-day free trial. 1:1 personalised programming, the structure behind the case studies in Section 12.
- **[Ask Roadman](/ask)** — got a specific question after reading this report? The on-site assistant pulls answers from the actual conversations with [Stephen Seiler](/guests/stephen-seiler), [Joe Friel](/guests/joe-friel), and the rest of the masters experts cited above.

## About the authors and reviewers

Authored by [Anthony Walsh](/author/anthony-walsh), founder of Roadman Cycling, host of the Roadman Cycling Podcast (1,400+ episodes), and head coach of the Not Done Yet coaching community. Reviewed before publication by the wider Roadman Cycling coaching team for technical accuracy and faithfulness to the on-the-record positions of the named experts cited inline. The full [editorial standards](/editorial-standards) page describes how every Roadman report is researched, reviewed, and corrected.
