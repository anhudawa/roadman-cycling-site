...
The phrase "all else being equal" is doing significant work there. Steve Trappe's 2003 paper on octogenarian lifelong endurance athletes found men in their 80s still producing aerobic power around 38 ml/kg/min — roughly double the 21 ml/kg/min of untrained men the same age ([Trappe et al., 2003](https://doi.org/10.1152/japplphysiol.01032.2002)). The decline is steep if you stop. The decline is a fraction of that if you don't.
