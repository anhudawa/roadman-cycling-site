...
If you want the structure and the accountability and the coaching the case studies in Section 12 had, [Cohort 3 of Not Done Yet](/apply) is opening now with 24-hour early access. If you want to start smaller, the [Strength Training programme](/strength-training) is the single highest-return thing you can add to your week this month. And if you want to stay in the orbit for free, the [Roadman Clubhouse](/community/clubhouse) is where a lot of this conversation keeps going.
