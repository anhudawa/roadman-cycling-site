...
Studies on trained cyclists show that blocks of heavy resistance training improve cycling economy and time-trial performance without compromising VO2max ([Rønnestad, Hansen & Raastad, 2011](https://pubmed.ncbi.nlm.nih.gov/19903319/); [Berryman et al., 2018](https://pubmed.ncbi.nlm.nih.gov/28459360/)). This means more power output for the same aerobic cost. For a 50-year-old rider who cannot increase their VO2max as readily as they could at 30, a gain in economy is a genuine performance lever.
