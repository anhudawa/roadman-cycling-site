...
seoDescription: >-
  The 2026 guide to masters cycling training. What actually declines after 40,
  what does not, and the training that holds up — a 10-part evidence report.
excerpt: >-
...
answerCapsule: >-
  ...
  training opportunity sits. Loaded resistance training that challenges the
  muscle in the 6–10 rep range with 2–3 reps in reserve, 2–3 sessions per week,
  attenuates muscle loss and preserves power. Protein rises
...
faq:
  ...
  - question: Is strength training really non-negotiable for masters cyclists?
    answer: >-
      Yes. The evidence is unambiguous. Loaded resistance training that
      challenges the muscle in the 6–10 rep range with 2–3 reps in reserve,
      two sessions per week off-season and one to two in-season, preserves
      Type II muscle fibres that atrophy fastest with age, improves cycling
      economy and time-trial performance, and supports bone density. It is
      the single most under-used tool in the masters cyclist's training and
  ...
  - question: >-
    ...
    answer: >-
      Strength training frequency rises to three per week rather than two,
      with loads that challenge the muscle in the 6–10 rep range with 2–3
      reps in reserve. Protein per meal sits at the higher end (30–40 g).
      Thermoregulation changes so hydration strategy
...
whoFor:
  - "Masters cyclists over 40 who train 6-12 hours a week and want evidence for what actually changes with age"
  - "Riders in their 50s questioning whether meaningful performance gains are still possible"
  - "Female masters cyclists navigating perimenopause or menopause alongside structured training"
  - "Self-coached riders who need a referenced framework rather than generic 'listen to your body' advice"
roadmanView:
  - "I've interviewed Seiler, Galpin, Friel, Lipman, Teel, Dunne, and Lorang across more than 100 episodes specifically about masters performance. This report distils what they agree on — and I can tell you, the consensus is often quite different from what the cycling internet repeats."
  - "I think the masters training conversation leans far too heavily on 'just ride more Zone 2.' That's half the answer. The other half — resistance training, protein distribution, recovery architecture — is where I see most over-40 riders leaving the biggest gains on the table."
  - "I've made sure every claim in this report carries a named source. If it doesn't, it's clearly flagged as coaching opinion from my work with NDY athletes. I think riders deserve to know where the evidence ends and experience begins."
---
...
The detail matters, so we're going section by section.
...
**Coaching roster observation.** The case studies in Section 12 are real riders from the Not Done Yet group coaching programme, named with consent and with results published on our [coaching testimonials](/blog/cycling-coaching-testimonials) and [results](/blog/cycling-coaching-results-before-and-after) pages. The 12-week sample block in Section 15 is the structure we use as a starting point with masters athletes in the programme before individualising — not a generic plan we drafted for the report.
...
The phrase "all else being equal" is doing significant work there. Trappe et al.'s study on octogenarian lifelong endurance athletes found men in their 80s still producing aerobic power around 38 ml/kg/min — roughly double the 21 ml/kg/min of untrained men the same age ([Trappe et al., 2013](https://doi.org/10.1152/japplphysiol.01107.2012)). The decline is steep if you stop. The decline is a fraction of that if you don't.
...
The single most common masters mistake, and I've seen it hundreds of times in rider files inside Not Done Yet group coaching: riders doing 50 to 60% of their weekly hours at a moderate-hard tempo. It feels productive. It feels like training. It's the worst of both worlds — too hard for recovery, too easy to drive top-end adaptation, and it eats into the Zone 2 volume that could be building the metabolic base.
...
Alcohol is a recovery antagonist. Two to three units in the evening suppresses overnight growth hormone pulse and cuts deep sleep. You can still drink. Just don't pretend the training is recovering the same when you do. Our [cycling sleep performance guide](/blog/cycling-sleep-performance-guide) goes deeper on the specific interventions worth your time.
...
Practical execution: [active recovery rides for cyclists](/blog/cycling-active-recovery-rides-guide).
...
Paired reading: [cycling carbs per hour](/blog/carbohydrate-per-hour-cyclists) and [the fasted-riding myth](/blog/cycling-fasted-riding-myth).
...
The named female cases on our results page include athletes under 40 (Claire Hennessy, 36, Belfast, 5 kg off in 12 weeks after reversing an under-fuelling pattern). We have perimenopausal and post-menopausal athletes on the roster; those case studies are being written up for a dedicated female-masters follow-up post in the coming weeks. If you're a female masters cyclist and you want to be part of that data — or you want us to work with you directly — see the Not Done Yet application below.
...
The long-form version: [common training mistakes from 1,400 podcast episodes](/blog/common-training-mistakes-from-1400-podcast-episodes).
...
If you want the full programming, weekly workout prescriptions, and accountability that comes with having the work reviewed by a coach, [start the two-minute application for Not Done Yet group coaching](/apply). It combines a personalised TrainingPeaks plan reviewed weekly by the Roadman coaching team with Anthony-led live group coaching, strength and nutrition guidance, and a private rider community.
...
If you want the structure, accountability, and coaching the case studies in Section 12 had, [Not Done Yet group coaching](/apply) combines a personalised TrainingPeaks plan reviewed weekly by the Roadman coaching team with Anthony-led live group coaching. Direct 1:1 access is available separately through the [Roadman Inner Circle](/inner-circle). If you want to start smaller, the [Strength Training programme](/strength-training) is the single highest-return thing you can add to your week this month. And if you want to stay in the orbit for free, the [Roadman Clubhouse](/community/clubhouse) is where a lot of this conversation keeps going.
...
- **25 August 2026** — Clarified the distinction between Not Done Yet group coaching and Roadman Inner Circle 1:1 coaching, and removed expired cohort-launch language.
...
- **[Apply for coaching](/apply)** — Not Done Yet group coaching. 7-day free trial. A personalised TrainingPeaks plan reviewed weekly, Anthony-led live group coaching, and the structure behind the case studies in Section 12. Direct 1:1 coaching is available separately through the [Roadman Inner Circle](/inner-circle).
...
Authored by [Anthony Walsh](/author/anthony-walsh), founder of Roadman Cycling, host of the Roadman Cycling Podcast (1,400+ episodes), and head coach of Not Done Yet group coaching. Reviewed before publication by the wider Roadman Cycling coaching team for technical accuracy and faithfulness to the on-the-record positions of the named experts cited inline. The full [editorial standards](/editorial-standards) page describes how every Roadman report is researched, reviewed, and corrected.
