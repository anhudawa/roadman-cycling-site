...
roadmanView:
  - "We have interviewed Seiler, Galpin, Friel, Lipman, Teel, Dunne, and Lorang across 100+ episodes specifically about masters performance — this report distils what they agree on, not what the cycling internet repeats."
  - "The masters training industry leans heavily on 'just ride more Zone 2.' That is half the answer. The other half — loaded resistance training, protein distribution, recovery architecture — is where most over-40 riders leave the biggest gains on the table."
  - "Every claim in this report carries a named source. If it does not, it is clearly flagged as coaching opinion from our work with NDY athletes."
---
