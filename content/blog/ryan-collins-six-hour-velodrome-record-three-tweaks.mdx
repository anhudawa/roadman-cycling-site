...
keyTakeaways:
  - "Collins averaged 46.6 km/hr for six hours on an indoor velodrome — roughly 277 km — after doctors told him he would never ride again following a 2017 car collision."
  - "Tweak one: he built a deeper aerobic base than his track years allowed, running the base block for months before any specific six-hour work appeared in the program."
  - "Tweak two: he trained his gut to absorb 90+ grams of carbohydrate per hour using glucose-fructose blends, up from the 30-50g/hr range most amateurs sit in."
  - "Tweak three: recovery — sleep, nutrition timing, mental preparation — was treated as a primary training variable, not an afterthought."
  - "The pro/amateur gap is not in secret methods; it is in the consistency of executing basics like easy rides at easy intensity, fuelling at the right rate, and protecting 8-9 hours of sleep."
faq:
...
whoFor:
  - Self-coached riders looking for proof that basics outperform complexity
  - Ultra-endurance cyclists refining their fuelling and base-building approach
  - Anyone interested in the gap between knowing what works and consistently doing it
  - Riders who assume elite performance requires elite resources
roadmanView:
  - This is the same Ryan Collins story told differently — focused tighter on the three changes that moved the needle. Base, fuel, recovery. That is it.
  - If you read this and think "I already knew that," ask yourself whether you are actually doing it. Collins was not doing it either, until he was.
  - The pro-amateur gap is not secret methods. It is the boring consistency of executing what everyone already knows.
---
...
**Build the base properly.** Easy rides at easy intensity, week after week, for blocks that are long enough to drive real adaptation. Read the [zone 2 training complete guide](/blog/zone-2-cycling-heart-rate-vs-power-vs-rpe) if you want the details. The discipline is in the execution, not the concept.
