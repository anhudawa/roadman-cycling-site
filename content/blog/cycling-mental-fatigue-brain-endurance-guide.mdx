...
answerCapsule: >-
  Mental fatigue inflates perceived exertion by 10-15% without any change in
  actual physiology. Marcora's psychobiological model shows endurance
  performance is governed by the conscious decision to stop, not by muscle
  failure. Brain Endurance Training — combining cognitive tasks with physical
  training — improves time to exhaustion by 12-15% over 8-12 weeks. Practical
  BET requires no equipment: reaction-time apps or simple maths during
  recovery intervals build cognitive resilience. Reducing pre-ride screen time
  is the lowest-effort, highest-impact intervention.
keyTakeaways:
