...
keywords:
  ...
  - triathlon coaching
answerCapsule: >-
  Brick workouts are back-to-back bike and run sessions that train the neuromuscular transition specific to triathlon. For Ironman, effective bricks are periodised across three phases: short transition runs in base (weeks 1–6), longer tempo runs off moderate rides in build (weeks 7–12), and race-specific sessions at 70–75% FTP followed by 60–90 minutes at Ironman run pace in the final block. One to two bricks per week is the working dose for most age-group athletes.
faq:
  - question: "How often should I do brick workouts for Ironman training?"
    answer: >-
      One to two bricks per week is the working dose for most Ironman athletes. In base phase, one short transition brick is enough. In build and race-specific phases, add a second longer brick, typically on the weekend. More than two per week usually compromises recovery and run durability, which is where most Ironman races are won or lost.
  - question: "How long should the run be after a long Ironman bike?"
    answer: >-
      In base phase, keep transition runs to 10–20 minutes at easy pace. In build, progress to 30–45 minutes at tempo. In race-specific weeks, one key session pairs a 4–5 hour bike with 60–90 minutes at target Ironman run pace. Avoid running longer than 90 minutes off a long ride unless you've built the durability over months.
  - question: "Should brick runs be fast or easy?"
    answer: >-
      It depends on the phase. Base-phase transition runs are easy, teaching cadence and posture off the bike. Build-phase runs include tempo efforts at half-marathon to marathon pace. Race-specific bricks rehearse exact Ironman run pace. Running hard off every bike session builds fatigue without the specificity that makes race day easier.
  - question: "Can I skip bricks if I already run well off the bike?"
    answer: >-
      No. Running well off the bike in training sessions does not replicate running well off a five-hour Ironman bike leg at target watts in race conditions. The neuromuscular and metabolic demand is different. Race-specific bricks in the final six weeks are the session that most separates a strong Ironman marathon from a walk.
  - question: "What's the biggest mistake with brick workouts?"
    answer: >-
      Running too hard too often. Most age-groupers treat every brick run as a hard effort, which accumulates fatigue and compromises the long run later in the week. The second common mistake is making bricks too long too early, arriving at race-specific weeks already overcooked. Match intensity to phase, and protect the long run.
---
