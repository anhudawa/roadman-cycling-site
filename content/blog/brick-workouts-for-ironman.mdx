...
If you want the brick programming built into a structured plan around your race, [NDY coaching at Roadman](/coaching) is built around exactly this for [triathletes](/coaching/triathletes). [The application](/apply) is where the conversation starts. Got a specific question — your own brick frequency, what to do about run quality off the bike? [Ask Roadman](/ask) for an answer drawn from the actual triathlon conversations on the podcast.
