...
roadmanView:
  - "I know most of you have a TrainingPeaks account you barely look at — I've had this conversation with so many riders on the podcast. The good news is the numbers are not as complicated as they look, and there are really only three signals worth acting on. This piece is the field guide I wish I'd had years ago."
  - "Here's the short version as I explain it on the podcast: CTL is your fitness, ATL is your fatigue, and TSB is the gap between them. When TSB is deeply negative you're buried, and when it swings positive you're fresh. I care far more about the trend across weeks than any single number on any single day."
  - "I want to be really clear about this one — stop chasing a CTL target for its own sake. A CTL of 80 built on structured, purposeful work is worth more than a CTL of 100 built on junk miles. The number tells you how much load you've absorbed, not whether it was the right load."
---
