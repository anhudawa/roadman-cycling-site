...
whoFor:
  - "Age-group triathletes training 12+ hours a week whose results have flatlined despite adding more volume"
  - "Solo-training endurance athletes who lack a team structure and wonder whether that is the missing piece"
  - "Cyclists and triathletes who treat mental training as optional and want a framework for making it structured"
  - "Masters athletes over 40 who stack training on top of unaccounted-for life stress and keep breaking down"
roadmanView:
  - "I had Ben Hoffman on the podcast and what struck me most is that after 20 years on the start line, none of his three habits are about volume. Recovery management, social structure, and structured mental work — that's where the separation happens."
  - "Here's the thing — 'stress plus rest equals growth' only works when you count all the stress. Work, family, financial, sleep debt. I see age-groupers treating training stress in isolation all the time. The system eventually breaks."
  - "What I took from Hoffman on the mental side: he treats it as a structured part of the programme, practised daily. Not something you pick up when motivation flags. The athletes who execute on race day have practised the mental side systematically."
---
