...
We laid out the broader case in [the Benji Naesen interview](/blog/benji-naesen-imposter-syndrome-cycling-weight-loss) — the consistency that produces results can be supported by social structure rather than willpower alone.
