...
roadmanView:
  - "Ben Hoffman has 20 years on the start line, and his three habits are not what most amateurs expect. Volume is rarely the issue. Recovery management, social structure around training, and structured mental work are the separators."
  - "The equation 'stress plus rest equals growth' only works when you count all the stress — work, family, financial, sleep debt — not just training load. Most age-groupers treat training stress in isolation. The system eventually breaks."
  - "Hoffman treats mental training as a structured part of the programme, practised daily, not done occasionally when motivation flags. The athletes who execute on race day are the ones who have practised the mental side systematically across the training block."
---
