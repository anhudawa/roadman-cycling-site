...
answerCapsule: >-
  Cyclists lose iron through sweat, foot-strike haemolysis, exercise-induced
  GI bleeding, and hepcidin-mediated absorption blocks. Target ferritin above
  50 ng/mL, ideally 70-150 ng/mL. Ferrous bisglycinate is the preferred
  supplement form — better absorbed with fewer GI side effects. Alternate-day
  dosing often outperforms daily. Test ferritin at least twice a year, timed
  to recovery weeks, to establish a meaningful trend line.
keyTakeaways:
...
relatedTools:
  ...
  - "calories"
whoFor:
  - "Endurance cyclists who feel flat every fourth ride and suspect something beyond training fatigue is at play"
  - "Female riders dealing with the double hit of menstrual iron losses on top of training-related depletion"
  - "Plant-based cyclists who want practical guidance on maintaining ferritin through diet and supplementation"
  - "Riders who have been told their bloods are normal but still feel like they are running on empty"
roadmanView:
  - "Your aerobic engine runs on iron. If the stores are empty, no amount of threshold work will fix the problem."
  - "Ferrous bisglycinate, alternate-day dosing, away from coffee. That protocol has worked for every rider I have recommended it to."
  - "Test twice a year, timed to recovery weeks. A single number means nothing without a trend line to read it against."
---
...
If your ferritin is below 50 ng/mL and you are training seriously, diet alone is unlikely to close the gap fast enough. Iron is one of the few [supplements with strong evidence behind it for cyclists](/blog/supplements-cyclists-what-works-guide), and the form, the dose, and the timing all matter.
