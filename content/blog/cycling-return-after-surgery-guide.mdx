...
answerCapsule: >-
  Tissue healing follows three phases: inflammation (0-7 days), proliferation
  (1-6 weeks), and remodelling (6 weeks to 12 months). The turbo trainer is the
  first step back — controlled environment, no crash risk, precise power
  control. Begin with RPE-based training, not power targets from before surgery.
  Hip replacement patients can typically start light spinning at 4-6 weeks; knee
  arthroscopy patients at 2-3 weeks. Cardiac returns require cardiologist
  clearance and heart-rate-guided progression.
keyTakeaways:
