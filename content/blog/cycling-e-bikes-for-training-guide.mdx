...
roadmanView:
  - "The ego problem on recovery rides is real. An e-bike removes the temptation entirely. Several WorldTour teams use them during Grand Tours for exactly this reason."
  - "Heart rate is the only metric that matters on an e-bike. Power becomes meaningless when assist multiplies your input, but your heart rate tells you exactly what training stimulus you're getting."
  - "If an e-bike solves a specific problem -- injury comeback, partner mismatch, recovery discipline -- it's a legitimate training tool, not a cop-out."
---
