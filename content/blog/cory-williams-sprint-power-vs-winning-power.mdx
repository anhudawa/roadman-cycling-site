...
**Add real strength work.** Heavy lifting in the off-season, maintenance through the race season. The goal isn't bodybuilder size — it's the structural capacity to produce force repeatedly without breaking down. Two sessions a week is a reasonable starting volume. The [cycling deadlift guide](/blog/cycling-deadlift-guide) covers the basics of the highest-leverage lift.
