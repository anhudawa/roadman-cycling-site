...
answerCapsule: >-
  ...
  power itself.
keyTakeaways:
  - "Cory Williams peaks at 1,640 watts in a sprint but won his biggest criterium on roughly 1,100 — a 540-watt gap between peak and winning power."
  - "The percentage of peak power you can deliver under fatigue predicts race outcomes far better than your fresh peak number."
  - "Place sprint work late in fatiguing sessions — sprints after 90 minutes of tempo build race-relevant power, sprints done fresh do not."
  - "Positioning is a power-saving variable: a rider in the front 10 of a 60-rider bunch does roughly 70% of the aerobic work of a rider at the back."
  - "Strength training for sprinters targets structural capacity for repeated force production, not maximum single-effort power."
faq:
...
whoFor:
  - "The amateur sprinter chasing peak power numbers on Strava without seeing race-day results"
  - "The crit racer who can win the sprint on fresh legs but fades after 60 minutes of racing"
  - "The masters rider looking for a smarter approach to sprint training with limited recovery"
  - "The cycling fan curious about how L39ION's Cory Williams actually trains and races"
roadmanView:
  - "This episode changed how I think about sprint training. Cory's peak is 1,640 watts. He won his biggest race on 1,100. That gap is where most amateurs are training the wrong number."
  - "The question is not how hard you can sprint fresh. It is how hard you can sprint after two hours of racing, in position, when it counts."
  - "Put your sprint work at the end of long, fatiguing sessions. Sprints done fresh feed the ego. Sprints done tired win races."
---
...
The relevant variable is the percentage of peak that you can deliver under those conditions. If your peak sprint is 1,400 watts and you can produce 950 watts after two hours of racing, your useful sprint is 950. If your peak is 1,200 and you can produce 1,000 after two hours, your useful sprint is 1,000. The second rider has a lower peak and a stronger race. The [W/kg calculator](/tools/wkg) will put both numbers in context against your body weight — and that ratio is what actually matters on the road.
