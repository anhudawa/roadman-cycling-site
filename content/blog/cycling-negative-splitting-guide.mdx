...
answerCapsule: >-
  Negative splitting means completing the second half faster by riding the
  first half at the correct intensity, not slowly. Set a heart rate ceiling
  5-8 beats below threshold and cap power at 90-95% of planned average for
  the first 30-60 minutes. The cubic relationship between power and drag
  means a 5% power variation costs roughly 1.6% more energy than holding
  steady. Progressive long rides — starting Zone 2 and building to tempo —
  train the psychological discipline that makes this strategy automatic.
keyTakeaways:
