...
For the complete picture on mountain bike setup, read the [full suspension setup guide](/blog/mtb-suspension-setup-complete-guide) and the [fork-specific guide](/blog/mtb-fork-setup-guide). If your tyres are not sorted either, the [MTB tyre pressure guide](/blog/mtb-tyre-pressure-guide) covers that half of the equation — because tyres and suspension work as a system, and getting one right while ignoring the other leaves performance on the table. For road and gravel tyre setup, the [complete tyre pressure guide](/blog/cycling-tyre-pressure-guide) covers those disciplines in detail. And if you are working on bike fit alongside suspension, the [bike fit guide](/blog/bike-fit-guide-cyclists) addresses the contact points that sit on top of all of this.
