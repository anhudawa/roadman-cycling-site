...
seoDescription: 'Podiatrist Courtney Conley on how the wrong cycling shoes cause knee pain, hot feet, and power loss — and how to fit shoes that actually carry watts.'
excerpt: >-
...
answerCapsule: >-
  ...
  Cycling Podcast, identifies forefoot cleat placement over the first
  metatarsal head, correct transverse width, and foot-specific insole selection
  as the three highest-impact interventions. Most off-the-shelf cycling shoes
  are built on a single last and fail roughly 60% of riders who deviate from a
  medium-width, low-arch foot profile.
keyTakeaways:
  - "A 2mm error in cleat placement changes the lever arm on the knee across thousands of pedal revolutions per ride."
  - "Most off-the-shelf cycling shoes are built on a single last and fail roughly 60% of riders who deviate from a medium-width, low-arch foot."
  - "Forefoot numbness and hot spots almost always trace to shoe width — symptoms typically appear 45-60 minutes into a ride, not at the start."
  - "More arch support is not always better — a high-arch foot needs accommodative cushioning, not a rigid support post that overcorrects alignment."
  - "Correcting foot pronation with proper arch support and cleat alignment produces immediate, measurable improvements in force application."
  - "Measure both feet standing in the afternoon when foot volume peaks, and match the measurement to the manufacturer's last, not the label."
faq:
...
whoFor:
  - "The cyclist with persistent knee pain that saddle adjustments have not fixed"
  - "The rider whose feet go numb or develop hot spots 45 minutes into every ride"
  - "The power-focused athlete who suspects their shoe fit is leaking watts"
  - "The cyclist about to buy new shoes who wants to get the fit right this time"
roadmanView:
  - "When I had Courtney Conley on the podcast, she made me rethink the foot completely. We obsess over saddle height and stem length, then shove our feet into whatever shoe was on sale. The foot is the only contact point that transfers power — get it wrong and everything above it compensates."
  - "Here's where it gets interesting — a 2mm cleat error is invisible to the naked eye but felt in the knee across thousands of pedal strokes. I'd never properly measured the first metatarsal head before that conversation. Most of us haven't."
  - "If your shoe is too narrow, no amount of insole or cleat adjustment will fix the numbness. I tell riders to measure foot width and match it to the manufacturer's last, not the label. It's one of those things that's completely fixable once you know."
---

Most cyclists will spend hours researching frame geometry, tyre pressures, and training zones. Their shoes get a cursory size check at the shop counter. Here's the problem: the foot is the only place where force transfers from the body into the drivetrain. Any energy that leaks there is gone for good.

Podiatrist Courtney Conley joined Anthony Walsh on the Roadman Cycling Podcast to walk through what goes wrong, why standard bike fits often miss it, and what a podiatric assessment adds. Her perspective cuts through a lot of the folklore around cycling shoe fit and replaces it with anatomy. This article draws on that conversation.
...
If you're already working through a [bike fit guide](/blog/bike-fit-one-change-amateurs-should-make) and finding that saddle and cleat adjustments don't resolve knee pain, the shoe itself is worth interrogating before you make further positional changes. The wider [knee-pain checklist](/blog/knee-pain-cycling-what-to-check-first) covers the order of variables to rule out before you book a podiatrist.
