...
seoDescription: >-
  Race week carb loading cycling with the Impey protocol. When to start, how much
  to eat, what foods work, common mistakes, and competition day meal timing.
excerpt: >-
...
answerCapsule: >-
  Start carb loading 36-48 hours before the event using the modern Impey
  protocol, which requires no depletion ride. Consume 8-12 g of carbohydrate per
  kilogram of body weight per day from low-fibre, refined sources. Eat the pre-
  race meal 3-4 hours before the start at 1-3 g/kg. A 1-2 kg weight increase is
  expected glycogen and water storage. The protocol benefits events over two
  hours most.
keyTakeaways:
  - "The modern carb loading protocol starts 36-48 hours before the event — no depletion ride needed, same glycogen supercompensation result."
  - "Target 8-12 g of carbohydrate per kilogram of body weight per day during the loading window, using low-fibre, refined carb sources."
  - "Pre-race meal should be 1-3 g carbs per kg, eaten 3-4 hours before the start, using only foods tested in training."
  - "Body weight rising 1-2 kg during loading is a positive sign — that is glycogen plus bound water, not fat gain."
  - "Full carb loading makes the biggest difference for events over two hours; events under 90 minutes are adequately covered by normal glycogen stores and a good pre-race meal."
...
whoFor:
  - "A rider preparing for a race or sportive over two hours who wants the modern carb loading protocol, not the outdated depletion method"
  - "Someone who has bonked in a previous event and suspects their pre-race nutrition was the problem"
  - "A masters cyclist who remembers the old six-day protocol and wants to know what has changed"
  - "A first-time racer who does not know what to eat the day before or on competition morning"
roadmanView:
  - "The old depletion method made everyone miserable and is no longer necessary. The Impey protocol gives you the same glycogen supercompensation in 36-48 hours with none of the suffering. Every rider I coach uses this approach."
  - "Eight to twelve grams of carbs per kilo per day sounds like a lot, and it is. Spread it across every meal and snack. A single pasta dinner will not cut it."
  - "Race morning: eat three hours before the start, stick to foods you have tested in training, and keep fibre and fat low. If you are improvising your breakfast on race day, you have already made a mistake."
---
...
Stick to foods you've eaten before training sessions. [Race morning](/blog/cycling-nutrition-race-day-guide) is not the time to try something new. Ever.
...
**During the event:** Your normal [in-ride fuelling protocol](/blog/cycling-in-ride-nutrition-guide) applies. The [carbs per hour guide](/blog/carbohydrate-per-hour-cyclists) covers this in detail, but the summary: start fuelling within the first 30 minutes and maintain your trained intake throughout. The [In-Ride Fuelling Calculator](/tools/fuelling) will set your per-hour carbohydrate and fluid targets for the event.
...
[Nutrition](/topics/cycling-nutrition) is one limiter. Training structure, recovery, and strength are the others. If you're not sure which one is actually holding you back, the [Plateau Diagnostic](/plateau) identifies your specific limiter in four minutes. Free, no sign-up required.
