...
**During the event:** Your normal in-ride fuelling protocol applies. The [carbs per hour guide](/blog/carbohydrate-per-hour-cyclists) covers this in detail, but the summary: start fuelling within the first 30 minutes and maintain your trained intake throughout. The [In-Ride Fuelling Calculator](/tools/fuelling) will set your per-hour carbohydrate and fluid targets for the event.
