...
whoFor:
  - "Cyclists building their own annual plan and unsure which training model to follow"
  - "Riders who have tried app-generated plans and found them too rigid for real life"
  - "Anyone preparing for an A-race 12 or more weeks out who wants a proper periodised structure"
  - "Self-coached athletes stuck between Friel, Lorang, and Johnson and wondering which approach fits"
roadmanView:
  - "I have had all three of these coaches on the podcast. The structures differ, but the principle is the same — consistency over complexity, every time."
  - "Most plans fail because they are built around the plan, not around the rider. Your life, your recovery, your hours — the plan adapts to you, not the other way round."
  - "Dan Lorang told me that 80 per cent of the value comes from executing consistently for 12 weeks. That stuck with me more than any interval protocol."
---
...
**Personally meaningful.** The event should matter to you. The cyclist who picks an A-race because they think they should is less motivated than the one who picks an event they want to perform at.
...
**Specific.** A date, a course, measurable success criteria. "[Marmotte](/blog/la-marmotte-training-guide) in July" is specific. "Sportive season" is not.
...
The ruthless assessment. Not what you wish you could train. What you actually can train consistently across 6+ months given work, family, sleep needs, and the rest of life.
...
For most amateur cyclists, the linear progression with recovery weeks every fourth week is the safer default. The oscillation model is worth testing if your life supports the high-volume weeks; it's not worth attempting if it doesn't.
...
**Every 8–12 weeks.** FTP test on consistent protocol. Compare to previous test. Adjust zones using the [FTP Zone Calculator](/tools/ftp-zones) if the number has moved.
...
**Related reading:** [How to Create a Triathlon Training Plan That Actually Works](/blog/olav-bu-triathlon-training-plan-design)
