...
seoDescription: >-
  Joe Friel's classic structure, Dan Lorang's consistency principle, and
  Dylan Johnson's oscillation model — three approaches, one synthesis,
  and the step-by-step framework for building a plan that fits your life.
excerpt: >-
...
Start by picking your A-race for the year. If you don't have one, this is the first decision — pick one event that matters and build the calendar around it. The [event planner tools](/plan) cover specific event preparation.
...
For deeper support, the [training diagnostic](/diagnostic) walks through limiter identification and produces a personalised recommendation. The [Not Done Yet community](https://www.skool.com/roadmancycling) runs weekly coaching calls where plan-building questions come up frequently. For higher-touch support, the [coaching pathways](/coaching) and the [Roadman Method](/method) are the structured options.
