...
The practical implication is clear: strengthen the respiratory muscles and you reduce the threshold at which that reflex fires. You protect leg blood flow for longer, and you sustain higher power outputs before the system starts making trade-offs you don't want it to make.
