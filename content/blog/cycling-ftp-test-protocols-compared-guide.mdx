...
answerCapsule: >-
  The ramp test is simplest but overestimates FTP in anaerobically strong
  riders. The 20-minute test is the most validated field protocol but demands
  even pacing — going out 5 per cent too hard inflates results by 10-15 watts.
  Preparation matters more than protocol: 48 hours of reduced training, a
  standardised warm-up, and consistent conditions explain more variance than
  the test itself. Pick one protocol, execute it properly, retest every 6-8
  weeks, and cross-validate against real ride data.
keyTakeaways:
