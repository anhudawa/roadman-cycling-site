...
relatedTools:
  ...
  - "training-load"
whoFor:
  - "Self-coached riders with a power meter who suspect their FTP number is wrong but cannot pinpoint why"
  - "Plateau-stuck racers retesting every few weeks and getting inconsistent results that make zone-based training meaningless"
  - "Comeback athletes returning to structured training who need a reliable baseline without blowing themselves apart"
  - "Riders preparing for a target event who want to set accurate training zones and stop guessing their threshold"
roadmanView:
  - "I have done every version of the FTP test and got a different number from each one — that is normal, and it is why protocol choice matters less than execution and consistency."
  - "The 20-minute test is still my go-to recommendation because it punishes bad pacing, and learning to pace a 20-minute effort is itself a useful skill for racing and sportives."
  - "Stop testing every fortnight — you are accumulating fatigue and chasing a number instead of training the system that produces the number."
---
