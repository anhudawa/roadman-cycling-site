...
whoFor:
  - "Women cyclists whose training feels brilliant some weeks and impossible others with no obvious explanation"
  - "Female riders following plans built on male physiology who suspect the advice is not quite right for them"
  - "Coaches working with female athletes who want an evidence-based framework for phase-based periodisation"
  - "Any cyclist who has dismissed menstrual cycle tracking as too complicated and wants a practical starting point"
roadmanView:
  - "I am not going to pretend I have lived experience of this. What I have done is spent a lot of time with Dr Stacy Sims, Dr Kirsty Elliott-Sale, and Dr Georgie Bruinvels, and what they have shown me is that most training advice was built on male data and handed to everyone as if it were universal. It is not."
  - "The framework is not about restricting training. It is about placing the right session in the right window so your body can actually absorb it. Once you understand the four phases, you stop fighting your physiology and start working with it."
  - "Track symptoms, energy, and session quality across three full cycles before you change anything. That is the minimum to see whether a pattern exists for you specifically. Individual variation is massive — some women feel strongest during menstruation. The science gives you a starting point, not a rulebook."
---
