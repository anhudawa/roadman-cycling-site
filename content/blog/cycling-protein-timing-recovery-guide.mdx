...
answerCapsule: >-
  Total daily protein intake of 1.6-2.2g per kilogram matters more than timing
  for cycling recovery. The anabolic window lasts 24-48 hours, not 30 minutes.
  Distribute protein across four meals of 30-40g each to hit the leucine
  threshold at every feeding. Pre-sleep casein at 30-40g has the strongest
  evidence for overnight recovery. Cyclists over 40 need 2.0-2.4g per kilogram
  daily due to anabolic resistance.
keyTakeaways:
...
relatedTools:
  ...
  - "recovery-screen"
whoFor:
  - "Cyclists eating under 100g of protein a day who suspect they are leaving recovery on the table"
  - "Masters riders over 40 noticing they lose muscle on training plans that worked a decade ago"
  - "Plant-based cyclists who want to match animal-source recovery without guesswork"
  - "Anyone who has been told they must drink a shake within 30 minutes or lose their gains"
roadmanView:
  - "I spent years thinking timing was everything because the supplement industry told me so. Then I looked at the research and realised I was eating half the protein I needed. Total intake first, timing second — that order matters."
  - "Pre-sleep casein changed my recovery more than any other single habit. Greek yoghurt before bed is boring. It also works better than most things with a fancy label."
  - "If you are over 40 and still eating like you did at 30, your body is not being lazy — it is dealing with anabolic resistance. You need more protein, not more motivation."
---
...
The science on protein timing is actually quite clear once you strip away the marketing. Let me break this down. Protein is one of the most misunderstood areas of [cycling nutrition](/topics/cycling-nutrition), and the gap between what the science shows and what most riders actually do is enormous.
...
Here is where it gets really interesting. The research from Eric Helms and others at AUT University has demonstrated that higher protein intakes within this range are particularly important during periods of energy deficit — when you are trying to [lose weight](/blog/cycling-weight-loss-fuel-for-the-work-required) or when training load is high relative to calorie intake. Protein becomes even more critical when you are not eating quite enough overall, because it is the macronutrient your body is least willing to waste. It preferentially preserves lean mass when calories are restricted.

For cyclists trying to drop body fat while maintaining power — which is half the riders reading this — getting protein right is the single most important nutritional variable. More important than carb timing. More important than [supplements](/blog/supplements-cyclists-what-works-guide). More important than whatever the latest podcast guest said about ketones.
...
With the pre-sleep evidence established, let me circle back to [post-training feeding](/blog/post-ride-recovery-nutrition-cyclists), because it still matters — it is just not the crisis the supplement industry made it.
