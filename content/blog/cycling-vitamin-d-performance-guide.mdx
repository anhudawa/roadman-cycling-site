...
answerCapsule: >-
  Studies find 50-65% of professional athletes deficient in vitamin D during
  winter, and cyclists in northern latitudes are at equal risk despite outdoor
  training hours. Supplement 1,000-4,000 IU of vitamin D3 daily, taken with
  a fat-containing meal to ensure absorption. Target serum 25(OH)D of
  75-125 nmol/L. The strongest evidence base is immune function — Owens et
  al. showed adequate levels significantly reduce upper respiratory infections
  during winter training. A blood test removes all guesswork and costs very
  little.
keyTakeaways:
