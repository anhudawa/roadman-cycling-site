...
roadmanView:
  - "An AFib diagnosis does not mean the end of cycling. It means the end of ignoring your heart rate monitor when it shows something strange. Get assessed, get managed, and then ride intelligently."
  - "If you are on beta-blockers, throw out your heart rate zones. They are meaningless on rate-control medication. Train by power or RPE instead."
  - "Everything in this guide assumes you have seen a cardiologist. If you have not, that is your first step. Not this article."
---
