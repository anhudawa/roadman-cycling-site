...
whoFor:
  - "Riders who jump on the turbo without a plan and wonder why their FTP hasn't moved after three months of sweating"
  - "Cyclists who train every indoor session at moderate-hard intensity and need to understand why polarising easy and hard sessions produces better results"
  - "Athletes looking for exact power targets and session structures they can programme into TrainerRoad or a smart trainer's ERG mode"
  - "Coaches and self-coached riders who want a reference framework for periodising a 16-week winter indoor block from November through February"
roadmanView:
  - "I had Professor Seiler on the podcast and his data keeps showing the same thing — five sessions at moderate-hard intensity produces more fatigue and less adaptation than two properly hard sessions and three properly easy ones. Tim Kerrison built Team Sky's entire philosophy around this."
  - "I'm a big believer that VO2max intervals are where the turbo earns its place. Outdoors, holding 106-120% FTP for exactly 4 minutes requires a perfect road with no junctions, no traffic, and no gradient changes. Indoors, you hit it every time."
  - "I've spoken to both Dan Lorang and John Wakefield about this — periodise the winter. November-December lean toward endurance and tempo. January-February shift to weekly threshold and VO2max work. That's how they structure their riders' indoor blocks."
---
...
Before the sessions, you need the framework. If you have not tested recently, run a 20-minute effort and plug the result into the [FTP Zone Calculator](/tools/ftp-zones) — every power target below depends on that number being right. Dan Lorang, Head of Performance at Red Bull-Bora-Hansgrohe, has talked about how periodisation means knowing which energy system you're targeting in every single session and why. Random suffering doesn't count. Each session in your indoor week should have a specific purpose, a specific power target, and a specific duration — and the mix between them across the week matters more than any individual session.
...
Two efforts of 20 minutes at 88-93% of your FTP — check the [sweet spot calculator](/tools/sweet-spot) for your exact target watts — with 10 minutes of recovery spinning between them. Total session time is around 70 minutes.
...
VO2max intervals are the sessions that build your ceiling — the absolute maximum rate at which your body can consume oxygen. They're brutal, they're effective, and they don't need to be long. Four minutes is enough to drive your oxygen consumption to near-maximum, and five repetitions accumulates enough time at that intensity to provoke adaptation. Lorang has talked about how even the hardest sessions he prescribes at Red Bull-Bora-Hansgrohe are precise in their dosage — it's not about surviving the most pain, it's about accumulating enough time at the right intensity.
...
These sessions are where the turbo trainer earns its place. Outdoors, sustaining exactly 4 minutes at VO2max power requires a perfect road — no junctions, no traffic, no gradient changes. Indoors, you set the power and hold it — use the [interval builder](/tools/interval-builder) to map out the exact efforts before you clip in. The controlled environment is made for this kind of work.
...
That gives you two hard sessions, two or three easy sessions, and one or two rest days. You can check whether the weekly dose is right by running the numbers through the [TSS Calculator](/tools/tss) — if your weekly total is climbing faster than you can absorb, the easy days are the first thing to protect. The ratio of easy to hard time lands close to Seiler's 80/20 split, which is not an accident — it's the distribution that his research, and the practice of coaches like Kerrison and Lorang and Wakefield, keeps converging on.
