...
roadmanView:
  - "Five sessions at moderate-hard intensity produces more fatigue and less adaptation than two properly hard sessions and three properly easy ones. Stephen Seiler's data keeps showing this, and Tim Kerrison built Team Sky's entire training philosophy around it."
  - "VO2max intervals are where the turbo earns its place. Outdoors, holding 106-120% FTP for exactly 4 minutes requires a perfect road with no junctions, no traffic, and no gradient changes. Indoors, you hit it every time."
  - "Periodise the winter: November-December lean toward endurance and tempo; January-February shift to weekly threshold and VO2max work. Dan Lorang and John Wakefield both structure their riders' indoor blocks this way."
---
