...
**Age is one part of the result, not the whole explanation.** Masters cyclists can still respond to structured training, but the size of that response varies with training history, health, measurement and genetics. We cover the distinction in [VO2max decline and reversibility for masters cyclists](/blog/vo2max-decline-reversibility-masters-cyclists). The [low-VO2max diagnostic](/blog/vo2max-cycling-fixable-reasons-low) checks the measurement and common causes before blaming the calendar.
