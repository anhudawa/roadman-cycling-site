...
relatedTools:
  ...
  - hr-zones
whoFor:
  - "Cyclists who have a VO2max number from a watch, a ramp test, or a lab and want to know what it actually tells them about their fitness and performance"
  - "Riders wondering whether their VO2max is good for their age and how it compares to other trained cyclists rather than the general population"
  - "Anyone confused by the relationship between VO2max and FTP who needs a clear explanation of why two riders with identical VO2max can differ by 30 watts at threshold"
  - "Cyclists considering a lab test who want to understand how field estimates from MAP or FTP compare and whether the expense is justified"
roadmanView:
  - "VO2max is the most-cited number in endurance sport and the least understood. It sets the ceiling, but it does not tell you how much of that ceiling you can use. Economy and fractional utilisation — how efficiently you convert oxygen into watts — are the variables the single number hides."
  - "I see riders fixate on their VO2max as though it is a performance score. It is not. It is a capacity measure. Two riders at 55 ml/kg/min can differ by 30 watts at threshold because one of them is more efficient. That distinction matters for how you train."
  - "Field estimates from a ramp test or FTP are accurate enough to track trends over months. Unless you are making a career decision or chasing a specific research question, the lab test is interesting but not necessary. Save the money and test more often with what you have."
---
