...
roadmanView:
  - "This is the most time-efficient cross-training a runner can add because it replaces time you are already spending travelling. A 30-minute commute each way is five hours of aerobic training at zero extra time cost."
  - "The cardinal rule is sequencing: never ride hard on a day you have a quality run planned. The commute exists to support your running, not to compete with it."
  - "You do not need a race bike. A hybrid or gravel bike with mudguards and flat pedals handles commuting in any weather and costs a fraction of what runners spend on shoes each year."
---
