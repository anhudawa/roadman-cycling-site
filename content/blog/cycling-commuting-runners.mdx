...
whoFor:
  - "A runner with a 20-40 minute commute who is looking for cross-training that does not eat into running time"
  - "A runner dealing with recurring impact injuries who needs aerobic volume without the ground reaction forces"
  - "A time-crunched runner who drives or takes the train to work and has never considered cycling as a commute option"
  - "A runner curious about cycling but unsure what bike to buy, what gear matters, and how to handle the first wet Tuesday"
roadmanView:
  - "I think this is the most time-efficient cross-training a runner can add, because you are replacing travel time you were already spending. A 30-minute commute each way is five hours of aerobic volume a week at zero extra cost to your schedule."
  - "The one rule I always give runners who start commuting by bike: never ride hard on a day you have a quality run planned. The commute exists to support your running, not compete with it for recovery."
  - "I always tell people you do not need a race bike for this. A hybrid or gravel bike with mudguards and flat pedals handles any weather, and it costs a fraction of what most runners spend on shoes in a year."
---
