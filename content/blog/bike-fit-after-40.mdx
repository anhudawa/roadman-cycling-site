...
roadmanView:
  - "Dr Andy Pruitt is blunt about it on the podcast: three things change after 40 and they all push the same way — flexibility drops, core endurance fades, and feet flatten and widen. The fit that felt perfect at 35 slowly becomes the reason your back hurts on every long ride."
  - "The roughly 45-degree torso angle is the working window for most masters riders. It is not a fixed number and it is not a concession. A position you can hold for four hours beats an aggressive setup you abandon after one — comfort is speed, not a compromise."
  - "Fit and mobility are two halves of one job. Raising the bars means nothing if your hips and T-spine are locked up. Shorter cranks — say 165mm from 172.5mm — open the hip angle at the top of the stroke with negligible power loss. Worth asking a fitter about if your hips feel cramped."
---
