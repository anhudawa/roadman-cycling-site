...
answerCapsule: >-
  Two hard sessions per week with 72 hours between them is the structure that
  produces the most consistent gains through menopause, per Stacy Sims's
  research. Shift intensity toward short, sharp efforts — 30-second sprints
  and 3-minute VO2max intervals — rather than sustained threshold work. HRT
  restores much of the recovery capacity that oestrogen loss removes. Use
  readiness-based autoregulation via morning HRV rather than rigid weekly
  plans, because day-to-day variability in menopause makes fixed scheduling
  counterproductive.
keyTakeaways:
...
relatedTools:
  ...
  - "recovery-screen"
whoFor:
  - "Women cyclists in perimenopause or menopause whose training has stopped producing results"
  - "Female riders whose sleep, recovery, and motivation have deteriorated without an obvious cause"
  - "Coaches working with menopausal athletes who need an evidence-based session framework"
  - "Women considering HRT who want to understand how it changes training capacity"
roadmanView:
  - "The practical advice for training through menopause is shockingly thin. The physiology is well documented, but when you ask what sessions to actually do, most sources offer vague advice about listening to your body."
  - "Stacy Sims's research changed how I think about this — two hard sessions with 72 hours between them, not three with 48. The recovery window is different, and the training has to respect that."
  - "Motivation dips through menopause are neurochemical, not personal. Declining oestrogen reduces serotonin and dopamine. Knowing that won't fix it, but it might stop you blaming yourself for something that isn't your fault."
---
