...
answerCapsule: >-
  Cycling podcasts pair with indoor sessions when the cognitive load of the audio matches the physical load of the effort. Long-form interviews (60–120 minutes) suit Zone 2 rides, where heart rate sits at 65–75% of max and the brain has capacity for nuance. High-intensity intervals above 90% FTP overwhelm working memory — music or race re-runs work better. Recovery spins under 60% FTP handle anything. Sweet-spot blocks of 88–94% FTP need structured, segmented content that tolerates focus gaps.
faq:
  - question: "Can you actually listen to a podcast during hard intervals?"
    answer: >-
      Not effectively. Above 90% of FTP, working memory narrows and breathing rate rises to 40–50 breaths per minute, which disrupts auditory processing. Studies on cognitive load during exercise show comprehension drops sharply past lactate threshold. Use music with 160–180 BPM for intervals, and save conversation-heavy podcasts for Zone 2 or recovery work where heart rate stays below 75% of max.
  - question: "What's the best podcast length for a two-hour Zone 2 indoor ride?"
    answer: >-
      One 90–120 minute interview, or two 45–60 minute episodes back to back. The Roadman Cycling Podcast episodes typically run 60–90 minutes, which fits a standard endurance block with a warm-up buffer. Avoid shows under 30 minutes for long rides — the repeated intro-outro cycle breaks rhythm. Pre-download three options so you're not scrolling mid-ride.
  - question: "Should I listen to coaching podcasts while training or separately?"
    answer: >-
      Separately, if the content is technical. Dan Lorang or Prof. Stephen Seiler interviews contain protocol detail worth notes — listen on a commute or walk. During Zone 2, treat podcasts as company, not curriculum. If you want to apply something from an episode, flag the timestamp and revisit it off the bike. Learning and training are different sessions.
  - question: "Do podcasts affect power output on the turbo?"
    answer: >-
      At endurance pace, no measurable effect. At threshold and above, verbal audio has been shown to reduce sustained power by 2–4% in controlled tests, because attention splits between effort regulation and comprehension. For efforts that matter — FTP tests, VO2 intervals, race-specific work — drop the podcast. For Zone 2 accumulation, the effect is negligible.
  - question: "What makes a podcast work for indoor training specifically?"
    answer: >-
      Three things: episode length matching session length, audio mastering that survives fan noise at 60–70 dB, and a host who lets guests finish sentences. Panel shows with heavy crosstalk become exhausting on the turbo. Solo monologues work for recovery. Long-form interviews work for endurance. Match the format to the effort, not the other way round.
---
