...
seoDescription: >-
  Team Visma is wiring riders with Tymewear breathing sensors. Heart rate is a
  proxy. Power is a proxy. Ventilation is the underlying signal — here is why.
description: >-
...
whoFor:
  - "Coached riders who rely on power and heart rate but notice the numbers stop telling the full story on fatigued days"
  - "Data-driven cyclists curious about what metric sits underneath power and heart rate in a lab setting"
  - "Riders frustrated by calibration creep — sessions that should feel easy drifting harder over a season without being noticed"
  - "Anyone following World Tour technology who wants to understand why Visma is wiring riders with chest-mounted breathing sensors"
roadmanView:
  - "When I sat down with Tymewear founder Arnar Larusson, the core message was clear — heart rate drifts, power decays, and ventilation sits underneath both as the signal the lab uses to calibrate everything else. I don't think you need the sensor to apply the principle. Conversation-test your easy days and walk away from threshold sessions when your body is not responding."
  - "I think the calibration-creep idea is the one that should make you sit up. What you call easy slowly drifts harder over a season. If it happens to World Tour riders, it is absolutely happening to you. I'd recommend auditing your endurance heart rate at fixed power — it's a free check you should be doing every month."
  - "I've had Professor Seiler on the podcast repeatedly, and his bow-tie model frames training stress as inputs producing adaptations. Ventilation is the cleanest measure of the input side I've ever come across. TrainingPeaks still works — ventilation just makes the intensity signal feeding it more honest."
---
  - andrew-sellars-breathing-co2-cycling
...
## The Overlooked Side of Your Power Meter
