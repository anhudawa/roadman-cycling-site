...
roadmanView:
  - "Heart rate drifts. Power decays. Ventilation sits underneath both, and it is the signal the lab uses to calibrate everything else. You do not need the sensor to apply the principle — conversation-test your easy days and walk away from threshold sessions when the body is not responding."
  - "The calibration-creep idea is the one that should make you sit up. What you call easy slowly drifts harder over a season. If it happens to World Tour riders, it is absolutely happening to you. Auditing your endurance heart rate at fixed power is a free check you should be doing every month."
  - "Seiler's bow-tie model frames training stress as inputs producing adaptations. Ventilation is the cleanest measure of the input side we have ever had. TrainingPeaks still works — ventilation just makes the intensity signal feeding it more honest."
---
  - andrew-sellars-breathing-co2-cycling
