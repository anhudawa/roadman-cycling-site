...
seoTitle: 'Benji Naesen Interview: Imposter Syndrome and Weight Loss'
seoDescription: >-
  A Benji Naesen interview on imposter syndrome in cycling, losing 10kg through
  consistency, and why creators like Lanterne Rouge outpace legacy media now.
excerpt: >-
...
answerCapsule: >-
  ...
  changes.
keyTakeaways:
  - "Naesen lost 10kg over a year by treating it as a consistency problem, not a willpower problem — manageable daily changes sustained long enough to become baseline behaviour."
  - "Imposter syndrome fades through accumulated reps, not affirmations — showing up 50 times recalibrates the self-concept in a way no mantra can."
  - "Aggressive weight-loss deficits cost watts and trigger hormonal resistance; losing 0.5-1kg per month holds power output steady while the ratio improves."
  - "External accountability — a coach, training partner, public commitment, or community — catches you when motivation drops and makes skipping cost more than showing up."
  - "Personality-driven cycling media now outperforms legacy outlets because audiences trust individuals whose work they can audit, not institutional brands."
faq:
...
whoFor:
  - "Cyclists carrying extra weight who have tried aggressive diets and blown up, wondering whether a slower approach actually works"
  - "Amateur riders who feel like imposters at their club or in their results and want to hear a respected voice describe the same struggle"
  - "Content creators and community builders in cycling who battle self-doubt about their credibility"
  - "Podcast loyalists who heard the Benji Naesen episode and want the weight-loss and mindset lessons in one place"
roadmanView:
  - "Benji Naesen lost 10kg over a year by treating it as a consistency problem, not a willpower problem. Manageable daily changes sustained long enough to become baseline behaviour. No crash diet, no dramatic transformation narrative — just a slow accumulation of better choices."
  - "Imposter syndrome fades through accumulated reps, not affirmations. Naesen describes showing up 50 times recalibrating the self-concept in a way no mantra can. That applies to cycling performance as much as it does to media."
  - "The aggressive deficit most amateur cyclists try costs watts and triggers hormonal resistance. Losing 0.5-1kg per month holds power output steady while the ratio improves. Naesen's approach is evidence of the principle in practice."
---
