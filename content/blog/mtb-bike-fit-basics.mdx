...
seoTitle: 'MTB Bike Fit Basics: Saddle, Reach & Stack Explained'
seoDescription: 'MTB bike fit basics done right. Saddle-height formula, reach and stack, handlebar width, stem length, and cockpit setup explained step-by-step for the trail.'
excerpt: >-
  A well-fitted mountain bike disappears underneath you on the trail. A badly
  fitted one fights you on every feature. Here's how to get the basics right.
pillar: community
...
faq:
  - question: How do I calculate my mountain bike saddle height?
    answer: >-
      Measure your inseam (barefoot, standing with a book pulled firmly into
      your crotch, measure floor to top of book). Multiply by 0.875 for a
      starting saddle height measured from the centre of the bottom bracket to
      the top of the saddle along the seat tube. This gives you a starting point
      — fine-tune by feel on the trail, typically dropping 5-10mm from the road
      formula to account for off-road terrain.
  - question: What handlebar width should I run on my MTB?
    answer: >-
      A good starting point is your shoulder width plus 2-4cm. Most trail riders
      end up between 760-800mm. Wider bars give more leverage and control at
      speed, but too wide causes shoulder fatigue and makes it harder to
      navigate tight trees. If in doubt, start wide and cut down 5mm at a time.
  - question: Does stem length matter on a mountain bike?
    answer: >-
      Absolutely. Shorter stems (35-50mm) give quicker steering response, better
      front wheel control on steep terrain, and a more centred riding position.
      Longer stems (60mm+) slow steering and can put too much weight over the
      front on descents. Most modern trail and enduro bikes are designed around
      40-50mm stems.
answerCapsule: >-
  Start your saddle height by multiplying your inseam by 0.875, then drop it
  5-10mm for mountain biking's rougher terrain. Use the heel test to validate:
  pedal at the ball of your foot with a 25-30 degree knee bend. Get this right
  and you stop bleeding power on every pedal stroke and stop loading your
  knees on technical terrain.
keyTakeaways:
  - "Saddle height is the single most important fit measurement — multiply your inseam by 0.875, then drop 5-10mm for MTB's rougher terrain."
  - "When choosing between frame sizes, a slightly longer reach with a shorter stem handles better than a shorter reach with a longer stem."
  - "Modern trail bikes run stems of 35-50mm; if you need anything longer than 60mm, the frame reach is probably too short for you."
  - "Handlebar width starts at shoulder width plus 2-4cm — most trail riders land between 760-800mm, and you can cut down but never add back."
  - "If your dropper post is set up correctly, your saddle height handles pedalling efficiency and the dropper handles the descending compromise."
relatedEpisodes:
...
whoFor:
  - "Mountain bikers losing power or comfort because their saddle height, reach, or stack is off"
  - "Road cyclists moving to MTB who assume their road fit transfers directly to the trail"
  - "Riders choosing between frame sizes and unsure how reach and stem length interact"
  - "Anyone experiencing knee pain, lower back fatigue, or shoulder tension on the mountain bike"
roadmanView:
  - "A well-fitted mountain bike disappears underneath you. A badly fitted one fights you on every feature. The difference between those two experiences is usually 10mm of saddle height and a stem swap. It is not complicated, but you have to actually do it."
  - "I see riders spend thousands on carbon bars and lightweight wheels while their saddle is 15mm too high. Start with the inseam formula, drop it 5-10mm for trail riding, and validate with the heel test. That costs nothing and changes everything."
  - "If you are caught between frame sizes, go longer reach with a shorter stem. A 40mm stem on a longer frame handles better than a 60mm stem on a shorter one. That is how modern trail bikes are designed to work."
---

Mountain bike fit is different from road bike fit. On the road, you set the bike up for sustained power output in a relatively static position. On the trail, you're constantly moving around on the bike — standing, sitting, shifting weight forward and back, absorbing impacts, cornering. Your fit needs to allow all of that movement while keeping you balanced and in control.
...
If you want to build the fitness behind the riding — base, intervals, strength — [NDY coaching at Roadman](/coaching) writes that around your week. Got a specific question about your own MTB fit numbers or how road fit translates to MTB? [Ask Roadman](/ask) for an answer drawn from the actual bike fit conversations on the podcast.
