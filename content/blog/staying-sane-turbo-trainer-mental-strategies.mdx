...
whoFor:
  - "Cyclists who dread the turbo trainer and struggle to stay consistent through winter"
  - "Riders who start indoor training blocks with enthusiasm and abandon them within three weeks"
  - "Anyone who finds unstructured indoor sessions unbearable and needs a system to make them tolerable"
  - "Time-pressed cyclists who rely on the turbo for midweek sessions and want those hours to count"
roadmanView:
  - "I know nobody loves the turbo. Not even the pros. When I had Tim Kerrison on the podcast, he talked about how even the Ineos riders find it mentally draining. The goal is not enjoyment — it is sustainability. Build a system that keeps you showing up."
  - "I'm convinced the single biggest predictor of winter training consistency is the social element. A Zwift group ride, an accountability partner, someone who checks in after the session. Willpower alone runs out by February — I've seen it happen too many times."
  - "I use the just-start rule myself: commit to 15 minutes, then reassess. In practice you almost never stop, because the resistance is in the starting, not the doing. That trick has saved more winter training blocks than any piece of equipment I've recommended."
---
