...
roadmanView:
  - "Nobody loves the turbo. Not even the pros. Tim Kerrison has talked about how even the Ineos riders find it mentally draining. The goal is not enjoyment — it is sustainability. Build a system that keeps you showing up."
  - "The single biggest predictor of winter training consistency is the social element. A Zwift group ride, an accountability partner, someone who checks in after the session. Willpower alone runs out by February."
  - "Use the just-start rule: commit to 15 minutes, then reassess. In practice you almost never stop, because the resistance is in the starting, not the doing. That trick has saved more winter training blocks than any piece of equipment."
---
