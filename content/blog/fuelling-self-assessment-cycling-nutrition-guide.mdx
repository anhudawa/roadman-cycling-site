...
roadmanView:
  - "I have spoken to Sam Impey, Alan Murchison, and the nutritionists behind World Tour teams across dozens of podcast episodes, and the consensus is always the same: most amateurs eat roughly half what they should on the bike. It is the single largest performance leak in the sport."
  - "I built the Fuelling Self-Assessment tool and Fuel Planner on this site so you can score and fix your nutrition without guesswork. They are based on the same periodised framework Impey uses with professional riders — I asked him to walk me through it on the show."
  - "I do not promote restriction or race-weight chasing. My position is simple: eat to support the work, train to absorb the fuel. The energy availability research backs that up completely, and every nutritionist I have had on the podcast agrees."
---

There is a stat I come back to every time I sit down with a new athlete in the [Roadman community](https://www.skool.com/roadmancycling): the gap between what most amateur cyclists eat on the bike and what the [cycling nutrition](/topics/cycling-nutrition) research says they should eat. It is not a small gap. It is not a rounding error. It is, in most cases, a factor of two.
...
Creatine has a defensible role alongside resistance training and a less certain role in repeated-sprint cycling, with no pooled trained-endurance benefit; the [reviewed creatine guide](/blog/creatine-for-cyclists-thirty-day-data) covers the dose and trade-off. Beta-alanine has modest support for short, high-intensity efforts. Beetroot juice (nitrates) has some evidence for time-trial performance. Beyond those, the supplement aisle is largely marketing.
