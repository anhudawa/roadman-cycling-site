...
relatedTools:
  ...
  - tss
whoFor:
  - "Cyclists adding running for time efficiency, bone density, or fitness insurance during time off the bike"
  - "Runners transitioning to cycling who want to understand how their aerobic fitness transfers and where the gaps are"
  - "Hybrid athletes over 40 balancing both sports without overloading connective tissue"
  - "Time-crunched riders who cannot always get on the bike and need a credible alternative that preserves the engine"
roadmanView:
  - "Here's a stat that should worry every cyclist — 84% of competitive cyclists meet the criteria for osteopenia or osteoporosis. Running is the single most accessible fix because it delivers the impact loading the skeleton needs, and I think the cycling industry has been far too slow to talk about this."
  - "I built the Run-Ride Converter tool on this site so you can translate performance between both sports using the research-backed VO2max crossover data. It's a calibrated conversion, not a guess."
  - "Let me be really clear — I run a cycling site first, and my position is that running supports the bike rather than replacing it. Build running volume far slower than your cardiovascular fitness suggests, and never let running fatigue compete with your key bike sessions."
citedClaims:
  - claim: "VO2max improvements from one endurance modality transfer approximately 60–70% to another because the central cardiovascular system is mode-independent"
    source: "Menges et al., Frontiers in Sports and Active Living"
    year: 2026
    evidenceLevel: "systematic-review"
    context: "The 2026 systematic review that settled the crossover transfer debate and underpins the run-ride converter tool"
  - claim: "84% of competitive cyclists meet the criteria for osteopenia or osteoporosis, and cyclists are seven times more likely to have osteopenia of the spine than runners"
    source: "Systematic review of 31 bone density studies in cyclists"
    year: 2019
    evidenceLevel: "systematic-review"
    context: "Cited as the primary reason running is the most accessible bone-density fix for cyclists, whose non-impact sport leaves the skeleton under-loaded"
  - claim: "The cardiovascular system is the engine and the sport-specific muscular system is the transmission — a strong engine in a poor gearbox still feels sluggish"
    source: "Prof. Stephen Seiler"
    year: 2023
    evidenceLevel: "expert-opinion"
    context: "Seiler's framing of why a strong runner can feel weak on a bike and vice versa, explaining the 30–40% of performance that does not transfer between modalities"
  - claim: "Maximum heart rate and lactate threshold heart rate are typically 5–10 bpm higher in running than cycling because running recruits more total muscle mass"
    source: "Exercise physiology literature; coaching consensus"
    year: 2024
    evidenceLevel: "cohort"
    context: "The basis for establishing separate heart rate zones for each sport, without which crossover athletes systematically over- or under-train in one modality"
  - claim: "Tendons adapt to load roughly three to four times more slowly than the cardiovascular system, making connective tissue the rate limiter for cyclists adding running"
    source: "Connective tissue adaptation research"
    year: 2022
    evidenceLevel: "cohort"
    context: "Cited as the physiological basis for the 10% weekly volume rule and the walk-run protocol for cyclists starting running despite superior cardiovascular fitness"
---
