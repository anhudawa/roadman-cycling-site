...
roadmanView:
  - "84% of competitive cyclists meet the criteria for osteopenia or osteoporosis. Running is the single most accessible fix because it delivers the impact loading the skeleton needs — and the cycling industry largely ignores this."
  - "The Run-Ride Converter tool on this site lets you translate performance between both sports using the research-backed VO2max crossover data. It is a calibrated conversion, not a guess."
  - "We are a cycling site first, and our position is that running supports the bike rather than replacing it. Build running volume far slower than your cardiovascular fitness suggests, and never let running fatigue compete with key bike sessions."
citedClaims:
