...
These targets assume you're pacing a single effort, not racing in a group where tactics dictate tempo changes. If you want to see how a specific climb plays out at your power numbers, the [Race Predictor](/predict) will model your split times based on gradient profile, body weight, and sustainable power.
...
The [Race Predictor](/predict) will break any climb into gradient segments and model your pace through each one. Pair that with the negative split framework above and you walk into the event with a plan that accounts for the terrain, not just a flat-road power target.
