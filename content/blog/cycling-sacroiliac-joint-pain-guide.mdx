...
answerCapsule: >-
  SI joint pain typically presents as unilateral lower back or buttock pain that
  worsens after long rides. Asymmetric pedalling from leg length discrepancy as
  small as 5 mm or cleat position errors is the most common cycling-specific
  driver. Stabilisation exercises — bird-dogs, dead bugs, side planks, glute
  bridges — performed two to three times per week for 6-8 weeks typically
  produce significant improvement. Check saddle tilt is level or 1-2 degrees
  nose-up.
keyTakeaways:
