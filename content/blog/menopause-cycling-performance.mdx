...
The reality is more specific, and more workable. Perimenopause and menopause produce real, predictable physiological changes that affect training adaptation, recovery, body composition, sleep and thermoregulation. Each of those changes has a defensible response inside a well-designed programme. The performance plateau most cyclists report through this window is real. So is the path through it.
