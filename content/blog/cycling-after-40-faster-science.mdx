...
Run the [Masters FTP Benchmark](/tools/masters-ftp-benchmark) — see where your current fitness sits against your age cohort. Then the [Masters Recovery Score](/tools/masters-recovery-score) — check whether your recovery is matching your training load. The diagnostic results usually point at one of three things: dropped intensity, insufficient strength work, or under-recovery.

For specific masters coaching, the [over-50 coaching pathway](/coaching/over-50) is the direct route. The [masters coaching page](/coaching/masters) covers the broader 40+ cohort. The [Not Done Yet community](https://www.skool.com/roadmancycling) is the lower-investment option for ongoing coaching support and accountability. For the structured 12-month masters programme, the [Roadman Method](/method) takes a rider through the full annual model with personal coaching.
