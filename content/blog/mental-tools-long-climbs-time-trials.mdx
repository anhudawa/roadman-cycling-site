...
seoDescription: "Four cycling mental strategies that hold up at threshold and above: segmenting, breath anchoring, the 90-second rule, and the second-person voice. No fluff."
excerpt: >-
...
whoFor:
  - Climbers who fade mentally before their legs actually give out
  - Time triallists who need pacing discipline in the second half
  - Riders who struggle in the last hour of any hard event
  - Anyone who wants practical mental tools rather than motivational fluff
roadmanView:
  - "These four tools — segmenting, breath anchoring, the 90-second rule, and the second-person voice — are the ones that hold up when everything hurts. I have tested all of them at threshold and above, and they work because they redirect attention, not because they pretend the pain is not there."
  - "The 90-second rule changed how I ride hard climbs. When the voice in your head says quit, commit to 90 more seconds. By the time they pass, the crisis has usually moved on. It is stupidly simple and reliably effective."
  - "If you want a poster on your wall that says believe in yourself, this is not the piece for you. If you want four tools that actually function at 350 watts, read on."
---
...
**Threshold session (e.g. 2 × 20 minutes at FTP).** If you haven't locked your zones recently, the [FTP zone calculator](/tools/ftp-zones) will set the target in seconds. Run segmenting — break each 20-minute interval into four 5-minute blocks, with a brief segment-boundary cue at each. Run breath anchoring — hold the 2:3 pattern through the entire interval. The mental rehearsal happens automatically alongside the physiological work.
