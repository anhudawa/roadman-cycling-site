...
answerCapsule: >-
  Endurance exercise raises HDL by 5-10% and lowers triglycerides by 10-20% but
  does not reliably lower LDL, which is the primary driver of cardiovascular
  disease. Total cholesterol is a blunt instrument; ask for ApoB and non-HDL
  cholesterol for a clearer risk picture. A Mediterranean diet reduces LDL by
  10-15%. If a statin is recommended, most cyclists notice no performance change,
  and the 5-10% who get muscle symptoms can usually resolve it by switching type
  or adjusting dose.
keyTakeaways:
...
roadmanView:
  - "You have done everything right. You ride four days a week, your resting heart rate is in the low fifties, you eat well. Then your GP reads out a total cholesterol of 6.8 and you wonder whether the last decade of riding was a waste of time. It was not. But the relationship between exercise and lipids is more complicated than fit equals healthy numbers."
  - "Ask for ApoB and non-HDL cholesterol, not just total cholesterol. A high total driven by very high HDL is a completely different risk profile from a high total driven by high LDL. Your GP's risk calculators were designed for sedentary populations, and the conversation needs context."
  - "If a statin is recommended, most cyclists notice no performance change. The 5-10% who get muscle symptoms can usually resolve it by switching type or adjusting dose. Do not dismiss the conversation because you are fit."
---
