...
faq:
  ...
  - question: What did Seiler's research actually prove?
    answer: >-
      ...
      intensity when measured by session count. The StÃ¶ggl & Sperlich 2014
...
## What the 2025-2026 Research Adds

**RÃ¸nnestad et al. (2024), *Scandinavian Journal of Medicine & Science in Sports*.** Compared polarised vs pyramidal distribution in trained cyclists over 12 weeks. Polarised delivered significantly greater VO2max and VT2 power gains. Sweet spot wasn't tested directly, but pyramidal distribution (which includes sweet spot intensity) underperformed polarised in this population of well-trained athletes.

**Mujika et al. (2025), *International Journal of Sports Physiology and Performance*.** Masters cyclists (40+) responded best to a pyramidal base phase followed by a polarised build phase. Strict polarised year-round underperformed the periodised hybrid. This validates the phased approach: sweet spot has a role in base phases, especially for time-crunched masters riders.

**Burnley et al. (2025), *European Journal of Applied Physiology*.** Demonstrated that Critical Power (CP) $€” not FTP $€” is the physiologically meaningful threshold. Sweet spot zones calculated from FTP may actually land below or above the true sustainable intensity for individual riders. The implication: if your sweet spot sessions feel too easy or too hard, your FTP test may be miscalibrated relative to your true CP.

For the complete research library, see the [research & evidence hub](/research).
