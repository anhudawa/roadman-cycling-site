...
answerCapsule: >-
  Polarised training allocates roughly 80% of sessions to low intensity (below the first lactate threshold) and 20% to high intensity (above the second threshold), with little time in the middle. Sweet spot training targets 84–97% of FTP to accumulate threshold-adjacent work efficiently. Prof. Stephen Seiler's research on elite endurance athletes supports polarised distributions at high volumes. Dr. Andrew Coggan's sweet spot concept fits time-constrained riders under 10 hours per week. Both work. The right choice depends on weekly hours, training age, and goal event.
faq:
