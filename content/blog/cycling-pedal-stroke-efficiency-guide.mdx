...
roadmanView:
  - "The pedal stroke advice on the internet is mostly wrong. Force profiling data from actual pros shows they produce almost all their power on the downstroke. The upstroke pulling cue needs to die."
  - "If your pedalling feels inefficient, start with bike fit before technique drills. Saddle height and cleat position affect force application more than any conscious effort to change how you push."
  - "Prof Jim Martin's research found that trained cyclists naturally adopt a pattern close to their biomechanical optimum. Your body is smarter than the coaching cues you read online."
---
