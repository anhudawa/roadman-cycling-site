...
seoDescription: >-
  Cycling training plan for triathletes. Structure bike sessions around swim and
  run, brick workouts, polarised training, and 3-sport fatigue management.
excerpt: >-
  Most triathletes under-train the bike. Here's how to structure your cycling
  training around swim and run sessions — without burning out before race day.
pillar: coaching
...
faq:
  - question: How many hours per week should a triathlete spend cycling?
    answer: >-
      For a competitive age-grouper targeting a 70.3 or Ironman, aim for 6-10
      hours of cycling per week during build phases. The bike leg is where the
      most time is gained or lost, so it should receive the largest training
      volume of the three disciplines — typically 45-55% of total training time.
  - question: Should triathletes do brick sessions every week?
    answer: >-
      One brick session per week is sufficient for most triathletes. The purpose
      is to rehearse the bike-to-run transition, not to accumulate extra
      training stress. A 90-minute ride followed by a 20-minute run at race pace
      teaches your legs to handle the transition without requiring a full race
      simulation every week.
  - question: Is polarised training effective for triathletes?
    answer: >-
      Yes. Research from Stephen Seiler and others shows that the 80/20
      polarised approach — 80% easy, 20% hard — works across all endurance
      disciplines. For triathletes, this means most cycling sessions should be
      genuine Zone 2, with 1-2 quality sessions per week targeting threshold or
      VO2max intensities.
answerCapsule: >-
  Stop treating the bike like an afterthought. Build 3-4 structured cycling
  sessions weekly: two at Zone 2 (easy), one at threshold or VO2 max, one at
  sweet spot. This works because consistent, polarized training across three
  sports forces your body to adapt efficiently without compounding fatigue
  across disciplines.
---
