...
answerCapsule: >-
  All cycling glasses must block 100 per cent of UVA and UVB (UV400 standard).
  Lens categories run from Cat 0 (clear) to Cat 4 (alpine), with Cat 2-3
  covering most road riding. Photochromic lenses are the most practical upgrade
  for British conditions, eliminating mid-ride lens swaps. Wrap-around frames
  prevent wind-driven dry eye above 30 km/h. Budget lenses protect against UV
  equally well — the price gap buys optical clarity and coating durability.
keyTakeaways:
