...
seoTitle: "Cycling Around Nice: Best Cols & Routes (2026)"
seoDescription: >-
...
keyTakeaways:
  ...
  - "Col de Turini (20.5km from Sospel at 5.7%) is the big day out — a proper mountain pass made famous by the Rally Monte Carlo. Remote, beautiful, and properly hard."
...
whoFor:
  - Cyclists planning a training trip to the south of France
  - Climbers looking for world-class cols within an hour of an airport
  - Riders choosing a warm-weather base for spring or autumn riding
  - Amateurs who want to train on the same roads as the WorldTour pros
roadmanView:
  - "Nice is the cycling destination I keep coming back to because it has everything — proper climbs, reliable weather, and you can be on Col de la Madone forty minutes after landing."
  - "If you only ride one climb near Nice, make it Col d'Eze. It is short enough to repeat, hard enough to test you, and the view from the top earns every watt you put in."
  - "I think most riders overcomplicate the logistics. Fly in, hire a bike or bring yours, and ride from the door. You do not need a tour operator for Nice."
---
...
For most well-trained amateurs, expect a time somewhere between 55 and 75 minutes depending on your power-to-weight — the [Climbing Calculator](/tools/vam) will estimate your time based on the gradient and your W/kg. The road is quiet enough that you can ride it on a Tuesday morning and see nobody. That's a big part of its appeal -- it feels like your own private test, not a tourist attraction.
