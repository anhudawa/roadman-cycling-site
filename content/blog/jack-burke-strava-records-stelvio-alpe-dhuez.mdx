...
seoDescription: "Jack Burke's Strava records on three iconic climbs in late 2024 — the Stelvio, Alpe d'Huez and Mortirolo. The preparation, pacing, and what you can borrow."
description: >-
...
faq:
  ...
  - question: What can amateurs learn from Jack Burke's story?
    answer: >-
      ...
      any single element.
whoFor:
  - Climbers who want to understand what world-class KOM preparation looks like
  - Amateur racers exploring the path from domestic racing to a pro contract
  - Strava segment hunters interested in pacing and execution at the sharp end
  - Riders who follow the competitive amateur-to-pro pipeline in modern cycling
roadmanView:
  - "When I had Jack on the podcast, I couldn't get over it — he turned up in cold weather with a borrowed bike and broke KOMs on three of the most iconic climbs in cycling. No team car, no race calendar, just years of preparation meeting one window of opportunity."
  - "The part most people miss — and I pushed Jack on this during our conversation — is the racing background. His amateur race season built the competitive sharpness that made the KOM attempts work. I've always said raw watts alone don't get it done."
  - "I walked away from that interview thinking: right, this is what's actually possible when an amateur commits fully. One of the best conversations I've had on the show."
---
...
For deeper context on the climbing-specific training that builds this kind of capacity, see [the polarised training guide](/blog/polarised-training-cycling-complete-guide) and [the altitude training piece](/blog/cycling-altitude-training).
...
**One. Climbing fitness is built from the boring work, not the secret protocols.** Burke's records were produced by sustained aerobic work, high-quality intensity, and a full season of competitive racing. The training is replicable in structure if not in absolute power numbers. The amateurs who climb fastest do the same kind of work as Burke, scaled to their capacity. If you want to see what your own climbing power means in concrete terms, the [W/kg calculator](/tools/wkg) and the [VAM calculator](/tools/vam) will show you where you stand on the climbs you're riding.

**Two. The conditions are part of the work.** Burke executed the Stelvio attempt in near-snow at 2,800 metres altitude. The weather and the cold were part of the test. Amateurs who skip sessions because the weather is marginal are skipping the part of the training that actually develops competitive sharpness. If the Stelvio is on your own list, the [Granfondo Stelvio training guide](/blog/granfondo-stelvio-training-guide) covers the pacing, altitude preparation, and the 48-hairpin summit finish in detail.
