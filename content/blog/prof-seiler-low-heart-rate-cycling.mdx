...
seoDescription: >-
  Cycling fast at a low heart rate: Prof. Stephen Seiler on why elites make big
  power at low pulses, and how amateurs can train the same aerobic adaptation.
excerpt: >-
...
keyTakeaways:
  - "Stroke volume — the amount of blood the heart ejects per beat — is what separates an elite cyclist's heart rate response from an amateur's at any given power."
  - "Structural cardiac adaptation (left ventricular remodelling) takes a minimum of six to twelve months of consistent aerobic volume to become measurable."
  - "The moderate-intensity trap is the default failure mode: riding too hard for aerobic adaptation and too easy for neuromuscular stress, producing mediocre returns at both ends."
  - "At six months of consistent polarised training (80% easy, 20% hard), most riders see a drop of 8-15 beats per minute at a given submaximal power output."
  - "Cardiac drift over a long ride is primarily a hydration and thermoregulation issue, not a sign of poor aerobic fitness — check heart rate against power to confirm."
faq:
  ...
  - question: Do elite cyclists always train at low heart rates?
    answer: >-
      No. Elite endurance athletes spend the majority of training time — around
      75–85% by session count across Seiler's analyses of elite endurance
      populations — at low intensity. The remaining sessions include genuine
      high-intensity intervals. What distinguishes elites is that their easy
      riding is truly easy, not moderate, and their hard riding is properly
      hard. Most amateurs compress both ends toward a grey middle zone that
      develops neither quality well.
relatedEpisodes:
...
whoFor:
  - Riders frustrated by a high heart rate at moderate power who want to understand why
  - Amateurs stuck in the moderate-intensity trap who need the science behind going easier
  - Self-coached cyclists building a polarised training plan for the first time
  - Anyone curious about what structural cardiac adaptation actually means and how long it takes
roadmanView:
  - "Seiler is the person who gave polarised training its name. When he explains why your heart rate is high at low watts, you stop guessing and start understanding what the fix actually requires."
  - "The moderate-intensity trap is real and it is where most amateur training hours go to die. Not hard enough to stress the system, not easy enough to build the aerobic base. Seiler's data makes the case better than I ever could."
  - "This is a long-game adaptation. Six to twelve months of consistent aerobic volume before your heart structurally remodels. Nobody wants to hear that, but it is the truth and I would rather tell you now than let you waste another winter."
---
...
The consequence for how pros ride is direct. An effort that sits at 65% of their VO2max — properly easy aerobic work — corresponds to a power output most amateurs would treat as a tempo effort. Their easy is objectively fast, and their heart rate stays low because the machinery underneath it has been built for this purpose.
...
Our [Zone 2 guide](/blog/zone-2-cycling-heart-rate-vs-power-vs-rpe) covers the practical implementation in detail. The principle is simple: most of your riding needs to be properly easy, defined by a physiological marker (lactate below 2 mmol/L, or the upper end of your Zone 1–2 band), not by whether it feels comfortable enough.
...
For the wider polarised picture, [what Stephen Seiler says about polarised training](/blog/what-stephen-seiler-says-about-polarised-training) and [Stephen Seiler research lessons](/blog/stephen-seiler-research-polarised-training-lessons) are the deeper reads, and the [Zone 2 complete guide](/blog/zone-2-cycling-heart-rate-vs-power-vs-rpe) is the practical companion.

If you'd rather have someone set the Zone 2 ceiling and the testing protocol around your data, that's exactly what [NDY coaching at Roadman](/coaching) is built around — [the application](/apply) is where the conversation starts. Got a specific question about your own HR drift, your Zone 2 number, or whether your easy rides are actually easy? [Ask Roadman](/ask) for an answer drawn from the actual conversations with [Stephen Seiler](/guests/stephen-seiler), [Joe Friel](/guests/joe-friel), and the rest of the polarised-training experts on the podcast.
