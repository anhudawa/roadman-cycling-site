...
roadmanView:
  - "Sam Impey formalised this approach as 'fuel for the work required' at Liverpool John Moores — when he was on the podcast, he made clear it is not low-carb dieting, it is intelligent carbohydrate distribution."
  - "Our Fuel Planner tool builds a 12-week nutrition calendar that adjusts daily carbohydrate targets based on your TrainingPeaks sessions, putting this framework into practice automatically."
  - "In the NDY community, periodised nutrition is the single intervention that most often shifts both body composition and power output simultaneously — particularly for riders over 40 who were chronically underfuelling hard days."
---
