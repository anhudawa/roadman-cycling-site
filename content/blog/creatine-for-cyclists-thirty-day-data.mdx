...
**Dose.** 5 grams per day. No loading phase necessary. If you want to reach full muscle saturation faster, a 5–7 day loading phase at 20g/day (split into 4 doses of 5g) works, but the result is the same — saturation in 1 week with loading vs 3–4 weeks without. If you want the dosing and loading decisions laid out on their own, [what 30 days on 5 grams actually did](/blog/creatine-for-cyclists-30-day-protocol) is the step-by-step protocol companion to the data above.
