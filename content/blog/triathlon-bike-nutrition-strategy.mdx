...
seoDescription: >-
  How to fuel the bike leg in triathlon. Carb targets for 70.3 and Ironman, what
  to eat on the bike, timing your nutrition, and why most triathletes
  under-fuel.
excerpt: >-
  The bike leg is your only real chance to eat. Get your triathlon bike
  nutrition wrong and you'll bonk on the run. Here's exactly what to consume,
  when, and how much.
pillar: nutrition
...
faq:
  - question: How many carbs per hour should I consume on the triathlon bike leg?
    answer: >-
      For a 70.3, aim for 80-100g of carbs per hour on the bike. For a full
      Ironman, target 90-120g per hour using a dual-source carbohydrate strategy
      (glucose + fructose). These higher intakes are well supported by current
      research and are trainable — start at 60g per hour and build up over 4-6
      weeks.
  - question: Should I eat solid food on the triathlon bike leg?
    answer: >-
      For a 70.3, liquid and gels are usually sufficient given the shorter
      duration. For a full Ironman, including some solid food in the first 2-3
      hours can help with satiety and provide a psychological break from gels.
      Rice cakes, energy bars, or bananas work well. Switch to gels and liquids
      only for the final 90 minutes before T2.
  - question: When should I start eating on the bike in a triathlon?
    answer: >-
      Start fuelling within the first 15 minutes of the bike leg. Don't wait
      until you feel hungry — by then you're already behind on your nutrition
      plan. Set a timer on your bike computer for every 15-20 minutes as a
      reminder to eat or drink. Early and consistent fuelling prevents the
      deficit that causes late-race bonking.
answerCapsule: >-
  Aim for 60–90 grams of carbs per hour on the bike, trained up to 120 if you've
  built gut tolerance. Pair that with sodium and hydration matched to sweat
  rate. You're not fueling the bike leg—you're banking energy so your run
  doesn't collapse at kilometre 25.
---
