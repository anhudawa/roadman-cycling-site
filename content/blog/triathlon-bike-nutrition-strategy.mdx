...
seoTitle: Triathlon Bike Nutrition — Fuel the Bike Leg Without Wrecking the Run (2026)
seoDescription: >-
  How to fuel the triathlon bike leg. Carb targets of 60-120g/hr, glucose to
  fructose 1:0.8 ratio, and a practical fuelling schedule that sets up the run
...
faq:
  ...
  - question: What is the glucose to fructose ratio and why does it matter?
    answer: >-
      A 1:0.8 glucose-to-fructose ratio lets you absorb roughly twice as many
      carbs per hour as glucose alone by using two different gut transporters.
...
The last decade has completely rewritten triathlon fuelling. Where 60 g/hr was once considered aggressive, elite Ironman racers now routinely push 120-150 g/hr. The numbers below are what work for trained amateurs with a reasonably prepared gut.
...
The single biggest upgrade to modern sports nutrition is multiple transportable carbohydrates. Glucose is absorbed through SGLT1 transporters, which cap out around 60 g/hr. Fructose uses GLUT5 — a completely separate transporter. Combine them at roughly a 1:0.8 ratio (glucose:fructose) and you can push total carbohydrate absorption to 120+ g/hr without the GI distress that glucose alone produces at those volumes.

Every decent modern endurance carb product — Maurten, Precision, SiS Beta Fuel, Neversecond — is built on some version of this ratio. If you are still taking straight-maltodextrin gels at 90 g/hr you are over-loading SGLT1, leaving carbs stranded in your gut, and almost certainly going to vomit.
