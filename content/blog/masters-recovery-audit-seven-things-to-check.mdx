...
**The fix.** If life is heavy — work, family, travel — drop to 2:1 for two cycles, then re-evaluate. Most riders find the form returns inside the second cycle when they were stalling in the third week of a 3:1 cycle that should have been a 2:1. If you ride with power and want to put numbers on this, [managing training load in your 40s and 50s](/blog/training-load-management-cyclists-40s-50s) covers the ramp rate and acute:chronic load ratios that tell you when the build has tipped from productive into a hole.
