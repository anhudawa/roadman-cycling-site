...
seoDescription: >-
  A practical cycling recovery audit for riders over 40: sleep, HRV, deload
  cadence, protein, alcohol, stress and the patterns that quietly stop gains.
excerpt: >-
...
whoFor:
  - Masters cyclists who train consistently but have stopped improving
  - Riders over 40 who feel chronically tired despite good fitness
  - Anyone who has never formally audited their recovery habits
  - Self-coached cyclists looking for a structured recovery checklist
roadmanView:
  - "I developed this seven-point audit from years of coaching inside Not Done Yet, and I can tell you it catches the same blind spots every single time. Recovery after 40 is not passive — it's the input that determines whether your training sticks or evaporates."
  - "Most riders who come to me plateau not because they train wrong, but because they recover badly. I've had this conversation with Joe Friel and David Lipman on the podcast, and they both say the same thing: fix sleep, alcohol, protein timing, and deload frequency, and the training you're already doing starts working again."
  - "Let me be really clear: ten minutes with this checklist will tell you more about your next breakthrough than another power-meter file ever will."
---
...
**The fix.** A 30-minute earlier bedtime, three nights a week, beats almost every other recovery intervention available to a masters cyclist. The intervention costs nothing, there is no learning curve, and the benefit lands inside a week. For the protocol behind the protocol — what to do in the 60 minutes before bed, where alcohol and screens fit, how to actually fall asleep faster — work through the [sleep optimisation guide](/blog/cycling-sleep-performance-guide).
...
The last and most overlooked piece. Cortisol does not distinguish between training stress, work stress, and life stress. The body sees one bucket. If the work stress went up 30% in March, the bucket has 30% less room for training stress, even though the training plan didn't change. You can see this in your numbers -- run your week through the [training load calculator](/tools/training-load) and compare the total against what you were absorbing when things were going well.
...
If you want a quick snapshot of where you stand right now, the [recovery diagnostic](/tools/recovery-screen) scores your current recovery status across sleep, training load, nutrition, and stress in under two minutes. The [masters recovery score tool](/tools/masters-recovery-score) runs through the key inputs in under two minutes. The [Plateau Diagnostic](/plateau) is a four-minute version of the same logic — it asks the same diagnostic questions in a structured order and recommends the specific fix that matches your pattern. The audit above is the long-form version of the same framework.
