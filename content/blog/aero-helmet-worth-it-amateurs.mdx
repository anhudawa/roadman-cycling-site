...
roadmanView:
  - "At 30-35 km/h — realistic amateur race pace — an aero helmet saves roughly 30 to 90 seconds over 40 km. That is real time, but it is not transformative. Body position and clothing are still worth 10-30 watts versus 2-6 watts for a helmet swap."
  - "Ventilation is the honest trade-off nobody in marketing mentions. Aero helmets run 3-5 degrees Celsius warmer than vented road helmets. If heat costs you watts through cardiovascular strain, you can lose the time you gained. Modern aero-road helmets like the Specialized Evade III close the gap but do not eliminate it."
  - "Fit matters more than brand. An aero helmet that sits wrong on your head shape can actually increase drag compared to a well-fitted standard helmet. Try before you buy, and if possible, get a head-shape assessment at a local bike fit studio."
---
