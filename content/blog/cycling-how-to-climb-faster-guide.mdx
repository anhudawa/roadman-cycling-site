...
roadmanView:
  - "Most amateur riders are trying to change the wrong half of the W/kg equation. They are counting calories when they should be counting intervals. A 10-watt FTP gain is worth roughly 1.5kg of weight loss at typical amateur numbers — and it is far safer to achieve."
  - "Pace the first third of every climb at 5% below target power. The oxygen debt from starting too hard compounds across the entire effort and you cannot repay it. This single change will improve your climbing times more than any equipment upgrade."
  - "The mental side is real. The riders who stay on the wheel are the ones who decided at the bottom that they would. Waiting to see how you feel is a decision to get dropped."
---
...
One thing I want to be clear about. This is a framework, not a prescription. Your specific sessions, volumes, and recovery needs depend on your current fitness, your available hours, your age, your stress load outside of cycling. If you want the specific session library with full interval prescriptions, the [training sessions guide](/blog/cycling-interval-training-sessions-guide) goes into that detail.
