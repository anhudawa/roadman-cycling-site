...
**A large catalogue of workouts.** The Zwift workout library covers most of the training spectrum — threshold intervals, VO2 max blocks, sweet spot, endurance. You can build a week of training without ever leaving the app.
