...
whoFor:
  - "A masters cyclist over 40 whose joints protest at heavy gym work but who knows they need to maintain muscle mass"
  - "A rider recovering from injury who needs a strength stimulus without loading damaged tendons or joints"
  - "A cyclist mid-season who cannot afford the recovery cost of heavy lifting but wants to protect lean mass"
  - "A strength-curious rider who has heard about BFR and wants to know whether the evidence is real or just hype"
roadmanView:
  - "I have been using BFR intermittently for two years, mostly during injury rehab and mid-season when I do not want heavy lifting anywhere near my key bike sessions. The burning sensation by set three is properly unpleasant, but it works."
  - "BFR is not a replacement for heavy lifting. It is a supplement for when heavy lifting is not available, not tolerated, or would wreck your recovery for the sessions that matter."
  - "Buy calibrated cuffs with a pressure gauge. Knee wraps and elastic bands make it impossible to control the one variable that matters most — occlusion pressure. Fifty to eighty quid is worth the safety."
---
