...
answerCapsule: >-
  BFR training uses inflatable cuffs to partially occlude venous return,
  triggering muscle protein synthesis at loads of just 20-30% of one-rep max.
  A 2019 meta-analysis found comparable hypertrophy to heavy lifting with
  significantly lower joint stress. The protocol is 30-15-15-15 reps with 30
  seconds rest at 40-80% limb occlusion pressure. It suits cyclists over 40
  whose joints protest at heavy loading, mid-season riders protecting lean
  mass, and injury rehabilitation. Use calibrated cuffs with pressure gauges
  — not improvised wraps. BFR supplements conventional training rather than
  replacing it.
keyTakeaways:
  ...
  - "Practical BFR protocol for cyclists: 30 reps, then 15, then 15, then 15, with 30-second rest between sets. Use 40-80 per cent of limb occlusion pressure. The load should feel easy on the first set and properly difficult by the fourth."
