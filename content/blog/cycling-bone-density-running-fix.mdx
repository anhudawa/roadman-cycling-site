...
roadmanView:
  - "I covered the 84 per cent osteopenia statistic on the podcast and it's still the most alarming number on this site. That figure comes from a systematic review of 31 studies, and it's the reason our Running for Cyclists series exists."
  - "The research supports two to three runs of 20 to 30 minutes per week — that's the dose. I was surprised how little running it actually takes to make a measurable difference to bone density."
  - "I'll be blunt: this isn't optional for riders over 40 training more than eight hours a week on the bike. Bone loss produces no symptoms until a fracture occurs. A DEXA scan and a running protocol are the minimum."
---
