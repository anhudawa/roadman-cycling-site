...
answerCapsule: >-
  Cyclists inhale 10-20 times more air per hour than pedestrians, amplifying
  pollution exposure on urban roads. Route selection matters: riding at 10am
  rather than rush hour reduces nitrogen dioxide exposure significantly. A buff
  over the mouth in cold weather below 5 degrees pre-warms inhaled air and
  reduces bronchospasm triggers by 40-60 per cent. Persistent post-ride cough
  after threshold efforts warrants a eucapnic voluntary hyperventilation test,
  as standard spirometry misses exercise-induced bronchoconstriction in half of
  cases.
keyTakeaways:
