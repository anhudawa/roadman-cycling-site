...
seoDescription: >-
  Sweet spot training for cycling explained: the science, how it stacks up
  against polarised, and how to programme a block, with a section for over-40s.
excerpt: >-
  ...
  the science, the real polarised debate, and how to build a block that
...
faq:
  ...
  - question: Is sweet spot or polarised training better?
    answer: >-
      ...
      well-rested athletes with the hours to ride a lot of easy
      volume. Sweet spot wins on time efficiency for the rider with 6–8 hours a
      week who can't fit the easy volume polarised assumes. The short answer
      most coaches land on: use sweet spot in a focused build block, keep some
      easy riding around it, and add top-end work before your event.
...
whoFor:
  - Cyclists over 40 who want sweet spot guidance that accounts for slower recovery between hard days
  - Riders debating whether sweet spot or polarised is the better approach for their situation
  - Time-crunched athletes training 6-8 hours a week who need every session to count
  - Anyone running sweet spot year-round who's noticed their progress has flatlined
roadmanView:
  - "I think sweet spot took over amateur cycling because it's efficient, not because it's magic. Those are different claims, and from what I've seen, the gap between them is where most riders get it wrong."
  - "I cover the over-40 angle because nobody else does it properly. You still adapt. You still improve. But the recovery maths changes, and I've seen most plans ignore that completely."
  - "I've said it on the podcast more than once — two to three sessions a week is the ceiling, not the floor. If you're doing more, you've turned a sharp tool into grey-zone miles and you're wondering why nothing moves."
---

Sweet spot training took over amateur cycling not because it's the most effective training ever discovered, but because it's the most *efficient* — the best result you can buy with six hours a week. Those are two different claims, and the gap between them is where most riders get it wrong.

TrainerRoad built a brand on this zone. Half the structured plans on the internet are sweet spot plans wearing different names. And for a lot of riders it works — until it doesn't, because they treated a tool with a ceiling like it had none. This guide covers all of it: what sweet spot actually is, what's happening in the muscle, the unvarnished version of the polarised debate, and how to programme it — including the part TrainerRoad's marketing skips, which is what changes when you're over 40.

## What sweet spot training actually is

Sweet spot is structured riding at **88–94% of your FTP**. If you're not sure where that sits in watts, the [sweet spot calculator](/tools/sweet-spot) will show you the exact power range, and the [FTP Zone Calculator](/tools/ftp-zones) maps the full zone picture. On the classic power-zone model — the one Andrew Coggan laid out in *Training and Racing with a Power Meter* — that's the top of zone 3 (tempo) bleeding into the bottom of zone 4 (threshold). The name describes the trade-off: it's the sweet spot between stimulus and fatigue. Drop below it and the adaptation thins out. Climb above it into full threshold and the recovery cost climbs faster than the benefit.
...
- **One longer easy ride** at the weekend — easy, zone 2, as long as you can make it. This is the base the sweet spot work sits on.
...
- **48–72 hours between hard days.** A sweet spot session Tuesday and your next hard effort no earlier than Friday. The days between are easy or off —.
...
Sweet spot isn't a secret and it isn't a scam. It's the most efficient way to raise sustainable power on limited hours — which makes it the best tool for the serious amateur, and the easiest one to overcook. Use it in a focused block. Keep your easy days easy. Add top-end work before it matters. And if you're over 40, drop to two sessions and guard the recovery like it's part of the training, because it is.
...
**Related reading:** [Sweet Spot Training For Cyclists: What It Actually Is And Why It Works](/blog/sweet-spot-training-cyclists-explained)
