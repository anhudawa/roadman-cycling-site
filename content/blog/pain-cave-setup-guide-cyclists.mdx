...
whoFor:
  - Cyclists setting up a dedicated indoor training space for the first time
  - Riders spending three or more sessions per week on the trainer who want to protect session quality
  - Amateurs upgrading from a basic turbo setup and unsure where to invest
  - Anyone whose indoor sessions consistently feel harder than the same effort outdoors
roadmanView:
  - "If your indoor sessions feel ten per cent harder than the same power outside, the problem is almost certainly cooling. Two fans minimum — one in front, one from the side. This is not optional. It is the single most important variable in your pain cave."
  - "I held off recommending a direct-drive trainer for years, but for anyone riding indoors three times a week or more, the power accuracy and noise difference justify the cost. Your zones and FTP tests need to be trustworthy."
  - "The setup detail nobody talks about is screen height. A laptop on the floor creates chronic neck tension that changes your pedalling mechanics across a full winter. Get the screen at eye level."
---
