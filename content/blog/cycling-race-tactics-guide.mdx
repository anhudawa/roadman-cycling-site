...
seoDescription: "Racing tactics for amateur cyclists. Bunch positioning, breakaway strategy, when to attack, energy management, and how to race smarter not harder."
excerpt: "Bike racing is chess at 40kph. The strongest rider doesn't always win — the smartest often does. Here are the tactical fundamentals that most amateur racers never learn."
pillar: le-metier
...
faq:
  - question: "Where should I position myself in a cycling race?"
    answer: "Top 15-20 riders, but not on the front unless you're driving pace deliberately. The front third gives you space to respond to moves and avoids the accordion effect at the back. Stay off the front to conserve energy."
  - question: "When is the best time to attack in a cycling race?"
    answer: "At the top of a climb (not the bottom), into a headwind (counterintuitive but the speed difference is smaller), after a hard effort by others (when they're recovering), or when another rider attacks and pulls the group's attention."
  - question: "Should I try to get in a breakaway as a beginner racer?"
    answer: "Not initially. Learn to race in the bunch first — positioning, cornering at speed, reading the race. Once you're comfortable, targeted breakaway attempts in appropriate situations are a great tactic."
---
