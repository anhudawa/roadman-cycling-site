...
roadmanView:
  - "A properly set up hardtail will outperform a poorly set up full-suspension bike on almost every trail. That is not an exaggeration. The difference between confidence and hesitation is often just a few clicks of rebound and a handful of PSI."
  - "Start with sag. Get it to 25-30% on both fork and rear shock for trail riding. Measure it properly — have a mate hold you upright in riding position. Then dial rebound using the drop test. The whole process takes about 20 minutes."
  - "The most important thing is balance. Fork and shock must work together. If one bottoms out consistently while the other has travel left, the bike pitches unpredictably under braking and on drops. Re-check settings every season, after any significant weight change, and after a service — fresh oil changes how damping feels."
---
