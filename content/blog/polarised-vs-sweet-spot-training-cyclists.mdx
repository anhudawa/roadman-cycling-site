...
roadmanView:
  - "The polarised-versus-sweet-spot debate is the training world's favourite false binary. Dan Lorang shifts the ratio by phase, not by ideology — more polarised in base, more specificity in build. That is the practical answer most riders need."
  - "If you are riding 8 hours a week, genuine polarised training does not work because you cannot accumulate enough low-intensity volume for the 80 per cent to do its job. Sweet spot fills that gap efficiently."
  - "We built the Roadman FTP Zone Calculator precisely so you can set your zones correctly and stop guessing which intensity bucket your rides fall into."
---
