...
whoFor:
  - "Time-crunched cyclists trying to decide whether their 8-10 weekly hours suit polarised or sweet spot training"
  - "Riders stuck in the Zone 3 grey zone who suspect their intensity distribution is holding them back"
  - "Self-coached athletes who want practical weekly schedules for both models at different volume levels"
  - "Anyone tired of the online arguments and wanting the actual research and real-world application"
roadmanView:
  - "I've had this argument with listeners for years, and here's where I've landed: the polarised-versus-sweet-spot debate is a false binary. When I had Dan Lorang on the show, he told me he shifts the ratio by training phase, not by ideology — more polarised in base, more specificity in build. That's the practical answer most riders need to hear."
  - "If you're riding 8 hours a week, here's the thing — genuine polarised training doesn't work because you simply can't accumulate enough low-intensity volume for the 80 per cent to do its job. Sweet spot fills that gap efficiently, and I wish more coaches were honest about that with their time-crunched athletes."
  - "I built the Roadman FTP Zone Calculator precisely so you can set your zones correctly and stop guessing which intensity bucket your rides fall into. Get the zones right first, then worry about the philosophy."
---
