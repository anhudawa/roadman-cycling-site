...
answerCapsule: >-
  Lactic acid does not exist in your body at physiological pH. What is
  produced is lactate plus a hydrogen ion — the hydrogen ion creates the burn,
  not the lactate. George Brooks proved lactate is shuttled between muscles,
  the heart, and the brain as fuel. Your threshold is defined by the balance
  between lactate production and clearance. Zone 2 training improves clearance
  by building mitochondrial density — more mitochondria means more capacity to
  consume lactate before it accumulates.
keyTakeaways:
