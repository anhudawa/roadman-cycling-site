...
answerCapsule: >-
  Track five metrics weekly: total TSS, CTL trajectory over 6-8 weeks, FTP
  progression across test cycles, acute-to-chronic workload ratio as a fatigue
  guardrail, and resting heart rate or HRV trend. Garmin VO2max estimates, body
  battery, and Strava suffer score are engagement features, not training tools.
  A 5-minute weekly review of these five numbers drives better decisions than 30
  minutes of post-ride analysis after every session.
keyTakeaways:
...
relatedTools:
  ...
  - "ftp-test"
whoFor:
  - "The cyclist who finishes every ride staring at six different apps and cannot tell whether the session was good or not"
  - "The self-coached rider who tracks everything and has started to suspect the data is making them worse, not better"
  - "The Garmin or Wahoo user who wants to know which platform metrics are real and which are engagement features dressed up as science"
  - "The masters athlete who wants a simple 5-minute weekly review that actually drives better training decisions"
roadmanView:
  - "The riders I have spoken to across 1,400-plus podcast episodes say the same thing. The ones who improve consistently track very little. The ones who stagnate track everything. That is not a coincidence."
  - "Five metrics deserve your weekly attention: TSS trend, CTL trajectory, FTP progression, acute-to-chronic workload ratio, and resting heart rate or HRV trend. Everything else is context or noise."
  - "Strava suffer score and Garmin body battery are engagement features, not training tools. They measure something, but what they measure has no reliable relationship to the training stimulus your body actually experienced."
---
