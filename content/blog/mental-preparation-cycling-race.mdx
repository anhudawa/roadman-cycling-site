...
whoFor:
  - Riders whose fitness is ready but whose head lets them down on race morning
  - Cyclists who suffer from pre-race anxiety and want practical tools to manage it
  - Anyone who has never practised structured race visualisation
  - Time triallists and road racers preparing for a target event in the next month
roadmanView:
  - "You have done the intervals. You have done the long rides. Then race morning arrives and your brain starts working against you. I have been there. The fix is not willpower. It is preparation, and it starts two to three weeks before the gun."
  - "Reframing anxiety as excitement is the single most useful mental trick I have encountered. The physiology is almost identical. The difference is the label you put on it."
  - "Process goals over outcome goals, every time. You cannot control where you finish. You can control your pacing, your fuelling, and your self-talk. Focus on what is actually within your reach."
---
