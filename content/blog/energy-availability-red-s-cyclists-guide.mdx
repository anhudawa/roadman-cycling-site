...
relatedTools:
  - energy-availability
whoFor:
  - "Cyclists whose performance is declining despite consistent training and who cannot work out why"
  - "Male riders who have never considered that under-fuelling could be behind their fatigue, poor recovery, or low mood"
  - "Female cyclists experiencing menstrual irregularity or bone stress injuries alongside heavy training"
  - "Anyone who has cut calories to lose weight for cycling and wants to understand where the safe boundary sits"
roadmanView:
  - "This is one of the most important pieces on the site. Energy availability is the thing most amateur cyclists have never heard of and many are already getting wrong. You can be eating enough to maintain weight and still be in a deficit deep enough to wreck your bones and hormones."
  - "RED-S in male cyclists is massively under-diagnosed because the symptoms — fatigue, low mood, declining performance — get written off as normal training stress. If that sounds familiar and you have been cutting calories, run the numbers."
  - "I am not a dietitian and this article is not a diagnosis. But if the calculator flags you below 30 kcal/kg FFM, that is a conversation worth having with a qualified professional. Do not try to fix this with a spreadsheet."
---
