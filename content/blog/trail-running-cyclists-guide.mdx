...
whoFor:
  - "Cyclists looking for off-bike cross-training that addresses cycling-specific weaknesses without high-impact pavement running"
  - "Riders wanting to build ankle stability, proprioception, and core strength that road cycling neglects entirely"
  - "Anyone considering running as cross-training and wanting to know why trail surfaces are better for cyclists than tarmac"
  - "Masters cyclists over 40 who need low-impact options that build bone density and single-leg stability without excessive joint stress"
roadmanView:
  - "I'm convinced that if you're going to run as a cyclist, run on dirt. Trail running addresses more cycling-specific weaknesses per minute than road running, with less impact stress and more mental engagement. I've felt the difference myself — uneven ground forces your ankles, hips, and core to work in ways that the fixed plane of a pedal stroke never does."
  - "I've seen it over and over — cyclists are terrible at proprioception. We sit on a stable saddle and push in a fixed plane for hours. Trail running retrains the stabilising muscles around your ankles and hips that cycling lets atrophy. I think that matters for injury prevention, and it matters for bike handling on rough surfaces."
  - "I always tell riders to start on fire roads, not technical singletrack. Your cycling fitness will tempt you to go hard and far, but your connective tissue is not ready. I've found that twenty to thirty minutes of moderate trail running twice a week is enough to get the benefits without the injury risk."
---
