...
roadmanView:
  - "If you are going to run as a cyclist, run on dirt. Trail running addresses more cycling-specific weaknesses per minute than road running, with less impact stress and more mental engagement. The surface changes everything — uneven ground forces your ankles, hips, and core to work in ways that the fixed plane of a pedal stroke never does."
  - "Cyclists are terrible at proprioception. We sit on a stable saddle and push in a fixed plane for hours. Trail running retrains the stabilising muscles around your ankles and hips that cycling lets atrophy. That matters for injury prevention, and it matters for bike handling on rough surfaces."
  - "Start on fire roads, not technical singletrack. Your cycling fitness will tempt you to go hard and far, but your connective tissue is not ready. Twenty to thirty minutes of moderate trail running twice a week is enough to get the benefits without the injury risk."
---
