...
answerCapsule: >-
  Regular cycling reduces resting systolic blood pressure by 5-7 mmHg in people
  with hypertension, comparable to a single medication. Post-exercise
  hypotension lasts 12-22 hours after a moderate ride; riding most days keeps
  the effect near-continuous. Beta-blockers cap heart rate by 20-30 bpm,
  invalidating standard zone calculations — recalculate using a field test while
  medicated. Endothelial function improves within 4-6 weeks of regular riding.
  Above 180 mmHg systolic at rest, hold off vigorous exercise until controlled.
keyTakeaways:
