...
answerCapsule: >-
  Handlebar width should approximate your acromioclavicular joint width,
  measured centre-to-centre across the bony points on top of the shoulders.
  Most stock 420mm bars are fitted for showroom breadth, not individual riders.
  Compact drop bars (120-125mm drop, 70-75mm reach) give access to every hand
  position including the drops — they are not a compromise for inflexible
  riders. A reach of 80mm or more can add 15-20mm of effective cockpit length
  that stem changes cannot compensate for. Get the measurement right before
  buying.
keyTakeaways:
