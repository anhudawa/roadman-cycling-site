...
seoDescription: >-
  The 12-week framework Not Done Yet members use to peak for a sportive — base,
  build, sharpen and a taper that lands form on race day, not in the file.
excerpt: >-
...
keywords:
  ...
  - cycling tapering
  - sportive race day
  - peaking for cycling event
  - cycling event preparation
  - amateur cyclist peaking
tags:
  - peaking
  - sportive
  - tapering
...
A good taper is recognisable in the data. Resting heart rate drifts back toward your usual baseline. Sleep quality holds or improves. Body weight is steady — you're eating roughly the same and moving meaningfully less, so a small uptick is normal. Power on shorter efforts feels easy at the wattage that felt hard a week earlier. The openers ride feels almost annoyingly easy. If you'd rather benchmark your form against a clear standard before the start line instead of reading the signals one by one, the [Sportive Training Readiness Index](/blog/sportive-training-readiness-index-2026) is the readiness check we're building for exactly that (coming Q3 2026).
