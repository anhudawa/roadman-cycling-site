...
roadmanView:
  - "When Prof. Stephen Seiler was on the podcast, he stressed that the hardest block should land 4-5 weeks out, not 7 days out — the taper structure in this framework follows that principle exactly."
  - "Our Training Load Calculator tracks your CTL and TSB through the peaking framework, so you can see whether you are on track to arrive fresh or fatigued."
  - "In the NDY community, the 12-week peaking framework is the standard approach for any rider targeting a specific event — and the most common fix is pulling the hardest week earlier, not later."
---
