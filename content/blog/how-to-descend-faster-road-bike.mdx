...
whoFor:
  - "Road cyclists whose descending has not improved despite years of riding the same hills"
  - "Riders who have been told to 'just relax' and found it completely useless advice"
  - "Anyone who tenses up the moment the gradient tilts downward and wants a structured way to fix it"
  - "Cyclists who want a skill-by-skill approach to descending rather than vague encouragement"
roadmanView:
  - "I always tell riders that 'just relax' is the most useless descending advice in cycling — it gives you absolutely nothing to do differently. I've felt that fear myself, and here's the thing: it's your brain telling you the technique isn't there yet, and the fix is building the skill, not pretending you're calm."
  - "I teach descending in layers because that's how it actually sticks. Drops first, then braking points, then vision, then weighting the outside pedal — each skill stacks on the last, and I've seen riders completely transform their descending in a matter of weeks by working through them in order."
  - "I've watched too many riders try to force speed before the skills are there, and that's how people crash. I'd rather you build each skill deliberately on descents you know, add five per cent each ride, and let the speed arrive on its own — because it will."
---
