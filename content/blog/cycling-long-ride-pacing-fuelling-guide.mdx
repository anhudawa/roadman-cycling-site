...
keyTakeaways:
  ...
  - "The low point at hours 4-5 is predictable and physiological, not a sign of poor fitness: core temperature has risen, glycogen stores are depleted, and cumulative dehydration has reduced plasma volume by 5-10%."
...
The target is 500-750ml of fluid per hour, adjusted for conditions. In cool weather, the lower end. In heat, the upper end or more. The [Hydration Calculator](/tools/hydration) factors in ambient temperature, body weight, and expected intensity to give you a per-hour target.
...
If you want to build a specific fuelling and pacing plan for your next long event — your per-hour targets, your intensity ceiling, your feed schedule — the [Fuelling Calculator](/tools/fuelling), [Hydration Calculator](/tools/hydration), and [FTP Zone Calculator](/tools/ftp-zones) will give you the numbers. And the [Calories Burned Calculator](/tools/calories) is worth running beforehand to see the total energy cost of the ride, because knowing the bill before you start is the only way to make sure you've packed enough to pay it.
