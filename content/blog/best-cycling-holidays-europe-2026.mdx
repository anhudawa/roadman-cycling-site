...
whoFor:
  - "Riders planning annual leave around cycling who want to pick the right European destination for their fitness level and riding goals"
  - "Training camp regulars who've done Mallorca and want to branch out to a destination that offers something different"
  - "Couples or groups where cycling ability varies and need a destination that scales from relaxed to ambitious"
  - "Bucket-list climbers who want to tick off iconic European passes but need practical guidance on when to go and what to expect"
roadmanView:
  - "Girona is where the WorldTour lives for a reason — the roads, the climate, the infrastructure. If you go once, you'll go back. I run Roadman Training Camps there because nothing else compares for the combination of accessible terrain and world-class climbs."
  - "Mallorca in February or March is the best value early-season training camp in Europe. Reliable weather, smooth roads, and you can build a week around the Sa Calobra climb without needing mountain fitness."
  - "The mistake most people make is going to the Dolomites or Alps too early in the season. June is the earliest the high passes reliably open, and even then you might find snow walls on the Stelvio. September is often the best month for both."
---
...
Best for experienced climbers comfortable with sustained efforts of 90 minutes to two hours. The [VAM calculator](/tools/vam) helps you gauge whether your climbing rate matches the sustained grades here, and the [race predictor](/tools/race-predictor) can model what a day like the [Sella Ronda](/blog/sella-ronda-bike-day-training-guide) actually costs you. Go mid-June through September once the high passes clear of snow. September is often the sweet spot — stable weather, fewer cars, extraordinary light. The standout ride is the Sella Ronda: four passes in a circuit of roughly 55 km with 1,800 m of climbing, manageable in a morning. Base yourself in Corvara, Selva di Val Gardena, or Canazei and book early for summer — the good hotels fill fast.
