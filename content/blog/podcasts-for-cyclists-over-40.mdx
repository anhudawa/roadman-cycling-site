...
Second, hormones matter more. Total testosterone declines gradually with age in men (roughly 1-2% per year on average from around age 30 in longitudinal data $€” see [Feldman et al., 2002](https://pubmed.ncbi.nlm.nih.gov/11836290/)). Perimenopause reshapes the training response for women from the mid-40s onward. Any show treating the 45-year-old body like the 25-year-old body is missing the actual variable.
...
On Fast Talk Labs, the masters-specific episodes and anything with Dr. IÃ±igo San MillÃ¡n on Zone 2 and mitochondrial function. Pair with Peter Attia's two-part series with San MillÃ¡n $€” same science, two lenses.
...
Skip podcasts built around a single coach's proprietary system that never cites external research. Methodology without citation is religion. The coaches worth listening to $€” Seiler, Lorang, Friel, San MillÃ¡n $€” reference studies and name the people they disagree with.
