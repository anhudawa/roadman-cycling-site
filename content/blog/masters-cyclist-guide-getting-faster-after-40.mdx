...
answerCapsule: >-
  Cyclists over 40 retain most of their capacity to improve, but the physiology changes. VO2max declines roughly 5-10% per decade without targeted training, maximal heart rate drifts down by around one beat per year, and recovery between hard sessions lengthens by 24-48 hours. Masters athletes who train successfully tend to hold two to three genuinely hard sessions per week, add 2x weekly heavy strength work to protect neuromuscular power, and prioritise sleep and protein intake. The biggest mistake is training the same programme that worked at 30.
faq:
  - question: "Can you still get faster at cycling after 40?"
    answer: >-
      Yes. Most masters cyclists who come to structured training in their 40s or 50s see 10-20% FTP gains in the first 12 months, because they've rarely trained systematically before. Even well-trained masters athletes continue to improve with the right stimulus. The ceiling drops slowly, but the gap between current fitness and personal ceiling is almost always the limiting factor, not age.
  - question: "How many hard sessions per week should a masters cyclist do?"
    answer: >-
      Two, sometimes three. Prof. Stephen Seiler's polarised model applies here, but with longer recovery windows. A Tuesday VO2max session and a Saturday threshold or tempo ride, with easy Zone 2 filling the rest of the week, works for most masters athletes. A third hard session is possible in build phases but only if sleep, nutrition, and strength work are dialled in.
  - question: "Is strength training necessary for cyclists over 40?"
    answer: >-
      Yes, non-negotiable. Type II muscle fibres atrophy faster than Type I with age, and that's what drives sprint power, climbing snap, and injury resistance. Two sessions per week of heavy compound lifts — squats, deadlifts, step-ups — in the 3-6 rep range preserves neuromuscular function better than bodyweight or machine work. Most masters cyclists undertrain strength, not overtrain it.
  - question: "How much recovery do masters cyclists need between hard rides?"
    answer: >-
      Plan on 48-72 hours between genuinely hard sessions, compared with 24-48 hours for athletes in their 20s. Hormonal recovery, glycogen replenishment, and connective tissue repair all slow with age. The fix isn't less training, it's smarter spacing. Back-to-back hard days are the fastest route to stagnation or injury for most riders over 40.
  - question: "What's the best training zone distribution for masters cyclists?"
    answer: >-
      Roughly 80% easy, 20% hard, measured by time not sessions. That means most weekly hours sit in Zone 2, with concentrated hard work on two days. This matches Seiler's polarised model and handles the recovery reality of older athletes. Riders who spend too much time in Zone 3 — the grey zone — accumulate fatigue without the physiological stimulus to get faster.
---
