...
seoDescription: "The 15-minute MTB maintenance routine for after every ride. Chain, brakes, tyres, bolts, suspension, and seasonal service schedule."
excerpt: "Fifteen minutes after every ride saves you hundreds at the bike shop and keeps your bike running properly between services. Here's the routine."
pillar: "le-metier"
...
faq:
  - question: "How often should I clean my mountain bike chain?"
    answer: "After every ride in wet or muddy conditions. In dry conditions, you can get away with every 2-3 rides, but a quick wipe and re-lube after each ride is the best habit. A clean, well-lubricated chain shifts better, lasts longer, and is more efficient — a dirty drivetrain can cost you 3-5 watts, which adds up over a long ride."
  - question: "How do I know when my MTB brake pads need replacing?"
    answer: "Check the pad thickness by looking through the caliper from the top. Most pads have a wear line or groove — when the friction material is worn down to that line (typically 1-1.5mm remaining), replace them. If your brakes feel weak, make unusual noise, or require the lever to come very close to the bar before engaging, check the pads immediately."
  - question: "What's included in a full mountain bike service?"
    answer: "A full service typically covers: suspension service (lower leg and damper), headset and bottom bracket inspection, hub service, brake bleed, full drivetrain clean and assessment, wheel true, pivot bearing check (on full suspension bikes), and cable/hose replacement if needed. Most riders should get a full service annually or every 100-150 hours of riding."
---
