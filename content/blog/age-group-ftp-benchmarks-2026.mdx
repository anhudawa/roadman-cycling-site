...
roadmanView:
  - "Coggan's reference ranges have been used by the cycling-science community for two decades and they still hold. For male amateurs, 3.3-3.7 W/kg is good recreational, 3.8-4.4 W/kg is strong amateur, 4.5-5.0 W/kg is cat 2 to cat 1, and 5.0+ W/kg is national level. These are honest numbers, not aspirational marketing."
  - "The age-related decline in peak aerobic capacity is roughly 5% per decade in continuously trained masters athletes — slower than the 10% figure for sedentary adults. Most masters cyclists improving their FTP in their 50s are reclaiming lost consistency, not beating the age curve."
  - "The bigger age-related factors are recovery capacity and injury risk, not raw power ceiling. A 50-year-old who trains smart and recovers properly will outperform a 35-year-old who trains hard and sleeps badly. The NDY coaching data supports this consistently."
---
