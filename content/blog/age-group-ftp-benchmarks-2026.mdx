...
seoDescription: >-
  Where your FTP and W/kg actually place you by age, category and discipline. The benchmarking framework age-group cyclists and triathletes should use in 2026 — with worked examples.
excerpt: >-
...
faq:
  - question: "What is a good FTP for an amateur cyclist?"
    answer: >-
      For male amateur cyclists, an FTP of 250–280 watts at 75kg body weight (roughly 3.3–3.7 W/kg) is the typical "good recreational" band. "Strong amateur" starts around 3.8–4.4 W/kg, "cat 2 to cat 1" sits at 4.5–5.0 W/kg, and national-level amateurs are 5.0+ W/kg. For female amateurs the equivalent "good recreational" band is 2.8–3.2 W/kg, with national-level sitting at 4.2+ W/kg. These are Coggan's reference ranges, which the cycling-science community has used for two decades.
  - question: "What's the difference between FTP and W/kg?"
    answer: >-
      FTP (Functional Threshold Power) is the highest power you can sustain for about an hour, measured in watts. W/kg is your FTP divided by your body weight in kilograms. Absolute watts matter on flat terrain and in time trials; W/kg matters on climbs and in most amateur road racing. Both numbers are useful — a 300W FTP rider at 95kg (3.16 W/kg) and a 200W FTP rider at 55kg (3.64 W/kg) have very different race-day profiles.
  - question: "How much should my FTP improve per year?"
    answer: >-
      Trained cyclists making a focused year of structured training should expect a 5–15% FTP improvement. Untrained or returning riders can see 20–40% in the first year. Experienced athletes at their ceiling often see only 2–5% year-on-year — and need to look at W/kg (through weight loss) or discipline-specific adaptations to gain further. Progression that outpaces these ranges significantly is either measurement error or worth questioning.
  - question: "Does age affect FTP?"
    answer: >-
      Yes — but less than most cyclists assume. Peak aerobic capacity typically falls 5–10% per decade after 35 without training stimulus. With consistent structured training, the decline is closer to 1–2% per decade. Masters cyclists frequently improve their FTP well into their 50s if they started later or trained unsystematically earlier in life. The bigger age-related factors are recovery capacity and injury risk, not raw power ceiling.
  - question: "How do I know if my FTP measurement is accurate?"
    answer: >-
      Use the same protocol every time (20-minute test × 0.95, or a validated ramp test). Run the test on the same trainer or the same outdoor loop, with a calibrated power meter, at a similar time of day, and well-rested. Most "my FTP jumped 30 watts" stories trace to protocol differences or a zero-offset drift on the power meter, not real fitness changes. Treat outlier results with scepticism and re-test.
answerCapsule: >-
  The useful W/kg benchmarks for age-group cyclists in 2026 are: 2.5 W/kg recreational, 3.3 W/kg good recreational, 3.8 W/kg strong amateur, 4.2 W/kg cat 3 equivalent, 4.5 W/kg cat 2, 5.0 W/kg cat 1, and 5.5+ W/kg regional elite. For women, subtract roughly 0.5 W/kg at each band. Age decline is only 1–2% per decade with structured training, not the 5–10% often quoted. Meaningful year-on-year FTP progression for trained cyclists is 5–15%; anything dramatically outside that range is usually measurement noise.
---
