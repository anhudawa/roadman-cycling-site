...
roadmanView:
  - "For a significant percentage of endurance athletes, the answer is not in the training plan — it is in the blood. Richard Burden's research at the University of Bath shows performance degradation begins when ferritin drops below 50 ng/mL, but your GP flags deficiency at 12-15 ng/mL. That gap is where most cyclists lose months chasing training fixes for what is actually a blood chemistry problem."
  - "Testing timing matters enormously: fasted morning draw, during a recovery week, same lab each time. A post-ride or mid-block panel is worse than no panel because the false signals will send you chasing problems that do not exist. Nicky Keay's work on Relative Energy Deficiency in Sport has been instrumental in establishing that many endocrine markers need an athletic lens."
  - "Vitamin D below 75 nmol/L compromises bone density, immune function, and muscle recovery. Most cyclists in northern latitudes are deficient by March, and supplementing 2,000-4,000 IU daily through winter is the cheapest performance intervention most riders never take. It costs pennies a day."
---
