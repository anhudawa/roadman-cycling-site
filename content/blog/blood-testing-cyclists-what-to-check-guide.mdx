...
answerCapsule: >-
  ...
  clinical threshold of 12-15 ng/mL. For vitamin D, serum 25(OH)D is the main
  status marker, but there is no universally established athlete-performance
  target. Test and interpret results for a clear clinical reason with a
  qualified professional rather than treating an internet range as a diagnosis.
keyTakeaways:
  ...
  - "Serum 25(OH)D is the main vitamin D status marker, but there is no universally established athlete-performance target and the adult 4,000 IU upper limit is a safety ceiling, not a dose recommendation."
...
faq:
  ...
  - question: "Do endurance athletes need different reference ranges for all blood markers?"
    answer: "No. Training context can affect some results, but that does not create one universal set of athlete-optimal ranges. Reference intervals vary by assay, laboratory, sex, age and clinical context. Use symptoms, trends and training load to inform a qualified clinician's interpretation rather than diagnosing or treating yourself from an online table."
relatedPosts:
...
roadmanView:
  ...
  - "Vitamin D is where internet athlete ranges create false certainty. Use serum 25(OH)D as the status marker, follow public-health guidance and let a clinician interpret suspected deficiency instead of turning a safety ceiling into a daily target."
---
...
Vitamin D contributes to calcium absorption, bone and muscle health. Low sunlight exposure can increase the risk of low status, but latitude or indoor training alone cannot diagnose a deficiency.

Serum 25-hydroxyvitamin D, written as 25(OH)D, is the main status marker. NIH guidance says levels below 30 nmol/L can indicate deficiency risk and levels of 50 nmol/L or more are sufficient for most people, while also noting that optimal concentrations have not been established.

That is not the same as a universal athlete-performance target. Observational associations do not prove that pushing every rider to a higher number improves recovery, immunity or performance, and athlete trials have not shown a reliable overall performance gain from supplementation when status is already adequate.

**Why cyclists miss this:**

You may ride outside yet still have limited effective UVB exposure because of season, time of day, clothing, skin pigmentation or other factors. Those are reasons to consider the public-health advice that applies to you, not proof that your blood level is low.

**What to test:** 25-hydroxyvitamin D (25(OH)D) is the main status measure. Routine testing is not recommended for every healthy person, so discuss whether it is useful when there are symptoms, bone-health concerns, relevant medicines or another clinical reason.

**How to interpret it:** Use the reporting laboratory and a qualified clinician. There is no single evidence-based athlete target that Roadman can safely prescribe to every cyclist.

**Supplementation:** Follow the public-health guidance for your country and risk group. In the UK, the NHS advises most adults to consider 10 micrograms (400 IU) daily during autumn and winter. Diagnosed deficiency and higher-dose treatment belong with a clinician. The adult upper limit of 100 micrograms (4,000 IU) is a safety ceiling, not a target.

Read the reviewed [vitamin D guide for cyclists](/blog/cycling-vitamin-d-performance-guide) for the full NHS, NIH, EFSA and athlete-performance evidence, including product choice and supplement-contamination risk.
...
| Vitamin D (25(OH)D) | Lab and clinical context | No universal athlete target established | Interpret with the lab and a qualified clinician |
