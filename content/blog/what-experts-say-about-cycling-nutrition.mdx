...
Tim Spector's work through ZOE adds a useful layer here: individual responses to foods vary considerably based on gut microbiome composition. But this variability operates within a ceiling. If [glycogen](/glossary/glycogen) is not available during high-intensity work, no amount of microbiome optimisation changes the outcome. The individualisation Spector champions is meaningful for food choices and meal timing around training; it does not alter the fundamental requirement for carbohydrate during hard sessions.
