...
seoTitle: 'What Sports Scientists Say About Cycling Nutrition'
seoDescription: >-
  Cycling nutrition advice from Jeukendrup, Spector and World Tour experts — carbs
  per hour, fasted training, race weight, and the four positions they agree on.
excerpt: >-
...
keyTakeaways:
  - "The unanimous expert claim is that most amateurs under-fuel hard sessions by 30-50%. The fix is on-bike, not at the dinner table."
  - "Fasted training has a small, specific role: easy aerobic sessions only. Doing it on intervals or long rides costs adaptation without producing the fat-burning benefit it promises."
  - "Race weight is downstream of fuelling competence. Sports scientists consistently sequence fuelling first, body composition second."
faq:
  ...
  - question: Should cyclists eat differently on hard days versus easy days?
    answer: >-
      ...
      appropriately, restrict only on easy days — is supported by
...
whoFor:
  - "Cyclists who want to know what the sports scientists — Jeukendrup, Spector, and World Tour nutritionists — actually agree on, not what social media repeats"
  - "Riders who suspect they are under-fuelling hard sessions and want the evidence-based target for carbohydrate intake per hour during rides"
  - "Anyone considering fasted training who needs to understand its narrow evidence-supported role and where it costs more adaptation than it delivers"
  - "Cyclists who have been chasing race weight through restriction and want to hear why every expert sequences fuelling competence before body composition"
roadmanView:
  - "The unanimous finding from every nutritionist and sports scientist we have had on the podcast is that most amateurs under-fuel hard sessions by 30-50%. That is not a marginal error. It is leaving adaptation on the table every single week. The fix is on-bike fuelling, not what you eat at dinner."
  - "Fasted training has a narrow role and amateurs have turned it into a lifestyle. Easy aerobic sessions under 90 minutes — that is where the evidence supports it. Doing intervals fasted costs you power output and muscle protein. The fat-burning benefit does not compensate for what you lose."
  - "Race weight is downstream of fuelling competence. Every expert I have spoken to sequences it that way. Get the fuelling right first, let body composition follow, and stop treating restriction as a training tool. That sequence works. The reverse produces fragile, under-recovered riders."
---

[Nutrition advice for cyclists](/topics/cycling-nutrition) tends to fall into two camps: under-complicated Instagram rules ("eat whole foods, stay lean") and over-complicated supplement stacks that apply to less than 1% of the riding population. Neither serves the athlete trying to hold power in the final hour of a five-hour ride or recover well enough to train again the next morning.
...
The practical implication is that if you are not tracking [what you eat on your bike](/blog/cycling-in-ride-nutrition-guide) during efforts above Zone 2, you are almost certainly under-fuelling. The [Fuel Planner](/tools/fuel-planner) will show you exactly how much food a proper fuelling protocol requires — most athletes are surprised by the number.
...
The framework that World Tour practitioners apply: fuel training correctly, support recovery, and allow body composition to stabilise before deliberately manipulating it. For most amateur athletes who are chronically under-fuelling, correcting the fuelling deficit alone results in improved body composition over 8-12 weeks — counterintuitively, eating more during training reduces fat mass because recovery improves, training quality increases, and lean muscle is preserved. Anthony's own [9kg loss-while-eating-more story](/blog/eating-more-weight-loss-off-bike-effects) is a worked example of exactly this sequence.

Race weight, where a specific composition target is appropriate, is addressed in a defined window: typically 8-12 weeks out from an A-race, with a modest caloric reduction applied only to easy training days and never to days with quality sessions. The Impey periodised nutrition framework formalises this — [fuel the work](/blog/fuel-for-the-work-required-fftwr-explained), restrict only when the work does not require it.
...
Got a specific question — your own per-hour target, whether to add fructose to your current mix, how to handle a hot race? [Ask Roadman](/ask) for an answer drawn directly from the conversations with the experts above. And if you want the whole nutrition system built around your training week rather than figured out solo, [the application for NDY coaching](/apply) is where that starts.

**Related reading:** [Why Cycling Nutrition Is Different For Women — And What To Do About It](/blog/cycling-nutrition-women-different)
