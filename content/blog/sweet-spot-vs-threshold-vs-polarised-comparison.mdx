...
**Threshold-limited riders.** Some cyclists have strong VO2max but weak threshold — they can spike hard for 4 minutes but can't sustain 95% of FTP for 20 minutes. For these riders, threshold-specific blocks address the actual limiter directly. The [training diagnostic](/diagnostic) helps identify this profile.
...
The [training diagnostic](/diagnostic) walks through this assessment in detail and produces a specific prescription. The decision tree above is the framework; the diagnostic is the actual diagnosis.
