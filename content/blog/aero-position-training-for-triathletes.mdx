...
keywords:
  ...
  - time trial bike fit
answerCapsule: >-
  Aero position training is the progressive development of the capacity to hold a low, narrow position on time trial bars for the full duration of a bike leg without losing power or compromising the run. It is a training adaptation, not a flexibility test. A 12-week progression typically builds from 20-minute tolerance blocks to 3-4 hour race-specific sessions, with intensity added only after positional endurance is established. Most age-group triathletes lose 15-25 watts when forced low for 90+ minutes they haven't trained for.
faq:
  - question: "How long does it take to adapt to a new aero position?"
    answer: >-
      Plan on 8-12 weeks of consistent, progressive exposure before a race. The first 3-4 weeks build tissue tolerance in the neck, lower back, and hip flexors. Weeks 5-8 add intensity in position. The final block replicates race duration. Riders who skip stages and go straight to long aero rides typically hit a breakdown point around 60-75 minutes where power drops 8-12%.
  - question: "Should I hold aero position the entire bike leg?"
    answer: >-
      For most age-groupers, 85-95% is realistic and optimal. Sit up briefly on steep climbs above 6%, through technical corners, and at aid stations. Coming out of position for 30 seconds every 20-25 minutes actually reduces total time lost versus forcing a compromised position when your lower back locks up. The goal is average aero time, not perfect aero time.
  - question: "Why do I lose power in the aero position?"
    answer: >-
      Three causes, in order of frequency. First, the position closes your hip angle and restricts the glutes and hamstrings, typically costing 10-20 watts at threshold. Second, neck and lumbar fatigue force compensations that leak power. Third, the fit itself is too aggressive for your current mobility. A proper time trial fit plus 12 weeks of progressive exposure closes most of that gap.
  - question: "Do I need a dedicated TT bike to train the aero position?"
    answer: >-
      No. Clip-on aero bars on a road bike replicate 80-90% of the positional demand and cost under €200. The adaptation is to the position, not the frame. Many of our athletes train through the winter on clip-ons and transfer to their TT bike 6-8 weeks out from the A race. The neural and tissue adaptations transfer cleanly.
  - question: "Can I do intervals in the aero position?"
    answer: >-
      Yes, and you should — but not from day one. Build 4-6 weeks of steady aero volume before adding threshold and VO2 work in position. Starting intervals too early reinforces compensations and teaches the body to produce power from a broken position. Once tolerant, aero intervals are the highest-specificity session a triathlete can do on the bike.
---
