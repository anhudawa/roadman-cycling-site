...
roadmanView:
  - "The 2026 Menges et al. systematic review confirmed meaningful VO2max transfer between running and cycling — evidence we covered on the Roadman Podcast and use to support off-season running prescriptions in NDY coaching."
  - "WorldTour riders including Roglič, Evenepoel, and Adam Yates run regularly as part of their programmes. This is not fringe cross-training — it is standard practice at the highest level."
  - "Our Run-Ride Equivalence Converter lets you translate running effort into cycling-equivalent training load so you can add running without accidentally overreaching."
---
