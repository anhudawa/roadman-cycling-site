...
seoDescription: >-
  A 12-week gran fondo training plan for a 100-180km ride: the week-by-week
  build, two quality sessions, the long ride, and pacing at 65-75% of FTP.
excerpt: >-
...
keyTakeaways:
  - "A 12-week gran fondo plan breaks into three four-week phases: aerobic base, sustained power, and event-specific sharpening."
  - "Target 65-75% of FTP as your average power on event day — riders who blow up in the first 90 minutes chased groups going too hard."
  - "80% of weekly training time should sit below 75% FTP, with the remaining 20% as threshold, VO2, or long tempo blocks."
  - "A 5-hour ride at 200 watts burns roughly 3,500 calories — even at 90g/hour carb intake you are running a 1,500-2,000 calorie deficit."
  - "Eight hours per week gets you to the finish if you pace and fuel well; twelve to fourteen hours lets you ride the event rather than survive it."
faq:
...
whoFor:
  - "Cyclists training for any 100-180km gran fondo who want a week-by-week structure rather than guessing"
  - "Riders who finish events but always finish empty, cramping on the final climb and walking the last pitch"
  - "Anyone riding 4-6 hours a week who needs to build specific event fitness in 12 weeks"
  - "Cyclists who have been doing the same Sunday loop at the same pace and wondering why event day still hurts"
roadmanView:
  - "I see this every year in the community — riders sign up for a summer gran fondo in April and spend eight weeks doing the same three-hour loop at the same moderate pace. On event day they finish empty. The training wasn't wrong, it just wasn't specific."
  - "I tell riders on the podcast to target 65-75 per cent of FTP as their average power on event day. Most people blow up in the first 90 minutes chasing groups going too hard. Start the first hour 10-15 watts below target."
  - "From what I've seen coaching and advising riders, eight hours per week gets you to the finish if you pace and fuel well. Twelve to fourteen lets you ride the event rather than survive it. Below six hours, a long mountainous fondo becomes a risk rather than a goal."
---
...
Those midweek Tuesday and Thursday quality blocks are the ones that get skipped when the light goes and the weather turns. They don't have to be. Load the week into [TrainingPeaks Virtual](https://www.trainingpeaks.com/virtual/) and the tempo and sweetspot efforts run themselves indoors on the days you can't get out — it's what I lean on through the dark end of a build, and it keeps the fondo prep on track without needing daylight.
...
Pick your event, count back 12 weeks, and put the long rides in your calendar first. Everything else fits around those. If you want the sessions built around your exact power numbers, schedule, and event profile, that is what [NDY coaching at Roadman](/coaching) does. [The application](/apply) is where the conversation starts.

Companion reads: [cycling sportive preparation](/blog/cycling-sportive-preparation), [what nobody tells you about your first gran fondo](/blog/first-gran-fondo-what-nobody-tells-you-guide), [cycling nutrition plan for a 100-mile sportive](/blog/cycling-nutrition-plan-100-mile-sportive), [Etape du Tour training plan](/blog/etape-du-tour-training-plan), [Mallorca 312 training guide](/blog/mallorca-312-training-guide), and the [Maratona dles Dolomites training guide](/blog/maratona-dles-dolomites-training-guide).

Got a specific question — your own race profile, when to taper, what to do about a missed week? [Ask Roadman](/ask) for an answer drawn from the actual coach conversations on the podcast.
