...
roadmanView:
  - "Consistency matters more than absolute accuracy. A meter that reads two watts high every ride still tracks your fitness perfectly — what breaks training data is switching between devices with different offsets."
  - "For most riders, the Favero Assioma Duo is the answer: dual-sided, accurate, swaps between bikes in 90 seconds, and costs less than a set of carbon wheels you do not need."
  - "Temperature drift affects every strain-gauge meter on the market. Zero-offset before every ride, especially if the bike has been sitting in a hot car or cold garage. It takes five seconds and saves your data."
---
