...
seoTitle: 'Bike Leg of Triathlon: Why Age-Groupers Get It Wrong'
seoDescription: >-
  The bike leg of triathlon is 50–60% of race-day and the biggest threat to your
  run. Most age-group plans give it a third of the attention. What to change.
excerpt: >-
...
keyTakeaways:
  - "The bike leg accounts for 50-60% of total race time in Olympic, 70.3 and Ironman formats, yet most age-group plans give it a third of the attention."
  - "Riding 10 watts too hard on the bike can cost you 15 minutes on the run — the pacing asymmetry between disciplines is enormous."
  - "Three fixable errors wreck most age-group bike legs: unstructured grey-zone volume, training on the hoods but racing on aerobars, and under-fuelling at race intensity."
  - "Run-protective bike programming means three sessions per week: one long aerobic ride, one sustained sub-threshold session at 88-94% FTP, and one race-pace or brick session."
  - "One quality brick every 10-14 days is enough — running the brick run too hard builds fatigue that simulates nothing on race day."
faq:
...
whoFor:
  - "Age-group triathletes who lose more time in the marathon they rode too hard for than they gain on the bike"
  - "Cyclists moving into triathlon who need to learn run-protective bike pacing"
  - "70.3 and Ironman athletes whose run splits collapse after a strong bike leg"
  - "Multi-sport athletes over 40 who need a structured bike-for-the-run framework rather than generic endurance volume"
roadmanView:
  - "I've spoken to Olav Bu, Dan Bigham, and Dan Lorang on the podcast about triathlon-specific cycling, and the consensus is stark. The bike leg is paced for the run that follows, not as a standalone time trial. Most age-groupers ride 10 watts too hard and pay for it with 15 minutes on the run. That trade-off is brutal."
  - "I approach triathlon from the cycling side — bike-leg power, aero position durability, and in-ride fuelling are where my depth sits. I'm not going to pretend to be a swim coaching service."
  - "The pacing tables in this guide — 70-78% FTP for Ironman, 80-85% for 70.3 — are the same ranges I use with Not Done Yet triathletes. They're conservative because conservative pacing wins age-group races. Every time."
---
...
This is why serious [triathlon bike coaching](/coaching/triathletes) treats the bike as the race-defining segment, not the filler between swim and run. Programming the bike well is programming the run well by proxy.
...
Companion reads: [70.3 bike training plan](/blog/70-3-bike-training-plan-12-weeks), [Ironman bike training plan 16 weeks](/blog/ironman-bike-training-plan-16-weeks), [triathlon FTP pacing strategy](/blog/triathlon-ftp-pacing-strategy), [triathlon bike nutrition strategy](/blog/triathlon-bike-nutrition-strategy), and [brick workouts for Ironman](/blog/brick-workouts-for-ironman).

If you want the bike block built around your race calendar, [Not Done Yet coaching at Roadman](/coaching) is built for [triathletes](/coaching/triathletes) specifically. [The application](/apply) is where the conversation starts. Got a specific question? [Ask Roadman](/ask) for an answer drawn from the actual coach conversations on the podcast.
