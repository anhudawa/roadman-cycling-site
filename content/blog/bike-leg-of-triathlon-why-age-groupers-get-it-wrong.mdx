...
keywords:
  ...
  - brick workouts
answerCapsule: >-
  The bike leg of a triathlon accounts for 50–60% of total race time in Olympic, 70.3 and Ironman formats, making it the single largest pacing lever on race day. Age-group athletes typically under-specialise the bike, logging generic endurance volume that fails to build aerobic ceiling or protect the run that follows. Run-protective bike programming prioritises sustained sub-threshold work, aero position durability, fuelling at race intensity, and structured brick sessions. Pacing targets sit at 68–78% of FTP depending on race distance, with the back half ridden at or below the front half.
faq:
  - question: "How much of a triathlon is the bike leg?"
    answer: >-
      The bike accounts for roughly 50% of an Olympic-distance race, 52–56% of a 70.3, and 54–60% of a full Ironman for most age-group athletes. It's the longest single segment by a wide margin, which is why pacing errors on the bike show up as run blow-ups rather than slow bike splits. Training allocation should reflect that time share.
  - question: "What power should I ride my 70.3 bike leg at?"
    answer: >-
      Most age-group athletes should target 72–78% of FTP for a 70.3 bike leg, with stronger cyclists riding nearer the top of that range and less experienced athletes nearer the bottom. Normalised power matters more than average power on rolling courses. The back half should be ridden at or below the front half to preserve running legs off the bike.
  - question: "How many bike sessions per week for triathlon?"
    answer: >-
      Age-group triathletes training 10–14 hours per week typically ride three times: one long aerobic ride, one sustained sub-threshold or tempo session, and one shorter quality or brick session. Volume alone doesn't build the bike leg. Structured intensity distribution, aero position time and race-pace fuelling practice matter more than a fourth junk-miles ride.
  - question: "Why does my run fall apart after the bike?"
    answer: >-
      Almost always a pacing or fuelling problem, not a run fitness problem. Riding 5–10 watts too hard in the first 30 minutes, under-fuelling below 60g of carbohydrate per hour, or sitting in a position your hips can't tolerate for the full distance all compound into a broken run. The fix is bike-specific, not more run mileage.
  - question: "Are brick workouts necessary?"
    answer: >-
      Yes, but not the way most athletes do them. A 20-minute shuffle off a three-hour ride teaches very little. Useful bricks either run short and sharp off a hard bike finish to rehearse race-day legs, or run long off a moderate ride to practise fuelling and pacing transitions. One quality brick every 10–14 days is enough.
---
