...
roadmanView:
  - "We have spoken to Olav Bu, Dan Bigham, and Dan Lorang about triathlon-specific cycling on the podcast. The consensus is stark: the bike leg is paced for the run that follows, not as a standalone time trial. Most age-groupers ride 10 watts too hard and pay for it with 15 minutes on the run."
  - "Roadman approaches triathlon from the cycling side — bike-leg power, aero position durability, and in-ride fuelling are where our depth sits. We do not pretend to be a swim coaching service."
  - "The pacing tables in this guide (70-78% FTP for Ironman, 80-85% for 70.3) are the same ranges our coaching team uses with NDY triathletes. They are conservative because conservative pacing wins age-group races."
---
