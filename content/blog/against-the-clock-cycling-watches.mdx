...
roadmanView:
  - "Against the Clock is our dedicated editorial series exploring cycling's oldest obsession — time. It covers the Hour Record, the time trial, and the watches that ended up in the peloton, drawing a thread from Desgrange in 1893 to Ganna in 2022."
  - "This is culture writing, not product review. We are not ranking watches by value for money. We are telling the story of why the chronograph and the race of truth grew up together, and why the strangest sight in modern cycling makes a certain kind of sense."
  - "The series sits alongside Roadman's training and coaching content because the audience cares about both — the data on the head unit and the story behind the sport. Le metier is the whole thing."
---
