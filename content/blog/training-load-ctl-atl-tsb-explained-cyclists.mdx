...
roadmanView:
  - "Three numbers run the Performance Management Chart that every serious cyclist eventually encounters: your fitness, your fatigue, and the gap between them. Coaches have used this framework for decades. Understanding it gives you a common language with your coach, your training platform, and the data you are already collecting."
  - "The model is useful but it is not gospel. CTL measures load absorbed, not fitness gained. A high CTL built on grey-zone rides is less useful than a moderate CTL built on polarised training with proper recovery. The number tells you how much work you did, not whether you adapted to it."
  - "TSB is most useful at the extremes. Below minus 30 for more than a week is a genuine warning. Above plus 15 into a race is useful confirmation of freshness. Between minus 15 and plus 5, your body knows more than the chart does."
---
