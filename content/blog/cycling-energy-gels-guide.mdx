...
seoDescription: "Complete guide to energy gels for cycling. How to choose the right gel, when to take them, glucose vs fructose ratios, and avoiding stomach problems on the bike."
excerpt: "Energy gels are the most convenient fuelling option on the bike — when used correctly. Get it wrong and you're spending the rest of the ride looking for a hedge. Here's how to get it right."
pillar: nutrition
