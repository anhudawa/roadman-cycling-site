...
keyTakeaways:
  - "The Dragon Ride Gran Fondo covers 311km with 4,700m of climbing across the Brecon Beacons — the UK's hardest sportive by any measure."
  - "Target 3.0 W/kg minimum for 311km with disciplined pacing; 3.6+ W/kg gets you under 12 hours."
  - "Welsh terrain rolls constantly with dozens of 10-25 minute climbs — train rolling tempo on hills, not flat threshold work."
  - "Welsh summer weather can deliver 8°C horizontal rain or 22°C sunshine in the same hour — waterproof jacket, full-finger gloves, and gilet are non-negotiable."
  - "Fuel 80-100g of carbs per hour from the start and force-fuel on a timer in cold weather when appetite is suppressed."
faq:
...
whoFor:
  - "Riders entering the Dragon Ride Gran Fondo who need a 14-week plan for 311km and 4,700m of climbing"
  - "Strong club cyclists at 3.0+ W/kg who want to know whether the full 311km route is realistic for them"
  - "Anyone choosing between the Dragon Ride distance options — 90km, 150km, 200km, or 311km — and wanting honest guidance on which to target"
  - "UK-based cyclists who want a domestic event that tests genuine European-level endurance without leaving Wales"
roadmanView:
  - "The Dragon Ride is the UK's hardest sportive and it is not particularly close. 311km through the Brecon Beacons with 4,700m of climbing in Welsh weather is a proper ultra-distance test. Do not enter the Gran Fondo route on enthusiasm alone."
  - "Welsh terrain rolls constantly. There is no flat recovery section where you can eat in peace. You need to practise fuelling on rolling hills, not on a turbo trainer, because your gut handles food differently when you are climbing and descending without pause."
  - "I always tell riders: finishing the 200km well beats not finishing the 311km. Pick the route that matches your training reality, not the route that looks best on social media."
---
...
The climbs on the Dragon are not Alpine. There is no [Marmotte](/blog/la-marmotte-training-guide)-equivalent 90-minute grind. Instead there are dozens of 10-25 minute Welsh mountain climbs that add up across the day in ways the headline elevation number doesn't quite communicate. By km 200, you've climbed dozens of times. None of them were brutal individually. Together, they are the day.

The other deciding factor is the weather, which shapes as much of the ride as the gradients do. Welsh summer is famously variable. June can be 8°C and pissing rain, or 25°C and sunny, or both inside the same hour. Riders who pack for one weather and meet the other are the ones DNF-ing at hour 6 with hypothermia, not muscle fatigue.
...
Four to five rides, 80% in [Zone 2](/blog/zone-2-cycling-heart-rate-vs-power-vs-rpe). The aerobic engine. [Stephen Seiler](/guests/stephen-seiler)'s polarised principle is the framework: easy stays easy. The temptation in week 1 is to grind every ride at moderate effort. Resist it.
...
[John Wakefield](/guests/john-wakefield)'s low-cadence work may fit when force production is a measured limiter. Treat 4-minute efforts at 40–60 RPM and RPE 7/10 as a coach-derived advanced option; the [evidence guide](/blog/low-cadence-training-cycling-torque-intervals) provides a conservative entry point and stop conditions.
...
**On the bike.** 80-100g carbohydrate per hour from the gun, laid out in advance with the [Fuel Planner](/tools/fuel-planner) so each aid-station leg has a clear feed schedule. Force-fuel on a timer if conditions are cold — set an alarm on the head unit if you have to. Asker Jeukendrup's research on multiple transportable carbohydrates is the basis for the standard 2:1 glucose-fructose mix used by most riders.
...
For underlying fuelling science, the [carbs-per-hour guide](/blog/carbohydrate-per-hour-cyclists) covers gut training and absorption.
...
**Waterproofing.** A genuine waterproof jacket (not a wind shell) in the jersey from the start. Full-finger gloves, ideally a thermal pair plus a backup if conditions are cold — 8°C air on a Brecon Beacons descent at 50 km/h drops the [feels-like temperature](/tools/wind-chill) to near freezing. A gilet under the jacket if it's properly cold. Overshoes in the jersey if forecast is wet.
