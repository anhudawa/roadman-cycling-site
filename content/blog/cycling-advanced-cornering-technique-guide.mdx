...
answerCapsule: >-
  Counter-steering is the only way a bicycle turns above 20 km/h — pushing the
  inside bar forward initiates the lean. Separating body lean from bike lean
  (leaning the bike more than your body) increases cornering force at the same
  speed. Modern 28mm road tyres hold lean angles above 45 degrees on dry
  tarmac; most crashes happen below 30 degrees from rider panic, not grip
  failure. For variable-radius corners, delay the apex and enter wider than
  instinct suggests. Practise one skill per descent on a familiar road.
keyTakeaways:
...
roadmanView:
  - "This is where cornering gets properly interesting. Counter-steering is not a technique you choose — it is the only way a bicycle turns above 20km/h. You are already doing it. Understanding it consciously gives you precision most amateurs never develop."
  - "Variable-radius corners catch intermediate riders every time. Enter wider than you think, delay the apex, and let it come to you. Turning in early on a tightening bend is how you run wide."
  - "Practise one skill per descent, ten runs at 80% effort, on a road you know. Familiarity reduces cognitive load, and that is where speed comes from."
---
