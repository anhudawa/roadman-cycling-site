...
seoDescription: >-
  Alex Welburn researches critical power and W' and coaches with them. On the
  podcast he explained the training metrics the pros use beyond FTP — and the
  stress-budget idea that keeps amateurs from digging a hole.
description: >-
...
It went somewhere more useful. Welburn can explain the metrics as well as anyone, but the thread that mattered most for ordinary riders wasn't a number at all. It was a way of thinking about how much you can take on in a day before you start doing yourself harm. Let me give you both halves.
...
You don't need a lab to use this idea. Knowing that you have a finite reserve above threshold — and that it recharges only when you ease genuinely below it — should change how you spend it. Burn your matches early chasing every move and you'll have nothing for the moment that decides the race.
