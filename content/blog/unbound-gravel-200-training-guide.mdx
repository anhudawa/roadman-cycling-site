...
seoTitle: 'Unbound Gravel 200 Training Plan: 16 Weeks for Flint Hills'
seoDescription: >-
  A 16-week Unbound Gravel 200 training plan. 320km of Kansas chert and endless
  rollers — tyre choice, drop-bag logistics, ultra pacing, and a 12-hour fuel plan.
excerpt: >-
...
keyTakeaways:
  - "Watts win less time at Unbound than tyre choice and a fed gut — a 3 W/kg rider with 42mm tyres and rehearsed fuelling will overtake a 4 W/kg rider on XC casings who skips a checkpoint."
  - "42-45mm reinforced tubeless tyres are mandatory; the Flint Hills chert shreds light XC casings inside 50km, and a sliced sidewall is the most common DNF cause."
  - "Back-to-back long weekends (Saturday 7-8 hours gravel, Sunday 3-4 hours on tired legs) repeated three times in the final 12 weeks are the specific stimulus that separates an Unbound build from a road sportive build."
  - "Target 80-100g carbs per hour from the gun, with real food at every checkpoint — across a 14-hour day that is 1,100-1,400g of carbs, a logistics problem before a fitness problem."
  - "Do not stand and surge on every roller: 200+ short rollers over 14 hours means sitting, holding endurance heart rate, and letting the gradient work — surging is the hidden energy leak that kills the second half."
faq:
...
whoFor:
  - Riders entered for Unbound Gravel 200 who need a structured 16-week build
  - Gravel cyclists stepping up from sub-200km events to their first ultra-distance race
  - Anyone who has trained for a road sportive and wants to understand why an Unbound build is fundamentally different
  - Riders who DNFed a long gravel race due to tyre failure, nutrition collapse or pacing errors
roadmanView:
  - I've spoken to enough Unbound finishers on the podcast to know this is an ultra disguised as a sportive. 320km across Kansas dirt with chert that destroys lazy tyres and rollers that never let you settle. If you train for it like a road sportive, you will not finish.
  - I'm convinced that watts win less time at Unbound than tyre choice and a fed gut. A 3 W/kg rider with 42mm reinforced tubeless and rehearsed fuelling will overtake a 4 W/kg rider on XC casings who skips a checkpoint.
  - From my conversations with gravel ultra athletes, I believe the specific stimulus that separates an Unbound build from a road build is back-to-back long weekends. Saturday seven to eight hours on gravel, Sunday three to four hours on tired legs, repeated three times in the final 12 weeks.
---
  - pete-stetina-worldtour-to-gravel-reinvention

Unbound Gravel 200 is an ultra disguised as a sportive. 320 kilometres across Kansas dirt — packed with embedded chert rocks that destroy inattentive tyres, with humidity in the 30s by mid-afternoon, with rollers that never let you settle into a rhythm. The 200-mile distance and the global field make it look like a cousin of GFNY or a long [Marmotte](/blog/la-marmotte-training-guide). It is not. It is a 12-20 hour self-supported ride with two checkpoints and a drop bag, and the riders who finish are the ones who treated it as ultra-territory from the start.

The watts barely matter at Unbound. A 3 W/kg rider with 42mm tyres, a fed gut, and a sleep plan from the night before will overtake a 4 W/kg rider running XC race tyres and skipping the second checkpoint. This is gravel ultra-territory, and it punishes road-sportive thinking with predictable consistency.
...
The weekend gravel miles can't be faked indoors — you need the surface, the line choice, the handling. The midweek threshold and sustained-tempo sessions are another story. Build the week in [TrainingPeaks Virtual](https://www.trainingpeaks.com/virtual/) and those efforts are loaded and waiting, so a wet evening or a 9pm finish doesn't cost you the structured work that holds the front-half pace together. For riders fitting an Unbound build around a job, that's how the weekday quality actually gets ridden.
...
For a related real-world look at multi-day ultra fuelling, the Roadman Cycling Podcast episode on the [Badlands 800km strategy](/blog/badlands-800km-fuelling-strategy) walks through the same calorie-deficit problem at an even longer time scale. The principles transfer directly to Unbound.
...
**Underestimating the heat.** Early June Emporia can be hot, humid and exposed. If
normal training is much cooler, use progressive event-specific preparation rather
than a universal closed-window or layered-clothing protocol. Rehearse pacing,
cooling and refill decisions and use the [heat training evidence guide](/blog/heat-training-cyclists-30-watts-ftp-protocol)
to set safety boundaries.
