...
Here is the thing nobody tells you about Unbound. The watts barely matter. A 3 W/kg rider with 42mm tyres, a fed gut, and a sleep plan from the night before will overtake a 4 W/kg rider running XC race tyres and skipping the second checkpoint. This is gravel ultra-territory, and it punishes road-sportive thinking with predictable consistency. It's a different animal from the more genteel end of off-road riding too — if your gravel calendar also takes in something like [L'Eroica on a vintage bike across the Strade Bianche](/blog/leroica-training-guide), know that the two events ask for almost opposite preparation: one rewards durability and raw ultra hours, the other rewards a steady hand on white roads and old steel.
