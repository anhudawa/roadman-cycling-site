...
answerCapsule: >-
  A cycling training plan is structured around five principles: progressive overload, specificity, recovery, intensity distribution, and individualisation. Volume and intensity rise gradually over three to four week blocks, followed by a recovery week at roughly 60% load. Most weekly hours sit in Zone 2, with 10–20% at threshold or above. Sessions target the specific demands of the rider's event. The template adapts to the individual's time, history, and response — not the other way around.
faq:
  - question: "How many hours per week should a cycling training plan include?"
    answer: >-
      It depends on the rider. A time-crunched amateur can build strong fitness on 6–8 hours a week if the intensity distribution is right. Club racers typically sit at 8–12 hours. Elite amateurs and masters racers run 12–18 hours. World Tour pros average 25–30. The number that matters is the one you can repeat weekly without breaking.
  - question: "How long should a cycling training block be before a recovery week?"
    answer: >-
      Three weeks of progressive load followed by one recovery week is the default for most riders. Stronger, younger athletes sometimes extend to four-on, one-off. Masters riders over 50 often respond better to two-on, one-off. The signal is fatigue: if power at a given heart rate is dropping and sleep is deteriorating, pull the recovery week forward.
  - question: "Should beginners follow polarised or sweet spot training?"
    answer: >-
      Beginners benefit most from a high volume of Zone 2 riding with one or two harder sessions a week. The polarised versus sweet spot debate matters more for trained riders chasing the last 5%. For the first two years of structured training, aerobic base plus occasional threshold work delivers nearly all the adaptation available.
  - question: "How do I know if my training plan is working?"
    answer: >-
      Track three markers: power at a fixed heart rate (should rise over 6–8 weeks), repeatability of key sessions, and subjective energy. A 5–10 watt improvement in Zone 2 power at the same heart rate across a block is a strong signal. If all three markers stall for three weeks, the plan needs adjusting.
  - question: "Can I build my own cycling training plan without a coach?"
    answer: >-
      Yes, if you apply the five principles honestly. Most self-coached riders fail at two of them: recovery (they skip easy weeks) and individualisation (they copy a pro's plan). If you track load, respect recovery weeks, and adjust based on response rather than ego, a self-built plan works. A coach accelerates the process and catches errors earlier.
---
