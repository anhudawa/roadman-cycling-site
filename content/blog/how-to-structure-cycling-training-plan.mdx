...
roadmanView:
  - Every good plan follows five principles — progressive overload, specificity, recovery, intensity distribution, and individualisation. Miss one and the whole thing unravels over time.
  - Friel, Lorang, Kerrison — they all land in the same place on this. The framework is not complicated. The discipline to follow it is the hard part.
  - A well-structured 10-hour week beats a chaotic 14-hour week. That's not a motivational line — it's what the data consistently shows.
---
