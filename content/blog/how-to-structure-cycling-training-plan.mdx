...
seoTitle: 'How to Structure a Cycling Training Plan: Coach Framework'
seoDescription: >-
  How to structure a cycling training plan: five principles, then the weekly
  template. Volume, intensity, recovery and progression the way Friel teaches it.
excerpt: >-
...
keyTakeaways:
  - "Every effective plan follows five principles — progressive overload, specificity, recovery, intensity distribution, and individualisation — and missing even one of them compounds into failure."
  - "Weekly training load should rise 5-10% across three build weeks, then drop 30-40% in the recovery week — skipping the easy week is the single biggest reason self-coached plans fail."
  - "Prof. Seiler's research shows roughly 80% of training volume should sit in Zone 1-2 and 20% at threshold or above, with the middle zone used sparingly."
  - "Specificity means training increasingly resembles the target event as race day approaches — cut sessions that don't transfer in the final block."
  - "Track power at a fixed heart rate, perceived effort on repeated sessions, and sleep quality weekly — if two of three trend down for five days, cut load immediately."
  - "A well-structured 10-hour week in build phase breaks down to roughly 80% Zone 1-2, 15% threshold or above, and 5% in the grey zone."
faq:
...
whoFor:
  - Self-coached riders building a training plan from scratch
  - Cyclists tired of downloading generic plans that fall apart by week three
  - Club racers who want coach-quality structure on a self-coached budget
  - Anyone whose training has been aimless and wants a proven framework
roadmanView:
  - "I've built enough training plans to know that every good one follows five principles — progressive overload, specificity, recovery, intensity distribution, and individualisation. Miss one and the whole thing unravels, and I've seen it happen more times than I'd like."
  - "When I had Friel, Lorang, and Kerrison on the podcast, they all landed in the same place on this. The framework itself is not complicated — the discipline to follow it is the hard part, and I think that's where most self-coached riders come unstuck."
  - "I always say a well-structured 10-hour week beats a chaotic 14-hour week. That's not a motivational line — it's what the data consistently shows, and I've seen it confirmed by every coach who's sat across from me on the show."
---
...
Load can be measured in hours, TSS, kilojoules, or kilometres. Pick one and stick with it. For self-coached riders, weekly hours plus one intensity metric (threshold minutes, or Zone 4+ time) is enough. Chasing TSS alone without watching duration hides the truth: a rider can rack up TSS on a trainer and still be undertrained for a four-hour race. If you want to see the ratchet rather than guess at it, the PMC chart in [TrainingPeaks](https://www.trainingpeaks.com) plots your CTL against ATL so you can tell whether load is trending up sensibly across the block or running away from you.
...
Specificity means the closer you get to your event, the more your training should look like the event. A road racer targeting a hilly one-day race in twelve weeks should, by week eight, be doing efforts that mimic the race's critical moments — repeated 3–5 minute climbs at 105–115% of FTP, for example. A gravel rider preparing for an eight-hour event should have at least two rides per month over five hours by the final block. The macro version of this — when each phase falls in the year — sits inside [how to periodise a cycling season](/blog/how-to-periodise-cycling-season).
...
The rule that covers 90% of cases: make easy days properly easy and hard days properly hard. Eliminate the middle unless you're doing a specific sweet spot block with a clear purpose.
...
**Monday: Rest or 30 minutes easy.** Full day off for most riders. If you need to move, keep it properly easy — under 60% of FTP, under 120bpm.
