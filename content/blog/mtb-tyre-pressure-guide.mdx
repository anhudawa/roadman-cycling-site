...
roadmanView:
  - "Tyre pressure is the single biggest free performance gain on a mountain bike. A correctly inflated budget tyre beats a premium tyre at the wrong PSI. Two PSI either way changes everything — grip, comfort, rolling speed, and flat risk all shift together."
  - "Run the front 2-3 PSI lower than the rear. Your weight sits roughly 40/60 front to rear, so the back tyre needs more support. For a 75kg rider on 2.4-inch tubeless trail tyres, start around 21 front and 23 rear, then fine-tune by 1 PSI per ride."
  - "Get a digital gauge accurate to 0.5 PSI. Floor pump gauges cannot reliably resolve the differences that matter at these pressures. A decent gauge costs less than a coffee and changes the way you set up your bike."
---
