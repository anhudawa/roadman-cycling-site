...
seoDescription: 'Dial in your MTB tyre pressure for maximum grip and minimum flats. Pressure charts by rider weight, tyre width, and riding style, from XC to enduro.'
...
keyTakeaways:
  - "Tyre pressure is the single biggest free performance gain on an MTB — a correctly inflated budget tyre beats a premium tyre at the wrong PSI."
  - "Run the front 2-3 PSI lower than the rear to match the 40/60 weight distribution and maximise cornering grip."
  - "A 75kg rider on 2.4-inch tubeless trail tyres should start around 21 PSI front and 23 PSI rear, then fine-tune by 1 PSI per ride."
  - "Tubeless setups can safely run 3-5 PSI lower than tubed, removing pinch-flat risk and increasing contact patch."
  - "Terrain matters: drop 1-2 PSI for wet roots and mud, add 2-3 PSI for bike parks and big hits."
  - "Use a digital gauge accurate to 0.5 PSI — floor pump gauges cannot reliably resolve the differences that matter at low pressures."
relatedEpisodes:
...
whoFor:
  - "Mountain bikers running default pressures who have never fine-tuned PSI for their weight and terrain"
  - "Trail, enduro, and XC riders who need discipline-specific starting pressures"
  - "Riders who feel disconnected from the trail or wash out in corners because pressure is too high"
  - "Anyone who has switched to tubeless and wants to take advantage of the lower pressures it allows"
roadmanView:
  - "I've said this on the podcast more times than I can count: tyre pressure is the single biggest free performance gain on a mountain bike. I've watched riders spend hundreds on premium tyres and get beaten by someone on budget rubber at the right PSI. Two PSI either way changes everything."
  - "I always run my front 2 to 3 PSI lower than the rear, and I tell everyone to do the same. Your weight sits roughly 40/60 front to rear, so the back tyre needs more support. For a 75kg rider on 2.4-inch tubeless trail tyres, I'd start around 21 front and 23 rear, then fine-tune by 1 PSI per ride."
  - "The good news is that the only tool you need is a digital gauge accurate to 0.5 PSI — I've been recommending this for years. Floor pump gauges can't reliably resolve the differences that matter at these pressures, and a decent gauge costs less than a coffee."
---
...
Think about it this way: tyre choice is a one-time decision. Pressure is something you can adjust every single ride, for free, in thirty seconds. It's the best setup change available to you.
