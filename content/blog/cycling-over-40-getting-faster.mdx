...
**3. Prioritise strength training.** This is non-negotiable over 40. Two gym sessions per week focusing on the posterior chain will offset muscle loss, improve bone density, and directly translate to power on the bike.

**4. Fuel better, not less.** The temptation is to eat less as metabolism slows. But under-fuelling compromises recovery — which is already your limiting factor. Eat to perform, focus on protein adequacy (1.6-2g/kg), and let body composition take care of itself.
