...
Your weekly structure should stack strength on hard bike days. If Tuesday is your threshold session, that's when you do heavier strength work. Thursday's VO2max intervals pair perfectly with explosive power movements in the gym. This protects your easy days for actual recovery and adaptation. Our [complete strength training guide for cyclists](/blog/strength-training-cyclists-complete-guide) lays out a full week if you want a template to start from.
