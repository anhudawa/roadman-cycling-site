...
seoTitle: 'Aerobic Decoupling Cycling: Cardiac Drift & Pa:HR Explained'
seoDescription: >-
  Aerobic decoupling is the most underused metric in masters cycling. How to
  measure cardiac drift, what under 5% really means, and whether your base is real.
excerpt: >-
...
whoFor:
  - "Cyclists who see their heart rate climb during long rides at steady power and want to understand what that drift actually means"
  - "Masters riders targeting gran fondos or long sportives who need to know whether their aerobic base can support race-distance efforts"
  - "Self-coached athletes using TrainingPeaks who have seen the Pa:HR or decoupling metric but do not know how to interpret it"
  - "Riders debating whether to add intensity or keep building base — decoupling gives the answer"
roadmanView:
  - "I love this metric because it cuts through the noise. Under 5% decoupling on a long zone 2 ride means your base is doing its job. Above 10% means you need more zone 2 before you start adding intervals. It's that simple."
  - "I've had both Joe Friel and Professor Seiler on the podcast and they both point to this as one of the cleanest signals of aerobic readiness. TrainingPeaks calculates it automatically — ride 60-90 minutes at steady zone 2, and the number tells you whether your floor is solid or whether you've just been counting hours."
  - "For the masters riders I work with, this is the metric that separates finishing strong from cooking yourself in the second half of an event. If your decoupling is above 5% on a two-hour zone 2 ride, you're not ready for threshold intervals yet — no matter how much you want to do them."
---
...
2. Start the test. Hold steady zone 2 power. For most cyclists that's 60–72% of FTP — if you are not sure where that sits in watts, run your number through the [FTP Zone Calculator](/tools/ftp-zones). Keep the cadence in your normal range, 85–95 rpm.
...
If decoupling is already low and you're still stuck, the issue may sit elsewhere — interval structure, fuelling, recovery or a health problem that ride data cannot diagnose. The [iron-deficiency guide](/blog/iron-deficiency-cyclists-masters) and [cycling-and-testosterone guide](/blog/cycling-testosterone-and-training-over-40-guide) explain when symptoms need clinical assessment.
...
Whatever the answer is, it's better information than you had on Friday. If the number is good, keep doing what you're doing. If the number is bad, the next four weeks of training have a clear job — and you can track the cumulative load of that base block with the [Training Load Calculator](/tools/training-load).
...
For more on building that base properly, the [zone 2 training complete guide](/blog/zone-2-cycling-heart-rate-vs-power-vs-rpe) goes deeper on the physiology and session structure. The [polarised training guide](/blog/polarised-training-cycling-complete-guide) explains how zone 2 fits into the broader weekly model. And the [efficiency factor for masters cyclists](/blog/efficiency-factor-cycling-masters) covers the closely-related metric you'll want to track alongside decoupling once you've started running this test.
