...
roadmanView:
  - "Under 5% decoupling on a long zone 2 ride is the benchmark coaches use to consider the aerobic base developed enough to progress to higher intensity work. Above 10% on a genuine zone 2 ride means the base needs more work before you start adding intervals."
  - "Joe Friel and Prof. Stephen Seiler both point to this metric as one of the cleanest signals of aerobic readiness. TrainingPeaks calculates it automatically — ride 60-90 minutes at steady zone 2, and the number tells you whether your floor is solid or whether you have been counting hours without building anything."
  - "For masters cyclists, this is the metric that separates finishing strong from cooking yourself in the second half of an event. If your decoupling is above 5% on a two-hour zone 2 ride, you are not ready for the intensity work yet, no matter how much you want to do threshold intervals."
---
