...
roadmanView:
  - "What I took from Naesen's weight-loss approach: 'consistency under tolerance, not transformation under pressure.' He set a manageable target, ran accountability calls with Matt Lane, and kept the rest of his life moving. The light touch is why it worked."
  - "I've watched independent cycling media overtake legacy outlets for years now, and Naesen's Lanterne Rouge is proof of why. Audiences trust individuals whose work they can audit. Personality-led shows convert listener trust at a rate that mastheads cannot match."
  - "The imposter syndrome point landed hardest for me. Naesen came from a gaming background, built one of cycling's most respected analytical voices, and still felt like an outsider years in. The only thing that reduced it was accumulated experience, not credentials."
---
