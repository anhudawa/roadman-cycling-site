...
whoFor:
  - "Cyclists who have tried strict identity-based diets ('I am a clean eater now') and failed when the first bad day arrived"
  - "Amateur riders interested in sustainable weight loss who want a real-world case study, not a nutrition plan"
  - "Cycling fans curious about why independent creators like Lanterne Rouge are outperforming legacy cycling media"
  - "Anyone in the cycling community who feels like an outsider despite putting in the work — on the bike or off it"
roadmanView:
  - "Naesen's weight-loss model is 'consistency under tolerance, not transformation under pressure.' He set a manageable monthly target, kept the rest of his life moving, and ran accountability calls with fellow creator Matt Lane. The light touch is why it worked — strict identity shifts had wrecked previous attempts."
  - "Independent cycling media is winning because audiences trust individuals whose work they can audit, not institutional brands. Personality-led shows convert listener trust at a rate that company-owned mastheads cannot match. Naesen and Lanterne Rouge are proof."
  - "The imposter syndrome point is the one that landed hardest for me. Naesen came from a gaming background, built one of cycling's most respected analytical voices, and still felt like an outsider years in. The only thing that reduced it was accumulated experience, not credentials."
---
...
**One — set a one-year body-composition target if you have one and want to take it seriously.** A year, not 12 weeks. With explicit tolerance for bad days. Pair with peer accountability if at all possible. Set the actual target honestly — run the [body composition calculator](/tools/body-composition) to see where you are now, use the [Race Weight calculator](/tools/race-weight) to set a sane number to work toward without crashing your hormones, and we covered the broader playbook in [the body-composition breakdown](/blog/alex-larson-body-composition-cyclists). Inside the [Not Done Yet community](https://www.skool.com/roadmancycling) the riders who hit body-composition goals are nearly always running this exact structure.
