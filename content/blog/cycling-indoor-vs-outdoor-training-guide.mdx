...
answerCapsule: >-
  The same wattage produces different physiological stress indoors versus
  outdoors. Core temperature rises 0.5-1.0C higher indoors, RPE is 1-2 points
  higher on the Borg scale, and neuromuscular recruitment is narrower without
  steering and balance demands. Hybrid periodisation — structured intervals
  indoors, endurance and race-specificity outdoors — produces superior outcomes
  to either environment alone. Indoor-only training plateaus around week 8-10.
keyTakeaways:
...
relatedTools:
  ...
  - "ftp-test"
whoFor:
  - "Riders debating whether to go indoor-only for a training block and wanting to know what the research actually says"
  - "Masters cyclists who find indoor sessions psychologically draining after week six and want strategies to manage that"
  - "Self-coached athletes trying to split their week between turbo and road in a way that maximises adaptation"
  - "Anyone whose indoor FTP does not transfer to outdoor race-day performance and wants to understand why"
roadmanView:
  - "Both sides of this argument are usually wrong. The turbo zealots ignore the neuromuscular gap and the outdoor purists ignore the efficiency gain."
  - "Hybrid periodisation is what I recommend to every rider I talk to. Structured intervals indoors, endurance and race-specificity outdoors."
  - "If you have been indoor-only for eight weeks and feel stale, that is not weakness. That is a documented physiological and psychological ceiling."
---
