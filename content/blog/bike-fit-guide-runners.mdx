...
whoFor:
  - "Runners new to cycling who are struggling with saddle discomfort, lower back tension, or hip flexor pain and cannot tell whether it is a fit problem or normal adaptation"
  - "Triathletes or cross-training runners who want specific guidance on how running-shaped bodies — tight hip flexors, dominant hamstrings, forward-tilted pelvis — need a different bike setup"
  - "Injured runners who have been told to ride while they recover but have no idea how to set up a bike for a body built by years of running"
  - "Runners riding 3-5 hours a week who are past the adaptation phase and ready to decide whether a professional fit is worth the investment"
roadmanView:
  - "I've talked to a lot of runners who've crossed over to cycling, and the pattern is always the same. Your running body arrives with tight hip flexors, dominant hamstrings, and a pelvis that wants to tip forward. The first month on a bike feels like a fight — and it is. Your running posture is actively resisting the position cycling demands."
  - "Here's the thing — start shorter on reach and lower on saddle height than any formula tells you. I've seen too many runners set up at 150 degrees of knee bend on day one, wonder why everything hurts, and quit. Set it at 140-145 and creep up over weeks."
  - "Saddle discomfort for the first two to three weeks is normal. I tell every runner that. But pain that's one-sided, numbing, or getting worse after week three? That's a fit problem, not adaptation. Get it looked at."
---
