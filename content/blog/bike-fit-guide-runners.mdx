...
roadmanView:
  - "Ten years of running shapes your body in ways a bike immediately exposes. Tight hip flexors, strong hamstrings, a pelvis that wants to tip forward — none of it matters on the road until you clip in. The first month on a bike will feel like a negotiation between your running posture and the position cycling demands."
  - "Start shorter on reach and lower on saddle height than the formulas suggest. Tight hamstrings mean most runners should set knee bend at 140-145 degrees and creep the saddle up over weeks, not jump to 150 degrees on day one."
  - "Saddle discomfort for the first two to three weeks is normal adaptation, not a fit failure. But pain that is one-sided, numbing, or getting worse after week three is a fit problem — act on it rather than gritting through another month."
---
