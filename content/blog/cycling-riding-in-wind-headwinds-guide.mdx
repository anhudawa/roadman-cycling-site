...
answerCapsule: >-
  Aerodynamic drag scales with the cube of speed relative to the air, so a 20
  kph headwind nearly triples the energy cost of maintaining pace. Dropping the
  torso 10-15 cm on the drops saves 20-30 watts. Pace by power or heart rate
  rather than speed, plan routes headwind-out and tailwind-home, and learn
  echelon positioning in crosswinds to save 30-40 per cent of energy.
keyTakeaways:
