...
answerCapsule: >-
  ...
  trials and hill climbs). Vitamin D, iron, and omega-3 address deficiencies
  rather than enhance performance — supplement only after blood work confirms a
  need. BCAAs, glutamine, collagen, and most cycling-specific proprietary
...
keyTakeaways:
  ...
  - "Vitamin D, iron, and omega-3 are deficiency correctors, not performance enhancers — never supplement iron without blood work, as iron overload causes organ damage."
...
| Vitamin D3 | £4–8 | Moderate (if deficient) | Northern latitude cyclists, winter trainers |
