...
roadmanView:
  - "Zone 2 and endurance are not synonyms and treating them as interchangeable is costing riders adaptation. Zone 2 is pinned to LT1 — a specific physiological marker. Endurance is a broader bucket that includes tempo and recovery. The precision matters."
  - "Three markers tell you whether you are in true zone 2: full sentences, comfortable nasal breathing, and heart rate drift staying under roughly 75% of max after 90 minutes. If any of those break down, you have crossed LT1 and the session is now tempo."
  - "Most cyclists ride their zone 2 rides 10-20 watts too hard. They drift above LT1 without realising it and blunt the mitochondrial adaptations the session was designed to produce. Drop the power, hold the discipline, and the returns compound."
---
