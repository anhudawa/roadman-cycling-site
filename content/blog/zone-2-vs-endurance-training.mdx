...
keywords:
  ...
  - "polarised training"
answerCapsule: >-
  Zone 2 and endurance training are not synonyms. Zone 2, as Prof. Stephen Seiler defines it, is intensity pinned to the first lactate threshold (LT1) — roughly 60-75% of FTP, where blood lactate stays near 2 mmol/L. Endurance training is a broader category covering any sustained aerobic riding below threshold, including tempo and recovery. Most cyclists ride their "zone 2" rides 10-20 watts too hard, drifting above LT1 and blunting the mitochondrial adaptations the session is designed to produce.
faq:
  - question: "Is zone 2 the same as endurance pace?"
    answer: >-
      No. Endurance pace is a broad aerobic category that covers anything from active recovery up to the lower edge of tempo. Zone 2 is narrower and physiologically specific — it sits at or just below LT1, the first lactate turn point. Most power-based systems put zone 2 at 56-75% of FTP, but the real anchor is lactate and breathing, not a fixed percentage.
  - question: "How do I know if I'm riding in true zone 2?"
    answer: >-
      Three markers. You can hold a full conversation in complete sentences without gasping. Nasal breathing stays comfortable for most of the ride. Heart rate drifts upward slowly but stays under roughly 75% of max after 90 minutes. If any of those break down, you've crossed LT1 and the session is now tempo, not zone 2.
  - question: "What's the difference between LT1 and LT2?"
    answer: >-
      LT1 is the first lactate threshold, where blood lactate first rises above resting baseline — typically around 2 mmol/L. LT2 is the second threshold, roughly equivalent to FTP or maximal lactate steady state, around 4 mmol/L. Zone 2 training sits at or just under LT1. Threshold intervals sit at or just under LT2. The two zones produce very different adaptations.
  - question: "How long should a zone 2 ride be?"
    answer: >-
      For trained cyclists, 90 minutes is the minimum to get meaningful mitochondrial and fat-oxidation adaptation. Two to four hours is the sweet spot for most amateurs. World Tour riders accumulate five to six hour rides at this intensity. Shorter sessions of 45-60 minutes have value as easy spin between harder days, but they don't deliver the full endurance stimulus.
  - question: "Can I do zone 2 on a turbo trainer?"
    answer: >-
      Yes, but watch the drift. Indoor heat load pushes heart rate higher for the same power, so pin the session to power or RPE rather than HR. Keep a fan on high, and expect to hold slightly lower watts than outdoors to stay under LT1. For sessions over 90 minutes indoors, most riders need to drop power 5-10% versus outdoor zone 2.
---
