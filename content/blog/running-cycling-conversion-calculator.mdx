...
whoFor:
  - Cyclists adding running who want to know what their rides are worth on foot
  - Duathlon or triathlon-curious riders planning cross-sport training weeks
  - Anyone who has searched "how many miles cycling equals running" and got confused
  - Riders managing total training load across two sports
roadmanView:
  - The 1:3 rule gets thrown around like gospel. It is a decent pub answer, not a training plan.
  - If you want a real comparison between a ride and a run, use time and intensity, not distance. Distance is a terrible currency across sports.
  - I wrote this because I was tired of seeing cyclists add a 5K to their week and have no idea how to account for it in their training load.
---
