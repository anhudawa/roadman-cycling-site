...
seoDescription: >-
  The five proven methods to raise your FTP, how to test it properly, realistic
  timelines by level, and how to break a plateau — built on the World Tour coaches
  Roadman has had on the podcast.
excerpt: >-
...
keywords:
  ...
  - over unders cycling
  - ftp test 20 minute vs ramp
  - ftp plateau
  - ftp masters cyclist
  - improve ftp after 40
relatedEpisodes:
...
faq:
  ...
  - question: Is the 20-minute FTP test or the ramp test more accurate?
    answer: >-
      ...
      under-rates diesel engines. Pick one, run it the same way every time, and
  ...
  - question: Can you still improve FTP after 40?
    answer: >-
      ...
      lost training consistency. The thing that genuinely changes is recovery
...
This is the one amateurs skip, and it's the one that holds everyone back. Seiler's research is blunt: the best endurance athletes spend around 80% of their training easy — genuinely easy, conversational, the pace where a recreational rider could sit on your wheel and chat. The other 20% is properly hard.

The amateur mistake is riding the middle. As I put it to Seiler [on the podcast](/blog/stephen-seiler-80-20-polarised-training-cyclists): most age-groupers ride 50% too hard on the days they think they're going easy, and not hard enough on the days meant to hurt. That grey zone — Zone 3, tempo — builds almost nothing while leaving you too tired to nail the real sessions.

The base isn't filler. Easy [Zone 2 riding](/blog/zone-2-training-complete-guide) builds mitochondrial density, capillary networks and fat oxidation — the aerobic engine your threshold sits on. A bigger engine means a higher ceiling for everything above it. **Do it:** the genuinely easy 3–4 hour weekend ride is the most important session in the week. Protect it. Don't let it drift into tempo because your mates half-wheel you.
...
This is the session that wins races, and it's the one most amateurs never program. Over-unders alternate just above threshold and just below it without stopping: 2 minutes at 105%, then 2 minutes at 90%, repeated. The "over" floods you with lactate; the "under" forces you to clear it while still working hard. You're training the buffering and clearing machinery directly.
...
**Do it:** the 4x4 is the most research-validated protocol going — 4 minutes hard (the top sustainable effort you can repeat four times), 4 minutes easy, four times through. Full detail in our [VO2max intervals guide](/blog/cycling-vo2max-intervals). These are the sessions that produced the FTP jump in the [episode on adding 30 watts](/blog/ftp-plateau-breakthrough) — but they're costly, so one a week is plenty and two is the absolute maximum in a short block.
...
- **Two to three years in:** 10–20% a year, slowing to 5–10W per block. Structure starts to genuinely matter here; unstructured riding plateaus fast.
