...
This post is about the width question specifically. For pressure, I&apos;ve covered the [safe setup and field-test method](/blog/cycling-tyre-pressure-guide) separately. This is about why width changed, where the evidence sits, and how to choose between 25mm, 28mm, 30mm, and beyond without falling for marketing or nostalgia.
...
**Set pressure correctly.** A wider tyre at the wrong pressure is not automatically faster than a narrower tyre at a suitable pressure. Use the [Tyre Pressure Calculator](/tools/tyre-pressure) as a starting point, then follow the [safety-first field-test method](/blog/cycling-tyre-pressure-guide). The width and the pressure are two halves of the same equation. Getting one right and the other wrong wastes the investment in both.
