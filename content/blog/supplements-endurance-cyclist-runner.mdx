...
roadmanView:
  - "The supplement industry sells the same promise as the aero upgrade aisle — you're training hard, results are slow, and here's a tub that claims to do the work for you. Most of it is noise."
  - "Beetroot juice is the one that surprises people. Genuine evidence for submaximal work, and it seems to benefit running slightly more than cycling. Worth trying before a target event."
  - "If you're a masters athlete, creatine at 3-5g a day has earned its place. Muscle maintenance, bone density, cognitive function. The evidence is solid and the cost is pennies."
---
