...
answerCapsule: >-
  Prof. Stephen Seiler is an American exercise physiologist at the University of Agder in Norway, best known for codifying polarised training — the 80/20 intensity distribution observed in elite endurance athletes. He has appeared multiple times on the Roadman Cycling Podcast with host Anthony Walsh, covering polarised training, session design, threshold testing, and amateur application. His research, originally built on Norwegian rowing and cross-country skiing data, now underpins training practice across cycling, running and triathlon at World Tour and age-group level.
---
