...
seoDescription: >-
  AI coaching, no periodisation, neglecting recovery, wrong metrics, no
  accountability — five mistakes the data and the coaches agree on, with
...
experts:
  - name: Dan Lorang
    role: Coached Vingegaard, Roglic; current Bora-Hansgrohe coach
