...
The [training diagnostic](/diagnostic) walks through the assessment systematically. If two or more of the five are problematic, the structure needs revision before any specific training change will help.

For external support, the [Not Done Yet community](https://www.skool.com/roadmancycling) at $195/month is the most common entry point for self-coached cyclists who need accountability. The [coaching pathways](/coaching) cover higher-touch options. The [Roadman Method](/method) is the structured 12-month programme for cyclists ready to commit to a full periodisation cycle with personal support.
