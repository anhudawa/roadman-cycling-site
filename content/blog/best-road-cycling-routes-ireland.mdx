...
roadmanView:
  - "I'm biased — I'm Irish — but I've ridden all over Europe and Ireland honestly holds its own against anything in Mallorca or the Alps. The difference is you'll barely see another car. The light here is something else entirely."
  - "Ring of Kerry is the one everyone knows — 180km, 2,200m of elevation — but here's where it gets interesting: Conor Pass on the Dingle Peninsula is the highest paved mountain pass in Ireland at 456m and rivals Kerry with half the traffic. I'd start there if you only have one day."
  - "You don't need a gravel bike or anything fancy. A road bike with 25-28mm tyres handles every route on this list. I'd go 28-32mm for comfort on the rougher patches, but that's preference, not necessity."
---
