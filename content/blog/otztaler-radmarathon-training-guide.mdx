...
seoDescription: >-
  An 18-week Otztaler Radmarathon training plan for 238km and four Alpine passes
  — Kuhtai, Brenner, Jaufenpass, Timmelsjoch. W/kg targets and pacing.
excerpt: >-
...
keyTakeaways:
  - "18-week build is the working minimum for riders already at 8-10 hours/week — the Timmelsjoch punishes anyone who skipped the sustained-climbing blocks."
  - "3.4 W/kg is the floor for finishing inside cut-offs; 4.0+ W/kg targets sub-9 hours across 238km and 5,500m of climbing."
  - "The Timmelsjoch at 29.9km and 7.1% average is the crux — it starts at km 200 on legs with 3,000m+ of climbing and 7-8 hours already done."
  - "One 8-9 hour over-distance ride with 4,000m+ of climbing before the taper is the bar — riders who skip it arrive guessing about hours 8-12."
  - "90-110g carbs/hour from the gun, with the Hochgurgl aid station treated as the most important stop of the day before the Timmelsjoch."
  - "Altitude at the 2,509m Timmelsjoch summit costs amateurs 5-10% of sea-level sustainable power — pace on power, not heart rate."
faq:
  - question: How long do I need to train for the Ötztaler?
    answer: >-
      ...
      Ötztaler is harder than [La Marmotte](/blog/la-marmotte-training-guide) and almost as hard as a single
...
whoFor:
  - Riders entered in the Otztaler Radmarathon who want an 18-week preparation framework
  - Experienced amateurs targeting one of the hardest single-day cycling events in the world
  - Cyclists preparing for 5,000m+ climbing days across multiple Alpine passes
  - Anyone who wants to understand what the Timmelsjoch demands after 200km of riding
roadmanView:
  - "The Otztaler is the event that separates serious from casual. 238km, four Alpine passes, and a final climb that starts at kilometre 200 on legs that have already done 3,000 metres of vertical. You cannot fake readiness for this."
  - "I think the minimum is 3.4 W/kg with disciplined pacing, and even then the Timmelsjoch will test you. Below that, you are looking at a very long day with real cut-off pressure."
  - "The one ride you must do before the taper is an eight to nine hour day with 4,000 metres of climbing. If you skip that, you arrive at Solden guessing about what hours eight through twelve feel like."
---
...
The first three passes of the Ötztaler are the warm-up. Kühtai feels long but rideable. The Brenner is steady. The Jaufenpass bites a little. By the time you start the Timmelsjoch at km 200, you've already done 3,000m of climbing and 7-8 hours of riding. Then the route turns up for 30 kilometres at 7.1%. That climb is the day. Everything before it is positioning for it.
...
**FTP in W/kg.** The floor is 3.4 W/kg with the right gearing. Mid-pack finishes at 3.7-4.0 W/kg. Sub-9-hour times need 4.0+ W/kg. The front of the field is 4.5+ W/kg with race-day weight to match. Use the [W/kg calculator](/tools/wkg) to set the number, the [FTP zones tool](/tools/ftp-zones) to set training intensities, the [Climbing Time Estimator](/tools/climb-time) to model your projected ascent time on the Timmelsjoch at your current power, and the [Race Predictor](/tools/race-predictor) to see where your W/kg lands across the full 238km day.
...
Four to five rides, 80% in [Zone 2](/blog/zone-2-cycling-heart-rate-vs-power-vs-rpe). The aerobic engine. [Stephen Seiler](/guests/stephen-seiler)'s polarised research is the framework: easy stays properly easy. The temptation in week 1 is to start hammering. Resist it. Riders who run base hard arrive at the Timmelsjoch aerobically stale.
...
[John Wakefield](/guests/john-wakefield) uses low-cadence torque work for sustained climbing. Treat 4-minute efforts at 40–60 RPM and RPE 7/10 as a coach-derived advanced option, not a universal study protocol; the [evidence guide](/blog/low-cadence-training-cycling-torque-intervals) gives a more conservative entry point.
...
For underlying fuelling science, the [carbs-per-hour guide](/blog/carbohydrate-per-hour-cyclists) covers gut training and absorption. For race-day timing, the [race-day nutrition guide](/blog/cycling-nutrition-race-day-guide) walks through the protocol.
...
**Underdressing for the descents.** The Brenner descent is fast and exposed. The Timmelsjoch descent is the longest of the day, drops 1,500m, and finishes in cold late-afternoon shadow — at 60 km/h, a 5°C summit temperature has a [wind chill](/tools/wind-chill) closer to -5°C on exposed skin. A gilet stashed in the jersey is non-negotiable. Long-finger gloves for the high-pass summits even in early September.
...
**Gearing.** 34x32 minimum, 34x34 if your derailleur fits it. Test the gearing on a 10% local climb at the end of a 5-hour ride. If you're at 50 RPM in your easiest gear, change the cassette before flights are booked. Use the [Gear Ratio Calculator](/tools/gear-ratio) to compare cassette options and see what cadence each setup gives you at a given power and gradient.
