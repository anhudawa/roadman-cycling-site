...
roadmanView:
  - "This is one of those problems that has a five-minute fix but causes months of confusion. Your heart rate runs 5-10 bpm lower on the trainer at the same power, assuming decent cooling. That means your outdoor Zone 2 is closer to tempo indoors, and your intervals are softer than you think."
  - "Test indoors. Test outdoors. Keep two zone tables. That is the entire solution. It takes less time than one turbo session and removes the guesswork for every session after it."
  - "The exception catches people out: if your room is hot and your fan is weak, heart rate runs higher indoors, not lower. Thermal drift overrides everything else. Before you adjust zones, fix the cooling. A decent fan is the cheapest training upgrade you will ever buy."
---
