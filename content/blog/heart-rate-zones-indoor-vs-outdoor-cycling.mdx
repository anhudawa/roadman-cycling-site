...
seoDescription: "Your heart rate zones shift between the trainer and the road. Why it happens, how much they drift, and how to set separate indoor and outdoor zones."
excerpt: >-
...
The fix is simple. Test in both environments. Set two zone tables.
...
This indoor-outdoor gap is actually a symptom of a bigger issue — are you training with the right intensity targets in the first place?
