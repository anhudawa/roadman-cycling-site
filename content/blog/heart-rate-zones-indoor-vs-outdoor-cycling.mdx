...
seoTitle: 'Heart Rate Zones Indoor vs Outdoor Cycling — Why (2026)'
seoDescription: >-
  Your heart rate zones indoor vs outdoor cycling don't match: why they drift on
  the trainer, by how much, and how to set separate zones that actually work.
excerpt: >-
...
keyTakeaways:
  - "Heart rate typically runs 5-10 bpm lower on a stationary trainer than outdoors at the same power, assuming adequate cooling."
  - "Using outdoor HR zones on the trainer means your Zone 2 is actually closer to tempo and your intervals are softer than intended."
  - "The gap is largest at low intensity and narrows at higher intensities as cardiac output demand overrides environmental factors."
  - "Poor ventilation can reverse the pattern — in a hot room without a strong fan, heart rate climbs higher indoors due to thermal cardiac drift."
  - "Test indoors and outdoors separately and maintain two zone tables — it takes five minutes to set up and removes guesswork entirely."
faq:
...
whoFor:
  - "Indoor trainers whose heart rate numbers never match what they see on the road"
  - "Riders using outdoor zones on the turbo and wondering why efforts feel harder than the numbers suggest"
  - "Anyone setting up a structured indoor training plan and unsure which zones to use"
  - "Cyclists who train by heart rate indoors and want to know whether their sessions are actually hitting the right intensity"
roadmanView:
  - "I get asked about this all the time on the podcast and it has a five-minute fix that stops months of confusion. Your heart rate runs 5-10 bpm lower on the trainer at the same power, assuming decent cooling. That means your outdoor Zone 2 is closer to tempo indoors, and your intervals are softer than you think."
  - "My recommendation is dead simple: test indoors, test outdoors, keep two zone tables. That is the entire solution. It takes less time than one turbo session and removes the guesswork for every session after it."
  - "The exception catches people out and I have seen it plenty of times: if your room is hot and your fan is weak, heart rate runs higher indoors, not lower. Thermal drift overrides everything else. Before you adjust zones, fix the cooling — a decent fan is the cheapest training upgrade you will ever buy."
---
...
The fix is dead simple. Test in both environments. Set two zone tables.
...
**Indoor:** Same test on the trainer within a couple of days. Same warm-up. Same 20-minute max effort. Apply the same 0.95 multiplier. The number will almost certainly be lower. That's your indoor threshold. Build a separate set of zones from it — the [heart rate zone calculator](/tools/hr-zones) does the maths for you in seconds.
...
The 5–10 beat gap isn't constant. It shrinks as intensity rises. By the time you're doing VO2max intervals — 3-minute efforts at 120% FTP (check yours with the [FTP zone calculator](/tools/ftp-zones)), gasping, seeing spots — your cardiovascular system is working so hard that the environmental difference gets swamped. Max heart rate is max heart rate whether you're on the turbo or halfway up the Tourmalet.
