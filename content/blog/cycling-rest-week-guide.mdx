...
answerCapsule: >-
  ...
  progressive loading. The purpose is supercompensation — letting
  accumulated training stimulus consolidate into fitness. You ride easier,
  sleep more, eat slightly less total but keep protein high, and return
  sharper, not rustier.
faq:
  - question: How often should cyclists take a rest week?
    answer: >-
      Typically every 3-4 weeks of progressive loading, though exact timing
      depends on training age, total load, and life stress. Younger riders
      with lower total load can sometimes push to 4-5 weeks. Older athletes
      or those managing high life stress often benefit from a 3-week cycle.
      The body's response to training, not the calendar, is the best
      indicator.
  - question: How much should I cut volume during a rest week?
    answer: >-
      Reduce total weekly volume by 40-50%. For a cyclist normally riding
      10 hours, a rest week sits around 5-6 hours. Keep one short session
      with some intensity (a 45-60 minute ride with a few short efforts) to
      maintain neuromuscular sharpness. The rest should be easy Zone 1-2,
      with at least two full rest days.
  - question: Should I keep any intensity in a rest week?
    answer: >-
      A small amount, early in the week, often helps. One short opener
      with 3-5 minutes of threshold or a few sprints keeps the nervous
      system primed without adding meaningful fatigue. Full cuts to
      intensity are also valid, particularly if you're arriving at the
      rest week deep in fatigue. Either works — dropping volume is the
      non-negotiable piece.
  - question: What are signs I need an unscheduled rest week?
    answer: >-
      Resting HR elevated 5-10 bpm for a week, HRV trending 15%+ below
      baseline, power dropping at the same RPE, sleep disrupted despite
      high fatigue, flat mood, and loss of motivation. When two or three
      of these stack, pull the rest week forward. A week off the plan is
      always cheaper than forcing through and blowing a whole block.
---
