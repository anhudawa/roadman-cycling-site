...
Here's what nobody tells masters cyclists honestly. The problem after 40 isn't that you can't train hard. You can — plenty of 50-year-olds still put out efforts that would bury a fit 25-year-old. The problem is what happens *between* the hard sessions. The recovery slows down, the margin for error shrinks, and the training approach that made you fast at 30 quietly stops working.

The riders who keep improving into their 40s and 50s figured out something the strugglers haven't: at this stage, managing training stress *is* the training. It's not a side task. It's the main skill. Get it right and you keep adapting for years. Get it wrong and you spend those years tired, plateaued, and blaming your age for a recovery problem you could actually fix.

Let me break down how to manage it — the HRV, the deloads, and the part almost everyone gets wrong.

## What actually changes after 40

First, the honest physiology, because the fix depends on understanding the problem.
