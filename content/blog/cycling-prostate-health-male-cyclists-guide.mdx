...
roadmanView:
  - "Nobody wants to write this article and nobody wants to read it. But if you are a male cyclist over 40, you have thought about this. The conversation is dominated by fear, not facts — so let me be clear: cycling does not cause prostate cancer."
  - "A saddle with a central cutout reduces perineal pressure by 50-65%. That is not marginal — that is the single most effective thing you can do. Get your sit-bone width measured and buy accordingly."
  - "Stand on the pedals for 30-60 seconds every 15-20 minutes on long rides. It takes no time, costs nothing, and the research on symptom reduction is clear."
---
