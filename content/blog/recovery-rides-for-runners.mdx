...
whoFor:
  - "Runners who take a recovery run the day after hard intervals and wonder why their legs never feel fresh"
  - "Marathon and half-marathon athletes looking for a genuine active-recovery option that does not add impact stress"
  - "Triathletes and multisport athletes who want to know the physiology behind cycling as cross-training for running"
  - "Any runner whose physio has told them to reduce impact load but who still wants to move on easy days"
roadmanView:
  - "A recovery run is a bit of an oxymoron. Every stride still loads your legs with two to three times your bodyweight in impact force, easy pace or not. A recovery ride does the same job — blood flow, metabolite clearance, gentle movement — minus the part that keeps hammering your joints."
  - "The key is keeping it properly easy. Zone 1, heart rate below 65 per cent of max, spinning at 85-95 rpm against almost no resistance. If you finish the ride feeling like you trained, you rode too hard for what it was meant to do."
  - "I have spoken to enough physios and running coaches on the podcast to know this: the best recovery day for a runner is often not running at all. Thirty minutes on the bike, properly easy, clears fatigue faster than a recovery jog and costs your legs nothing."
---
...
**Heart rate below 65% of max.** This is properly easy — noticeably easier than what most people default to when they say they're "taking it easy" on a bike. If you're not sure what that number actually is for you, the [HR zone calculator](/tools/hr-zones) will set your zones in seconds. If you're used to running paces where your heart rate sits in the 70s or 80s percent range for an "easy" run, this will feel almost too gentle by comparison. That's the point.
