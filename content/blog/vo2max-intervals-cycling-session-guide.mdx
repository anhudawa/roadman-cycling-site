...
faq:
  ...
  - question: Can I do VO2max intervals on a turbo trainer?
    answer: >-
      ...
      more.
whoFor:
  - "Cyclists who want the exact session formats, power targets, and recovery times for VO2max intervals — not vague advice to ride hard"
  - "Riders planning a 6-week VO2max block who need a structured progression from conservative to aggressive across the weeks"
  - "Anyone who has blown up trying VO2max intervals and wants to understand why pacing the first rep conservatively matters more than hitting a peak number"
  - "Cyclists who know the 4x4 but want to understand when to use 30/30s, Ronnestad 30/15s, 5x3, or 3x5 — and which format suits their profile"
roadmanView:
  - "Time spent at VO2max matters more than peak power. That single idea changes how you approach every interval session. A well-paced 4x4 accumulates 8-12 minutes at the oxygen ceiling. An all-out effort that blows up at rep three accumulates under 90 seconds. The conservative approach wins every time."
  - "If you cannot complete the final interval at the same power as the first, you started too hard. Drop 2-3% and try again next session. This is the rule I wish someone had given me ten years ago — it would have saved me from dozens of wasted sessions where I mistook suffering for stimulus."
  - "Two VO2max sessions per week is the ceiling, separated by 48 hours, with everything else as Zone 2. More than that and fatigue compromises session quality, which defeats the entire purpose. The gains come from the quality of the work, not the quantity."
---
