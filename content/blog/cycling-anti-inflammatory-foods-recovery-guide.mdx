...
roadmanView:
  - "Acute inflammation after training is not the enemy — it is the signal that drives adaptation. Chronic low-grade inflammation is the enemy. The food strategies here target the chronic kind."
  - "Tart cherry concentrate, 30ml twice daily around hard sessions, has the best evidence base of any anti-inflammatory food for endurance athletes. It is not glamorous but it works."
  - "Stop taking ibuprofen after hard rides. NSAIDs reduce inflammation but also blunt the adaptive response to training. You are paying for today's comfort with tomorrow's gains."
---
...
What you eat — specifically, the balance of pro-inflammatory and anti-inflammatory compounds in your daily diet — has a direct effect on which kind dominates. This is the guide to shifting that balance.
