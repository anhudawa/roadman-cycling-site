...
answerCapsule: >-
  Piriformis syndrome occurs when the piriformis muscle compresses the sciatic
  nerve, causing deep glute ache that often appears hours after riding. The FAIR
  test — flexion, adduction, internal rotation — is a reliable self-screening
  tool. Treatment requires four elements together: targeted stretching, soft-
  tissue release with a tennis ball, glute strengthening, and sciatic nerve
  glides. The 30-minute rule at the desk — standing every half hour — prevents
  recurrence more effectively than any single stretch.
keyTakeaways:
...
relatedTools:
  ...
  - "recovery-screen"
whoFor:
  - "Cyclists with a deep ache in the glute that runs down the back of the leg hours after riding"
  - "Desk workers who ride and develop post-ride pain that worsens when sitting at work the next day"
  - "Riders who have been told they have sciatica but whose symptoms do not match a disc problem"
  - "Cyclists with recurring hip or glute niggles that disappear for a few weeks then come back every time training ramps up"
roadmanView:
  - "I hear about this injury constantly in the NDY community, and it's the one nobody diagnoses properly until it stops you riding. You feel fine on the bike, fine getting off, and then six hours later at your desk the pain arrives. The combination of cycling and desk work is the single biggest risk factor."
  - "Let me be really clear — stretching alone will not fix this. I've had physios on the show who've hammered this point home: you need the full protocol — targeted stretching, soft-tissue release, glute strengthening, and nerve glides. All four together. Miss one and it comes back."
  - "The 30-minute rule at your desk is the boring prevention piece that actually works. Stand and move for two minutes every half hour. I know it sounds too simple, but it reduces piriformis load more effectively than any single stretch."
---
