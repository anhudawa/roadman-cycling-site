...
answerCapsule: >-
  Aero socks at roughly 25 pounds save 2-4 watts, making them the best value
  aero upgrade. A well-fitted skinsuit saves 10-15 watts at 40 kph, but a poorly
  fitted one can be slower than tight standard kit. Aero helmets save 5-12
  watts. Fit matters more than fabric — a jersey one size too large creates more
  drag than switching to a correctly sized skinsuit. Buy aero socks first, then
  skinsuit, then helmet.
keyTakeaways:
...
relatedTools:
  ...
  - "wind-chill"
whoFor:
  - "The rider about to spend on a skinsuit who wants to know whether the claimed watt savings are real"
  - "The time triallist or sportive racer looking for the best return per pound on aero clothing"
  - "The cyclist wearing kit one size too large who does not realise it is costing more watts than their frame choice"
  - "The racer who already has the bike sorted and wants to know what clothing upgrades actually show up in the data"
roadmanView:
  - "Fit matters more than fabric. I have seen riders turn up in full aero skinsuits with a flapping gilet shoved in their back pocket. The gilet is costing them everything the skinsuit saved."
  - "Aero socks at 25 quid are the best value upgrade in cycling. The wind tunnel data is consistent. Buy them before you buy anything else."
  - "The order matters: aero socks, then a properly fitted skinsuit or race-cut kit, then an aero helmet if you ride flat courses. Everything after that is diminishing returns."
---
