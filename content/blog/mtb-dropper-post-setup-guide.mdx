...
seoTitle: 'MTB Dropper Post Setup Guide: Height, Travel, When to Drop'
seoDescription: >-
  Dropper post setup done right — the correct saddle height, choosing travel,
  and when to drop it on the trail for real descending and cornering confidence.
excerpt: >-
...
keyTakeaways:
  - "A dropper post is the single best upgrade you can make to a mountain bike — it transforms descending from surviving to actually riding."
  - "Get as much travel as your frame allows — 150-170mm for most trail riders — because there is no downside to having more travel available."
  - "Most riders don't drop the saddle enough or often enough; the best riders adjust saddle height dozens of times per ride without thinking about it."
  - "Drop 30-50mm even for flat or off-camber corners to drive weight through the outside pedal and lean the bike harder — this is the technique most people miss."
  - "Service the dropper every 100-200 hours: wipe the stanchion after every ride, check air pressure periodically, and replace seals and oil annually at minimum."
relatedEpisodes:
...
whoFor:
  - "Mountain bikers who have a dropper post but rarely use it or do not drop it far enough"
  - "Riders upgrading from a rigid seatpost who need to set up and learn dropper technique"
  - "Anyone who descends stiffly because their saddle is in the way of proper body position"
  - "Trail riders who corner flat because they have not learned the partial drop for turns"
roadmanView:
  - "A dropper post is the single best upgrade you can make to a mountain bike. I will say that to anyone. But only if it is set up right and you actually use it. Most riders drop it once at the top of a descent and raise it at the bottom. The best riders adjust height dozens of times per ride."
  - "The technique most people miss is the partial drop for corners. Drop 30-50mm on flat or off-camber turns, drive weight through the outside pedal, and lean the bike harder. That is where real cornering confidence comes from."
  - "Get as much travel as your frame allows. There is no downside to having more travel available. And service it — wipe the stanchion after every ride, check pressure periodically. A sticky dropper that you stop trusting is worse than no dropper at all."
---
...
The general rule is simple: get as much travel as your frame and body will allow. More travel means more room to move on steep terrain, which means more control. There is no downside to having more travel available — you don't have to use all of it, but it's there when you need it.
...
For the fitness behind the riding, [NDY coaching at Roadman](/coaching) writes a plan around your week. Got a specific question about your own dropper choice or how to set up around an injury? [Ask Roadman](/ask) for an answer drawn from the wider Roadman archive.
