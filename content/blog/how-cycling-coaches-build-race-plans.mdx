...
roadmanView:
  - "The coaching is the thinking, not the software. TrainingPeaks and WKO5 are brilliant tools, but a spreadsheet full of sessions is not coaching — the value is the human judgement about what to train, when to adjust, and when to pull you back."
  - "Red flags are easy to spot once you know them. If your plan looks identical to someone else's, if nothing changes when you report bad sleep or a dodgy knee, and if you never hear why a session exists — that is a template, not coaching."
  - "Self-coaching works until the stakes rise or you lose objectivity. For general fitness and familiar events, you can do it yourself. For an unfamiliar target race or a season that actually matters, a good coach earns their fee."
---
