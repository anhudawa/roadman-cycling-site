...
whoFor:
  - "Riders considering hiring a coach for the first time and wondering what they'd actually get"
  - "Self-coached athletes who suspect they're missing something but aren't sure what"
  - "Cyclists already paying for coaching who want to know whether what they're receiving is good"
  - "Anyone who's bought a 12-week plan online and wondered why it felt generic"
roadmanView:
  - "I've had dozens of coaches on the podcast, and the good ones all say the same thing: the coaching is the thinking, not the software. TrainingPeaks and WKO5 are brilliant tools, but a spreadsheet full of sessions is not coaching — the value is human judgement about what to train, when to adjust, and when to pull you back."
  - "I can spot red flags in coaching a mile off now. If your plan looks identical to someone else's, if nothing changes when you report bad sleep or a dodgy knee, and if you never hear why a session exists — you're getting a template, not coaching."
  - "From what I've seen, self-coaching works until the stakes rise or you lose objectivity. For general fitness and familiar events, you can absolutely do it yourself. For an unfamiliar target race or a season that actually matters, a good coach earns their fee."
---
...
If you cannot hire a coach but want to run this analysis yourself, the [Race Time Predictor](/tools/race-predictor) will model your expected finish time from your FTP, weight, and course profile — it is the DIY version of this exact process.
