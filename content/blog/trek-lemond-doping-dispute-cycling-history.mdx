...
roadmanView:
  - This was never about bikes. It was about who gets to tell the story of cycling, and what happens when the money says one version and the truth says another.
  - LeMond spoke up when speaking up cost him everything. Trek deleted his name from the catalogue. The sport looked the other way. The receipts tell a story the press releases would not.
  - The structural lesson here goes well beyond cycling. When an entire industry's commercial momentum depends on a single hero, the pressure to silence alternative versions comes from thousands of small decisions, not one grand conspiracy.
---
