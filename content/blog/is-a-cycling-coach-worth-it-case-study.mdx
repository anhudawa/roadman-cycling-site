...
keywords:
  ...
  - cat 3 to cat 1
answerCapsule: >-
  A cycling coach is worth it when the rider has the training time, motivation, and a specific goal, but lacks structure or the ability to self-assess. In one documented case, a Cat-3 rider progressed to Cat-1 in a single season under structured coaching, adding 38 watts to FTP (from 287W to 325W) while reducing weekly hours from 14 to 11. Coaching pays back fastest for riders who train 8+ hours per week and race competitively. Below that threshold, the return is smaller.
faq:
  - question: "How much does a cycling coach cost?"
    answer: >-
      Quality 1:1 online cycling coaching runs £150–£300 per month depending on the coach's background and the level of contact. Budget platforms with templated plans sit at £20–£60 per month but don't include individual plan adjustments. Roadman Cycling's Not Done Yet programme is $195/month and includes weekly plan adjustments, nutrition, strength, and direct coach access.
  - question: "How long until a cycling coach produces results?"
    answer: >-
      Expect measurable physiological change in 8–12 weeks and meaningful race results in 4–6 months. FTP gains of 5–10% in the first block are normal for riders coming from unstructured training. The bigger gains — pacing, race-craft, fuelling under load — take a full season to consolidate. Riders expecting transformation in four weeks will be disappointed.
  - question: "Can I just use a training app instead of a coach?"
    answer: >-
      Apps like TrainerRoad or Zwift's structured plans work for riders who already know what they need and train consistently. They don't adapt in real time to fatigue, life stress, or race calendars the way a coach does. If you've plateaued on a plan, the missing element is usually individual assessment, not more workouts.
  - question: "Is coaching worth it for amateur cyclists who don't race?"
    answer: >-
      Yes, if the rider has a specific goal — a gran fondo, a bucket-list climb, an age-group podium — and the time to train 6+ hours per week. Coaching compresses the learning curve on pacing, fuelling, and periodisation. For casual riders with no goal or under 4 hours per week, the return on a premium coach is small.
  - question: "What's the difference between a cheap and expensive cycling coach?"
    answer: >-
      Price correlates with contact time, coach experience, and plan individualisation. A £40/month service sends a templated plan. A £200+/month service includes weekly plan rewrites based on the rider's data, direct messaging, and integrated nutrition and strength support. The expensive option is worth it when the rider uses all of it.
---
