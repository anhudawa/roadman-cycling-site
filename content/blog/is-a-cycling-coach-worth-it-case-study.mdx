...
answerCapsule: >-
  ...
  smaller.
keyTakeaways:
  - "A coached Cat-3 to Cat-1 progression in one season added 38W to FTP (287W → 325W) while reducing weekly hours from 14 to 11. Structure beat volume."
  - "The biggest coaching gains came from removing the wrong work, not adding the right work. Most amateur training programmes have more to lose than to add."
  - "Coaching pays back fastest at 8+ hours per week with race-specific goals. Below that threshold, structured app-based training usually offers a better return per pound."
faq:
...
whoFor:
  - Cyclists stuck at a performance plateau wondering if coaching is the answer
  - Riders considering their first coaching investment and unsure of the return
  - Cat-3 or Cat-4 racers with genuine ambitions to move up
  - Self-coached athletes training 8+ hours a week without clear direction
roadmanView:
  - "I've seen coaching pay for itself time and again when the rider has the hours, the motivation, and the goal — but keeps making the same mistakes. The biggest gains I see always come from removing the wrong work, not adding more."
  - "I wanted to share this case study because it's one rider, one season, Cat-3 to Cat-1 — he added 38 watts and dropped three hours a week. Structure beat volume, and in my experience it nearly always does."
  - "Let me be really clear on this: below eight hours a week, structured app-based training is usually the better return per pound. Above that, I believe a coach who knows you will outperform any plan you download."
---
...
The other change was less visible but arguably more important. Every Sunday evening, Daniel wrote a short review of the week — what hit, what didn't, how he felt. His coach read it before releasing the next week's plan, which synced into Daniel's calendar so the indoor sessions ran on [TrainingPeaks Virtual](https://www.trainingpeaks.com/virtual/) with the prescribed targets already set — no translating a spreadsheet onto the turbo at 6am. That feedback loop is what an app cannot replicate. It's also what separates coaching that's worth $195/month from coaching that's worth $40.

## The numbers: FTP, training hours, racing performance

Twelve months later, the numbers looked like this.

FTP moved from 287W to 325W — a gain of 38 watts, or 13.2%. Weight dropped slightly, from 74kg to 72kg, putting [W/kg at 4.51](/tools/wkg). 5-minute power went from 372W to 421W, a 13% improvement that reflected the targeted VO2 work.

Training hours actually decreased. Weekly average went from roughly 14 hours (with high variance) to 11 hours (with low variance). Annual volume dropped from 520 hours to 485 hours, but [weekly training load](/tools/training-load) was more consistent and better managed. More output, less input — which is the signature of better-distributed training, not harder training.
...
What it did not cost: extra training hours. As noted, weekly hours went down. It did require more discipline about when those hours happened. Hard days were hard, easy days were properly easy, and that meant resisting the urge to chase Strava segments on recovery rides. For some riders this is the hardest change.
...
If three or more of those apply, the investment pays back. The [Roadman fit quiz](/find-your-fit) is a three-minute self-check on the same conditions, and the [is a cycling coach worth it](/blog/is-a-cycling-coach-worth-it) piece is the wider version of this case study. [Apply for coaching](/apply) and have a conversation before committing — any coach worth hiring will tell you honestly whether you're ready.
