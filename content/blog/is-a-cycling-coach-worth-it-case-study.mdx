...
roadmanView:
  - "Coaching pays for itself when you have the hours, the motivation, and the goal — but keep making the same mistakes. The biggest gains come from removing the wrong work, not adding more."
  - "This case study is one rider, one season, Cat-3 to Cat-1. He added 38 watts and dropped three hours a week. Structure beat volume. It nearly always does."
  - "Below eight hours a week, structured app-based training is usually the better return per pound. Above that, a coach who knows you will outperform any plan you download."
---
