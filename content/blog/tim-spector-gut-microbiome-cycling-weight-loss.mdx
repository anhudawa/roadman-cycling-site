...
roadmanView:
  - "Spector is the most cited voice in nutrition science right now and he sat down with us to explain why the calorie is the wrong unit. His twin studies showed that identical meals produce wildly different glucose responses across individuals. The microbiome is the variable nobody is measuring."
  - "The practical advice is simpler than the science: 30 different plant foods a week, more fermented foods, cut the ultra-processed stuff, and respect a 12-hour overnight fast. That is it. Your gut adapts visibly in two weeks."
  - "For cyclists specifically, the piece that matters is this: a damaged gut absorbs nutrients less efficiently, recovers more slowly, and gets less adaptation from the same training. You can have the best training plan in the world, but if your gut is wrecked, you are leaving gains on the table."
---
