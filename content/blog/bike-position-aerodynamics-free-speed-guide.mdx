...
whoFor:
  - "Riders chasing free speed who want to know the exact watt savings from position changes, clothing swaps, and helmet selection before spending anything on equipment"
  - "Cyclists considering deep-section wheels who need to understand that narrowing their elbows saves more watts than any wheelset and costs nothing"
  - "Time trialists and sportive riders who want Dan Bigham's hierarchy: position first, then clothing, then helmet, then wheels, then frame"
  - "Amateur racers who have gone aggressive on position but lost power through restricted breathing and want to find the sustainable balance"
roadmanView:
  - "When I had Dan Bigham on the podcast — former Hour Record holder and aero engineer at Red Bull-Bora-Hansgrohe — his hierarchy was dead clear: position first, then clothing, then helmet, then wheels, then frame. Most amateurs start at the expensive end and work backwards. Narrowing your elbows by 5-8cm on the hoods saves 8-15 watts at 35km/h. That costs nothing."
  - "Here's where it gets interesting — getting lower only works if you can hold the power. I've seen riders chase an aggressive position that saves 20 watts in drag but costs them 25 watts from restricted breathing. That's a net loss. The goal is the lowest sustainable position, not the lowest possible one."
  - "One that surprises people: a properly fitted race jersey beats a baggy club jersey by 5-10 watts, and covering your arms with fitted fabric is actually faster than riding bare-skinned. Boundary layer effects. The aerodynamics don't care what you think looks fast."
---
