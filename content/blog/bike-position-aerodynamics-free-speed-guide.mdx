...
roadmanView:
  - "Dan Bigham — former Hour Record holder and aero engineer at Red Bull-Bora-Hansgrohe — is clear on the hierarchy: position first, then clothing, then helmet, then wheels, then frame. Most amateurs start at the expensive end and work backwards. Narrowing your elbows by 5-8cm on the hoods saves 8-15 watts at 35km/h with zero cost."
  - "Getting lower only works if you can maintain power output. A position that saves 20 watts in drag but costs 25 watts from restricted breathing is a net loss. The goal is the lowest sustainable position, not the lowest possible position. That is a critical distinction most riders miss."
  - "A properly fitted race jersey beats a baggy club jersey by 5-10 watts, and covering arms with fitted fabric is actually faster than riding bare-skinned due to boundary layer effects. That one surprises people, but the aerodynamics are clear."
---
