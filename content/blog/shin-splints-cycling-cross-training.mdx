...
whoFor:
  - "Runners with shin splints who want to maintain fitness on the bike without aggravating the injury"
  - "Endurance athletes dealing with medial tibial stress syndrome who need a structured cross-training plan"
  - "Cyclists who also run and want to understand how to manage running injuries around their riding"
  - "Anyone returning from a lower-leg overuse injury who needs clarity on when and how to add impact back"
roadmanView:
  - "Shin splints and cycling is one of the cleanest injury-to-cross-training matches in endurance sport. Zero impact through the tibia, full aerobic stimulus, and most runners can ride at full volume from day one."
  - "The biggest mistake I see is runners treating the bike as a holding pattern. It is not. Train the bike with the same intent you trained running — structure, intensity, purpose — and you will come back fitter, not just less unfit."
  - "The hard part is not the cycling. It is the patience to reintroduce running gradually when the shin feels fine, because feeling fine and being healed are not the same thing."
---
