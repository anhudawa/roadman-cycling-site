...
For the wider position assessment, read the [Roadman bike-fit guide](/blog/bike-fit-guide-cyclists). For the setup sequence, use [how to set saddle height](/answers/how-to-set-saddle-height).
