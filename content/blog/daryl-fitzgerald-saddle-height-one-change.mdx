...
roadmanView:
  - "When I spoke to Daryl Fitzgerald on the podcast, his message was simple: saddle height is the one change most amateurs should make first. Not stem length, not cleat position — just the height of the thing you sit on."
  - "The story that stuck with me from that conversation is a rider who dropped his saddle 7mm and went a minute faster on the same time-trial loop. Seven millimetres — less than the width of a pencil."
  - "Daryl told me to move it one millimetre at a time. That sounds absurdly cautious, but he insists even 1mm is noticeable, and big jumps create new problems faster than they solve old ones. I've taken that advice myself and he's right."
---
