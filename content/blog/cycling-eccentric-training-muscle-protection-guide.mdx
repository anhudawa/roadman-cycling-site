...
answerCapsule: >-
  Cycling is almost entirely concentric, leaving riders vulnerable to eccentric
  demands from descents, hiking, and running. The repeated bout effect means a
  single eccentric session protects the muscle for weeks to months. Six key
  exercises cover the spectrum: eccentric calf raises, step-downs, slider
  hamstring curls, tempo split squats, single-leg press, and Nordic curl
  progressions. Use a 4-0-1-0 tempo (four seconds lowering). Start with two sets
  per exercise during a recovery week and expect significant soreness from the
  first two sessions.
keyTakeaways:
...
relatedTools:
  ...
  - "recovery-screen"
whoFor:
  - "The cyclist who is strong on the bike but gets destroyed by off-bike activities like hiking or running"
  - "Any rider over 35 who notices longer recovery from rides with big descents"
  - "The masters cyclist dealing with patellar tendon or Achilles pain that isn't responding to rest"
  - "Anyone preparing for a mountainous sportive with sustained descents they haven't trained for"
roadmanView:
  - "Cycling builds a body that's strong in one direction and fragile in the other. I found this out the hard way on a hiking holiday where my quads were wrecked for days from walking downhill."
  - "The repeated bout effect is remarkable. One session of eccentric work protects you for months. But that first session will make you very sore -- plan it during a recovery week."
  - "Six exercises, two sessions a week, a 4-0-1-0 tempo. That's the prescription. Most of it needs nothing more than a step and a wall."
---
