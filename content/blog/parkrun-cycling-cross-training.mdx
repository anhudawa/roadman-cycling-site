...
whoFor:
  - "Cyclists who have been dragged along to parkrun and want to understand why their aerobic engine already gives them a head start"
  - "Runners dealing with injury who need a low-impact way to maintain fitness without losing their 5K speed"
  - "Time-crunched athletes who want a practical weekly structure that combines cycling and parkrun without overtraining"
  - "Masters athletes over 40 looking for a cross-training approach that protects joints while still building cardiovascular capacity"
roadmanView:
  - "There is a particular kind of cyclist who turns up at parkrun expecting to get beaten by proper runners — and then runs a time that surprises everyone, including themselves. That is not a fluke. The aerobic engine you built on the bike transfers directly. Parkrun rewards cardiovascular fitness, and cycling builds exactly that."
  - "The mistake I see people make is treating cycling and running as competing priorities instead of complementary ones. Three to five rides plus one parkrun a week is a structure that works. The bike builds the engine; the run sharpens the specifics. Do not overthink it."
  - "If you are a cyclist over 40 and you have never done a parkrun, go and do one. Seriously. It is free, it takes 20-odd minutes, and I guarantee you will be surprised by how much fitness carries over. It might be the best thing you do for your motivation all month."
---
