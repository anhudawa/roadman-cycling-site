...
seoTitle: 'Gran Fondo NYC Training Plan: 12 Weeks for Bear Mountain'
seoDescription: 'A Gran Fondo NYC training plan: a 12-week build for 160km from Manhattan to Bear Mountain — pack tactics, threshold pacing, and Hudson Valley rollers.'
excerpt: >-
...
keyTakeaways:
  - "GFNY is timed, ranked, and pack-dominated — picking the right group in the first 15km decides more of the day than peak FTP."
  - "Bear Mountain is a 25-30 minute threshold effort at km 90: pre-fuel at km 75, pace on watts, and do not overcook the bottom."
  - "Target 2.7 W/kg minimum to finish, 3.4-3.8 W/kg for sub-7 hours, 4.0+ W/kg for an age-group podium."
  - "Plan three weekly group rides in the final eight weeks to rehearse holding a wheel at threshold — solo riders pay for it on the GW Bridge."
  - "Mid-May humidity is the silent factor: train hydration in temperate weather and fuel 70-90g carbs per hour from the start."
faq:
  ...
  - question: Is GFNY a hard or easy gran fondo?
    answer: >-
      ...
      160km — modest compared to [Marmotte](/blog/la-marmotte-training-guide) or Maratona, harder than RideLondon
      or the [Cape Town Cycle Tour](/blog/cape-town-cycle-tour-training-guide). The challenge isn't elevation; it's
...
whoFor:
  - "Riders entering Gran Fondo New York who want a 12-week plan that accounts for pack tactics, not just climbing"
  - "US-based cyclists targeting a timed, ranked 100-mile event and wanting to finish well rather than just finish"
  - "Riders who train solo and need to develop group-riding skills before a pack-dominated race"
  - "Anyone who has blown up on Bear Mountain because they went too hard in the first 30km off the GW Bridge"
roadmanView:
  - "I've talked about GFNY on the podcast a few times — it's the gran fondo where pack discipline decides more of the day than peak FTP. The first 15km off the GW Bridge is a fast, nervous bunch, and if you pick the wrong group you'll pay for it on Bear Mountain."
  - "Bear Mountain is a 25-30 minute threshold effort hitting you at km 90. My advice: pre-fuel at km 75, pace on watts, and don't overcook the bottom. The riders who blow up here are always the ones who raced the first half."
  - "If you train solo and haven't ridden in a group in months, I'd plan three weekly group rides in the final eight weeks. Solo riders consistently pay for it at this event."
---
...
Three to four rides, 80% in [Zone 2](/blog/zone-2-cycling-heart-rate-vs-power-vs-rpe). The aerobic engine. [Stephen Seiler](/guests/stephen-seiler)'s polarised principle applies hardest here: the easy stuff stays properly easy. Riders who run base block in the grey zone are the riders who plateau at week 7.
...
For the underlying science, the [carbs-per-hour guide](/blog/carbohydrate-per-hour-cyclists) covers the gut-training detail. The [race-day nutrition guide](/blog/cycling-nutrition-race-day-guide) walks through the timing for events of this duration.

## Common Mistakes

**Burning matches matching pace on the GW Bridge.** The first 5km is a race start by half the field. Let them go. Pick a pack at your goal pace within the first 15km and stay in it. Riders who chase the front pack on the bridge are the same ones cracked at km 100. If this is your first major event, the [first gran fondo survival guide](/blog/first-gran-fondo-what-nobody-tells-you-guide) covers the mistakes that catch newcomers before the race even hits Bear Mountain.
