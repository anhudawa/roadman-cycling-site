...
answerCapsule: >-
  A dirty drivetrain wastes 5-12 watts compared to a clean, lubricated one.
  Replace the chain at 0.5-0.75 per cent elongation (every 2,000-3,000 km for
  most riders) to protect the cassette. Wax-based lubricants measure 1-3 watts
  faster than wet lubes when applied to a fully degreased chain. Clean and re-
  grease jockey wheel bearings to recover 1-2 watts. A 20-minute weekly chain
  wipe and a 90-minute monthly strip-down keeps losses below 2 watts above
  baseline.
keyTakeaways:
