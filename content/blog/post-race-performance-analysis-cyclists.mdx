...
roadmanView:
  - "The biggest waste in amateur cycling is not bad training — it is good race data that never gets reviewed. Every file contains months of direction if you sit with it for twenty minutes."
  - "Write the debrief within 24 hours. The power file is not going anywhere, but how your legs felt on that climb at kilometre 85 will vanish from memory by Monday."
  - "Our TSS Calculator and Training Load tools will give you the numbers. The interpretation is on you — and that is what separates riders who repeat the same mistakes from riders who fix them."
---
