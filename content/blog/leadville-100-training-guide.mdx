...
seoTitle: 'Leadville 100 Training Plan: 16 Weeks for Sub-12 Buckle'
seoDescription: 'Leadville Trail 100 MTB training plan. 16-week build for 160km starting at 3,100m — Columbine, Powerline, altitude work, and the sub-12 buckle.'
excerpt: >-
...
keyTakeaways:
  - "3.2 W/kg sea-level FTP with 2 weeks of altitude prep gets you the 12-hour buckle; 3.7+ W/kg with 3+ weeks at altitude targets sub-9 gold."
  - "Above 3,000m you lose 12-18% of your sea-level FTP — acclimatisation moves the needle more than another 10 watts."
  - "Arrive in Leadville 2 full weeks early or 36 hours before — arriving 4-7 days out lands acute mountain sickness on race day."
  - "Pace Columbine Mine on heart rate, not power — HR runs 8-12 bpm above sea-level Z3 at the same wattage at altitude."
  - "XC race tyres last 80km on Leadville rocks and then you walk — 2.3-2.4 inch casings with MaxxTerra or Enduro reinforcement are the floor."
faq:
...
whoFor:
  - "Riders entering the Leadville Trail 100 who want a 16-week plan built around the specific demands of racing 160km at 3,100m altitude"
  - "Mountain bikers targeting the sub-12-hour buckle who need to understand the W/kg thresholds, altitude penalties, and acclimatisation timing"
  - "Road cyclists crossing over to MTB endurance events who want to know what Leadville demands beyond fitness, including tyre choice, technical skills, and altitude strategy"
  - "Anyone drawn to Leadville by the mystique of Columbine Mine who wants a realistic assessment of what it takes to get there and back inside the cut-off"
roadmanView:
  - "I've spoken to riders who went to Leadville with massive FTP numbers and still walked Columbine because they hadn't acclimatised. Here's the thing — fitness meets altitude at this event and altitude wins every time. I always say the two-week or thirty-six-hour arrival rule is the single most important decision you make."
  - "I think the tyre point is the one that catches roadies out. I've seen it happen — XC race tyres last 80km on Leadville rocks and then you're walking. This is not a weight-saving exercise. Run proper casings, accept the grams, and finish on rubber instead of rims."
  - "I always tell riders to pace Columbine on heart rate, not power. At 3,800m your power meter will tell you comfortable lies while your cardiovascular system tells you the truth. Heart rate runs eight to twelve beats higher at the same wattage at altitude. Trust the strap, not the crank."
---
...
At sea level your FTP is one number; at Leadville, it isn't. Above 3,000 metres you'll lose 12-18% of that number, and there is nothing your training can do about the air pressure. What training can do is prepare your aerobic system to operate efficiently in low oxygen, and what logistics can do is land your body in Leadville at the right point in the acclimatisation curve. Riders who arrive 48 hours before the race lose more time to altitude than to fitness.
...
**FTP in W/kg (sea level).** 2.8-3.2 W/kg with 1-2 weeks altitude prep can finish in 10-12 hours and get the buckle. 3.2-3.7 W/kg with 2 weeks altitude prep targets sub-12 with margin. 3.7+ W/kg with 3+ weeks altitude exposure targets sub-9 gold. Above 4.0 W/kg you're racing for the front group — but it's still riders who live at altitude or arrive 4+ weeks early who win. Use the [W/kg calculator](/tools/wkg) to set the number, the [FTP zones tool](/tools/ftp-zones) to set training intensities, and the [Race Predictor](/tools/race-predictor) to see how your sea-level power translates to a buckle time once you factor in the course profile and altitude adjustments.
...
**On the bike.** 70-90g carbohydrate per hour from the gun. That's gels every 30 minutes plus a bar at km 30 and km 95 — use the [Fuel Planner](/tools/fuel-planner) to map the whole day against the aid-station gaps so altitude-suppressed appetite doesn't leave you guessing. Force-fuel on a timer if appetite isn't there — set an alarm on the head unit if you have to. Asker Jeukendrup's research on multiple transportable carbohydrates is the basis for the standard 2:1 glucose-fructose mix used by most riders.
...
**Bike.** A modern XC-trail mountain bike. Hardtail or short-travel full suspension. Tubeless mandatory. Disc brakes required. If you're running suspension, use a [shock pressure calculator](/tools/shock-pressure) to get your sag right before race week — not on race morning.
