...
answerCapsule: >-
  Tight hamstrings in cyclists are usually neurologically tight, not
  structurally short — the nervous system increases resting tone because the
  muscle lacks eccentric strength at longer lengths. Static stretching alone
  will not fix it. Nordic hamstring curls reduce injury risk by up to 51 per
  cent according to a 2019 meta-analysis. A 10-minute twice-weekly protocol of
  Nordic curl progressions, single-leg Romanian hinges, and supine sliders
  offsets the imbalance cycling creates.
keyTakeaways:
...
relatedTools:
  ...
  - "body-composition"
whoFor:
  - "Cyclists who stretch their hamstrings every night and wonder why the tightness never goes away"
  - "Riders over 40 noticing increasing post-ride stiffness in the back of the thighs that takes longer to warm out"
  - "Anyone who has had a bike fit change and developed new hamstring pain or tightness they cannot explain"
  - "Comeback athletes rebuilding mileage who want to prevent hamstring problems before they become injuries"
roadmanView:
  - "I spent years stretching tight hamstrings when the real problem was weakness. Once I understood the difference, a ten-minute twice-weekly routine fixed what years of stretching could not."
  - "Nordic curls are not glamorous, but the injury prevention evidence is hard to argue with — a 51 per cent reduction in hamstring injury risk is worth the discomfort."
  - "If your hamstrings feel tight in the first ten minutes and then loosen up, that is probably neural tone. If the pain gets worse as you ride, see a physio."
---
