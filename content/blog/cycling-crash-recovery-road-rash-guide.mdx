...
answerCapsule: >-
  Treat road rash with moist wound healing using hydrocolloid dressings, which
  cuts recovery time by 30-40 per cent compared to letting it dry and scab.
  Clean with running water and mild antiseptic; seek medical attention for
  embedded debris. A collarbone fracture accounts for 30 per cent of cycling
  fractures and needs an X-ray if shoulder impact occurred. Limit NSAIDs to the
  first 48 hours, then switch to paracetamol. Increase protein to 1.6-2.0 g/kg
