...
roadmanView:
  - "The Haute Route Alps is the event that taught me that single-day fitness is almost irrelevant in stage racing. Day-1 power means nothing if you cannot recover overnight and produce again on day 4. The training has to reflect that."
  - "Back-to-back long weekends are the non-negotiable. Saturday five hours, Sunday four hours, and you ride Sunday on Saturday's legs. If that feels grim in training, it is because it is supposed to. That is the simulation."
  - "Most riders overtrain the engine and undertrain the recovery. If you arrive at the Haute Route with a 4.0 W/kg threshold but no fuelling plan, no sleep protocol, and no pacing discipline, you will lose 20 GC places in the second half of the week."
---
