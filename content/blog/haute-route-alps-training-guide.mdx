...
answerCapsule: >-
  ...
  does not transfer.
keyTakeaways:
  - "The Haute Route Alps is seven timed stages: 920km, 21,000m climbing — single-day fitness does not transfer to a seven-day stage race."
  - "Back-to-back long-ride weekends (5-6 hours Saturday, 4-5 hours Sunday) are the only training that simulates recovering overnight and riding hard again."
  - "Target 3.4 W/kg minimum to finish all seven stages inside cut-offs; 4.2+ W/kg for the GC top third."
  - "Fuel 80-100g carbs per hour on the bike, with total daily carb intake reaching 8-10g per kg of body weight during race week."
  - "Altitude costs most amateurs 8-15% of sea-level sustainable power at 2,500m — arrive 7-10 days early or accept the deficit."
faq:
...
whoFor:
  - "Riders entered or considering the Haute Route Alps who need a structured 16-week build"
  - "Cyclists training for any multi-day Alpine stage race and unsure how to simulate back-to-back days"
  - "Amateurs targeting 3.4-4.2 W/kg who want to know what those numbers actually mean across seven stages"
  - "Anyone who has completed a single-day Alpine sportive and wants the next step up"
roadmanView:
  - "The Haute Route Alps is the event that taught me single-day fitness is almost irrelevant in stage racing. Day-1 power means nothing if you cannot recover overnight and produce again on day 4. I had to learn that the hard way, and the training has to reflect it."
  - "I make every Haute Route rider I work with do back-to-back long weekends — Saturday five hours, Sunday four hours, riding Sunday on Saturday's legs. If that feels grim in training, good. That is the simulation, and nothing else replicates what stage 4 actually feels like."
  - "What I see again and again is riders who overtrain the engine and undertrain the recovery. You can arrive at the Haute Route with a 4.0 W/kg threshold, but without a fuelling plan, a sleep protocol, and pacing discipline, you will lose 20 GC places in the second half of the week."
---
...
**FTP in W/kg.** The floor is 3.4 W/kg if your recovery protocol is locked in. Mid-pack GC starts around 4.0 W/kg. Front-of-field GC requires 4.5+ W/kg with the body composition to match. These are sea-level numbers — at 2,500m, expect to be riding the equivalent of 8-15% lower in real terms. If you're not sure where you sit, our [W/kg calculator](/tools/wkg) and [FTP zones tool](/tools/ftp-zones) will get you to a real number quickly. The [Climbing Time Estimator](/tools/climb-time) then translates that W/kg into projected ascent times on specific cols — useful for setting pacing targets on Bonette, Galibier, or Iseran before you reach them.
...
This is where the Haute Route is won and lost. Single-day fuelling is simple: top up glycogen, eat 80g carbs/hour, drink to thirst, recover whenever. Multi-day fuelling is a different problem because the deficit compounds.
...
For the full breakdown on race-day fuelling, the [race-day nutrition guide](/blog/cycling-nutrition-race-day-guide) covers the science underneath. For a deeper look at how multi-day fuelling actually plays out under fatigue, the Roadman Cycling Podcast episode on the [Badlands 800km strategy](/blog/badlands-800km-fuelling-strategy) walks through the same problem at an even longer time scale.
...
**Clothing.** Two complete kit setups so one is always laundered. Base layer plus jersey plus bib for hot valley starts. Light insulated jacket and arm warmers for high-pass descents — Bonette and Iseran summits can be 4-6°C even in late August, and the descents to the next valley are 30-40 minutes of exposed downhill on tired legs where the [wind chill](/tools/wind-chill) drops the feels-like temperature well below freezing. Long-finger gloves for the cold mornings. Sunscreen at every feed — UV at altitude is 2x sea-level intensity and burns through normal SPF in 90 minutes.
