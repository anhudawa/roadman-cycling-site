...
<div className="my-10 rounded-xl border border-coral/20 bg-coral/5 p-8 text-center">
  <p className="font-heading text-2xl text-off-white mb-2">COHORT 2 IS OPEN</p>
  ...
  <p className="text-foreground-subtle text-xs mt-3">Applications close Friday 17th, midnight.</p>
</div>
