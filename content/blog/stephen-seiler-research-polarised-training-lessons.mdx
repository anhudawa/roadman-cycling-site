...
Inside the <a href="https://www.skool.com/roadmancycling/about">Roadman Cycling community on Skool</a> we host a free library of plan templates — base plans, build plans, VO2 max blocks, FTP builder plans, plus dedicated sportive, road race and gravel templates. Every one is built around the 80/20 distribution Seiler's research points to. Grab a base plan for the aerobic block, layer a VO2 max block on top for the HIT dose, and you've got the polarised structure the Norwegian lab has been pointing at for twenty years. Free to join.

If any of this sounds familiar, it's because it's exactly what we build the <a href="/community/not-done-yet">Not Done Yet</a> curriculum on. Reverse periodisation. Heavy low-intensity base. Small, precise doses of real HIT. No time wasted in the threshold rut. It's not because I invented it. It's because Seiler, Fiskerstrand, Tønnessen, Haugen and about twenty years of Norwegian Olympic data all point in the same direction — and I'd rather build on that than on the latest hot take.

If you want that applied to your training — your power numbers, your events, your calendar, your life — <a href="/apply">apply for Not Done Yet coaching</a>. Seven-day free trial. We'll build the plan the pros' distribution would if you had a lab in Norway in your back pocket.
