...
answerCapsule: >-
  Seven warning signs: resting heart rate 5+ beats above baseline for three or
  more days, persistent insomnia, declining power over 2-3 weeks despite
  sustained effort, mood changes, lingering muscle soreness beyond 48 hours,
  lost motivation, and increased illness frequency. One sign is a data point,
  two are a warning, three or more mean reduce load immediately. Functional
  overreaching resolves in 1-2 weeks; true overtraining syndrome can take 3-6
  months.
keyTakeaways:
  - "Resting heart rate 5+ beats above baseline for three or more consecutive days is a reliable signal that systemic stress is outpacing recovery."
  - "Overreaching often causes insomnia rather than deep sleep — elevated cortisol from chronic training stress disrupts sleep architecture."
  - "Declining power output over 2-3 weeks despite sustained or increased effort means fatigue is winning; a proper 40-60% volume reduction week is the fix."
  - "Training stress and life stress draw from the same recovery budget — a brutal work week plus a hard training block is a bigger load than either alone."
  - "One warning sign in isolation is a data point; two concurrent signs are a warning; three or more are a clear instruction to reduce load immediately."
  - "Functional overreaching resolves in 1-2 weeks with reduced training; true overtraining syndrome can require 3-6 months to recover from."
relatedPosts:
...
whoFor:
  - "Dedicated riders pushing through fatigue for weeks without realising their power curve has been declining — not improving"
  - "Masters cyclists juggling heavy training blocks with demanding jobs and family life who suspect their total stress load has tipped over"
  - "Comeback athletes rebuilding fitness aggressively after time off and unsure where the line sits between productive overreaching and genuine overtraining"
  - "Riders who have been ill, flat, or unmotivated for longer than a recovery week can explain and want to know whether to train through it or back off"
roadmanView:
  - "I have seen this pattern hundreds of times — the most dedicated riders are the ones most likely to confuse suffering with progress, and they are not the same thing."
  - "One warning sign is a data point; two are a caution; three or more are a clear instruction to reduce load immediately."
  - "Functional overreaching resolves in a week or two with rest. True overtraining syndrome can take months. Catch it early and you save yourself a lost season."
---
...
This is different from the occasional bad night. It's a pattern: three or more consecutive nights of disrupted sleep that coincides with high training load. The relationship between sleep loss and declining performance runs deeper than most riders realise — the [sleep and cycling performance complete guide](/blog/sleep-cycling-performance-complete-guide) covers the hormonal and adaptation costs in detail.
...
**What to do:** Take a full recovery week. Not a modified one — a proper 40-60% volume reduction. The [training load calculator](/tools/training-load) will help you quantify what a 50% reduction actually looks like against your recent weeks. If power rebounds after recovery, the training load was the issue and you need more frequent or longer recovery periods. If power doesn't rebound, the problem may be deeper — nutrition, illness, or chronic stress outside of training.
...
One sign in isolation is a data point. Two concurrent signs are a warning. Three or more concurrent signs are a clear instruction to reduce load before the body forces the issue through illness or injury. The [masters recovery score](/tools/masters-recovery-score) pulls several of these signals into a single readiness check, and the [recovery screen](/tools/recovery-screen) walks you through the full cluster in a structured format so you do not have to guess which combination you are sitting in.
