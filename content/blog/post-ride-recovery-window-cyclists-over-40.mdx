...
whoFor:
  - "Masters cyclists over 40 who notice recovery taking longer than it used to and want evidence-based protocols"
  - "Riders unsure whether the 30-minute anabolic window still matters or has been debunked"
  - "Time-crunched athletes who need to optimise the recovery window because they cannot afford extra rest days"
  - "Cyclists returning to structured training after a break who want to get post-ride nutrition right from the start"
roadmanView:
  - "Let me be really clear on this: the 30-minute window was always overstated, but the first two hours still matter — especially over 40. I've spoken to enough sports nutritionists on the podcast to know that glycogen resynthesis and protein synthesis both run slower than they did at 25, and that gap only widens as the years add up."
  - "A chocolate milk and a banana within an hour of finishing isn't fancy sports science. I recommend it because it's a convenient 3:1 carb-to-protein ratio that you'll actually consume, and here's the thing — that matters more than the perfect shake you leave sitting in the fridge."
  - "I say this constantly on the show: recovery is where masters cycling is won or lost. You cannot out-train a recovery deficit. The riders in the NDY community who take this seriously are the ones still improving in their fifties, and the ones who don't are wondering why the legs never come round."
---
...
After the first window, the next stage is making sure the rest of the day's [nutrition](/topics/cycling-nutrition) supports continued recovery. This is the bit most cyclists don't think about.
...
The principle is [regular protein doses across the day](/blog/cycling-protein-timing-guide) (every 3–4 hours), enough total carbs to fully restore glycogen, and enough fluid and salt to undo the day's sweat losses.

For a long ride day, total daily intake might be 4–5g carbs per kg body weight and 1.6–2g protein per kg body weight. For an 80kg cyclist that's around 320–400g carbs and 130–160g protein — the [calorie calculator](/tools/calories) will estimate the ride's energy cost so you can see how much of that total the ride itself accounts for. Most masters cyclists are eating well below those numbers and wonder why recovery feels grudging.
...
None of these are dramatic on their own. They compound. The masters cyclist who fuels carelessly across a week ends up two or three sessions in deficit by Saturday. The cyclist who doesn't ends up with their full quota of training adaptation. If you are not sure which camp you fall into, the [masters recovery score](/tools/masters-recovery-score) gives you a quick read on whether you are actually recovered or just hoping you are.
...
For the broader recovery picture, [cycling recovery tips](/blog/cycling-recovery-tips) covers the full set of recovery levers. The [cycling sleep optimisation](/blog/cycling-sleep-performance-guide) post sits next to this one. And the [bedtime protein protocol](/blog/bedtime-protein-cyclists-recovery-protocol) is the overnight companion to the post-ride window.
