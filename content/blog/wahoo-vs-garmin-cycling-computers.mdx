...
The Edge 1050 ships with full colour topographic maps, Trendline popularity routing (which biases routes onto roads other cyclists actually use), turn-by-turn directions with chime and vibration, and fast off-route rerouting. You can search a cafÃ© by name, drop a pin, and route to it in under 30 seconds. Points-of-interest depth is genuinely useful $€” water stops, bike shops, train stations.
