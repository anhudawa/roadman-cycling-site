...
keywords:
  ...
  - zwift polarised training
  - wahoo systm vs zwift
...
Here's the thing nobody tells you about Zwift: the platform that rescued indoor training from being the most miserable hour of your week might also be the reason your FTP hasn't moved since last winter.
...
Let me break this down, because this isn't a case against Zwift. It's a case for using Zwift deliberately, the way you'd use any training tool — with a purpose and a plan.
