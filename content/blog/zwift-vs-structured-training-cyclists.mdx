...
keyTakeaways:
  - "Three Zwift races per week pushes intensity distribution to 40-75% hard — more than double the 20% ceiling Seiler's research supports for long-term aerobic development."
  - "Free-riding on Zwift is almost never genuine zone 2: segment timers, draft mechanics, and other riders trigger constant grey-zone surges that burn matches without buying adaptation."
  - "The hybrid approach works: one Zwift race per week as a hard session, structured intervals on ERG mode or a dedicated platform, and group endurance rides for zone 2 accountability."
  - "A rider following a structured plan for 20 weeks does fewer total hard efforts than the nightly Zwift racer but gets more adaptation because the work progresses, varies, and includes recovery."
  - "The platform is a tool, not a training plan — Zwift's incentives (engagement, leaderboards, dopamine) point in the opposite direction from your training plan's incentives (periodisation, recovery, progression)."
answerCapsule: >-
...
whoFor:
  - Riders racing on Zwift three or four nights a week whose outdoor FTP has not moved in months
  - Cyclists who love Zwift for motivation but suspect it is wrecking their training structure
  - Self-coached athletes trying to fit Zwift into a periodised plan without overloading intensity
  - Anyone debating whether to keep Zwift, switch to a structured platform, or run both
roadmanView:
  - "I think Zwift saved indoor training from being the most miserable hour of your week. But it also created a generation of riders who race four nights a week and wonder why their outdoor numbers have not moved. I see this pattern constantly in NDY applications — the platform is a tool, not a training plan."
  - "I have discussed this with Seiler on the podcast: three Zwift races per week pushes your intensity distribution to 40 to 75 per cent hard, more than double the 20 per cent ceiling his research supports. I recommend one race per week as a hard session, structured intervals on ERG mode, and group endurance rides for zone 2 accountability."
  - "I always tell riders to recognise that Zwift's incentives and their training plan's incentives point in opposite directions. Zwift wants engagement, leaderboards and dopamine. Your plan wants periodisation, recovery and progression. Recognise the tension and manage it."
faq:
