...
The skinny-tyre myth — the idea that narrower tyres are always faster because they have less contact area — ignores tyre construction, pressure, rim shape, aerodynamics and surface. Wider tyres can reduce vibration and work well at lower pressures, but no one width-pressure pair wins on every road. The [tyre pressure guide](/blog/cycling-tyre-pressure-guide) covers the evidence and safety boundaries, and the [tyre pressure calculator](/tools/tyre-pressure) gives you a reproducible starting point for your weight and setup.
