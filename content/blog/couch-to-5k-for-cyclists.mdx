...
whoFor:
  - "The cyclist with a huge engine who tried running and got injured within three weeks"
  - "The time-crunched rider who wants a second sport for travel days and dark winters"
  - "The masters cyclist looking for bone density work that the bike cannot provide"
  - "The bucket-list athlete with a duathlon or triathlon on the horizon and no running base"
roadmanView:
  - "I have seen this go wrong so many times. A cyclist with a 280-watt FTP goes for a run, feels fine for 3K, then spends six weeks in the physio's chair. The engine writes cheques the chassis cannot cash."
  - "Standard C25K is too easy for your heart and exactly right for your tendons. Do not skip the early weeks — your connective tissue does not care about your FTP."
  - "The 8-week plan here respects what you already have and protects what you do not. Cap every run at RPE 4, leave 48 hours between sessions, and do the calf raises."
---
