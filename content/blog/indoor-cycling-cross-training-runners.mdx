...
whoFor:
  - Runners adding cycling as cross-training without the logistics of outdoor riding
  - Marathon runners who need aerobic volume without extra impact
  - Injury-prone runners looking for a zero-impact conditioning tool
  - Triathletes managing run mileage while building bike fitness
roadmanView:
  - "I've said this on the podcast more than once — the turbo is the best cross-training tool a runner can own. No junctions, no coasting, no wasted minutes, just continuous aerobic work that protects your legs."
  - "I've watched so many runners try outdoor cycling, hate the dead time and the skill gap, and quit within a month. Indoor removes every one of those barriers, and I think it's the version most runners should start with."
  - "If you're running five or six days a week and wondering where the bike fits, I wrote this to answer that question honestly — without pretending you need to become a cyclist."
---
...
The short version: the hardware matters far less than the execution. A $200 used trainer ridden easy four times a week beats a $2,500 smart bike used as a clothes rack.
...
**ERG mode is your friend.** In a structured workout, a smart trainer in ERG mode holds your target power automatically — the resistance adjusts so that whatever cadence you pedal, you produce the prescribed watts. For an easy session this is close to perfect: set 60% of your threshold power (the [run-ride converter](/tools/run-ride-converter) can translate your running paces into cycling targets), watch a show on the second screen, and the trainer guarantees you never drift into the grey zone where easy rides go to die.
...
So the sensible split for a runner: ride outside when you want to, ride inside when it's about the training. You'll capture a solid 80% of cycling's cross-training benefit without ever leaving the house — and the 20% you give up is mostly scenery.
