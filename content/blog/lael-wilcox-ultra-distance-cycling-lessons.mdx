...
roadmanView:
  - "Lael's approach has almost nothing to do with watts and everything to do with problem-solving under fatigue. After 37 ultra races, the training plan is not the thing that gets you to the finish. The ability to keep making good decisions when your brain is running on four hours of sleep is the thing."
  - "The route reconnaissance point stuck with me. She pre-rode half the Badlands course before racing it. That is not obsessive. That is practical. Knowing where the water is, where the terrain changes, and where you can safely stop for a nap is worth more than any interval session."
  - "Her nutrition under extreme stress simplified to ice cream and electrolyte drinks. That sounds like a joke but it is deadly serious. When appetite regulation fails after seventy-two hours, you eat whatever stays down. Palatability beats optimisation every time."
---
