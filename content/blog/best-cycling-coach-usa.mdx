...
seoDescription: >-
  How US riders should choose a cycling coach: USAC credentials, communication,
  discipline fit, pricing, questions to ask, and red flags to avoid.
excerpt: >-
...
answerCapsule: >-
  ...
  communication.
keyTakeaways:
  - "USA Cycling Expert or Elite certifications carry real weight — USAC Level 1 alone is entry-level."
  - "The US market is too varied for one coaching answer; your discipline (road, gravel, MTB, triathlon) narrows the field fast."
  - "Gravel is now the dominant amateur A-race: Unbound 200, SBT GRVL, BWR, Mid South, and Leadville demand durability-specific coaching."
  - "Altitude and heat acclimation protocols are essential for Colorado, Utah, and Rocky Mountain events — if your coach does not mention them, that is a problem."
  - "Time-zone overlap matters more than your coach's home state; Ireland-based coaching works well with East Coast and Central riders."
faq:
  ...
  - question: How much does a cycling coach cost in the USA?
    answer: >-
      ...
      coaching in the US commonly costs $200–$500. Roadman's Not Done Yet group
      coaching is $195/month; Roadman Inner Circle 1:1 coaching is $525/month.
relatedEpisodes:
...
whoFor:
  - "Riders in the US shopping for a cycling coach who are overwhelmed by ranked lists and want a clear framework for evaluating candidates"
  - "Gravel racers targeting Unbound, SBT GRVL, or Leadville who need coaching that understands durability-specific event demands, not just road racing"
  - "US-based cyclists wondering whether working with an overseas coach is viable or whether they need someone in their time zone"
  - "Self-coached riders whose FTP has stalled and who want to know what separates real coaching from plan delivery at a $150/month price point"
roadmanView:
  - "Let me be clear: USAC Level 1 is entry-level. It's a weekend course. I'd look for Expert or Elite certification, and then I'd check the results attached to real names, not anonymous testimonials."
  - "The US gravel calendar has changed the coaching conversation entirely. Unbound 200 and Leadville demand durability coaching — pacing over 10+ hours, in-ride fuelling at 80-120g/h, heat and altitude protocols. I've talked to coaches on the podcast who still don't account for this."
  - "I coach US riders from Ireland and the time-zone overlap matters more than geography. East Coast and Central work well because the call windows align. West Coast needs flexibility, but it's workable."
---
...
If you are ready to hire rather than compare, see the [Roadman cycling coach service for US riders](/coaching/usa). This guide owns the US selection question; that page owns the coaching service.
...
**In-race nutrition.** Unbound 200 is an 11-hour-plus day for most amateurs. Nutrition plans have to be rehearsed in training, not guessed at the start line — the [Roadman fuelling planner](/tools/fuelling) is a good starting point for hourly carb targets.
...
More on why [a local cycling coach isn't what most riders actually need](/blog/cycling-coach-near-me-why-location-doesnt-matter-2026).

## Where Roadman Cycling fits

[Roadman coaching](/coaching/usa) runs Not Done Yet at $195/month: a personalised TrainingPeaks plan reviewed weekly by the Roadman coaching team, live group coaching led by Anthony Walsh, and periodisation built around your actual events — including altitude or heat preparation where it applies. Most of our US clients are East Coast or Midwest riders targeting gravel A-races (Unbound, SBT GRVL, BWR), gran fondos, Ironman bike legs, or USAC category progression. Riders who want direct, high-touch 1:1 access can apply for the [$525/month Roadman Inner Circle](/inner-circle). If Not Done Yet sounds like your fit, the [application process](/apply) is where we talk.
