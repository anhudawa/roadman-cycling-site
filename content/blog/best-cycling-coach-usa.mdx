...
roadmanView:
  - "USAC Level 1 is entry-level — it's the difference between a weekend course and years of applied coaching. Look for Expert or Elite certification, and then check the results attached to real names, not testimonials."
  - "The US gravel calendar has changed the coaching conversation. Unbound 200 and Leadville demand durability coaching — pacing over 10+ hours, in-ride fuelling at 80-120g/h, heat and altitude protocols — that traditional road coaching rarely covers."
  - "Time-zone overlap matters more than geography. Roadman coaches in Ireland work well with East Coast and Central riders because the call windows align. West Coast needs flexibility, but it's workable."
---
