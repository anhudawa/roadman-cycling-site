...
roadmanView:
  - "Ballinastoe put Irish MTB on the map. Fifteen kilometres of tight, rooty singletrack, fifty minutes from Dublin, and the trail building matches UK standards. Start there if you haven't already."
  - "Ballyhoura on the Limerick-Cork border has 98 kilometres of marked trail — the most of any centre in Ireland by a significant margin. If you want volume and variety in one location, nothing else comes close."
  - "The trail network in Ireland has matched UK quality in the last decade. Most centres are free to ride and maintained by Coillte or Forest Service NI. The riding is here — it just doesn't get the press it deserves."
---
