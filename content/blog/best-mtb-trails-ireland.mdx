...
answerCapsule: >-
  Ireland's got 15 legitimately world-class trails worth the drive, with
  Ballinastoe the standout — tight rooty singletrack that put Irish riding on
  the map. Start in Wicklow if you're near Dublin, push west to Kerry for the
