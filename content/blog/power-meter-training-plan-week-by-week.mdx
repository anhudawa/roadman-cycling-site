...
answerCapsule: >-
  ...
  effort to set session targets. The process is four steps: establish FTP with
  a 20-minute or ramp test, set seven training zones from that FTP, follow an
  8-week progression that builds volume before intensity, and monitor weekly
  TSS between 300 and 600 depending on training age. Done correctly, power
  training removes guesswork from pacing, intervals, and recovery decisions
...
faq:
  - question: "How long does it take to see results from power meter training?"
    answer: >-
      ...
      riding. The first gains come from better pacing and executing intervals
      at the right intensity rather than physiological change. Genuine
      adaptation — mitochondrial density, lactate clearance — takes 6-8 weeks
      of consistent work before it shows up in test numbers.
  - question: "Do I need to do an FTP test every month?"
    answer: >-
      No. Testing every 6-8 weeks is enough for most riders. Testing too often
      wastes a hard session and the number barely moves week to week anyway.
      Use field indicators instead — how a 2x20 at threshold feels, whether
      Zone 2 power at the same heart rate is climbing. Formal retesting
      confirms what training data already suggests.
  - question: "What's the difference between TSS and training load?"
    answer: >-
      ...
      is the rolling average of TSS over time, usually 7 or 42 days. TSS is
      the input; training load is what your body actually adapts to. Managing
      weekly TSS prevents the spikes that cause injury and burnout.
  - question: "Can I use a power meter training plan without a coach?"
    answer: >-
      ...
      improve most self-coached riders. The limit comes when progress stalls
      and you need someone to interpret why — fatigue masking fitness, zones
      drifting, life stress distorting data. That's usually the 6-9 month
      mark, when the decisions get harder than the sessions.
  - question: "Should I train by power or heart rate?"
    answer: >-
      ...
      fatigue, heat stress, and fitness changes that either metric alone
      hides. A rising heart rate at the same power across a block signals
      accumulated fatigue. Falling heart rate at the same power signals
      fitness gains.
---
