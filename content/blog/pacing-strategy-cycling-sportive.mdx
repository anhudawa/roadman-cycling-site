...
whoFor:
  - "First-time sportive or gran fondo participants who have no pacing reference and need concrete power targets"
  - "Riders who have blown up in the final third of a sportive because they went out too hard in the opening kilometres"
  - "Power-meter users who want specific intensity factor and normalised power targets rather than ride-by-feel advice"
  - "Cyclists targeting a century ride of 160km or more who need to budget energy across 5-7 hours of riding"
roadmanView:
  - "I've watched more sportive riders blow up at the 70km mark than I can count. The intensity factor targets I use — 0.75-0.80 for 100km, 0.65-0.72 for 160km — come from pacing data across my NDY athletes and match what coaches like Andrew Coggan have laid out in their research."
  - "Here's something I bang on about constantly: pacing and nutrition are the same strategy, not two separate ones. Start fuelling from the first 20 minutes with 60-90g of carbs per hour, or the best power plan in the world falls apart after hour three."
  - "I built our Race Day Checklist and Race Time Predictor tools specifically so you can walk through both the pacing numbers and the logistics ahead of time. Nothing should be left to race-morning improvisation."
---
...
If this is your first event, the damage tends to be worse because you have no reference point for what sustainable feels like over four or five hours — the [first gran fondo guide](/blog/first-gran-fondo-what-nobody-tells-you-guide) walks through the reality checks that experienced riders take for granted.
...
Dan Lorang, Head of Performance at Red Bull–Bora–Hansgrohe, applies this same logic at the highest level. Watch any Grand Tour mountain stage where the team rides conservatively on the early climbs, then attacks when everyone else has spent their matches. The amateur version is not attacking on the final climb — it is simply still having legs when everyone else is cooked.
...
If you have a power meter and you know your FTP, you have everything you need. If you do not know your FTP, [run an FTP test](/tools/ftp-test) before your event. Pacing by feel is guessing. Pacing by heart rate is delayed and unreliable. Pacing by power is precise.

For a 100km sportive lasting 3 to 4 hours, target an intensity factor of 0.75 to 0.80. If your FTP is 250 watts, your normalised power should be 188 to 200 watts — the [Power-Speed Calculator](/tools/power-speed) can show you what that power translates to in km/h on a given gradient. That is your ceiling, not your floor.
