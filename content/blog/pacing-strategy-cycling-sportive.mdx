...
roadmanView:
  - "The intensity factor targets here — 0.75-0.80 for 100km, 0.65-0.72 for 160km — come from pacing data across NDY coaching athletes and match the ranges discussed with coaches on the Roadman Podcast."
  - "Pacing and nutrition are the same strategy, not two separate ones. Start fuelling from the first 20 minutes with 60-90g of carbs per hour, or the best power plan in the world falls apart after hour three."
  - "Our Race Day Checklist tool and Race Time Predictor walk you through both the pacing numbers and the logistics so nothing gets left to race-morning improvisation."
---
