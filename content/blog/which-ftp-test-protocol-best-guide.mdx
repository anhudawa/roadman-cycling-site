...
relatedEpisodes: []
whoFor:
  - "Cyclists whose training zones feel wrong but who cannot pinpoint whether the FTP test or the protocol is the problem"
  - "Time triallists and diesel-type riders who suspect the standard 95 per cent factor overestimates their FTP"
  - "Riders with strong anaerobic capacity who get inflated ramp test results and then cannot complete threshold intervals"
  - "Anyone who wants to cross-validate their tested FTP against real ride data rather than trusting a single number"
roadmanView:
  - "I remind riders constantly that every FTP test uses a population-average conversion, and you are probably not average. The 95 per cent factor on a 20-minute test suits most riders, but I have seen it land 2 to 5 per cent off for individuals. If your zones feel wrong, they probably are."
  - "I think the best FTP validation tool any rider has is a hard 45 to 70-minute effort they did not plan as a test — a road race, a hard group ride, a time trial. If the normalised power from that exceeds your tested FTP, the test was too conservative."
  - "I tell NDY athletes that the right FTP is the one that makes your training zones work. If you can complete your prescribed intervals at the right RPE, the number is close enough. If sweet spot feels like threshold, drop it 3 to 5 per cent and watch the training quality improve."
---
