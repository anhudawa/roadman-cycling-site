...
seoTitle: Triathlon Off-Season Cycling — Build Real Bike Fitness in Winter (2026)
seoDescription: >-
  How to use the triathlon off-season to build real cycling fitness. Pure
  cycling base, riding with roadies, winter strength, dropping bricks and the
...
Ronnestad's research consistently shows that heavy strength training raises cycling economy and time-to-exhaustion in trained cyclists. Our [cycling gym exercises guide](/blog/cycling-gym-exercises-best) covers the full set and programming. Winter is when the volume of this work is highest. By March, you drop to one maintenance session a week for the rest of the season.
