...
seoTitle: Triathlon Off-Season Cycling
seoDescription: >-
  How to use the triathlon off-season to build real cycling fitness $€” the
  structured block that adds watts to the bike leg without wrecking your run
  base.
excerpt: >-
...
[RÃ¸nnestad's research](https://pubmed.ncbi.nlm.nih.gov/24862305/) consistently shows that heavy strength training raises cycling economy and late-ride performance in trained cyclists. Our [cycling gym exercises guide](/blog/cycling-gym-exercises-best) covers the full set and programming. Winter is when the volume of this work is highest. By March, you drop to one maintenance session a week for the rest of the season.
