...
seoDescription: "Cycling knee pain, front to back — where it hurts tells you why. The cyclist-specific causes, the IT band myth, and when to see a fitter or physio."
excerpt: >-
...
keyTakeaways:
  - "Knee pain in cyclists is almost always mechanical — bike fit, training load, or both — and the location of pain points directly at the cause."
  - "Anterior (front) pain is the most common type, typically caused by a saddle too low or cleats too far forward compressing the kneecap."
  - "You cannot stretch or foam roll the IT band loose — it is dense connective tissue anchored to the bone; outer-knee pain is fixed by building hip-abductor strength."
  - "Cyclists develop a specific muscle imbalance: massive quads with weak glutes, weak hip abductors, and a lazy VMO — off-the-bike strength work is the missing piece."
  - "Tendons adapt slower than muscles, so ramping weekly volume more than 10% or adding new stress types without an 8-week build invites overuse pain."
  - "Cycling is one of the best activities for an arthritic or worn knee — spin higher cadence in lower gears and avoid grinding big gears on climbs."
faq:
...
whoFor:
  - "Riders with persistent knee pain who have been told to just rest and hope it goes away"
  - "Cyclists wondering whether their knee problem is a bike fit issue or something structural"
  - "Anyone who has avoided getting a professional bike fit and is now paying for it"
  - "Comeback riders whose knees started hurting after ramping up volume too quickly"
roadmanView:
  - "My own knee pain turned out to be a saddle 8mm too low. Eight millimetres. I wasted months blaming age when the fix took ten minutes."
  - "Where it hurts tells you why it hurts. That's the principle Dr Pruitt built his career on, and it's the first thing I'd check before you touch anything on the bike."
  - "You cannot foam roll the IT band loose. I know everyone says you can. The research says you can't. Strengthen the hips instead."
---
...
What changes is how you ride. Spin a higher cadence in lower gears so you're turning the pedals briskly rather than forcing big gears — the [gear ratio calculator](/tools/gear-ratio) shows you what combinations give you the range to keep the legs spinning at 85-95 rpm without grinding. A 53×11 up every climb puts the kind of compressive load a worn joint doesn't need. Keep your range of motion with gentle mobility work, and keep the quads and glutes strong, because muscle is what protects the joint underneath. Pay attention to the difference between the normal stiffness of an older knee and a joint that's hot, swollen, or sharp — the first you ride through gently, the second you back off and let settle. The supplements aisle promises a lot here; the sober read of the evidence on glucosamine and the rest is that it's weak, so don't pin your hopes on a pill over the basics of load, strength, and motion.
...
**Related reading:** [Is Cycling Bad for Your Back? Causes and Real Fixes](/blog/is-cycling-bad-for-your-back)
