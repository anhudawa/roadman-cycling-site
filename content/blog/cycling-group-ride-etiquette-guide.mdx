...
seoDescription: >-
  Cycling group ride etiquette, the unwritten rules — hand signals,
  through-and-off, half-wheeling, and how not to be that person on the club run.
excerpt: >-
  Every group ride has unwritten rules. Break them and you'll get dropped
  socially long before you get dropped on the road. How to ride safely and earn
  respect in the bunch.
pillar: community
...
keyTakeaways:
  - "Hold a straight, consistent line — at 35kph with 30cm between wheels, a small swerve can bring down the group."
  - "Half-wheeling unconsciously drags the whole group's pace up and marks you as someone who doesn't understand bunch riding."
  - "Never overlap wheels with the rider ahead — a front wheel touch at speed is the most common cause of group crashes and it's unrecoverable."
  - "Through-and-off pulls should be 30-60 seconds on training rides; don't surge when you hit the front or you'll gap the rider who just pulled off."
  - "If your legs aren't there, say so and sit in — honesty is always respected more than pretending."
faq:
...
whoFor:
  - "Newer riders joining their first club run who do not want to be the person everyone talks about afterwards for the wrong reasons"
  - "Comeback cyclists returning to group riding after years away who want a refresher on bunch etiquette and signals"
  - "Solo riders looking to join a group for the social and training benefits but unsure how through-and-off rotations actually work"
  - "Experienced group riders who want a clear reference to share with newer members before a club ride"
roadmanView:
  - "I have ridden in groups where 20 riders moved like a single organism, and in groups where one person nearly put six riders on the ground because they swerved without warning — the difference is etiquette."
  - "The cardinal sin is not being slow — it is being unpredictable, and every sudden movement forces the rider behind you to react with no margin."
  - "If your legs are not there, say so and sit in — honesty is always respected more than pretending, and the group will look after you."
---
...
Save the racing for races. The club run is for building fitness, social connection, and enjoying the ride together. If the group ride is your hard day, that's fine — but make sure you have [enough easy days](/blog/zone-2-cycling-heart-rate-vs-power-vs-rpe) to balance it. There's usually an agreed sprint point or a hill where it's acceptable to open it up. Wait for that.
...
- For a more structured route in, [NDY coaching at Roadman](/coaching) writes a plan around your week and connects you with the rest of the community. [The application](/apply) is where the conversation starts.
- Got a specific question — what to do when the group rides too hard, how to handle a chaingang as a beginner? [Ask Roadman](/ask) for an answer drawn from the wider Roadman archive
