...
roadmanView:
  - "When Dr Andrew Sellars described the French study on the podcast — 6 per cent FTP improvement from respiratory muscle training over 48 weeks — half the community wanted to buy a device and the other half said it was too good to be true. The truth is somewhere between."
  - "This is real science with a solid evidence base. But not every cyclist benefits equally, not every device is the same, and the protocol matters. Thirty breaths, twice a day, for 6-12 weeks. That's what the research used."
  - "The cost is 6-10 minutes a day and under 30 quid for the device. For a 2-5 per cent time-trial improvement in the right rider, that's about the best return on investment in cycling."
---
