...
answerCapsule: >-
  Inspiratory muscle training strengthens the diaphragm and intercostals,
  delaying the respiratory metaboreflex that diverts blood from legs to
  breathing muscles during hard efforts. A meta-analysis of 21 studies found a
  3.5 per cent time-trial improvement in trained cyclists. The protocol is 30
  breaths at 50-70 per cent of maximal inspiratory pressure, twice daily, for
  6-12 weeks. Pressure-threshold devices like POWERbreathe have the strongest
  cycling-specific evidence base.
keyTakeaways:
