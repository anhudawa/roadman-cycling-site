...
answerCapsule: >-
  Most people have some leg length difference, but cycling problems typically
  begin at 6-10mm. Distinguish true (structural bone length) from functional
  (muscle tightness, pelvic obliquity) discrepancy — shimming a functional
  problem makes things worse. For confirmed true discrepancy of 3-9mm, cleat
  shims on the shorter leg are the standard correction. Start at half the
  measured difference and reassess after 2-4 weeks of riding before increasing
  to full correction.
keyTakeaways:
