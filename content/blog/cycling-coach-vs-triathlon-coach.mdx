...
roadmanView:
  - "The bike-run interaction is where most age-groupers lose their race, and it is exactly where the coaching decision matters most. A cycling coach who does not understand run fatigue will overbuild the bike at the cost of your marathon split."
  - "If you hire both coaches, one of them needs to hold final authority over weekly load. Two coaches making independent calls is the fastest route to injury or burnout."
  - "For most age-groupers, a triathlon coach with a genuine bike specialism is the right call. Hire a cycling coach only when the bike alone is the goal."
---
