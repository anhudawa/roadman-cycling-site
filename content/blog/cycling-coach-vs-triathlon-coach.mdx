...
seoTitle: 'Cycling Coach vs Triathlon Coach: Which Do You Need?'
seoDescription: >-
  When to hire a cycling coach vs a triathlon coach — and when to use both. A
  framework for age-group triathletes deciding where their coaching spend lands.
excerpt: >-
  Triathlon coach, cycling coach, or both? Here's the framework for deciding,
  based on where your time is leaking in race-day splits.
pillar: coaching
...
answerCapsule: >-
  A triathlon coach periodises all three disciplines and manages total training
  load so the run survives the bike. A cycling coach builds bike-specific power,
  durability, and aerodynamics without accounting for swim or run fatigue.
  Age-group triathletes whose bike split is the primary limiter, or whose
  overall performance has plateaued across all three, benefit most from a
  triathlon coach with a bike specialism. Hiring both coaches works only when
  they communicate directly and one holds final authority over weekly load.
keyTakeaways:
  - "A triathlon coach periodises three disciplines and manages total load so the run survives the bike. A cycling coach builds bike-specific power without accounting for swim or run fatigue."
  - "Hire a triathlon coach when the bike split is the limiter or when overall performance has plateaued across all three disciplines. Hire a cycling coach when the bike alone is the goal."
  - "Hiring both works only when they communicate directly and one holds final authority over weekly load. Two coaches making independent calls is the fastest route to injury."
faq:
  - question: Do I need a cycling coach if I already have a triathlon coach?
    answer: >-
      Usually not. A competent triathlon coach with bike expertise covers what a
      cycling coach would prescribe, and critically manages how bike load
      interacts with swim and run fatigue. Adding a separate cycling coach
      creates conflicting sessions unless both coaches talk weekly. The
      exception is a triathlon coach who openly admits the bike is their weakest
      discipline — then a specialist helps.
  - question: Can a pure cycling coach handle a triathlete?
    answer: >-
      Only if they understand that bike sessions must protect the run. Most
      cycling coaches prescribe sessions assuming recovery goes into more
      cycling. For a triathlete, a Tuesday VO2 session on the bike wrecks
      Wednesday's run quality. A cycling coach without triathlon experience
      often overbuilds the bike at the cost of race-day run splits.
  - question: What does a bike-specialist triathlon coach cost?
    answer: >-
      Quality 1:1 triathlon coaching with genuine bike specialism runs $150–$300
      per month. Roadman's Not Done Yet coaching community sits at $195/month
      and includes training, nutrition, strength, recovery, and accountability.
      Cheaper template-based coaching exists but rarely delivers the load
      management needed to protect the run off the bike.
  - question: I'm an age-grouper — is coaching worth it?
    answer: >-
      If you train 8+ hours per week and have raced at least one full season,
      yes. The return on coaching comes from load management and session
      quality, both of which scale with training volume. Under 6 hours per week,
      a structured plan and honest self-assessment usually delivers 80% of the
      benefit for a fraction of the cost.
  - question: How do I know if the bike is my weak discipline?
    answer: >-
      Compare your bike split percentile to your swim and run percentiles in the
      same race. If you finish 25th percentile on the bike but 40th on swim and
      run, the bike is your limiter. Also check power-to-weight with a [W/kg calculator](/tools/wkg): under 3.0 W/kg
      for 70.3, under 3.5 W/kg for full-distance, and the bike is the deciding factor.
relatedEpisodes:
...
whoFor:
  - "An age-group triathlete whose bike split is the weakest leg and who is wondering whether a cycling-specific coach would help"
  - "A triathlete already working with a tri coach but considering adding a separate bike coach"
  - "A cyclist moving into triathlon who is unsure whether their existing cycling coach can handle multi-sport planning"
  - "A time-crunched age-grouper trying to decide where to spend a single coaching budget across three disciplines"
roadmanView:
  - "I have had Joe Friel, Dan Lorang, and Stephen Seiler on the podcast, and the one thing they all agree on is that the bike-run interaction is where age-groupers lose their race. A cycling coach who does not understand run fatigue will overbuild the bike and wreck your marathon split."
  - "If you hire both coaches, one of them has to hold final authority over weekly load. I have seen the alternative up close — two coaches making independent calls is the fastest route to injury or burnout."
  - "I'll give you my honest view: for most age-groupers, a triathlon coach with a genuine bike specialism is the right call. Hire a cycling coach only when the bike alone is the goal."
---
...
That gap is why the bike-specialist triathlon coach exists — and why we built [triathlon bike coaching](/coaching/triathletes) as a specific offering rather than a generic three-sport service.

## What a cycling coach actually does

A cycling coach builds one thing: bike performance. Power at threshold, durability over four to six hours, repeatability of hard efforts, and increasingly, aerodynamic optimisation. [Dan Bigham](/guests/dan-bigham), former UCI Hour Record holder and now a performance engineer at Red Bull-Bora-Hansgrohe, has shown that position and equipment choices often deliver 15–30 watts of free speed at the same physiological cost — which most age-group triathletes leave on the table.

The training model is usually simpler than triathlon. Two to four key sessions per week, long endurance work on the weekend, and a periodisation that peaks for one or two events. [Prof. [Stephen Seiler](/guests/stephen-seiler)'s polarised model](https://pubmed.ncbi.nlm.nih.gov/20861519/) — roughly 80% of training below the first lactate threshold, 20% above the second — is the dominant framework, and it maps cleanly onto a single-sport schedule.
...
In this case, the bike isn't just a weakness — it's the decisive factor. Fixing it returns more minutes than any other intervention. [Dan Lorang](/guests/dan-lorang), who coached Jan Frodeno and Anne Haug to Ironman world titles, now coaches Lucy Charles-Barclay, and heads performance at Red Bull–Bora–Hansgrohe, has been explicit that for triathletes with a clear bike weakness, the bike has to become the organising discipline of the training week for 12–16 weeks at a time.
...
First, they ask for your power file history before they prescribe anything. Not just FTP — the full curve, durability data, and how power holds at hour three and four. If they start with an [FTP test](/tools/ftp-test) and nothing else, they're working from a template.

Second, they talk about position and aerodynamics, not just watts. A 15-watt aero saving at 40kph is worth more than a 15-watt FTP gain, and it doesn't cost training stress. [John Wakefield](/guests/john-wakefield), Red Bull-Bora-Hansgrohe's Director of Coaching & Sports Science, has been clear on the podcast that aero testing is now standard even at junior World Tour level. Age-group triathletes should treat it the same way.
...
Companion reads: [what does a cycling coach do](/blog/what-does-a-cycling-coach-do), [is a cycling coach worth it](/blog/is-a-cycling-coach-worth-it), [triathlon cycling training plan](/blog/triathlon-cycling-training-plan), and the [70.3 bike training plan](/blog/70-3-bike-training-plan-12-weeks).

If you want a coach who works with cyclists targeting [triathletes](/coaching/triathletes) specifically, that's the page to start with. Got a specific question — your own ratio of bike vs run focus, what to ask on a discovery call? [Ask Roadman](/ask) for an answer drawn from the actual coach conversations on the podcast.
