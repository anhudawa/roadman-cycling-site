...
roadmanView:
  - "Bottrill is the real deal. Multiple national TT titles, coached Campenaerts before the Hour Record, and everything he says is immediately usable. No theory for the sake of it."
  - "The session-intent point alone is worth the read. Most amateur riders start a session with no declared purpose and wonder why four hours on the bike produced nothing. Bottrill does not let that slide."
  - "If you are eating 30 grams of carbs an hour on a hard three-hour ride, you are running on half the fuel you need. That one change — 60 to 90 grams per hour — will transform how you finish sessions."
---
