...
answerCapsule: >-
  Seated climbing is more efficient below 8% gradient, using less oxygen per
  watt. Above 8-10%, standing becomes mechanically advantageous because body
  weight contributes to the downstroke, though it costs 5-10% more oxygen.
  Heavier riders benefit more from standing than lighter riders. Millet's
  research showed that alternating seated and standing every 1-2 minutes reduces
  perceived effort. The sit-to-stand transition is where most power is lost and
  should be practised specifically.
keyTakeaways:
