...
seoTitle: 'Raid Pyrénéen Training Plan: 20 Weeks, 720km Crossing'
seoDescription: 'A Raid Pyreneen training plan: a 20-week build for the 720km self-supported crossing — Tourmalet, Aubisque, Aspin, Peyresourde, plus multi-day pacing.'
excerpt: >-
...
keyTakeaways:
  - "A 20-week build is the working minimum; riders without prior multi-day experience should plan 28+ weeks."
  - "2.8 W/kg with disciplined pacing finishes in 5-7 days, but a rider with great recovery at 3 W/kg beats a rider with poor recovery at 4 W/kg."
  - "Back-to-back-to-back long climbing days (7-8h, 5-6h, 3-4h) repeated three times in the build are the specific stimulus — single long rides do not prepare a body for hour 50 of climbing."
  - "Pace at 60-65% FTP from minute one every day; riders who attack Aubisque on day 1 are the ones crawling up Peyresourde on day 4."
  - "Pre-book accommodation along the route and plan around French shop hours — logistics and recovery decide more than peak FTP."
  - "Fuel at 70-90g carbs per hour from the start of every day, and execute the post-stage recovery protocol (shake within 30 min, real meal within 90 min, 7-8 hours sleep) without exception."
faq:
...
whoFor:
  - Riders planning a Raid Pyreneen attempt who need a 20-week structured build
  - Amateurs with no multi-day riding experience who want to know what the preparation demands
  - Self-supported cyclists who understand that logistics and recovery decide more than FTP
  - Anyone weighing up whether 2.8 or 3.4 W/kg changes the Raid from survival to enjoyment
roadmanView:
  - "I think of the Raid as part pilgrimage, part ultra — 720km from the Atlantic to the Mediterranean across every col the Pyrenees can throw at you. Here's what I tell every rider who asks me about it: the person with the best logistics wins, not the person with the best FTP."
  - "I've spoken to enough Raid finishers on the podcast to know this is true: a rider with great recovery at 3 W/kg beats a rider with poor recovery at 4 W/kg over five to seven days. Pre-book your accommodation, plan around French shop hours, and treat the post-stage recovery protocol as non-negotiable."
  - "If you attack the Aubisque on day one because your legs feel good, you'll be crawling up the Peyresourde on day four. I cannot say this strongly enough — pace at 60-65 per cent FTP from minute one every single day. The Raid punishes ego like nothing else in cycling."
---
...
The climbs of the Raid are famous — Tourmalet, Aubisque, Aspin, Peyresourde — but the day-to-day reality is that almost nothing on the Pyrenean transect is flat. The route shape is climb-descend-climb for 720 kilometres. The fitness required for any single climb is not the limiting factor. The limiting factor is doing the same kind of climbing day, after day, after day, with the right sleep and the right fuelling and the right logistics.
...
**FTP in W/kg.** 2.8 W/kg with disciplined pacing finishes in 5-7 days. 3.0-3.4 W/kg lands you in the 3-5 day bracket. Above 3.4 W/kg with polished logistics targets sub-100 hours. Use the [W/kg calculator](/tools/wkg) to set the number, and run individual stages through the [Race Predictor](/tools/race-predictor) to estimate daily ride times — but understand that watts matter less here than at any single-day event.
...
For multi-day fuelling at scale, the [Badlands 800km strategy](/blog/badlands-800km-fuelling-strategy) on the Roadman Cycling Podcast walks through the same calorie-deficit problem at an even longer distance. The principles transfer.
...
**Clothing.** Two complete kit setups so one is always laundered. Base layer, jersey, bib for warm valley days. Light insulated jacket and arm warmers for high-pass descents — the [wind chill](/tools/wind-chill) on a 2,000m Pyrenean col descent can drop the feels-like temperature 15°C below the summit reading. Long-finger gloves. Sun sleeves for midday. A small fast-drying towel saves headaches at end-of-day hotels.
