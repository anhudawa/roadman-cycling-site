...
roadmanView:
  - "Dr Christian Schrot of Team Jayco explained it on the podcast: most amateurs are not training too easy. They are training in the mixed-metabolism zone — below threshold but above fat max. It looks like easy riding. It is not. And it is the reason most riders stall."
  - "Your FTP test gives you a power number but tells you nothing about where your metabolism actually shifts. That is why your Zone 2 might be set 20 watts too high — and why everything built on top of it drifts off target."
  - "The fix is not complicated. Ride properly easy on easy days. Go properly hard on hard days. If you have never had a metabolic test, use RPE and the talk test as your backstop — they are more reliable than zones built on a 20-minute test."
---
