...
answerCapsule: >-
  Fat adaptation increases fat oxidation but impairs carbohydrate oxidation
  above threshold. Burke's SUPERNOVA studies showed ketogenic athletes improved
  fat burning yet performed worse at race pace. Train-low strategies — riding
  specific sessions with depleted glycogen — are a targeted stimulus, not
  chronic restriction. The practical approach is to periodise carbohydrate:
  fuel hard sessions at 60-90g per hour, reduce intake around easy rides, and
  never restrict during events.
keyTakeaways:
...
roadmanView:
  - "I had Sam Impey on the podcast to talk about his research at Loughborough, and I've spoken to Barry Murray about metabolic flexibility. Both made the same point — the carb-is-king crowd and the keto crowd are each right in very specific circumstances and catastrophically wrong when they try to apply their answer to everything."
  - "The nuance matters here, and I think it's where most people get lost. Train-low is a targeted stimulus for specific easy sessions — it's not a licence to restrict carbs across the board. Those are completely different things."
  - "Periodise your carbohydrate. Fuel the hard days properly, ease off on the easy days, and never restrict during events. That's the practical takeaway from all the research, and it's what I do myself."
---

The cycling internet has split itself into two camps, and both of them are shouting.

Camp one says carbohydrate is king. Load up before the ride, smash gels every twenty minutes, hit 120 grams an hour, and if you [bonk](/blog/bonking-cycling-what-happens-how-to-prevent) it is because you did not eat enough. Camp two says go keto, become a fat-burning machine, run on your own body fat, and never bonk again. Between them, the average cyclist trying to fuel properly is left wondering if carbs are essential or poison.
...
The most practical framework for applying all of this comes from Sam Impey's research at Loughborough University. Impey's work centred on a concept called "[fuel for the work required](/blog/fuel-for-the-work-required-fftwr-explained)" — the idea that carbohydrate intake should be matched to the demands of each specific training session, not set at a fixed daily level.
...
Periodised nutrition — fuel for the work required — is the [cycling nutrition](/topics/cycling-nutrition) approach that squares the circle. It captures the aerobic benefits of occasional low-glycogen training without sacrificing the carbohydrate availability that powers race-pace efforts. It is flexible, sustainable, and supported by the work of researchers like Impey, Burke, and Jeukendrup.
