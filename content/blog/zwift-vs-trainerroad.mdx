...
There's a third way to slice this if your plan already lives in [TrainingPeaks Virtual](https://www.trainingpeaks.com/virtual/): less about TrainerRoad's adaptive library or Zwift's worlds, more about running the exact session your plan prescribed, already loaded in ERG when you clip in. If your coach writes the week in TrainingPeaks — as Roadman's Method plans do — Virtual just rides it, the 2x20 sitting there waiting instead of something you build by hand.
