...
keywords:
  ...
  - "ironman 70.3 pacing"
answerCapsule: >-
  A 12-week 70.3 bike training plan for age-group athletes runs in three phases: a four-week aerobic base at 65–75% FTP, a five-week sustainable-power block targeting 80–90% FTP with race-specific bricks, and a three-week taper into race day. Realistic bike-split gains range from 5 to 15 minutes depending on starting fitness, with race-day power held at 70–78% of FTP to protect the half-marathon run that follows.
faq:
  - question: "What power should I ride a 70.3 at?"
    answer: >-
      Most trained age-group athletes should target 70–78% of FTP (intensity factor 0.70–0.78) for a 90km 70.3 bike leg. Stronger runners with a high FTP can push 0.78–0.82. Going above 0.80 usually costs more on the run than it gains on the bike. Pace the first 20 minutes 5–10 watts below target to avoid the opening surge that wrecks the final 30km.
  - question: "How many hours per week do I need for a 70.3 bike plan?"
    answer: >-
      Expect 6–10 hours per week of bike training during the peak weeks of a 12-week 70.3 plan, spread across three to four rides. That sits inside a total weekly load of 10–14 hours once swim, run, and strength are added. Athletes training under 8 hours total per week should extend the plan to 16 weeks or accept a more conservative bike-split target.
  - question: "Can I improve my 70.3 bike split in 12 weeks?"
    answer: >-
      Yes. Twelve focused weeks typically produce a 5–15 minute improvement on the 90km bike, depending on starting FTP, aerodynamics, and pacing discipline. The biggest gains come from raising sustainable power at 75–85% FTP, not from raw FTP jumps. Athletes who also fix position and pacing at the same time often see the upper end of that range.
  - question: "Should I do long rides or intervals for a faster 70.3 bike?"
    answer: >-
      Both, in the right ratio. Roughly 75–80% of weekly bike volume sits at aerobic intensity (Zone 2), with 20–25% at threshold and sweet spot. This polarised-leaning structure is consistent with Prof. Stephen Seiler's research on endurance training. Long rides build the durability to hold race power in hours three and four; intervals raise the ceiling you're drawing from.
  - question: "How long should my longest ride be before a 70.3?"
    answer: >-
      Your longest ride should reach 4 to 4.5 hours, completed two to three weeks before race day. That is 30–45 minutes longer than your expected race bike split and builds the fuelling and positional durability the race demands. Two rides in the final build should also include a 20–30 minute run off the bike at target race pace.
---
