...
A correctly set up mid-range fork will outperform a badly set up top-tier fork every single time. For the full picture — fork and rear shock together — read our [complete MTB suspension setup guide](/blog/mtb-suspension-setup-complete-guide). A Fox Rhythm dialled in to your weight and riding style will feel better than a Factory with the settings all over the place. Setup is the upgrade that costs nothing but twenty minutes of your time.
