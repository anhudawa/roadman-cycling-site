...
roadmanView:
  - "Breakfast before a long ride is one of the cleanest, cheapest performance levers in cycling. There is no genetic ceiling on it, no expensive kit — just a question of what you eat, when, and whether you have built a routine that works for your gut."
  - "Fasted riding has minimal evidence for fat-loss benefit and a strong evidence base for cost: reduced training quality, slower recovery, and disrupted hormone profile — especially in masters athletes. Eat to fuel performance."
  - "The pros plan their pre-ride meals down to the gram. You do not need to go that far, but 1-2g of carbohydrate per kg of body weight, 2-3 hours before riding, is the baseline that separates a good last hour from a bad one."
---
  - cycling-nutrition-race-day-guide
