...
## HRV: one clue about total stress

HRV can add context to autonomic regulation, but it is not a cortisol dashboard. Training, sleep, alcohol, psychological stress, illness, breathing, posture and measurement quality can all influence it, and the direction is not diagnostic.

The detail is in the [HRV training guide](/blog/cycling-hrv-training-guide). The [autonomic-recovery guide](/blog/cycling-autonomic-nervous-system-recovery-guide) explains why one cardiac metric is not a whole-body sympathetic-versus-parasympathetic verdict. A repeated change from your own consistently measured pattern can prompt a wider stress check, especially when sleep, mood, resting heart rate and training also look different. It cannot prove that cortisol is high or that your “stress bucket” is full.

That distinction matters. When HRV changes, the reflex is often to blame the training. Sometimes training contributes; sometimes sleep, a project deadline, family strain, alcohol, illness or the recording method does. The number does not identify the cause. Your job is to look at the whole picture and work out which factor can be changed.

Practical application: use one validated resting or overnight method consistently. If repeated HRV change agrees with worse sleep, mood, resting heart rate or function, reduce the cost of training while you investigate the cause. Do not use HRV to diagnose cortisol, illness or overtraining. The [masters recovery score tool](/tools/masters-recovery-score) can help organise the broader questions.
