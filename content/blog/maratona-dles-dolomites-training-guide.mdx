...
seoTitle: 'Maratona dles Dolomites Training Plan: 14 Weeks (2026)'
seoDescription: 'Maratona dles Dolomites training plan. 14-week build for 138km and seven Dolomite passes — Pordoi, Sella, Giau, Falzarego. W/kg targets and pacing.'
excerpt: >-
...
keyTakeaways:
  - "14-week build is the working minimum for riders already at 7-9 hours/week — below that the Giau becomes survival, not racing."
  - "3.0 W/kg is the floor for finishing; 3.8+ W/kg targets a sub-7-hour day across all seven Dolomite passes."
  - "The Passo Giau at 9.8km and 9.3% average is the crux — it lands at km 80 on legs with 2,500m of climbing already done."
  - "Pace the first three passes (Campolongo, Pordoi, Sella) at high Zone 2 on power, not on feel — riders who race them early grind the Giau at 6 km/h."
  - "90-110g carbs/hour from the first climb, with a full bottle and two gels pocketed before the Giau base because there is no useful feed in its early section."
  - "34x32 minimum cassette gearing, 34x34 if your derailleur fits it — test on a steep local climb at the end of a 4-hour ride, not fresh."
faq:
...
whoFor:
  - "Riders with a Maratona ballot place who want a 14-week build structured specifically around seven Dolomite passes and the Passo Giau crux"
  - "Cyclists who have done the Etape or Marmotte and want to understand why the Maratona demands different preparation — climbing density, not distance"
  - "Flat-terrain riders heading to the Dolomites for the first time who need to know what sustained 9 per cent gradients on tired legs actually feel like"
  - "Experienced sportive riders chasing a sub-7-hour finish who need to pace the entire day backwards from the Giau"
roadmanView:
  - "I tell every rider who asks about the Maratona the same thing: the first three passes feel easy, and that's the trap. The Giau at kilometre 80 is where the day is decided, and I've seen too many riders arrive there having paced on feel rather than power, climbing at 6 km/h wondering where it all went wrong."
  - "When I discussed pacing with John Wakefield on the podcast, he was adamant — you pace the entire Maratona backwards from the Giau. I think of it this way: if you're racing Campolongo and Pordoi because they feel easy, you're writing a cheque the Giau will cash. High Zone 2 on power for the first three passes, even when your legs say they have more."
  - "I always tell Maratona riders to pocket two extra gels before the Giau base. There's no useful feed in its early section, and I've learned from enough post-race conversations that by the time you need fuel up there, it's too late to eat it."
---

The Maratona dles Dolomites is the densest climbing event in cycling. 138 kilometres. Seven Dolomite passes. 4,230 metres of vertical. That is 30 metres of climbing per kilometre — higher than [La Marmotte](/blog/la-marmotte-training-guide), higher than the Étape, higher than any other event amateurs queue for in their thousands.

That statistic hides something. It does not feel hard at first. The opening passes — Campolongo, Pordoi, Sella — come early and steady, switchbacks at 6-7%, big crowds, golden Dolomite light. Most amateurs hit the third climb still feeling the sportive buzz. Then the route drops down through Gardena and into the Passo Giau, and the day shows you what it actually is.
...
**FTP in W/kg.** The floor is 3.0 W/kg with the right gearing — below that the Giau becomes a walk regardless of fitness. Mid-pack starts around 3.4-3.8 W/kg. Sub-7-hour finishes need 4.0+ W/kg. Use the [W/kg calculator](/tools/wkg) to get a real number, the [FTP zones tool](/tools/ftp-zones) to set the right training intensities, the [Climbing Time Estimator](/tools/climb-time) to model your projected ascent time on the Giau at your current power, and the [Race Predictor](/tools/race-predictor) to estimate your finish time across all seven passes — it makes the difference between a number and a pacing plan.
...
Four to five rides, 80% in [Zone 2](/blog/zone-2-cycling-heart-rate-vs-power-vs-rpe). The aerobic engine that everything else sits on. [Stephen Seiler](/guests/stephen-seiler)'s research on training intensity distribution is what underpins this — the easy stuff has to be easy, or it becomes the most expensive moderate-intensity work you'll ever do.
...
[John Wakefield](/guests/john-wakefield) uses low-cadence torque work for climbing events. Treat 4-minute efforts at 40–60 RPM and RPE 7/10 as a coach-derived advanced option, not a universal study protocol; the [evidence guide](/blog/low-cadence-training-cycling-torque-intervals) gives a conservative entry point. Long ride climbs to 5 hours with 1,500-2,500m of climbing.
...
For the underlying fuelling science, the [carbs-per-hour guide](/blog/carbohydrate-per-hour-cyclists) covers gut training and absorption rates. For race-day timing, the [race-day nutrition guide](/blog/cycling-nutrition-race-day-guide) walks through the protocol.
...
**Underdressing for the descents.** The Pordoi and Falzarego descents drop 800-1,000m at speed. Even in mid-July, you'll be at 6-8°C in the wind on the upper sections — at descent speed, the [wind chill](/tools/wind-chill) pushes the feels-like temperature well below freezing. A gilet stashed in the jersey is non-negotiable. A rain cape on a thunderstormy year has saved more days than aero socks ever will.
...
**Gearing.** 34x32 minimum, 34x34 if your derailleur fits it. The Giau on day-of-event legs is the kind of climb where one extra cog buys you 10rpm and 15 minutes. Test on a 10% local hill at the end of a 4-hour ride — if you're at 50rpm in your easiest gear, change the cassette before flights are booked. Use the [Gear Ratio Calculator](/tools/gear-ratio) to compare cassette options against the Giau's 9.3% average before you commit.
