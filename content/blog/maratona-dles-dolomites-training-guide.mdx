...
The Maratona dles Dolomites is the densest climbing event in cycling. 138 kilometres. Seven Dolomite passes. 4,230 metres of vertical. That is 30 metres of climbing per kilometre — higher than La Marmotte, higher than the Étape, higher than any other event amateurs queue for in their thousands. If the Maratona is on your list, the longer Alpine monsters usually are too — the [Ötztaler Radmarathon and its four passes](/blog/otztaler-radmarathon-training-guide) is the natural next entry once you've ticked the Dolomites.
