...
whoFor:
  - "Cyclists who have done a full base block and wonder whether it actually worked because FTP barely moved"
  - "Masters riders looking for a single metric that tracks aerobic fitness without needing a lab test"
  - "TrainingPeaks users who see the EF column and have never known what to do with it"
  - "Riders who want an honest progress check beyond the coffee-stop FTP number"
roadmanView:
  - "I spent years watching FTP and ignoring EF. Then a coach pointed out that my aerobic efficiency had been declining for months while my FTP held steady. That was the clearest warning sign I had ever missed."
  - "For masters riders especially, EF is the metric. Our FTP moves slowly, recovery takes longer, and aerobic efficiency is where the real adaptation happens. One number, one trend line, no guesswork."
  - "If your EF is flat after eight weeks of base work, the base work is not working. That is a properly useful thing to know before you spend another eight weeks doing the same thing."
---
...
- **Set a benchmark.** Pick one steady 60–90 minute zone 2 ride profile you can repeat — use the [Heart Rate Zone Calculator](/tools/hr-zones) to confirm your zone 2 ceiling so you're not accidentally drifting into tempo. Indoor trainer is easiest. Same warm-up, same target power, same conditions.
...
For more on building the engine that drives EF up, the [zone 2 training complete guide](/blog/zone-2-cycling-heart-rate-vs-power-vs-rpe) is the foundational read. The [polarised training guide](/blog/polarised-training-cycling-complete-guide) covers the full weekly model. And [aerobic decoupling for cyclists](/blog/aerobic-decoupling-cycling-cardiac-drift) is the within-ride companion metric you should be tracking alongside EF.
