...
answerCapsule: >-
  Muscles store 400-500g of glycogen and the liver another 80-110g, providing
  roughly 2,000-2,500 calories of carbohydrate. At threshold intensity, this
  depletes in about 90 minutes. Zone 2 burns 30-40g of carbohydrate per hour;
  threshold burns 120-150g. Periodise daily intake to match the work: rest days
  3-5g/kg, easy ride days 5-7g/kg, hard session days 7-10g/kg. Modern carb
  loading needs only 48 hours at 10-12g/kg with reduced training.
keyTakeaways:
...
relatedTools:
  ...
  - "energy-availability"
whoFor:
  - "Riders who bonk regularly on rides over three hours and suspect their fuelling is wrong but do not understand why"
  - "Sportive and gran fondo riders who want to carb-load properly for an event without resorting to the outdated six-day depletion protocol"
  - "Self-coached athletes confused by conflicting advice on daily carbohydrate intake, fasted riding, and train-low strategies"
  - "Masters cyclists over 40 weighing up the risk-reward of glycogen depletion sessions against recovery capacity and immune health"
roadmanView:
  - "I bonked so badly on a sportive that I sat on a verge for twenty minutes eating jelly babies from a petrol station — that experience made me learn this properly."
  - "The biggest mistake I see is riders eating the same amount of carbohydrate every day regardless of the training load — match the fuel to the work, not to a fixed number."
  - "Glycogen management is not complicated once you understand the tank — how big it is, how fast different intensities drain it, and what it takes to refill."
---
...
[The bonk](/blog/bonking-cycling-what-happens-how-to-prevent) is not a single event. It is two parallel failures happening at the same time.
...
The key principle is periodisation. [Fuel for the work](/blog/fuel-for-the-work-required-fftwr-explained). A rest day does not need 10 g/kg. A hard interval day cannot survive on 3 g/kg. Match the intake to the demand, and the glycogen management takes care of itself.
