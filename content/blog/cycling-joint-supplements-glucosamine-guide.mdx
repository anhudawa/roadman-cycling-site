...
answerCapsule: >-
  Glucosamine and chondroitin performed no better than placebo for general
  knee pain in the NIH GAIT trial, though a moderate-to-severe OA subgroup
  did benefit from the combination at 1,500mg glucosamine sulphate plus
  1,200mg chondroitin sulphate daily. If choosing one joint supplement,
  collagen peptides (15g with 50mg vitamin C before exercise) have a clearer
  mechanism and stronger recent evidence. Most cycling knee pain is a bike fit
  problem, not a supplement deficiency.
keyTakeaways:
...
**Oily fish.** Two to three portions per week of salmon, mackerel, sardines, or herring provides EPA and DHA from whole food sources. This is the foundation of anti-inflammatory [cycling nutrition](/topics/cycling-nutrition). If you do nothing else from this article, eat more oily fish.

**Colourful vegetables and berries.** Deeply coloured produce provides polyphenols alongside fibre and micronutrients. Tart cherry products have been studied for exercise recovery, with selected positive and null findings rather than one universal effect. The [tart-cherry guide for cyclists](/blog/cycling-tart-cherry-juice-recovery-guide) covers that evidence. The broader point is that one supplement does not reproduce a varied dietary pattern.
