...
Five minutes is a common field-test duration for maximal aerobic power. The effort is long enough that the aerobic system carries much of the load while still including an anaerobic contribution. Use [the VO2max number guide](/blog/vo2max-cycling-what-your-number-means-guide) to separate a field proxy from a laboratory measurement.
...
Your maximal-aerobic power may be the current limiter. You might have decent FTP relative to body weight but comparatively weak five-minute power. Confirm the interpretation with [the VO2max number guide](/blog/vo2max-cycling-what-your-number-means-guide) before treating one field effort as a laboratory result.
