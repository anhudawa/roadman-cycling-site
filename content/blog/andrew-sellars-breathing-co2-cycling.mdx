...
seoDescription: >-
  Dr Andrew Sellars studies respiratory physiology and built breathing tools for
  athletes. On the podcast he explained why CO2, not oxygen, drives your breathing
  — and how training CO2 tolerance can help cyclists.
description: >-
...
The practical promise Sellars makes is the part that's genuinely interesting for time-pressed riders. Normally, to expose your body to the breathing demands of a hard race, you have to actually ride hard — which is costly in fatigue and limited by how much intensity you can recover from. He describes a way around that.
