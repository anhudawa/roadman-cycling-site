...
roadmanView:
  - "We had Dr Stacy Sims on the podcast and it was one of those conversations that made me realise how much of what we publish assumes male physiology. Most fuelling protocols were built on research done on young men. That is a problem."
  - "The menstrual cycle is not a minor variable. It changes carbohydrate metabolism, protein breakdown, core temperature, and hydration needs. Ignoring it is not toughness — it is bad science."
  - "This is an area where the cycling industry has been properly poor. The research exists. The practical advice exists. It is just not reaching the riders who need it. That needs to change."
---
