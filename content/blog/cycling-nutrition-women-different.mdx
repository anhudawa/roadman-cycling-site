...
seoTitle: 'Cycling Nutrition for Women — What to Do Differently'
seoDescription: >-
  Why cycling nutrition advice built for men fails women. RED-S risk, iron needs, carb and protein timing around the menstrual cycle, and what to do instead.
description: >-
...
whoFor:
  - "Women cyclists who have followed standard nutrition advice built on male physiology and wondered why it did not work"
  - "Female riders experiencing unexplained fatigue, iron deficiency, or performance dips tied to their menstrual cycle"
  - "Coaches and partners of women cyclists who want to understand how hormonal fluctuations change fuelling needs"
  - "Any cyclist who has heard of RED-S and wants to understand why it disproportionately affects women in endurance sport"
roadmanView:
  - "I had Dr Stacy Sims on the podcast and it was one of those conversations that properly stopped me in my tracks. I realised how much of what we publish — and what I assumed I knew — is built on research done on young men. That's a problem I take seriously now."
  - "The menstrual cycle is not some minor footnote. It changes carbohydrate metabolism, protein breakdown, core temperature, and hydration needs. Dr Nicky Keay made this point brilliantly when she was on the show — ignoring it is not toughness, it's bad science."
  - "Let me be really clear — this is an area where the cycling industry has been properly poor. The research exists, the practical advice from people like Sims and Georgie Bruinvels exists. It's just not reaching the riders who need it, and I think that needs to change."
---
...
During the follicular phase, you can fuel close to standard protocols. For rides over 90 minutes, aim for 60 to 90 grams of carbohydrate per hour — the [Calories Burned Calculator](/tools/calories) will estimate your energy expenditure for a given ride so you can see the total picture. Your glycogen storage and utilisation are working well. Your body tolerates carbohydrate loads effectively. This is the phase where you'll feel most like the fuelling advice on the internet actually applies to you, because, for once, it does.
...
Look at your overall energy intake relative to your training load. The [Energy Availability Calculator](/tools/energy-availability) will show you whether your current intake is supporting your training or quietly pushing you toward RED-S. If your cycle has become irregular or you've lost your period, treat that as urgent. It is not a badge of commitment. It is your body telling you that something is wrong.
