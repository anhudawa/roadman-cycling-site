...
answerCapsule: >-
  Plyometric training improves rate of force development — the speed at which
  muscles produce force — which cycling alone cannot train because the pedal
  stroke lacks eccentric loading. Low-impact exercises such as A-skips, ankle
  hops, and step-up hops provide the neuromuscular stimulus without joint
  stress. Two sessions per week of 60-100 ground contacts, programmed during
  base and build phases, improved time trial performance by 3.5 per cent in
  research by Berryman and colleagues.
keyTakeaways:
...
roadmanView:
  - "Here's the thing that fascinated me when I first looked into this — two riders can have identical peak power on a lab test, but the one who reaches peak force 80 milliseconds faster wins the sprint, closes the gap, holds the wheel. Plyometrics train that gap directly, and it's the bit most cyclists ignore."
  - "I always recommend low-impact plyometrics to riders over 35 — A-skips, ankle hops, step-up hops. You get the neuromuscular stimulus without the joint stress of box jumps. This distinction is not optional for masters riders. It's the entire point."
  - "Rate of force development peaks in your late twenties and declines faster than maximal strength as you age. When I discussed Berryman's research on the podcast, the numbers were striking — two 20-minute sessions a week produced a 3.5 per cent improvement in time trial performance from plyometrics alone. That's a significant return for very little time."
---
