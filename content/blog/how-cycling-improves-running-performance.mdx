...
whoFor:
  - "Runners adding cycling to their programme and wanting to know exactly what transfers"
  - "Triathletes trying to understand how their bike fitness carries over to the run"
  - "Injured runners looking for an aerobic maintenance option that doesn't involve impact"
  - "Cyclists whose running mates keep asking whether all that time on the bike actually helps"
roadmanView:
  - "I've talked to enough sports scientists on the podcast to know this cold: the engine transfers, the skill does not. Your heart, lungs, blood volume, and mitochondria don't care which limbs are doing the work — build them on the bike and they show up when you run. But running economy and impact tolerance only improve by running."
  - "I'm convinced cycling is the best cross-training a runner can do, precisely because it loads the cardiovascular system hard without the musculoskeletal cost. That's not a small thing — it's the reason injured runners can maintain fitness on the bike and come back faster."
  - "Don't expect your bike FTP to make you a better technical runner. I've seen plenty of strong cyclists get humbled on their first 10k. It gives you a bigger aerobic base to run off, and that is properly valuable, but the transfer has a ceiling and the ceiling is your running-specific fitness."
---
