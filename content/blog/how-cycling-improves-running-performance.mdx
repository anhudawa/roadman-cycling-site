...
roadmanView:
  - "The engine transfers. The skill does not. Your heart, lungs, blood volume, and mitochondria do not care which limbs are doing the work — build them on the bike and they show up when you run. But running economy, impact tolerance, and technique only improve by running."
  - "Cycling is the best cross-training a runner can do precisely because it loads the cardiovascular system hard without the musculoskeletal cost. That is not a small thing — it is the reason injured runners can maintain fitness on the bike and come back faster."
  - "Do not expect your bike FTP to make you a better technical runner. It gives you a bigger aerobic base to run off, and that is properly valuable, but the transfer has a ceiling and the ceiling is your running-specific fitness."
---
