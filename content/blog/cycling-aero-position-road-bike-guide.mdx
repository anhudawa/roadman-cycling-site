...
answerCapsule: >-
  The rider's body produces 70-80% of total aerodynamic drag. Tucking the chin
  saves 10-15 watts at 40 kph. Narrowing the elbows by 5-8 cm saves 8-15 watts —
  more than deep-section wheels. Each 0.01 CdA reduction saves roughly 3-5 watts
  at 40 kph. The position must remain sustainable: a 20-watt aero saving that
  costs 25 watts of power output makes the rider slower. Dan Bigham confirmed
  body position outweighs every equipment change.
keyTakeaways:
