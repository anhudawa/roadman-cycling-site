...
roadmanView:
  - "You are ninety minutes in, the road tilts up, and your legs feel like they belong to someone else. That is not a fitness problem. That is a nutrition problem that started three hours before you clipped in."
  - "Set a twenty-minute timer on your head unit. Eat or drink something every time it beeps. Three feeding windows per hour. That single habit prevents the drift that kills fuelling plans."
  - "The rule is simple. Nothing new on race day. Every gel, every drink mix, every piece of food must have been tested at race intensity in training. Your gut does not care about optimal macros if it rejects the food entirely."
---
