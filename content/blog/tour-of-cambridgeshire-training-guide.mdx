...
answerCapsule: >-
  A 12-week build emphasising sustained tempo work, echelon riding, and time
  trial position comfort prepares riders for 128km on closed Fenland roads
  with 300m of climbing and relentless crosswind. Target 3.5 W/kg for a
  front-group finish and UCI Gran Fondo World Championship qualification. 3.0
  W/kg finishes comfortably mid-pack. Echelon skills are not optional — losing
  the wheel in a crosswind split means riding solo into the wind for 80km.
  Aerodynamic savings from deeper wheels and a sustainable aero position
  outweigh marginal FTP gains on flat, exposed terrain.
keyTakeaways:
...
Eighty per cent of your riding at [Zone 2](/blog/zone-2-cycling-heart-rate-vs-power-vs-rpe). The remaining 20% is tempo and aero position work. The focus here is building the aerobic base to sustain 3+ hours of continuous effort and conditioning your body to hold a lower, more aerodynamic position on the bike.
