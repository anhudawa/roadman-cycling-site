...
seoDescription: >-
  Dr David Dunne (INEOS, EF, Uno-X), Alex Larson, Dr Sharon Madigan, Yori
  Carlson, and Dr Tim Podlogar on the body composition framework that
  actually works — and why crash-dieting kills training adaptation.
excerpt: >-
...
Use the [race weight calculator](/tools/race-weight) to set a realistic target based on performance body fat ranges, not aspirational numbers. The [energy availability tool](/tools/energy-availability) tells you whether your daily intake is matching your training load — chronic under-fuelling is the most common amateur problem. For a guided composition pathway, the [weight loss coaching programme](/coaching/weight-loss) is the direct route, with Anthony's full framework applied to your specific situation.

The [Not Done Yet community](https://www.skool.com/roadmancycling) runs regular Q&As on body composition. The most common questions: how to plan a composition block around a target event, how to break through a weight plateau without crashing training, how to handle the body image piece while staying performance-focused. We work through them case by case.
