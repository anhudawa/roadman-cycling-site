...
seoDescription: >-
  The cycling weight loss model that works: I lost 7kg in 12 weeks eating more.
  Dr David Dunne and Alex Larson on protecting power while you lean out.
excerpt: >-
...
experts:
  ...
  - name: Dr Sharon Madigan
    ...
    href: /podcast/ep-2080-struggling-to-lose-weight-this-is-why
...
whoFor:
  - "Cyclists stuck in the 'ride more, eat less' weight loss model who have hit a wall and suspect the approach itself is the problem"
  - "Riders who want to lose weight without losing power and need a structured framework for periodising body composition work into specific training phases"
  - "Masters athletes over 40 who have noticed that the restriction approach that worked at 30 now stalls their training, tanks their recovery, and shifts nothing on the scales"
  - "Cyclists riding 10-12 hours a week who cannot lose weight and have never considered that they might be eating too little rather than too much"
roadmanView:
  - "I lost 7kg in 12 weeks eating more food than I had ever eaten. Protein went up, in-ride fuelling went up, rest day calories came down slightly. Power held. The cycling internet's 'ride more, eat less' model is the reason most amateurs are stuck — Dr David Dunne, who has worked with INEOS, EF, and Uno-X, calls it the paradigm that keeps them there."
  - "Dr Sharon Madigan's timing rule is the practical key: do not stack heavy training with caloric deficit. Periodise composition work into specific phases when training load is lower. The crash-dieted lean cyclist underperforms the well-prepared lean cyclist by a wide margin, every time."
  - "Uri Carlson's finding is the one most riders refuse to believe: cyclists riding 10-12 hours a week who cannot lose weight are usually eating too little, not too much. Chronic under-eating suppresses metabolic rate and holds onto body fat. More food, better timed, is often the fix."
---
...
The detail of how I lost the weight is in [the 9kg eating more episode](/podcast/ep-1-i-lost-9kg-eating-more-and-got-faster-on-the-bike), and the headline numbers are surprising even to me looking back at them.
...
[Alex Larson](/guests/alex-larson) is a sports dietitian who specialises in recomposition — losing fat while protecting muscle and power. Her framework, covered in [the Alex Larson body composition episode](/blog/alex-larson-body-composition-cyclists), differs from simple weight loss in several specific ways.
...
[Dr Tim Podlogar](/guests/tim-podlogar) at Tudor Pro Cycling flagged a specific maths error amateur cyclists keep making, covered in the pro cycling stay lean episode. The mistake is calculating caloric intake as if every day is similar.
...
The tools matter for tracking this properly. DEXA scans give the most accurate body composition reading. Bioelectrical impedance scales are less accurate but workable for tracking trends over months. The [body composition calculator](/tools/body-composition) gives you a quick estimate using the Navy circumference method, and the [race weight calculator](/tools/race-weight) gives a realistic target based on performance body fat ranges rather than aspirational numbers from cycling magazines.
...
**Related reading:** [Carb Loading for Cyclists: The Modern Approach That Actually Works](/blog/carb-loading-cyclists-modern-approach)
