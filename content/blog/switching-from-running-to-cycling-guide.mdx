...
whoFor:
  - Runners whose bodies are telling them the mileage isn't sustainable anymore
  - Ex-runners looking for an endurance sport they can still be doing at 60 or 70
  - Runners who've bought a bike and are surprised how hard cycling feels despite their cardiovascular fitness
  - Anyone curious about how much running fitness actually transfers to the bike
roadmanView:
  - "I've spoken to so many runners making this switch, and I always say the same thing — switching to cycling isn't giving up. Your engine comes with you. Around 80-90% of your VO2max transfers. What you're missing is cycling-specific muscular endurance, and that takes six to twelve weeks to build."
  - "I hear it all the time — the knees, the calves, the mileage that just isn't sustainable. I think cycling gives you an endurance sport you can still be doing decades from now, and that's not a compromise."
  - "I've watched this pattern play out again and again — the hardest part is accepting that your cardiovascular fitness is ahead of your cycling legs. Your heart and lungs are ready. Your quads need time to catch up."
---
...
A solid entry-level road bike — aluminium frame, carbon fork, reliable groupset like Shimano 105 — runs **$1,500-2,500** new. You can spend less on the used market, and if you have a mechanically-minded friend that's a good route, but a worn drivetrain and dead bearings can quietly erase the savings.
...
**Spin, don't grind.** Runners on new bikes default to low cadence and big force, because muscling through resistance feels like honest work. Aim for 85-95 rpm. Higher cadence shifts load from untrained muscle onto your very well-trained cardiovascular system. Later, once your knees and legs are conditioned, low-cadence torque work becomes a useful tool — coaches like Dan Lorang and John Wakefield prescribe it to World Tour riders — but it's a season-two conversation, not a week-two one.

**Recalibrate your zones.** Your heart rate runs 5-10 beats lower on the bike than running for the same effort, because less muscle mass is working. Don't import your running zones wholesale — the [run-ride converter](/tools/run-ride-converter) translates your running paces into equivalent cycling efforts so you know what to target, and the [HR zones calculator](/tools/hr-zones) establishes bike-specific numbers after a few weeks of riding, then [structure your training](/blog/how-to-structure-cycling-training-plan) the way you always have: mostly easy, occasionally hard, progressively loaded. The methodology you trust still applies; only the numbers change.
