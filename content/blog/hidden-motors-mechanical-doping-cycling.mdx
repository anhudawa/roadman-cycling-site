...
roadmanView:
  - "Almost every confirmed case of mechanical doping has been at amateur and masters level, caught by other riders, not by federations. The clean racers are the ones holding the line. That fact should make every governing body uncomfortable."
  - "A seat-tube motor weighing under 2kg delivers around 200 watts to the cranks. That is the difference between getting dropped in a Cat 4 race and riding at the front of a Tour stage. The technology exists, it is accessible, and detection is still a cat-and-mouse problem."
  - "Greg LeMond told us he no longer trusts certain Tour results until cycling solves the detection problem. When a three-time Tour winner says that publicly, the sport has a credibility issue that thermal cameras at a handful of races will not fix."
---
