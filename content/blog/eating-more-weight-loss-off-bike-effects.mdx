...
seoDescription: "Anthony Walsh's cycling weight loss: he lost 9kg eating more food. The off-bike effects — energy, mood, sleep, food guilt — most riders miss until they try it."
description: >-
...
faq:
  - question: Why did Anthony Walsh lose 9kg eating more food than before?
    answer: >-
      The framework — fuel for the work required, developed by Dr Sam Impey and
      Professor James Morton at Liverpool John Moores University — matches
      carbohydrate intake to the demands of each session rather than applying a
      flat daily restriction. Anthony fuelled hard sessions with around 170g of
      carbohydrate beforehand and 90g per hour on the bike, then pulled
      carbohydrate back on easy days. The weekly deficit emerged as a side
      effect, not from chronic restriction.
  - question: What are the off-bike effects of periodised cycling nutrition?
    answer: >-
      Higher daytime energy, the elimination of late-night food cravings, better
      sleep, faster post-ride recovery, and a reset of the moral language
      cyclists use about food. These typically appear within three to four
      weeks. The loss of evening cravings, in particular, is a clinical sign
      that the previous fuelling pattern was creating a daytime deficit the
      body was trying to repair after dark.
  - question: How long does it take to see results from fuel for the work required?
    answer: >-
      The first three weeks are noisy. Real signal usually appears from week
      four or five — steady weight loss of 0.5 to 1kg per week, alongside the
      off-bike changes that show up earlier than the scale moves. Twelve weeks
      is the minimum useful evaluation window.
  - question: Is the cycling internet's weight loss advice out of date?
    answer: >-
      Largely, yes. The dominant amateur model — calorie restriction, fasted
      long rides, blanket low-carb — was retired at WorldTour level around 2015
      to 2017. Dr David Dunne and others have been explicit that the science is
      settled and the gap is now in behaviour change, not research.
  - question: What signals tell me I need to change how I am fuelling?
    answer: >-
      Three signals. Your evenings are a fight against food cravings. Long
      rides leave you flat for the rest of the day with low mood and snacking.
      You use moral language about food — cheat days, being good, earning it.
      Two of those three together is a strong sign your daytime fuelling is
      creating a deficit your body is trying to repair after dark.
answerCapsule: >-
...
whoFor:
  - "Cyclists who have been restricting food for months and are tired, moody, sleeping badly, and still not losing weight"
  - "Riders who feel guilty about eating after rides and want to break the cycle of restriction, bingeing, and self-blame"
  - "Anyone who has heard about fuel for the work required but wants to know what it actually feels like to live it — the off-bike effects, not just the numbers"
  - "Serious amateurs whose relationship with food has become anxious or transactional and who want a reset that does not involve another diet"
roadmanView:
  - "I lost 9kg eating more food than I had ever eaten before. The weight loss was the side effect. The real story is what happened off the bike — my energy stabilised, my sleep improved, my mood lifted, and the food guilt that had quietly haunted me for years just disappeared."
  - "The signal that you need this reset is not on the scales. It is in your evening cravings, your post-ride collapse, and your guilt response to a slice of pizza. If that sounds familiar, you are not weak — you are underfuelled."
  - "This is the most personal piece I have written, and I share it because I know how many riders are stuck in the same pattern. You do not need to eat less. You need to eat the right amount at the right time. The difference is life-changing."
---
...
3. Weigh in once a week, same morning, same conditions. Give it eight weeks before judging anything. Run the [body composition calculator](/tools/body-composition) to get a baseline body fat estimate, and if you don't have a sensible target to chase, the [Roadman race-weight calculator](/tools/race-weight) puts a realistic ceiling on how far down it makes sense to go.

If you want to operationalise the daily targets without doing the maths yourself, the [Fuel Planner](/tools/fuel-planner) gives you calorie and macro targets matched to each day's training load. For the full WorldTour-grade version, the Hexis app — built by Dr Sam Impey and Dr David Dunne, used by roughly 40% of the WorldTour — periodises against your TrainingPeaks calendar.
...
- For the underlying framework, read the [fuel for the work required guide](/blog/cycling-weight-loss-fuel-for-the-work-required). For the on-bike side, the [carbs per hour guide](/blog/carbohydrate-per-hour-cyclists) and [in-ride nutrition guide](/blog/cycling-in-ride-nutrition-guide). For the body composition lens, the [body composition guide](/blog/cycling-body-composition-guide).
...
**Related reading:** [Why Cyclists Struggle to Lose Weight: Dr Sharon Madigan on Fuelling the Block](/blog/sharon-madigan-cycling-weight-loss-fuelling)
