...
keyTakeaways:
  - "Sweet spot sits at 88-93% of FTP — below that is tempo, above it is threshold with sharply higher fatigue cost."
  - "The advantage is repeatability: you can stack three sweet spot sessions per week without wrecking recovery, and the cumulative load across a block drives real aerobic adaptation."
  - "Tim Kerrison built Ineos base phases around sweet spot volume before layering threshold and VO2max work on top — the sequencing matters more than any single session."
  - "Seiler's polarised model and Allen's sweet spot approach both work when placed correctly in a periodised plan rather than used as the only intensity year-round."
  - "A 4-week block of three progressive weeks plus one recovery week is the standard structure — skipping the recovery week wastes the stimulus you loaded."
  - "Over-under variations (10 min at 90% FTP with 2-min surges at 105%) build lactate clearance and race-day resilience in a single session."
relatedPosts:
...
whoFor:
  - Cyclists new to structured training who keep hearing about sweet spot but don't fully understand it
  - Riders doing 2x20 sessions and getting it wrong without knowing why
  - Anyone who wants the science behind the stimulus-to-fatigue ratio explained clearly
  - Time-crunched athletes looking for the most efficient way to raise sustainable power
roadmanView:
  - "I see it in the community every week — everyone prescribes sweet spot, and most people do it wrong. The difference between 88% and 93% of FTP doesn't sound like much, but five watts over the ceiling triples your fatigue cost."
  - "When I've discussed Tim Kerrison's approach on the podcast, the key point is always the same — he built entire Ineos base phases around sweet spot volume before layering threshold and VO2max on top. The sequencing matters more than any single session."
  - "I always tell riders a 4-week block — three weeks loading, one week recovery — is the structure. Skip the recovery week and you waste the stimulus you spent three weeks building."
---
...
The term was coined by Hunter Allen, co-author of *Training and Racing with a Power Meter* and one of the people who did more than almost anyone to bring power-based training to amateurs. Allen identified a narrow band — 88 to 93 percent of your functional threshold power — where something interesting happens. Use the [sweet spot calculator](/tools/sweet-spot) to see exactly where that band falls for your power. The training stimulus is very high, close to what you'd get from riding at threshold, but the physiological cost is meaningfully lower. Not slightly lower. Meaningfully lower. The fatigue you accumulate in twenty minutes at 91 percent of FTP is a different animal from the fatigue you accumulate in twenty minutes at 100 percent. And that gap is the whole point.
