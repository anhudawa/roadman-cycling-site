...
answerCapsule: >-
  Trained masters cyclists lose about 5% of VO2max per decade versus 10% for
  sedentary adults — half of what riders blame on age is detraining. FTP
  declines 5-7% per decade through the 40s, accelerating after 55-60. Pino et
  al. found the steepest decline begins after 55, not 40. A strong 55-year-old
  at 3.0 W/kg outperforms the median casual 30-year-old. Efficiency, pacing, and
  recovery discipline improve with experience.
keyTakeaways:
...
whoFor:
  - "The cyclist over 40 who wants to know the actual rate of decline rather than relying on anecdotes and forum speculation"
  - "The masters rider who started structured training late and needs to understand how much headroom they still have"
  - "The data-minded athlete who wants published research on VO2max, FTP, and W/kg decline rates per decade"
  - "The rider approaching 55 who is concerned about accelerating decline and wants to know what they still control"
roadmanView:
  - "The decline between 40 and 55 is roughly 0.5% per year for trained cyclists. I find that number reassuring — it's close to imperceptible year to year and easily masked by smarter training. The panic is premature."
  - "Here's what I keep coming back to: half of what riders blame on age is actually detraining. Sedentary adults lose 10% of VO2max per decade. Trained masters athletes lose 5%. That other 5% isn't age — it's choices."
  - "Most over-40 cyclists I've spoken to have never touched their age-adjusted ceiling. The gap between where you are and where you could be is almost certainly bigger than the gap age has created. The good news is that's fixable."
---
