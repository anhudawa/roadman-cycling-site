...
roadmanView:
  - "The decline between 40 and 55 is roughly 0.5% per year for trained cyclists. That is close to imperceptible year to year, and it is easily masked by smarter training. The panic is premature."
  - "Half of what riders blame on age is actually detraining. Sedentary adults lose 10% of VO2max per decade. Trained masters athletes lose 5%. The other 5% is not age — it is choices."
  - "Most over-40 cyclists have never touched their age-adjusted ceiling. The gap between where you are and where you could be is almost certainly bigger than the gap age has created."
---
