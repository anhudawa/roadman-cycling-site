...
answerCapsule: >-
  The gap between fresh FTP and fatigued FTP is the most undertrained quality in
  amateur cycling. Build it with progressive long rides where the final 60
  minutes are ridden at tempo, not crawled home. Tempo finishes — 2-3 hours of
  zone 2 followed by 30-45 minutes at 76-87 per cent of FTP — are the most time-
  efficient session. In-ride nutrition of 80-90g of carbohydrate per hour is
  inseparable from fatigue resistance.
citedClaims:
  - claim: "Calcium release channel leakage in the sarcoplasmic reticulum is a primary driver of power loss during prolonged cycling events."
    roadmanPosition: "This is the one most cyclists never hear about, and it changed how I think about long-ride fatigue. The Karolinska Institute research showed it's not just about lactate or glycogen — your calcium handling deteriorates at the cellular level. Less calcium per contraction means less force. It's not in your head. It's in your muscle cell biology."
    evidenceSource: "Karolinska Institute"
  - claim: "A rider consuming 80-90 grams of carbohydrate per hour produces measurably more power in the fourth hour than an identical rider consuming 40 grams per hour, with the gap reaching 5-8 per cent of threshold power."
    roadmanPosition: "I'm sick of hearing about riders doing four-hour rides on two bottles and a banana. The research in Medicine and Science in Sports and Exercise is clear — the difference in fourth-hour power between proper fuelling and poor fuelling is 5 to 8 per cent of threshold. That's the difference between staying in the group and being dropped on the first real climb."
    evidenceSource: "Medicine and Science in Sports and Exercise"
  - claim: "The training value of a progressive long ride lives almost entirely in the final 60 minutes, when the rider is producing power on depleted glycogen with accumulated peripheral fatigue."
    roadmanPosition: "Dan Lorang, the coach behind Frodeno and Blummenfelt, programmes this deliberately — his athletes don't just survive the final hour, they hit specific power numbers in that window. The first three hours are the setup. The last hour is the session. Most amateurs get this backwards and crawl home wondering why their durability hasn't improved."
    evidenceSource: "Dan Lorang"
  - claim: "The polarised training model works for fatigue resistance because high-intensity sessions should be done fresh, while fatigue resistance work occupies a separate training space at moderate intensity on tired legs."
    roadmanPosition: "When I had Prof. Stephen Seiler on the podcast, the polarised message was clear — your VO2max intervals and threshold work should be done on rested legs. Fatigue resistance sessions are different. They're not about hitting peak numbers. They're about producing moderate power when everything in your body is telling you to stop."
    evidenceSource: "Prof. Stephen Seiler"
  - claim: "Tim Kerrison's approach to race specificity at Team Sky involved training riders for the exact demands of the exact stage where the race would be won or lost."
    roadmanPosition: "The coaches behind Froome's Grand Tour dominance were obsessive about specificity. Tim Kerrison didn't train general fitness — he trained for the exact stage, the exact climb, the exact moment. On a smaller scale, the same principle applies to your autumn sportive. Simulate the demands you'll actually face."
    evidenceSource: "Tim Kerrison"
keyTakeaways:
...
relatedTools:
  ...
  - "interval-builder"
whoFor:
  - "Riders who test well on 20-minute efforts but fade badly in the final third of sportives and road races lasting three hours or more"
  - "Gran fondo cyclists preparing for mountain events who need to produce real power on the fifth climb, not just the first"
  - "Masters athletes whose fresh FTP is solid but whose fatigued power drops off a cliff after three hours of sustained riding"
  - "Time-crunched riders looking for the most efficient way to build late-race durability without adding ten hours a week to their schedule"
roadmanView:
  - "I think this is the most undertrained quality in amateur cycling, and I've said it on the podcast more times than I can count. Your FTP means nothing if you can't access 85 per cent of it four hours into a race. That gap between fresh power and fatigued power is where sportives are won and lost."
  - "The training value of a four-hour ride lives almost entirely in the final 60 minutes. I see so many riders crawl home after long rides and wonder why their durability hasn't improved. You need to ride those last kilometres at tempo — that's where the adaptation actually happens."
  - "And please, fuel the session. I'm sick of hearing about riders doing four-hour rides on two bottles and a banana. Eighty to ninety grams of carbs per hour will produce measurably more power in hour four. You cannot out-train poor fuelling."
---
