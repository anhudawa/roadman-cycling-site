...
answerCapsule: >-
  FTP, LT1, LT2, and MLSS are four distinct measurements, not synonyms. FTP
  estimates one-hour sustainable power but is not a physiological boundary. LT1
  marks the top of true aerobic riding. LT2 is where lactate accumulates faster
  than clearance. The 20-minute FTP test often overestimates MLSS by 5-10%,
  shifting all derived training zones upward. The talk test approximates LT1; a
  30-minute field test approximates LT2.
keyTakeaways:
...
relatedTools:
  ...
  - "hr-zones"
whoFor:
  - "Riders who have heard FTP, LT1, LT2, and MLSS used interchangeably and want to know what each actually means"
  - "Self-coached cyclists who suspect their training zones are set wrong because the efforts never feel right"
  - "Anyone whose Zone 2 rides feel harder than conversational and cannot work out why"
  - "Riders considering a lactate test and wanting to understand what the numbers will tell them"
roadmanView:
  - "This is one of those topics where the cycling internet has made things worse, not better. People throw the word threshold around like it means one thing. It does not. And if your zones are built on the wrong number, you are training in the wrong place."
  - "I have spoken to enough coaches now — Professor Seiler, Dan Lorang, John Wakefield — to know that the 20-minute FTP test overestimates threshold for a lot of riders. If that is you, every zone is shifted up and your easy rides are not easy."
  - "You do not need a lab to sort this out. A structured field test and the talk test will get most riders close enough. But you do need to understand what you are measuring, and that is what this guide is for."
---
