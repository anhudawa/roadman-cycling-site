...
seoDescription: >-
  RPE and power together: power tells you what you're doing, RPE tells you what
  it costs. The two-channel system serious amateurs use to train off both.
excerpt: >-
...
whoFor:
  - Riders who own a power meter but still guess intensity by feel
  - Self-coached cyclists building structured training plans
  - Anyone noticing their RPE creeping up at the same wattage
  - Time-crunched riders who need every session to count
roadmanView:
  - I used to ignore RPE entirely once I had a power meter. Took me years to realise the meter tells you what you are producing — only your body tells you what it is costing.
  - The day your 220-watt tempo feels like threshold is the day RPE saves your training block, if you are listening.
  - Run both channels. Power is the speedometer, RPE is the fuel gauge. You would not drive with only one.
---
...
**Short, precise intervals.** A 4-minute VO2 effort or a 90-second over-threshold push. The duration is too short to settle into a stable RPE; the wattage is the cleaner signal. Hold the watts and let the RPE be whatever it is. The [interval session builder](/tools/interval-builder) sets the target power and recovery for these efforts so the execution is clean before you clip in.
