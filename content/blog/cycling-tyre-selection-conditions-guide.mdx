...
roadmanView:
  - "A fifty-quid tyre change can transform the ride quality of a five-thousand-pound bike. Tyre selection is the highest-impact equipment decision most cyclists completely ignore."
  - "Tread pattern does almost nothing on tarmac. Grip in the wet comes from compound softness, not grooves. A slick tyre with soft rubber will outgrip a treaded tyre with hard rubber every time."
  - "If you are still on 25mm tyres, move to 28mm. The aerodynamic penalty is negligible at amateur speeds. The comfort, grip, and rolling resistance gains are not."
---
