...
seoDescription: >-
  The real structure behind cycling periodisation — base, build, peak, taper — with a pro-grade annual template you can adapt to your own race calendar.
excerpt: >-
...
keyTakeaways:
  - "A standard annual plan runs four phases: base (8-16 weeks), build (6-10 weeks), peak/taper (2-3 weeks), and transition (1-2 weeks) — the sequence never changes."
  - "Starting intensity too early is the most common mistake — riders compress base to 4-5 weeks, peak in April, and flatline by June."
  - "Block periodisation concentrates a single stimulus into 7-14 day doses, and World Tour teams now layer this on top of the traditional Friel model."
  - "Recovery weeks are not optional: the body adapts during rest, and skipping the 3:1 load-to-recovery ratio drives riders into overreaching."
  - "Separate two A-races by at least 10-12 weeks so you can actually recover and rebuild — three A-races per season is the upper limit."
  - "Weekly volume should increase by 5-10% per build week, and field tests every 6-8 weeks keep zones honest as fitness changes."
faq:
...
whoFor:
  - Self-coached riders doing the same training year-round
  - Club racers who want to peak for two or three priority events
  - Riders who fade by mid-season every year
  - Anyone building an annual training plan for the first time
roadmanView:
  - "I know periodisation sounds complicated, but when I spoke to Joe Friel on the podcast, he broke it down simply: it's deciding when to train hard, when to rest, and when to peak. He codified the model decades ago and World Tour teams still use it — that tells you everything."
  - "If you're doing the same sessions in January and July, I think this is the piece you're missing. I always tell riders the body adapts to phases, not to randomness, and I've seen that play out hundreds of times."
  - "I've watched too many riders compress their base, peak in April, and have nowhere to go by June. That mid-season plateau is almost always a periodisation problem, and this template stops it happening."
---
...
This article gives you the annual template coaches actually use — the four-phase [Joe Friel](/guests/joe-friel) model, the block periodisation overlay that modern World Tour teams have added, and the specific mistakes that waste seasons. Copy the structure. Adapt the numbers to your calendar.
...
None of this is theoretical. [Dan Lorang](/guests/dan-lorang), who coached Jan Frodeno and Anne Haug to world titles and runs performance at Red Bull-Bora-Hansgrohe, has described the annual plan as the single most important document a coach builds. The workouts are details. The structure is the job. Sequence it in [TrainingPeaks](https://www.trainingpeaks.com) and the build actually has a shape on the calendar — base, build, peak, taper, each phase doing its job — rather than living as a pile of disconnected sessions. Most coaches, including the ones behind Roadman's own Method plans, deliver structured blocks this way, so the rider just opens the app and rides what's prescribed.
...
**No recovery weeks.** A three-week build and one-week recovery pattern exists because the body adapts during rest, not during load. Riders who skip the [recovery week](/blog/cycling-recovery-week-what-to-actually-do) accumulate fatigue, interpret declining power as a need to train harder, and drive themselves into overreaching. The recovery week is not a reward. It's part of the stimulus.
...
**No testing.** Without a field test or a well-executed ramp test every 6–8 weeks, zones drift and phases lose their target. Test at the start of base, end of base, mid-build and end of build. Adjust zones each time. If you're working from a self-built plan rather than coaching, [how to structure a cycling training plan](/blog/how-to-structure-cycling-training-plan) walks through the weekly skeleton each phase sits inside.
...
**Weeks 3–6: Base 1.** Aerobic volume building from 7 to 10 hours per week. Strength training twice weekly, cycling-specific work — split squats, hip hinges, single-leg deadlifts, hip thrusts, presses and core. One tempo session per week by week 6. Cadence and skill drills.
...
**Weeks 11–14: Base 3.** Volume peaks at 10–13 hours. Sweet spot progresses to 3x20 or 2x30. Strength moves from hypertrophy to a more strength-focused emphasis with controlled, meaningful loads in the 6–10 rep range with reps in reserve. First field test at end of week 14.
