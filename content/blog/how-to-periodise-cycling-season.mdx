...
roadmanView:
  - Periodisation sounds complicated but it's really just deciding when to train hard, when to rest, and when to peak. Joe Friel codified the model decades ago and World Tour teams still use it.
  - If you're doing the same sessions in January and July, this is the piece you're missing. The body adapts to phases, not to randomness.
  - Most riders who plateau mid-season compressed their base, peaked too early, and had nowhere to go by June. This template stops that happening.
---
