...
answerCapsule: >-
  The Roadman Cycling Podcast records remote interviews via Riverside.fm at 48kHz WAV, with local backups on a Shure SM7B through a Rodecaster Pro II. Guests are booked 6–10 weeks out, briefed with a one-page prep sheet, and interviewed for 60–90 minutes. Audio ships to Apple, Spotify, and the main RSS feed; a multi-camera edit goes to YouTube. The operation produces two episodes per week and reaches over one million monthly listeners.
faq:
