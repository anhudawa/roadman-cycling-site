...
roadmanView:
  - "Two meals can deliver 35 grams of protein each and produce completely different recovery outcomes. The source matters because leucine content, amino acid profiles, and digestibility all vary massively."
  - "If you are only going to focus on one protein source, make it eggs. Cheap, fast, nutrient-dense, and they work at any meal. The most underrated recovery food in cycling."
  - "Use whey when convenience matters — straight after a ride, travelling, when a meal is not practical. Whole food the rest of the time. Supplements fill gaps; they do not replace meals."
---

Most cyclists know the number by now. You need 1.6 to 2.2 grams of protein per kilogram of bodyweight per day. If you weigh 75 kilograms, that is somewhere between 120 and 165 grams daily. I have covered the evidence behind those numbers, the distribution across meals, and the leucine threshold in the [complete protein guide](/blog/protein-for-cyclists-complete-guide). That post is the "how much and when."
