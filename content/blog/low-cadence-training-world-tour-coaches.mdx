...
seoDescription: >-
  The 2024 Habis study, John Wakefield's exact protocol, and why the
  cycling internet got this session wrong for a decade. The full case
  for low cadence training and the specific sessions to add to your
  week.
excerpt: >-
...
relatedEpisodes:
  ...
  - ep-2132-how-team-bora-approach-building-endurance-john-wakefield
...
When I ran [the I tried gym and bike for 30 days experiment](/blog/gym-and-bike-30-days-experiment), one of the findings was specific to low cadence work. The gym strength sessions and the on-bike low cadence sessions both target type 2 fibre development, but they're not interchangeable.
...
Use the [FTP zone calculator](/tools/ftp-zones) to set your zones so the rest of the week (easy days and other hard days) hits the right intensities. Run the [training diagnostic](/diagnostic) if you're not sure whether low cadence is your specific limiter — for many amateurs it is, but the diagnostic helps confirm.

For specific protocol support, the [Not Done Yet community](https://www.skool.com/roadmancycling) runs weekly coaching calls where session prescription questions come up. The most common low cadence questions: which gradient works best, how to manage knee comfort, how often to run the block, what to combine it with. The [coaching pathways](/coaching) cover higher-touch options for cyclists who want a coach to build the block into their full periodisation.
