...
answerCapsule: >-
  Strength training for triathletes should build three things: resilience in the aero position, force production that transfers to sustained watts, and durability for the final third of the bike leg. Two 30–45 minute sessions per week, built around heavy compound lifts (trap bar deadlift, split squat, single-leg press) and targeted posterior-chain and trunk work, deliver the adaptation without adding fatigue that damages the run. Hypertrophy-style bodybuilding splits, high-rep leg burnouts, and plyometrics scheduled near brick sessions are the common mistakes.
faq:
  - question: "How many strength sessions per week should a triathlete do?"
    answer: >-
      Two sessions per week is the sweet spot for most age-group triathletes in base and build phases. One session in race-specific phases. Each session runs 30–45 minutes, focused on 3–4 compound movements at heavy loads with low reps. More than two sessions tends to compromise key swim, bike, and run workouts, especially once weekly training volume goes above 12 hours.
  - question: "Does strength training hurt running performance in triathletes?"
    answer: >-
      Badly programmed strength training hurts running. Heavy lifting 48 hours before a long run or quality brick leaves the legs flat. Done correctly — heavy loads, low reps, 48 hours of clearance before key run sessions — strength training improves running economy. The research from Rønnestad and others shows 4–8% economy gains in endurance athletes who lift heavy twice weekly across 12 weeks.
  - question: "Should triathletes lift heavy or do high-rep endurance circuits?"
    answer: >-
      Heavy. Loads of 80–90% of one-rep max for 3–5 reps drive the neuromuscular adaptation that transfers to bike power and running economy. High-rep circuits (15–20 reps) produce local muscular fatigue without the force adaptation you actually need. Your bike and run training already delivers endurance stimulus. The gym is for what the bike and run can't give you.
  - question: "What's the best single exercise for triathlon bike strength?"
    answer: >-
      The trap bar deadlift. It loads the posterior chain through a full hip hinge, builds the glute and hamstring force needed to drive watts in the aero position, and carries lower injury risk than a conventional barbell deadlift. Three to five sets of 3–5 reps at heavy load, once or twice weekly, is the foundation most triathletes are missing.
  - question: "When should I stop lifting before a triathlon race?"
    answer: >-
      Drop heavy lifting 10–14 days before an Ironman and 7–10 days before a 70.3. Keep one light maintenance session with reduced load (50–60% of working weight) up to five days out to preserve neural drive without adding fatigue. Stop all strength work five days out. The adaptation is already banked; the remaining job is arriving fresh.
---
