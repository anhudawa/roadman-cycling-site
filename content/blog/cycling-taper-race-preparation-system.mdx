...
seoDescription: >-
  Joe Friel's taper framework, Matt Bottrill's race-day details, the 24-hour
  pre-event timeline, and the ultra-endurance exception. The full taper
  and race-day system for amateur cyclists.
excerpt: >-
...
relatedEpisodes:
  ...
  - ep-17-vlog-tips-on-preparing-for-your-big-event
  - ep-30-how-a-pros-insane-fuel-plan-almost-won-badlands
answerCapsule: >-
...
For events over 6 hours — Badlands, Unbound, ultra-distance gravel, long-distance Audax events — the taper model changes. The detail is in [the Chris Melmän Badlands fuel plan episode](/blog/chris-melman-badlands-fueling-strategy) and [the badlands 800km fuelling strategy guide](/blog/badlands-800km-fuelling-strategy).
...
For event-specific planning, the [event planner tools](/plan) cover Etape du Tour, Marmotte, Ride London, Wicklow 200, Ring of Beara, and a range of other targeted events. Use the [race predictor](/predict) for a realistic finish time estimate, which helps calibrate the training targets and the race-day pacing.

For coaching support around event preparation, the [event prep coaching pathway](/coaching/event-prep) is the direct route. The [Roadman Method](/method) is the structured 12-month programme that takes a rider through a full periodisation cycle with personal coaching support through the taper and race day. The [Not Done Yet community](https://www.skool.com/roadmancycling) runs a weekly call where race week and taper questions come up frequently.
