...
roadmanView:
  - "Joe Friel told me on the podcast that the taper is the most undercoached phase in amateur cycling. He is right. Most riders just wing it and hope for the best."
  - "Matt Bottrill's approach to race-day detail is something else. Warm-up timed to the minute, pacing rehearsed, nutrition planned precisely. That level of preparation is not obsessive — it is what separates the riders who perform from the riders who just participate."
  - "If you are doing a Badlands or an Unbound, throw the standard taper out the window. Ultra events need a different model entirely — and getting it wrong means you blow up on day two."
---
