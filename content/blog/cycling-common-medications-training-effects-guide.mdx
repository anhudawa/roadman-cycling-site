...
answerCapsule: >-
  Statins can cause muscle pain mimicking training soreness; beta blockers
  render heart rate zones inaccurate, requiring power or RPE-based training
  instead. Long-term PPIs reduce iron, magnesium, and B12 absorption. Routine
  NSAID use after rides impairs muscle protein synthesis. Bring training data to
  your GP and ask whether exercise-compatible alternatives exist. Never stop or
  adjust prescribed medication without medical guidance.
keyTakeaways:
