...
The plan is the framework. The judgment is when to flex it. Self-coached riders often struggle here because there's no external check. The [training diagnostic](/diagnostic) and the [Not Done Yet community](https://www.skool.com/roadmancycling) weekly coaching call exist partly to provide that external check.
