...
seoDescription: 'Anthony Walsh on the cycling taper from a Mallorca camp — why backing off is the hardest discipline, and how to land the 15 percent gain amateurs skip.'
description: >-
...
answerCapsule: >-
  Peer-reviewed meta-analyses put the typical taper gain at 2 to 6% on
  time-trial performance — that is the evidence-based expectation for most
  riders. The 15% figure quoted in this vlog is an extreme outlier, what
  becomes possible only when a clean taper sits on top of a deep, well-built
  training block. The protocol is simple — reduce duration, hold or raise
  intensity, ride fewer hours but the same kind of efforts you have been
  doing all block. The discipline is the hard part. Backing off feels
...
keyTakeaways:
  ...
  - The evidence-based expectation from peer-reviewed meta-analyses is a 2 to 6% gain on time-trial performance. The 15% figure in this vlog is an extreme outlier — what becomes possible only when a clean taper lands on top of a deep, well-built training block.
...
whoFor:
  - "Riders in their final fortnight before a target event who are fighting the urge to squeeze in extra training"
  - "Cyclists who have trained hard all season but have never executed a proper taper and peak"
  - "Anyone who has arrived at race day feeling flat and suspected the last two weeks were to blame"
  - "Serious amateurs balancing event preparation with the real-world demands of family, work, and life"
roadmanView:
  - "I filmed this one from the road home from Mallorca. Family illness cut the camp short. That is the reality of this sport when you are not a full-time professional — the plan has to bend."
  - "The 15% figure is the extreme end. The evidence says 2-6% is the realistic expectation from a clean taper. But even 2% is free watts. No extra training required. Just the discipline to back off."
  - "Backing off feels like falling behind. That feeling is the trap. Every rest day in race week feels like fitness draining out of your legs. It is not. The freshness is the adaptation."
---
...
That is the whole protocol. Volume drops 40 to 60% over the final two weeks. Intensity stays exactly where it has been. A 2x20 threshold session becomes 2x10. A 4x4 VO2max set becomes 2x4. Same shape. Less of it. (If you are not sure where your threshold and VO2max zones sit, the [FTP zone calculator](/tools/ftp-zones) sets them from a single test number.)
...
This is also where TrainingPeaks earns its keep, by the way. Monitoring your [training load](/tools/training-load) through the taper gives you a number for the fatigue you are shedding — and when the week falls apart, having the plan visible to a coach who can rearrange it on the fly is one of the genuine wins of a structured platform. You are not making it up by yourself at 11pm on Tuesday. The plan moves with you.
...
- Acknowledge the personal cost of chasing performance. Missed events, time away from family, the quiet trade-offs. The serious amateur faces this every season. The pros do too. Pretending it is not there does not help.
