...
roadmanView:
  - "When Dan Lorang was on the podcast, he prescribed one hard session, three easy rides, and one long ride for amateur cyclists with 6-8 hours — and explicitly warned against stacking two hard days in a short week."
  - "Our Training Load Calculator tracks your weekly TSS against the Lorang framework, flagging when you are drifting into grey-zone accumulation instead of polarised structure."
  - "In the NDY community, the time-crunched riders who improve fastest are the ones who protect their one long weekend ride. Cutting it to save time is the most expensive shortcut."
---
