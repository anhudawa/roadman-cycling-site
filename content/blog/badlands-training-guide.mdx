...
seoTitle: 'Badlands 800km Training Plan: 16 Weeks for Andalusia'
seoDescription: 'Badlands training plan — 16-week build for the 800km gravel ultra across southern Spain. Sierra Nevada, Tabernas Desert, sleep strategy, ultra pacing.'
excerpt: >-
...
keyTakeaways:
  - "Badlands is a logistics, sleep, and durability event — watts are a small part of the picture at 800km."
  - "Build to 18-22 hours per week with at least three back-to-back-to-back long-day weekends (8h + 6h + 4h)."
  - "Complete one 400-500km self-supported ultra in training before race week — no exceptions."
  - "2.5 W/kg with smart pacing finishes in 5-7 days; 3.0-3.2 W/kg contests the front group; 3.5+ W/kg races for the podium."
  - "Cross the Tabernas Desert at night or before 09:00 — midday crossings are the most consistent DNF cause."
  - "Write your sleep plan before the start: where, how long, and what triggers each stop."
faq:
...
whoFor:
  - "Riders with a Badlands entry who need a structured 16-week build, not a generic ultra plan"
  - "Experienced sportive riders stepping up to self-supported ultra-distance for the first time and unsure what the training demands actually look like"
  - "Cyclists who can hold 2.5-3.5 W/kg and want to understand what that means for pacing, sleep strategy, and finishing time at 800km"
  - "Bucket-list gran fondo achievers eyeing Badlands as the big one and wanting an honest assessment of whether they're ready"
roadmanView:
  - "I've said this on the podcast more than once: Badlands is not an FTP event. It's a logistics, sleep, and durability event. The rider with the best sleep strategy wins it, not the rider with the highest threshold. That distinction should change every training decision you make."
  - "The training that actually prepares you is back-to-back-to-back long days — 8 hours Saturday, 6 hours Sunday, 4 hours Monday — repeated three times in the build. I've seen too many riders show up having done single long rides and wonder why they fell apart on day three."
  - "Here's race intelligence that belongs in your plan from day one: cross the Tabernas Desert at night or before 09:00. Midday crossings are the most consistent DNF cause. I've talked to finishers and DNFs, and this is the line between them more often than fitness is."
---
...
The fitness ceiling is not what stops most amateurs at Badlands. The limiting factor is sleep, kit choice, gut training, resupply planning, and the discipline to pace at sustainable wattage when the leaderboard is in front of you. Watts are a small part of the picture. The rest is logistics.
...
Five to six rides, 80% in [Zone 2](/blog/zone-2-cycling-heart-rate-vs-power-vs-rpe). The aerobic engine is non-negotiable for ultra distance. [Stephen Seiler](/guests/stephen-seiler)'s research on training intensity distribution applies hardest at this distance — the easy stuff has to be properly easy, because you're going to spend 90% of Badlands well below threshold and the body needs to be efficient at that pace.
