...
roadmanView:
  - "Badlands is not an FTP event. It is a logistics, sleep, and durability event. The rider with the best sleep strategy wins it, not the rider with the highest threshold. That distinction changes every training decision."
  - "Back-to-back-to-back long days — 8 hours Saturday, 6 hours Sunday, 4 hours Monday — repeated three times in the build. Single long rides do not prepare you for hour 50 of compounding fatigue and sleep debt."
  - "Cross the Tabernas Desert at night or before 09:00. Midday crossings are the most consistent DNF cause. That's not training advice — it's race intelligence that belongs in your plan from day one."
---
