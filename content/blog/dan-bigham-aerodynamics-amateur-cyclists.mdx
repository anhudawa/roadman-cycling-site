...
roadmanView:
  - "Dan Bigham held the UCI Hour Record and is Head of Engineering at Red Bull-Bora-Hansgrohe. He came on the Roadman Podcast and was direct: body position alone is worth 15-20 watts for most amateurs — more than clothing, helmet, wheels, and frame combined."
  - "Most amateurs invert Bigham's hierarchy because equipment purchases are visible and marketed, while position and clothing gains are cheap and unglamorous. This piece corrects that inversion with specific watt savings at each level."
  - "Alex Dowsett, another Roadman Podcast guest with multiple Hour Record attempts, confirmed the same hierarchy independently: position first, equipment last. The experts agree on the order."
---
