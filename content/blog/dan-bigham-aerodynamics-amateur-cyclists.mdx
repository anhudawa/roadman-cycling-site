...
seoDescription: 'Dan Bigham on cycling aerodynamics for the amateur: which aero gains matter, which are just marketing, and where to spend money for real time savings.'
excerpt: >-
...
keyTakeaways:
  - "Body position accounts for 15-20 watts of a typical amateur's 40-watt total aero improvement — more than clothing, helmet, wheels, and frame combined."
  - "Most amateurs invert the hierarchy: they buy the frame or wheels first because those purchases are visible and marketed, while the cheap gains in position and clothing get ignored."
  - "A well-fitted skinsuit saves 5-15 watts over baggy kit, and counterintuitively, covered arms and legs are faster than bare skin due to boundary layer effects."
  - "Deep-section wheels save 3-6 watts at 40 km/h — real savings, but they sit below position, clothing, and helmet in the hierarchy."
  - "An aero frame saves just 2-4 watts at amateur speeds; spending $3,000 on a frame to save 3 watts when a bike fit could save 15 watts is a poor return."
faq:
...
whoFor:
  - "Sportive and time trial riders who want to know where to spend money for the biggest aerodynamic return"
  - "Amateur cyclists who have bought an aero frame or deep-section wheels and are still slower than expected"
  - "Riders preparing for a time trial or triathlon bike leg who want a prioritised hierarchy of gains"
  - "Cyclists curious about wind tunnel testing who need to know whether it is worth the cost at their level"
roadmanView:
  - "When I had Dan Bigham on the podcast, he was blunt: body position alone is worth 15-20 watts for most amateurs. More than clothing, helmet, wheels, and frame combined. That's coming from a bloke who held the UCI Hour Record and now runs engineering at Red Bull-Bora-Hansgrohe."
  - "What I see constantly is riders inverting Bigham's hierarchy — spending thousands on frames and wheels because those purchases are visible and marketed, while ignoring the cheap gains in position and clothing that would save them three times the watts."
  - "Alex Dowsett, who I've also had on the podcast with multiple Hour Record attempts behind him, confirmed the same hierarchy independently. Position first, equipment last. When two blokes at that level agree, I tend to listen."
---
...
The frame is also the most expensive item in the system. Spending $3,000 on an aero frame to save 3 watts when position work could save 15 watts for the cost of a bike fit is a poor return on investment.
...
Quantifying this concretely: if a typical amateur cyclist has 40 watts of total aero improvement available to them (a reasonable estimate for a rider going from unoptimised to fully optimised), the breakdown might look like this. Position improvements account for 15-20 of those watts. Clothing and helmet together account for another 8-12 watts. Wheels account for 5-7 watts. Frame accounts for 2-4 watts. The first two categories — both of which cost less than a mid-range wheelset — represent 55-75% of the total available gain. Use the [Power-Speed Calculator](/tools/power-speed) to see what those watt savings translate to in speed at your riding pace.
...
Step three is the helmet. If you are still riding in an old round-vented helmet, an aero road helmet matched to your head angle saves 3-7 watts and costs $100-250. That is a strong return per dollar spent. Match the helmet tail angle to your actual riding position, not to the position shown in the marketing imagery.
