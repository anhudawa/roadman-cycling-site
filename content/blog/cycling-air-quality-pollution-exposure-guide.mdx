...
answerCapsule: >-
  During cycling, ventilation increases to 40-60 litres per minute versus 6-8 at
  rest, multiplying pollutant intake five to eight-fold. PM2.5 is the critical
  metric. Counter-intuitively, cyclists receive lower cumulative exposure per
  trip than car drivers because car cabins trap and recirculate polluted air.
  Moving one street from a main road reduces NO2 exposure by 30-60%. When the
  AQI exceeds 150, move indoors. Below 100, the health benefits of riding
  outweigh the pollution costs.
keyTakeaways:
...
relatedTools:
  ...
  - "training-readiness"
whoFor:
  - "The urban cyclist who rides through traffic daily and wants to know the actual respiratory risk"
  - "The rider with asthma or respiratory sensitivity who needs evidence-based thresholds for when to move indoors"
  - "The commuter cyclist weighing up whether city riding is doing more harm than good"
  - "The rider planning routes who wants to know how much difference one street back from a main road actually makes"
roadmanView:
  - "Here's something I think every cyclist should know: you're breathing five to eight times more air than the person walking beside you. That means five to eight times more of whatever's in it. Worth thinking about."
  - "Here's where it gets interesting — the research shows cyclists actually get lower cumulative exposure per trip than car drivers on the same route. The car cabin traps and recirculates the polluted air. You move through it. I found that properly surprising."
  - "The easiest win I've seen in the research: one street back from a main road cuts NO2 exposure by 30-60 per cent. Route selection beats timing for most riders. That's a five-minute detour for half the exposure."
---
