...
roadmanView:
  - "You are breathing five to eight times more air than the person walking beside you. That means five to eight times more of whatever is in it. You should know what that is."
  - "The counterintuitive finding is that cyclists actually get lower cumulative exposure per trip than car drivers on the same route. The car cabin traps and recirculates polluted air. You move through it."
  - "Route selection beats timing for most riders. One street back from a main road cuts NO2 exposure by 30-60 per cent. That is the easiest win available."
---
