...
roadmanView:
  - "Barry Murray is one of the clearest voices on this topic. His core point: most cyclists burn carbohydrate because they have never given their body the slow, six-month progression it needs to burn fat efficiently. That is a training problem, not a metabolism problem."
  - "The progression matters more than the destination. Jumping straight to low-carb wrecks training. Murray describes building up fasted rides gradually — an hour, then ninety minutes, then two hours — over months, not weeks."
  - "Fat adaptation has a place in long, low-intensity endurance work. It is not a replacement for carbohydrate when the road tilts up or the race starts. Both fuels answer different demands, and the smart rider trains both systems."
---
