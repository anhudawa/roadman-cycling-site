...
seoTitle: 'Iron Deficiency in Masters Cyclists — Symptoms and Fixes'
seoDescription: >-
  Iron deficiency is the hidden cause of stalled FTP and fatigue in cyclists over
  40. Symptoms, the bloods to ask for, ferritin targets, and how to fix it.
excerpt: >-
...
relatedEpisodes:
  ...
  - ep-2222-discover-the-ultimate-fat-burning-foods-that-99-miss-mark-si
claims:
...
whoFor:
  - Masters cyclists with stalled FTP despite consistent training
  - Riders experiencing heavy legs and fatigue they cannot explain
  - Athletes whose blood work has never been properly checked for ferritin
  - Cyclists over 40 who are blaming age for declining performance
roadmanView:
  - "This is the silent performance killer I see again and again. You're doing everything right and the numbers still won't move — and the answer is sitting in a blood test most riders never request."
  - "Your GP will tell you your iron is 'in range' at 30 ng/mL. That's fine for a sedentary person. For a serious endurance athlete, you want ferritin above 50, ideally 70 to 150."
  - "Before you change your training, your diet, or your coach, get your bloods done. If ferritin is low, fix that first. Everything else is noise until the engine has oxygen."
---

Train into your forties and fifties and you can do everything right — sleep, fuel, structure, recovery — and still feel like you're riding through treacle. Same power numbers, twice the effort. Heart rate creeping up at zone 2. The third climb of every long ride feeling like a brick wall.
...
**Heart rate that runs hot at zone 2.** You're producing the same power but your heart is working harder to deliver oxygen. The [HR zones calculator](/tools/hr-zones) will map what zone 2 should look like for your max heart rate — if the numbers you're seeing on easy rides are well above that ceiling, something is off. The earliest sign in most cyclists is that the same easy ride that used to sit at 130 bpm is now drifting up into the 140s.
...
**FTP stuck or going backwards despite consistent training.** This is the one most riders see and immediately blame on age. Sometimes age is part of it. Often it isn't. The [masters FTP benchmark](/tools/masters-ftp-benchmark) will show you where your threshold sits relative to your age group — if you're well below where the data says you should be, that gap may not be training.
...
And sometimes — more often than people expect — it's the bloods. Iron, vitamin D, B12, hormones in some cases. The training stimulus is fine. The body just doesn't have the raw materials to respond to it. Before you change your training, make sure the nutrition side is covered too — the [Fuel Planner](/tools/fuel-planner) will confirm whether your on-bike intake is where it needs to be.
...
Iron deficiency is one of three or four things we see most often when a serious masters rider tells us their training "stopped working." The others — usually some combination of [low free testosterone](/blog/free-testosterone-cyclists-50th-percentile-dr-gordon), under-fuelling on the bike, and [poor sleep architecture](/blog/cycling-sleep-performance-guide) — share a common theme. Once you have the bloods sorted, the next question most riders ask is which supplements are actually worth taking — the [supplements guide](/blog/supplements-cyclists-what-works-guide) separates the short list with real evidence from the long aisle of noise. The training is fine. The terrain underneath the training is what's off.
