...
seoTitle: 'Wind Tunnel Aero Gains: Gravel Lessons From Dylan Johnson'
seoDescription: >-
  Wind tunnel cycling testing at Silverstone: four hours, 13 watts saved, none
  from the bike. The kit lessons gravel racers should steal, plus cost-per-CdA.
excerpt: >-
...
whoFor:
  - "Gravel racers who want to know where the biggest aerodynamic gains actually sit before spending money on equipment"
  - "Cyclists who assume aero improvements require a new frame or deeper wheels and have never considered kit and position first"
  - "Riders preparing for Unbound, the Migration, or any long-distance gravel event where small watt savings compound over hours"
  - "Anyone interested in the cost-per-CdA framework as a rational way to prioritise aero spending"
roadmanView:
  - "I found Sam Calder's session with Dylan Johnson properly eye-opening — thirteen watts saved in four hours of tunnel time and not a single watt came from the bike. I have been saying on the podcast that the cheap watts are hiding in your socks, your helmet sizing, and your hydration setup, and this data proves it."
  - "I like Sam's framework of cost per CdA instead of cost per gram. When I talked to him on the show, he made the case that a hundred-pound pair of woven socks beats a four-thousand-pound frame on most gravel courses. That is not opinion — it is what the wind tunnel data shows."
  - "I think most amateurs spend in exactly the wrong order. The pros are not winning because of marginal frame differences — they are winning because every layer of kit and every position decision has been tested against a real airflow signal. Start with the items that move the needle most."
---
...
Most amateur cyclists shop on cost per gram. They will pay 1,500 dollars to drop 100 grams from a wheelset. It sounds rational. It is rational, but only on sustained climbs above six or seven percent — the part of the course where gravity wins and aerodynamics quietly stops mattering. The wider [aero vs weight question](/blog/aero-vs-weight-cyclist) goes into the speed at which the curves cross.
...
The hierarchy is not subtle. Kit and position dominate everything until you have already optimised them. The frame is the last thing you should be replacing, not the first. If you want to see what those watt savings mean for your actual speed on course, the [Power-Speed Calculator](/tools/power-speed) makes the translation concrete.

## What This Looks Like In Practice

If you are a serious amateur racing gravel this year, the order is clear.
...
If you want this thinking woven into a year of training and racing — not just a bike-park decision tree — that is what the [Roadman coaching system](/coaching) does for athletes inside the [Not Done Yet community](https://www.skool.com/roadmancycling). The aero work lands harder when it sits on top of structured intensity discipline — the kind of weekly load TrainingPeaks was built to track — and a body composition number that is actually moving. Kit savings compound when the engine underneath is being built properly too.
