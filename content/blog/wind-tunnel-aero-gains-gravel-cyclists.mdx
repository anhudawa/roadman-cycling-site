...
roadmanView:
  - "Thirteen watts in four hours of tunnel time and not a single watt came from the bike. That is the lesson most riders need to hear. The cheap watts are hiding in your socks, your helmet sizing, and your hydration setup — not in a frame upgrade."
  - "Sam Calder from Rule 28 uses cost per CdA, not cost per gram. A hundred-pound pair of woven socks beats a four-thousand-pound frame on most gravel courses. That is not a controversial opinion — it is what the wind tunnel data shows."
  - "The pros are not winning because of marginal frame differences. They are winning because every layer of kit and every position decision has been tested against a real airflow signal. Amateurs can do the same by starting with the items that move the needle most."
---
