...
whoFor:
  - "Runners adding cycling for cross-training or injury management who are overwhelmed by the bike market and want a clear decision framework"
  - "Marathon and half-marathon runners considering a first road or gravel bike purchase within a realistic budget"
  - "Fitness-focused athletes who want a bike for structured aerobic work, not racing, and need to know which features actually matter"
  - "Runners with tight hip flexors and hamstrings who keep hearing 'just buy a road bike' without anyone mentioning geometry or saddle adaptation"
roadmanView:
  - "Runners approach a first bike purchase like a marathon build — six weeks of research, fourteen browser tabs, a spreadsheet. Meanwhile the fitness you wanted the bike for is sitting there waiting. Buy well in a weekend and get riding."
  - "A gravel bike is the more forgiving first choice for most runners: wider tyres, more stable handling, access to traffic-free routes. A hybrid only makes sense if you will never ride longer than 45 minutes. And racing geometry demands flexibility most runners do not have."
  - "Whatever the budget, reserve $150-300 of it for a professional bike fit. The single biggest reason new cyclists quit is discomfort, and the single biggest cause of discomfort is a bike that does not fit. The saddle conversation nobody has with you is the one that matters most."
---
...
**Tyre clearance.** Room for wider tyres — 32mm on a road bike, 40mm-plus on gravel — means more comfort at [lower pressures](/tools/tyre-pressure) and more route options. Wider is the direction the whole sport has moved, for good reason.
