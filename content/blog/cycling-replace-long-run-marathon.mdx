...
whoFor:
  - "Marathon runners with a tight calf or heavy legs wondering whether a bike session can replace Sunday's long run"
  - "Triathletes and dual-sport athletes trying to balance cycling volume with running-specific demands"
  - "Runners in a high-fatigue week who need aerobic stimulus without the impact cost of more miles"
  - "Cyclists who also run and want to know where the research actually draws the substitution line"
roadmanView:
  - "The bike is brilliant for keeping your aerobic engine running when your legs can't take more pounding. But it cannot teach your tendons and bones to survive 42 kilometres of impact. Those are different jobs."
  - "I've seen runners use cycling as a loophole to skip the hard work their tissues actually need. It works early in the build. It falls apart at kilometre 32 when the aerobic engine is fine and the legs are gone."
  - "If your goal is a fast marathon, run. If your goal is fitness and durability across the year, the bike can absorb a meaningful share of your aerobic volume with far less injury risk."
---
...
None of this makes the bike useless in a marathon build. Used in the right slots, it's one of the smartest tools available. Four situations where the substitution works:
...
Distance doesn't convert cleanly between the sports, so when you do substitute, swap by time and effort rather than kilometres. A 50-minute easy run becomes a 60-75 minute Zone 2 ride — conversational effort, higher cadence, no surges. The [run-ride converter](/tools/run-ride-converter) does the maths for you — plug in the run and get the equivalent bike session. The full exchange-rate logic is covered in the [conversion guide](/blog/running-cycling-conversion-calculator), but the short version is that cycling needs roughly one and a half times the duration to match a run's aerobic stimulus, because the bike carries your body weight and running doesn't.
...
One more practical note: keep the substituted rides properly easy. The temptation on a bike is to chase speed, chase segments, half-race the group that passes you. A recovery-run replacement ridden at tempo isn't a substitution — it's an extra hard day smuggled into your week, and it will show up as flat legs on Thursday.
