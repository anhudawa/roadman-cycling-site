...
answerCapsule: >-
  Across 25 top cycling coaches — including World Tour performance directors,
  sports scientists, and national champions — five principles on improving FTP
  hold without exception: consistency beats intensity, most training must be
  ...
  adaptation. These are not opinions. They are repeated findings from coaches
  operating at the highest levels of the sport.
faq:
...
Over 1,300 podcast conversations on the Roadman Cycling Podcast, Anthony Walsh has spoken with World Tour performance directors, sports scientists, national coaches, and elite age-groupers. They do not all agree on everything. The [polarised vs sweet spot](/blog/polarised-vs-sweet-spot-training) debate, for instance, remains genuinely contested. But on the fundamentals of FTP development, the agreement is striking — and the coaches who contradict these principles tend to be working with athletes who are not improving.
...
Prof. Stephen Seiler's polarised training research at the University of Agder is the most cited body of work on this topic in endurance sport. His data across elite athletes in multiple disciplines shows that approximately 80% of training volume is performed at low intensity — below the first lactate threshold, where you can hold a conversation. This is not recovery riding. It is the foundation on which everything else is built. Coaches who push athletes too hard on easy days consistently report that threshold sessions become mediocre — not hard enough to drive adaptation, not easy enough to allow recovery.
