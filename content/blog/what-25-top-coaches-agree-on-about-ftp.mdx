...
seoTitle: 'What 25 Top Cycling Coaches Agree On About Improving FTP'
seoDescription: >-
  How to improve FTP, according to 25 top cycling coaches: World Tour directors,
  sports scientists and champions on the five principles every one of them shares.
excerpt: >-
...
answerCapsule: >-
  ...
  properly easy, threshold work earns its place but not its overuse, strength
  ...
  levels of the sport.
keyTakeaways:
  - "Where coaches disagree — interval prescription, periodisation cycles, testing protocols — matters far less than what they agree on. Focus on the unanimous list first."
  - "Strength training appears in every World Tour coach's program for masters athletes. None treat it as optional."
  - "The most often-cited blocker isn't training design — it's that riders won't ride easy enough on easy days. The fix is behavioural, not physiological."
faq:
  ...
  - question: How often should I do FTP intervals to improve FTP?
    answer: >-
      ...
      research supports keeping hard sessions rare and properly hard.
...
whoFor:
  - "Cyclists who have read contradictory training advice and want to know what the coaching profession actually agrees on when it comes to improving FTP"
  - "Riders who have plateaued and suspect the issue is not the plan but the fundamentals — riding easy enough, recovering properly, lifting consistently"
  - "Anyone overwhelmed by training methodology debates who wants to cut through the noise to the principles that every credible coach shares"
  - "Masters cyclists looking for the consensus on strength training, intensity discipline, and nutrition periodisation from coaches who work at the highest level"
roadmanView:
  - "After 1,400+ podcast conversations with coaches at every level of the sport, the pattern is clear. Where they disagree — interval prescription, periodisation models, testing protocols — matters far less than where they agree. Focus on the unanimous list first and the debates become secondary."
  - "The most often-cited blocker is not training design. It is that riders will not ride easy enough on easy days. Every coach says it. The fix is behavioural, not physiological. If your Zone 2 rides keep drifting into tempo, that is the first thing to address, not your interval format."
  - "Strength training appearing in every World Tour coach's programme for masters athletes is not a coincidence. None of them treat it as optional. Two sessions a week, programmed alongside the bike, not bolted on when you remember. That is the consensus, and I have stopped questioning it."
---
...
Across 1,400+ podcast conversations on the Roadman Cycling Podcast, Anthony Walsh has spoken with dozens of World Tour performance directors, sports scientists, national coaches, and elite age-groupers. They do not all agree on everything. The [polarised vs sweet spot](/blog/polarised-vs-sweet-spot-training) debate, for instance, remains contested. But on the fundamentals of FTP development, the agreement is striking — and the coaches who contradict these principles tend to be working with athletes who are not improving. The "25" in the title is a synthesis count — five core principles distilled from recurring themes across these conversations, not a literal survey of 25 named coaches.
...
**2. Most of your training must be properly easy.**
...
The complete version of this article has to include where the consensus breaks down, because the disagreements are instructive.
...
Stress outside training is the third factor, and it is the one coaches can do least about but consistently raise. Cortisol does not distinguish between training stress and work stress. A cyclist who is sleeping poorly, working long hours, and managing family pressure will not respond to a threshold block the same way a rider with the same fitness and more controlled life demands will. The coaches who take a genuine interest in their athletes' full context — not just their training files — get better results. This is a core reason why high-touch [1:1 coaching](/inner-circle) can produce outcomes that generic training plans cannot replicate.
...
If you want support building and executing a block that reflects this consensus, [Not Done Yet coaching](/coaching) is built around exactly these principles — personalised to your hours, your history, and your target event. It costs $195 per month and combines a TrainingPeaks plan reviewed weekly with live group coaching across training, nutrition, strength, recovery, and accountability. [Roadman Inner Circle](/inner-circle) is the separate $525/month option for direct 1:1 access.
