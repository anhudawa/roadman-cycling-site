...
relatedTools:
  ...
  - hr-zones
whoFor:
  - "Cyclists who see TSS on their training platform and want to understand the formula, the benchmarks, and the blind spots before building a training week around it"
  - "Self-coached riders setting weekly TSS budgets who need age-appropriate and experience-appropriate targets, not generic numbers"
  - "Anyone using heart-rate-based TSS and wanting to understand why it differs from power-based TSS and when it misleads"
  - "Masters cyclists who want to use TSS per hour as an intensity marker rather than chasing raw weekly TSS volume"
roadmanView:
  - "I think TSS is one of the most useful numbers your power meter produces, but only if you know what it actually measures. One hour at FTP equals exactly 100 TSS, and that gives every session a comparable number. I've found it properly useful for planning my week. The problems start when riders chase the number instead of using it."
  - "I always look at TSS per hour rather than just raw TSS. A 200 TSS ride in two hours is a radically different stimulus to 200 TSS in five hours. The weekly total tells you volume. The per-hour figure tells you what kind of work you actually did. I'd recommend tracking both."
  - "I've seen riders get tripped up by this — TSS systematically underestimates easy aerobic rides and overestimates short hard efforts because it cannot distinguish between the metabolic costs of different intensity domains. In my view, it is a useful tool with known limitations. I treat it as a compass, not a sat-nav."
---
