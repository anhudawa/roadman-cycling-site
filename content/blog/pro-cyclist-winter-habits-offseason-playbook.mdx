...
The pro winter is not exotic. It is just structural. Take a real break. Get the dental check. Pull the full bloods. Sit down with the season's data and write the unflinching review. Set process goals against directional outcomes. Reset zones with a sensible test, not a lab stress event. Commit to the strength work while the riding hours are low.
