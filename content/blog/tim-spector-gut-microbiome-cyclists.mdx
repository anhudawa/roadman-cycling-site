...
seoTitle: Tim Spector — Cyclist Gut Microbiome and Why Calories Are the Wrong Metric
seoDescription: >-
  Prof. Tim Spector on why calories-in/calories-out is a broken model for
  cyclists, what 30 plants a week actually does to your microbiome, and the
  evidence behind food quality over quantity.
excerpt: >-
...
The Spector position isn't that calories are meaningless. It's that they're the wrong primary lens. Quality first. Diversity second. Satiety third. The arithmetic falls out of those three. We laid out the broader framework in [the cycling weight-loss breakdown](/blog/why-cyclists-cant-lose-weight-five-causes) and inside the coaching that runs in the [Not Done Yet community](/community/not-done-yet).
