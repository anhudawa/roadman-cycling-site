...
roadmanView:
  - "British Cycling Level 3, TrainingPeaks Level 2, or a sports-science degree separate coaches from hobbyists in the UK market. A certificate alone is not enough — verifiable race results, sportive PBs, and client progression are the real test."
  - "Prescribing six outdoor rides a week in a Yorkshire January is a red flag. British weather and short winter daylight are coaching variables, and any coach who ignores them is not coaching for the UK — they are copying a template from somewhere sunnier."
  - "Online coaching from Ireland or mainland Europe is functionally identical to UK-based coaching when time zones and calendar knowledge align. That is exactly how Roadman's NDY programme works — and why geography is rarely the deciding factor."
---
