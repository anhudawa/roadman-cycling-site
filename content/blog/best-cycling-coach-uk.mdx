...
**Sportive peaking.** Ride London (summer), Fred Whitton (May), Étape Caledonia (May) — each needs a specific taper and nutrition plan. The [Roadman race-time predictor](/predict) has presets for Ride London, Fred Whitton, and the Étape so you can sanity-check the time you're actually capable of before the work begins.
