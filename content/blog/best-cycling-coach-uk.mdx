...
seoDescription: >-
  How to choose a cycling coach in the UK $€” what actually matters when picking
  one, what doesn't, and why distance to your coach is rarely the right filter.
excerpt: >-
...
answerCapsule: >-
  ...
  London, Fred Whitton, Tour of the Peak, Ã‰tape Caledonia), TT culture, and the
...
faq:
  ...
  - question: How much does a cycling coach cost in the UK?
    answer: >-
      ...
      Yet programme is $195/month (around $$155). Below $$80 is usually plan
      delivery, not coaching. Above $$400 needs an elite CV you can verify.
relatedEpisodes:
...
- **Sportive culture.** Ride London, Fred Whitton, Ã‰tape Caledonia, Tour of the Peak, Tour of Wessex, Dragon Ride, Dirty Reiver for the gravel crowd. These are the target events for most UK amateurs.
- **Target overseas events.** Ã‰tape du Tour, Haute Route, Maratona, Marmotte $€” a UK coach needs to know how to periodise for a 10$°C September sportive AND a 35$°C Alpine day.
...
What matters less: weekend online certs, general PT qualifications bolted onto cycling, and race palmarÃ¨s alone. A former Premier Calendar rider with zero coaching study is a fast person, not automatically a coach.
...
- **No system for travel/overseas events.** If you're targeting Ã‰tape or Haute Route, your coach must know heat acclimation, altitude acclimation, and taper-into-travel protocols.
- **Pressure sales.** Real coaches don't run countdown timers.

## What UK cyclists actually need

**Weather and daylight.** UK base season (November$€“February) is wet, cold, and dark. Coaches who only know how to build volume outdoors are useless here. Look for integrated indoor work that isn't just "do a 2 Ã— 20 on Zwift" every week.
...
**Sportive peaking.** Ride London (summer), Fred Whitton (May), Ã‰tape Caledonia (May) $€” each needs a specific taper and nutrition plan.
...
Honestly: [Roadman](/coaching/uk) runs the Not Done Yet coaching community at $195/month (around $$155). One-to-one online, based in Dublin, run by me (Anthony Walsh). Same time zone as you, same kind of weather you ride in, and a calendar view that covers the UK sportive and race scene plus European target events. Most of our UK clients ride 8$€“14 hours a week, target either Cat progression, a sportive PB, or an Ã‰tape-type peak, and want someone who'll actually reply when they message. If that sounds like the fit, the [application process](/apply) is where we talk $€” no pitch, just a conversation about whether it's the right call.
