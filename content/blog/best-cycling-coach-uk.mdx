...
Not really. I've coached riders from Glasgow to Brighton from Dublin and it makes no difference to outcomes, because TrainingPeaks, WhatsApp, and Zoom close the distance completely. Ireland–UK also means zero time-zone difference. The same logic holds further afield — if you're reading this from the other side of the Atlantic, the [how to choose a cycling coach in the USA](/blog/best-cycling-coach-usa) version walks through the same framework against US racing categories and the time-zone question that comes with it.
