...
whoFor:
  - "A road cyclist entering their first duathlon who has never run off the bike before"
  - "A cyclist who tried running after a ride once, hated the jelly-leg feeling, and gave up"
  - "A rider adding running for cross-training or bone health who wants to combine it with cycling sessions"
  - "A cyclist exploring multisport without committing to full triathlon and wanting a structured plan"
roadmanView:
  - "The jelly-leg feeling is completely normal and it goes away faster than you would expect. Most of the adaptation happens in the first handful of sessions, not over months."
  - "This is written for cyclists, not triathletes. The goal is not Ironman preparation. It is teaching your body to switch movement patterns so running off the bike stops feeling like a punishment."
  - "One or two bricks a week is the maximum useful dose. More than that just adds fatigue without adding skill. Keep it simple and consistent."
---
...
**Weeks 3–4.** Add some tempo to the middle of the ride so you dismount with properly tired legs, then run fifteen easy minutes without walk breaks. Focus on quick, short steps — aim for a cadence around 170–180 steps per minute. Overstriding on jelly legs is how people hurt themselves.
...
**Running too hard off the bike.** Your perceived effort is scrambled for the first ten minutes — pace feels harder, so cyclists with good engines push to compensate, land on their normal pace anyway, and turn a skill session into an interval session. Running by [heart rate zones](/tools/hr-zones) rather than pace solves this: stay in zone 2, accept the slower kilometres early, and let the pace come back to you as the legs come online.
...
**Treating every brick as a fitness test.** Chasing pace numbers on tired legs, week after week, is how a smart stimulus becomes an overuse injury. Track the [training stress](/tools/tss) the brick adds to your week rather than fixating on pace — the metric that matters is the shrinking gap between your fresh pace and your off-the-bike pace at the same effort, not the absolute number.
