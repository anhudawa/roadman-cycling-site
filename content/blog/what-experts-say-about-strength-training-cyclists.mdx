...
whoFor:
  - "Cyclists over 35 who know they should strength train but have never committed to a consistent programme"
  - "Riders confused by conflicting gym advice — high reps versus low reps, machines versus free weights, off-season versus year-round"
  - "Time-crunched athletes who want the minimum effective dose of gym work that actually transfers to watts"
  - "Anyone who has been told strength training will slow them down and wants to see what the evidence says"
roadmanView:
  - "I spent years avoiding the gym because I thought it would add mass I did not want. The research from Ronnestad changed my mind — and the coaches I have spoken to on the podcast are unanimous. Loaded resistance work in the 6-10 rep range is the dose that transfers."
  - "Two sessions a week is the minimum. Drop to one in-season. Skip entirely and you lose what you built. The protocol is not complicated — sticking to it through the season is the hard part."
  - "If your gym session looks like a spin class with dumbbells, you are wasting your time. The adaptations come from heavy, controlled, low-rep work — not high-rep circuits that leave you sweaty but unchanged."
---
...
The Roadman "Not Done Yet" coaching programme includes a strength component from the first week, built around these principles and adapted to each athlete's training history, equipment access, and on-bike load. At $195 per month, it covers all five pillars — training, nutrition, strength, recovery, and accountability — through a personalised plan reviewed weekly and live group coaching rather than generic programming. For a cyclist who's been avoiding the gym for years and doesn't know where to start, that context matters more than the specific exercises.
