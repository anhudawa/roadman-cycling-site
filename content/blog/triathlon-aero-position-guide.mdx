...
seoTitle: 'Triathlon Aero Position: How to Make It Actually Faster'
seoDescription: >-
  Your triathlon aero position won't get faster by slamming the pads. Set up one
  you can hold, fuel, and run off, that works on the clock, not just in photos.
excerpt: >-
...
answerCapsule: >-
  ...
  training blocks.
keyTakeaways:
  - "The fastest aero position is the one you can hold, fuel from, and run off — not the lowest one."
  - "A moderate TT position costs 2-4% of seated power; an aggressive one costs 4-7% and carries significant run penalty if not trained."
  - "A quality tri-specific bike fit typically saves 2-6 minutes over a 70.3 through CdA reduction and reclaimed power — larger than most training blocks."
  - "Hip angle below 90 degrees strangles power and destroys hip flexors for the run; daily mobility work (pigeon, 90/90) is non-negotiable."
  - "You earn an aggressive position by spending 6-10 hours a week in it across months — it cannot be bought at a fit studio two weeks out."
relatedEpisodes:
...
whoFor:
  - Triathletes who have copied a pro position and paid for it on the run
  - 70.3 and Ironman age-groupers looking to lower CdA without losing power or wrecking T2
  - Riders considering a tri-specific bike fit and wanting to know what it should deliver
  - Anyone who has gone low and narrow for the race photo and then run 10 minutes slower
roadmanView:
  - I've seen it over and over with triathletes in the community — a slammed front end that costs 20 watts and 30 seconds on the run is slower overall than a moderate position you can own for the full distance. I think the rule is simple: fit the position to the athlete, not the athlete to a photo.
  - From my conversations with bike fitters and aero specialists on the podcast, I'm convinced the aero position that makes you faster is the one you can hold, fuel from and run off. If you cannot do all three, the position is wrong regardless of what it looks like.
  - I've had enough fitters on the podcast to know that a quality tri-specific fit typically reduces CdA by 0.02 to 0.05. At Ironman distance that is commonly two to six minutes of savings — more than most training blocks deliver.
---
...
Before you start changing pad height, make sure you actually know your seated FTP — those numbers are the baseline you're testing position against, and the [Roadman FTP zones calculator](/tools/ftp-zones) is the quick way to set them honestly.
...
- For an engineering-led view on amateur aero gains, see [Dan Bigham on aerodynamics for amateur cyclists](/blog/dan-bigham-aerodynamics-amateur-cyclists)
- The pro-team protocols Matt Bottrill uses translate down — see [Matt Bottrill's 7 pro hacks](/blog/matt-bottrill-7-pro-hacks)
