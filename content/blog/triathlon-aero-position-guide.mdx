...
seoTitle: Triathlon Aero Position — How to Actually Make It Faster, Not Just Look Pro (2026)
seoDescription: >-
...
faq:
  - question: How low should my aero position be?
    answer: >-
      As low as you can hold for the full race duration without losing more
      than 3-5 per cent of your seated FTP, and without cooking your hip
      flexors for the run. An aggressive position that costs 20 watts and 30
      seconds off the run is slower overall than a moderate one you can own.
  ...
  - question: When does a bike fit pay for itself?
    answer: >-
      ...
      reduces CdA by 0.02-0.05 and reduces power loss relative to the road
      bike. At 70.3 and Ironman distances that's commonly 2-6 minutes of
      savings — more than most training blocks deliver.
  - question: Does an aero position wreck the run?
    answer: >-
      A bad one does. Shortened hip flexors, closed hip angles and overloaded
      lower back all compound across the bike leg and show up as a stiff,
      slow first 5km of the run. A well-fitted position should leave you
      able to run at target pace off T2.
answerCapsule: >-
  A faster triathlon aero position is one that lowers CdA without costing
  meaningful power or destroying your run. Target pad drop you can hold for
  race duration, power loss under 3-5 per cent vs seated FTP, and hip angles
  that protect your hip flexors. A fit typically saves 2-6 minutes — bigger
  than most training blocks.
---
