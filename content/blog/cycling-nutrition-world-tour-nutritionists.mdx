...
roadmanView:
  - "When Dr. Sam Impey was on the podcast, he explicitly walked back the 120g/hr message for amateurs — the number was designed for sub-3-hour TT efforts at threshold, not a four-hour Saturday spin."
  - "Our Fuel Planner calculates your carbohydrate targets per hour based on ride duration and intensity, so you are not guessing from a number that was never meant for you."
  - "In the NDY community, riders who drop from 120g/hr to 60-80g/hr on endurance rides consistently report fewer GI issues and no measurable power loss — the data backs what Dr. Impey told us."
---
...
Nutrition isn't fixed across a year. The amount of carbohydrate that's appropriate during a base phase is different from a build phase is different from a race phase. The [nutrition periodisation guide](/blog/nutrition-periodisation-base-build-race) lays out the phases in full, but the short version:
