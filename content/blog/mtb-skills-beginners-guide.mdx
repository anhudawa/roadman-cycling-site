...
**Entry speed:** Set your speed before the corner by braking on the straight. Enter the corner at the speed you want to carry through it. No braking mid-corner unless you absolutely have to — braking in a corner stands the bike up and pushes you wide.
...
**Don't brake on roots.** Especially wet roots. They have almost zero traction and braking on them is a recipe for a slide-out. Scrub speed before the roots and roll through.
...
**Where to practice:** Pump tracks are purpose-built for this. Find one and spend an afternoon on it. The goal is to maintain speed through the rollers without pedalling. Once you can pump a pump track, you'll start finding opportunities to pump on every trail you ride.
...
3. **Cornering** — Practice on easy corners first, looking through the exit.
4. **Roots and rocks** — Relaxed grip, let the bike move.
5. **Climbing** — Smooth power, forward weight, early shifting.
6. **Descending** — Dropper down, balanced weight, trust the bike.
7. **Line choice** — Start looking further ahead.
8. **Drops** — Start small, build gradually.
