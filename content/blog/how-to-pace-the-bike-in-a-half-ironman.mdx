...
seoDescription: >-
  Half Ironman bike pacing that protects your run: wattage targets, heart-rate
  ceilings, and fuelling timing so you finish the 90km ready to run fast off it.
excerpt: >-
...
answerCapsule: >-
  ...
  decided.
keyTakeaways:
  - "Target 70-78% of FTP as Normalised Power for the 90km bike leg — above 0.80 Intensity Factor is almost always a bike PB followed by a run blow-up."
  - "The first 30 minutes are the biggest trap: post-race power files consistently show first-hour NP running 5-12% higher than second-hour NP in age-groupers."
  - "Set a heart-rate ceiling 5-8 bpm below threshold as a backup channel — if HR climbs 8-10 beats above expected at the same power, back off immediately."
  - "Start fuelling within 15 minutes of leaving T1 and deliver 70-90g carbohydrate per hour across the full bike leg."
  - "Variability Index should stay under 1.05 on flat courses — surging and coasting burns more glycogen than a steady effort at the same NP."
  - "If you overcooked the first 30 minutes, drop NP by 5% for the next hour rather than the next 10 minutes — you cannot un-burn glycogen, but you can limit the damage."
faq:
...
whoFor:
  - Age-group triathletes racing their first 70.3
  - Experienced triathletes who keep blowing up on the run
  - Cyclists crossing into triathlon who over-bike the course
  - Anyone targeting a half Ironman PB through smarter pacing
roadmanView:
  - I've looked at hundreds of 70.3 power files and the mistake is always the same — too hot in the first 30 minutes when adrenaline masks the cost.
  - The bike split is not where you win a half Ironman. The run is. Everything in this guide is about protecting that run.
  - Set the wattage cap, respect the heart-rate ceiling, start fuelling inside 15 minutes, and resist every instinct to chase wheels early.
---
...
[Dan Lorang](/guests/dan-lorang), who coached Jan Frodeno and Anne Haug through multiple world titles, has been explicit on the Roadman Cycling Podcast. The bike in a long-course race is about energy conservation, not output maximisation. His top athletes routinely ride the first 15 minutes 5–10% under target, not at it.
...
If you want this built properly into a block that targets your A-race, [triathlon bike coaching](/coaching/triathletes) inside the Not Done Yet coaching community sets the cap based on your recent testing, your run durability, and the specific course profile.
...
Prof. [Stephen Seiler](/guests/stephen-seiler)'s work on internal versus external load applies directly here. Power is external load — what you produced. Heart rate is internal load — what it cost you. A mismatch between the two is always information worth acting on.
...
[Dan Bigham](/guests/dan-bigham)'s aero work is worth a note here: on a flat course, holding an aggressive TT position saves more time than any extra 10 watts would. Pace conservatively and stay aero. That's the combination that produces the fastest bike split you can run off.
...
Companion reads: [70.3 bike training plan](/blog/70-3-bike-training-plan-12-weeks), [bike leg of triathlon — why age-groupers get it wrong](/blog/bike-leg-of-triathlon-why-age-groupers-get-it-wrong), [triathlon FTP pacing strategy](/blog/triathlon-ftp-pacing-strategy), and [triathlon bike nutrition strategy](/blog/triathlon-bike-nutrition-strategy).

If you want the pacing plan rehearsed in training across a full build, [NDY coaching at Roadman](/coaching) is built for [triathletes](/coaching/triathletes) specifically. Got a specific question — your own IF target, what to do if your power runs hot in the first hour? [Ask Roadman](/ask) for an answer drawn from the actual coach conversations on the podcast.
