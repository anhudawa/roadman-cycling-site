...
answerCapsule: >-
  In a half Ironman, the 90km bike leg should be ridden at 70–78% of FTP (Normalised Power) for most age-group athletes, with a heart-rate ceiling roughly 5–8 beats below threshold. The first 30 minutes are the biggest trap — riders routinely push 10–15% above target while adrenaline masks the cost. Fuelling should start inside the first 15 minutes and deliver 70–90g carbohydrate per hour. The run, not the bike split, is where the race is decided.
faq:
...
**0–30 minutes.** Start drinking by minute 10. Take your first gel or 25g carb dose at minute 15. HR will still be elevated from the swim — don't force solid food. A carb drink at 60–80g/litre is the easiest way to get fuel in while the gut settles. Target: 30–40g of carbs in the bag by the 30-minute mark.
