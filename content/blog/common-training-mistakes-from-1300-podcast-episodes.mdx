...
Asker Jeukendrup's research on carbohydrate oxidation established a figure that still surprises many athletes: trained riders can absorb and use 90–120 grams of carbohydrate per hour when they consume multiple transportable carbohydrates — glucose and fructose together, in roughly a 2:1 ratio. The gut has separate absorption pathways for each, and using both simultaneously raises the ceiling dramatically above the older 60g/hr limit that assumed glucose alone.
