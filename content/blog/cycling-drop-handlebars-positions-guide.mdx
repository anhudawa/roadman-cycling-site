...
answerCapsule: >-
  Drop bars offer three positions: hoods (default, 70-80% of riding time), drops
  (descending, sprinting, headwinds -- reduces frontal area by 10-15%), and tops
  (recovery spinning on flat roads, no brake access). Rotating between them every
  10-15 minutes reduces nerve compression and fatigue. Adjust brake lever reach
  with the small screw inside the lever body so drops feel comfortable for
  braking. Bar width should roughly match shoulder width measured at the acromion
  points.
keyTakeaways:
...
relatedTools:
  ...
  - "wind-chill"
whoFor:
  - "The new road cyclist who rides on the hoods for every metre and never uses the drops or tops"
  - "Any rider suffering from hand numbness, neck pain, or shoulder soreness on longer rides"
  - "The cyclist who avoids the drops because the brake levers feel too far away"
  - "Anyone who has never adjusted their brake lever reach and didn't know it was possible"
roadmanView:
  - "I have watched thousands of riders on group rides and the pattern is always the same — hands glued to the hoods for the entire ride. Drop bars have three positions, each designed for a different job. Ignoring two of them is like owning a six-speed car and never leaving third."
  - "The lever reach adjustment is a five-minute job that completely transforms descending confidence. I cannot tell you how many riders I have spoken to on the podcast who did not even know that little screw existed."
  - "Rotate your hand position every ten to fifteen minutes. I have lost count of the riders who come off long rides with numb fingers and blame the bike when the real problem is they never moved their hands."
---
