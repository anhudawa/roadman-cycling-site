...
roadmanView:
  - "Most zone 2 guides tell you what to do. This one explains why it works at the cellular level — mitochondrial biogenesis, fat oxidation, capillary development — because understanding the mechanism changes how seriously you take the dose."
  - "San Millan's research is clear: 8-12 weeks of consistent zone 2 work before measurable changes in lactate clearance appear. That is a long time to train on faith. But the structural adaptations compound over 6-18 months and the riders who stick with it are properly transformed."
  - "Indoor zone 2 needs 5-10% lower power targets than outdoor riding. Reduced airflow raises core temperature, cardiac drift inflates heart rate, and what looks like zone 2 on the screen is zone 3 in your body. Adjust or the session is wasted."
---
