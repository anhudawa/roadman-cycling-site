...
seoTitle: 'What 5 World Tour Coaches Say About Zone 2 Training'
seoDescription: >-
  Zone 2 training from the experts: Seiler, Lorang, Wakefield, Friel and
  Anastopoulos on where they agree, where they split, and what it means for you.
excerpt: >-
...
answerCapsule: >-
  ...
  training volume should sit at easy intensity (Zone 2), with the
...
keyTakeaways:
  - "The disagreement isn't whether Zone 2 matters — it's how to define \"easy\". Lactate (Lorang), heart rate (Friel) and perceived effort (Seiler) all give different answers to the same question."
  - "At 8 hours per week, that's ~6.5 hours easy plus 90 minutes of structured high-intensity. Most amateurs miss both ends — too hard on easy days, too cautious on hard ones."
  - "Cross-training counts toward aerobic base if intensity stays low. Specificity still matters for the top 20% — that work belongs on the bike."
faq:
  - question: What do professional coaches say about Zone 2 training?
    answer: >-
      ...
      roughly 80% of weekly training volume at easy intensity and 20%
  ...
  - question: Does cross-training count as Zone 2 for cyclists?
    answer: >-
      ...
      intensity stays low. The aerobic adaptations — mitochondrial
...
whoFor:
  - "Riders who have heard about 80/20 training but are not sure whether their easy rides are actually easy enough"
  - "Cyclists training 8-10 hours a week who want to know how five different World Tour coaches would split that time"
  - "Anyone frustrated by conflicting zone definitions — heart rate versus power versus lactate versus perceived effort"
  - "Self-coached athletes who suspect they are spending too much time in the grey zone but have no framework to fix it"
roadmanView:
  - "I have had five of the best coaches in the world sit across from me and answer the same question about Zone 2. They all agree on the principle. Where they disagree is how to define the ceiling — and that disagreement is the thing most riders have never heard explained properly."
  - "If you are breathing through your mouth on your easy ride, you are not in Zone 2. That is not my opinion — that is Seiler, Lorang, Wakefield, and Friel all saying the same thing in different words."
  - "The amateur mistake is riding the middle. Not hard enough to adapt, not easy enough to recover. Fix that one problem and everything else starts to move."
---
...
The confusion is partly definitional — five coaches will give you five slightly different numbers for where Zone 2 ends. But across 1,400-plus podcast episodes, certain patterns emerge. When you put Prof. [Stephen Seiler](/guests/stephen-seiler), [Dan Lorang](/guests/dan-lorang), [John Wakefield](/guests/john-wakefield), Vasilis Anastopoulos, and [Joe Friel](/guests/joe-friel) in separate conversations and ask the same questions about low-intensity training, the agreements are striking. So are the disagreements.

This article maps both. Where the evidence is clear, it says so. Where experts actually differ, it gives you the tools to decide which position fits your situation.

## The consensus: 80% of training should be properly easy
...
Lorang and Wakefield both accept cross-training as base volume for their athletes, particularly during off-season blocks or when injury forces it. The stipulation is that intensity must stay easy. A Zone 2 run at 65% of max heart rate contributes to aerobic base. A tempo run does not, and neither does easy cycling if it is actually moderate cycling with a slow cadence.
...
For triathletes, the calculus is different. All three modalities are the sport, so cross-training is simply training. The relevant question is whether the aerobic work in each discipline is easy. On the Roadman Cycling Podcast, Lorang noted that his triathlon athletes often needed to be held back from turning easy swims into threshold efforts — the competitive instinct does not switch off in the pool.
...
Eight hours a week is a realistic ceiling for a working adult who trains seriously. At that volume, the 80/20 split means roughly 6 to 6.5 hours at Zone 2 and 90 minutes to 2 hours of high-intensity work. That sounds simple. In practice, it requires real discipline.
...
The single change, then, is not a new workout, a new supplement, or a new technology. It is riding your easy days easy enough that your hard days can be hard.
...
If you want a structured approach built around your specific training hours, current fitness, and target events, that is exactly what the [Not Done Yet coaching programme](/coaching) is designed to deliver: a personalised TrainingPeaks plan reviewed weekly, live group coaching, and the same principles these coaches have spent their careers refining.
...
For the practical companion reads, see the [zone 2 complete guide](/blog/zone-2-training-complete-guide), [Zone 2 by HR vs power vs RPE](/blog/zone-2-cycling-heart-rate-vs-power-vs-rpe), and [Zone 2 vs endurance training](/blog/zone-2-vs-endurance-training). For the source-level Seiler reads, see [what Stephen Seiler says about polarised training](/blog/what-stephen-seiler-says-about-polarised-training) and [Prof. Seiler on cycling fast at a low heart rate](/blog/prof-seiler-low-heart-rate-cycling).

Got a specific question after reading the experts — your own Zone 2 number, drift, or whether your easy rides are actually easy? [Ask Roadman](/ask) for an answer drawn directly from these expert conversations.
