...
roadmanView:
  - "Most cyclists have a cadence. Few have trained it. The difference between 82 rpm out of habit and 92 rpm because your neuromuscular system can handle it is the difference between fighting the pedals and flowing with them."
  - "The Contador-Froome spinner-versus-grinder debate is misleading. Both riders adjusted cadence to gradient and effort. The best climbers use the full range, not one fixed gear."
  - "For masters riders especially: neuromuscular speed declines with age if you do not train it. High-cadence drills are not just for track sprinters."
---
