...
If that sounds familiar, it should. It's the exact tension every cyclist with a power meter lives inside. The numbers tell you what you produced. They don't tell you what it cost, how the legs felt, whether something was off. The best in the world, in a sport drowning in data, still trust the human in the seat. So should you. Your power file and your perceived effort are two instruments reading the same effort, and the riders who get fitful insist on both — which is the whole argument for [pairing RPE with power](/blog/rpe-and-power-using-them-together) rather than worshipping the watts.
