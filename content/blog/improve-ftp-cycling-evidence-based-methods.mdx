...
seoDescription: >-
  Seven evidence-based methods to raise your FTP, drawn from the Habis low
  cadence study, Ronstad's heat protocol, Dr Sellars' respiratory research, and
  prescriptions from coaches who work with the World Tour.
excerpt: >-
...
relatedEpisodes:
  ...
  - ep-4-low-cadence-training-8-7-vo2max-gain
  - ep-17-7-fixable-reasons-your-vo2-max-is-low
...
If your FTP has been stuck for more than six months, run the [training diagnostic](/diagnostic) — it'll tell you which of the seven methods is your weakest link. Plug your current FTP into the [FTP Zones Calculator](/tools/ftp-zones) so the next block of work targets the right intensities. If you want the structure built around your week and the live coaching to keep the periodisation honest, the [Not Done Yet community](https://www.skool.com/roadmancycling) runs weekly calls where FTP plateau breakdowns are the most common request we get. For deeper one-on-one work, the [Roadman Method](/method) is the structured 12-month programme that takes a rider through all seven methods in sequence with personal coaching support.
