...
roadmanView:
  - Most FTP plateaus aren't a ceiling — they're a sign you've been doing the same two things for too long. Each of these seven methods has a named study or a named coach behind it.
  - The 2024 Habis study on low-cadence intervals nearly doubled VO2max gains versus freely chosen cadence. Same sessions, same effort, very different outcome. That's the kind of evidence that should change what you do this week.
  - Stack two or three of these methods across a season and the number moves. Keep doing what you've always done and it won't. That's not opinion — it's what the research consistently shows.
---
