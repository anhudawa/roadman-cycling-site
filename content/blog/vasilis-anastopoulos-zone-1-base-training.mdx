...
For an amateur, the practical version is simple. If you can complete two to three hours of easy riding without your heart rate drifting and without being wrecked the next day, you have the platform. If a two-hour "easy" ride leaves you flat for two days, you do not yet — and piling threshold work on top of that will only bring the decline he describes forward.
