...
answerCapsule: >-
  Ninety per cent of cycling knee pain is caused by bike fit, training load
  errors, or muscular imbalances — not structural damage. Pain location is
  diagnostic: anterior points to saddle height, lateral to cleat rotation or
  IT band tension, posterior to saddle too high. A saddle 5mm too low
  increases patellofemoral compression by up to 20%. If pain persists beyond
  two weeks of reduced volume or involves swelling, see a sports
  physiotherapist.
keyTakeaways:
