...
roadmanView:
  - "A 70 kg rider at moderate intensity burns roughly 200-300 calories per 30-minute session. Round trip, five days a week, that is 2,000-3,000 calories — close to a pound of fat loss per week before any dietary change. The maths is not dramatic but it compounds."
  - "Prof. Stephen Seiler's polarised model depends on a large base of easy aerobic volume. A daily commute at zone 1 to low zone 2 is exactly that — mitochondrial density, fat oxidation, durability — provided you keep it properly easy and do not let it drift into zone 3."
  - "The mood data is the part most riders underestimate. Self-reported improvement shows up inside the first week. Habit-formation neurology takes 60-90 days to lock in. The physical changes are visible sooner, but the psychological ones are what keep you riding through winter."
---
