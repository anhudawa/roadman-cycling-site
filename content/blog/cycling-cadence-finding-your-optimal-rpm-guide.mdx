...
answerCapsule: >-
  Optimal cadence is a real-time trade-off between muscular cost and
  cardiovascular cost. Self-selected cadence in trained cyclists tracks within
  3-5 rpm of the metabolic optimum. Lucia's research shows pros self-select
  5-10 rpm higher than their most economical rate because the muscular fatigue
  reduction outweighs the cardiovascular penalty. VO2max is the strongest
  predictor of preferred cadence — higher aerobic capacity supports higher
  rpm. Terrain should shift your cadence: flat roads at natural rpm, climbs
  5-10 rpm lower. If fitness has improved but cadence has not moved, watts are
  likely being left on the table.
keyTakeaways:
