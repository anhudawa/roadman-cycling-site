...
roadmanView:
  - "Jay Vine dropped four hours a week and got faster. The lesson for amateurs isn't to train less — it's to stop filling the week with sessions that don't actually do anything."
  - "If more than 30 percent of your training sits in the grey zone, that's the cut to make. Not volume, not intensity — just the sessions that are too hard to recover from and too easy to adapt to."
  - "The specificity piece is what most self-coached riders miss. UAE prescribe race efforts at exact wattages. Your hard sessions should rehearse the demands of your target event, not just make you tired."
---
