...
You don't need a lab, but you do need a real anchor. An honest [FTP test](/blog/zone-2-training-complete-guide) to [set your zones properly](/tools/ftp-zones), and then the discipline to actually stay below the easy ceiling, is the difference between a Zone 2 ride and a Zone 3 grind that feels like Zone 2. If you ride to a number rather than to feel — or [anchor your easy ceiling to heart rate](/tools/hr-zones) — you stop accidentally turning easy into medium. This is the same accountability the [Welburn stress-budget idea](/blog/alex-welburn-critical-power-w-prime-training-metrics) points at from a different angle.
