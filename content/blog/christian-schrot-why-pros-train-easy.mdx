...
whoFor:
  - "The time-crunched rider who trains 6-8 hours a week and rides every session at a comfortably hard pace because easy feels like a waste"
  - "The cyclist stuck on a plateau who cannot understand why more effort is not producing more speed"
  - "The masters rider whose legs are always tired but who feels guilty about going slow"
  - "The self-coached amateur who has heard about polarised training but does not trust it enough to actually ride easy"
roadmanView:
  - "Christian Schrot coaches at WorldTour level and he sees the same mistake in every amateur he talks to: they ride everything at moderate intensity because their time is limited and easy feels like a waste. The pros do the exact opposite, and that is why their hard days actually work."
  - "I have had this conversation with Stephen Seiler, with Dan Lorang, with Joe Friel -- the message never changes. Make easy days properly easy. Ration the hard ones. Even on a tight schedule, this applies."
  - "The hardest thing for a motivated rider to do is go slow. But if you spend the whole week tired from comfortably-hard riding, you never have the freshness to go properly hard when it counts. You end up in a permanent middle ground that costs recovery and delivers almost nothing."
---
...
You don't need a lab, but you do need a real anchor. An honest [FTP test](/blog/zone-2-cycling-heart-rate-vs-power-vs-rpe) to [set your zones properly](/tools/ftp-zones), and then the discipline to actually stay below the easy ceiling, is the difference between a Zone 2 ride and a Zone 3 grind that feels like Zone 2. If you ride to a number rather than to feel — or [anchor your easy ceiling to heart rate](/tools/hr-zones) — you stop accidentally turning easy into medium. This is the same accountability the [Welburn stress-budget idea](/blog/alex-welburn-critical-power-w-prime-training-metrics) points at from a different angle.
