...
Every fit lives on a line between maximum aero and maximum comfort, and the industry sells you the aero end. Here's the uncomfortable truth: for the vast majority of amateurs, the fastest position is the most *sustainable* one. We dig into this properly in [aero vs weight for cyclists](/blog/aero-vs-weight-cyclist), but the principle is simple — drag you can't hold isn't an advantage. If your "fast" position means you sit up on every climb and bail to the tops after an hour, your average position is slower than a slightly higher setup you stay in all day.
