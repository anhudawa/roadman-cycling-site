...
roadmanView:
  - "Heart rate was the first training metric that gave us a window into what our bodies were actually doing, and it is still one of the most useful — even with a power meter on the bike."
  - "For easy rides, HR is the better governor. It catches the intensity creep that a power number alone will miss, and keeping zone 2 honest is where most amateur gains live."
  - "If you can only afford one device, buy the chest strap. A cyclist with a good HR monitor and the discipline to use it will outperform one with a power meter they ignore."
---
