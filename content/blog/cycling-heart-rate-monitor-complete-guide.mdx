...
The [cycling heart-rate zone calculator](/tools/hr-zones) shows the exact percentage convention and limitations. A repeatable field protocol gives you a working estimate rather than a laboratory measurement. Retest with the same protocol and conditions when the current ranges no longer fit your training response.
