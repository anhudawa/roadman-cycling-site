...
**Set an hourly drinking target and hit it on a schedule.** Sip regularly rather than waiting for the gulp of thirst that arrives too late. On a hot, hard ride that might be 750ml to a litre an hour or more for a heavy sweater — but use your own number, not a generic one.
