...
answerCapsule: >-
  Cyclists inhale 100-150 litres of air per minute at threshold — ten times
  resting rate — pulling pollen deep into the lower airways. Grass pollen is
  lowest between 1pm and 4pm, making lunchtime the best riding window.
  Fexofenadine is the preferred non-sedating antihistamine with the lowest
  drowsiness rate. Nasal barrier balms trap pollen before it enters the airway.
  Wraparound glasses reduce pollen contact with the eyes by up to 65 per cent.
  Move key sessions indoors when counts reach very high.
keyTakeaways:
...
relatedTools:
  ...
  - "hr-zones"
whoFor:
  - "Cyclists who lose weeks of outdoor training every spring and summer to streaming eyes and blocked airways"
  - "Riders who take antihistamines but have never optimised timing, product choice, or physical barriers for on-bike use"
  - "Anyone who built winter form on the turbo and dreads losing it the moment pollen season starts"
  - "Masters athletes over 40 whose hay fever symptoms seem to worsen year on year and want a proper management plan"
roadmanView:
  - "I used to accept hay fever as something you just suffered through. Then I learned that fexofenadine, a nasal barrier balm, and wraparound glasses cut my symptoms by about 80 per cent."
  - "The single easiest change is ride timing. Grass pollen is lowest between 1pm and 4pm — a lunchtime ride in peak season is worth more than a dawn session where you are inhaling through a wet flannel."
  - "If you are losing more than two weeks of outdoor riding per year, talk to your GP about sublingual immunotherapy. It is a three-year commitment, but it addresses the root cause rather than just masking symptoms."
---
...
Seasonal allergies might seem separate from [cycling nutrition](/topics/cycling-nutrition), but they directly affect how well you fuel, hydrate, and recover — making hay fever management a genuine performance consideration.
...
A cyclist riding at threshold inhales 100-150 litres per minute. At that volume, nasal breathing is impossible. You switch to mouth breathing, which bypasses the nose's filtration system entirely. Pollen grains — some as small as 10 microns — are pulled directly into the bronchi and lower airways, where they trigger inflammatory responses that would never occur during normal breathing. Mouth breathing also increases fluid loss, making a solid [hydration strategy](/blog/cycling-hydration-guide) even more important during pollen season.
...
Training through severe symptoms is not tough. It is expensive. Airway inflammation from high pollen exposure takes 24-48 hours to resolve. During that window, your perceived effort at any given power output is elevated, your breathing is less efficient, and your recovery is impaired. You pay for one bad outdoor session with two compromised follow-up sessions. Getting your [recovery nutrition](/blog/post-ride-recovery-nutrition-cyclists) right on symptomatic days matters even more — your body is managing airway inflammation on top of the normal training load.
