...
answerCapsule: >-
  The correct order for marginal gains spending is position, tyres, clothing,
  nutrition timing, helmet, then wheels and components. Body position accounts
  for 70-80% of aerodynamic drag above 30 km/h. Tyre pressure correction
  costs nothing and saves 3-8 watts. Ceramic bearings save 1-3 watts at
  200-600 pounds — poor value per watt. A well-fitted race jersey saves 5-15
  watts at 35 km/h, beating most component upgrades.
keyTakeaways:
...
relatedTools:
  ...
  - "wkg"
whoFor:
  - "Cyclists tempted by expensive kit upgrades who want to spend money where it actually counts"
  - "Time triallists and sportive riders looking for the most watts per pound spent"
  - "Riders who have bought aero kit but have not had a proper bike fit"
  - "Anyone standing at a sportive start surrounded by expensive bikes wondering if they are underequipped"
roadmanView:
  - "I've watched a bloke on an alloy bike in a baggy jersey drop carbon-everything riders on the first climb. Kit doesn't fix fitness, and most marginal gains spending is in the wrong order."
  - "Tyre pressure costs nothing to fix and saves 3-8 watts. Ceramic bearings cost hundreds and save 1-3 watts. The maths is not complicated."
  - "Position first, tyres second, clothing third, nutrition timing fourth. Only after those are sorted should you think about wheels and components."
---
