...
answerCapsule: >-
  Restricted ankle dorsiflexion forces compensatory patterns — toe pointing,
  heel dropping, lateral knee tracking — that waste watts and stress connective
  tissue. The wall-knee test takes 30 seconds: less than 10 cm clearance
  indicates a meaningful restriction. Three exercises fix it: weighted
  dorsiflexion mobilisations, eccentric calf raises off a step, and banded ankle
  distractions. Two sets each, three times per week, produces measurable
...
relatedTools:
  ...
  - "training-readiness"
whoFor:
  - "The cyclist with recurring Achilles pain or knee issues who has never had their ankle range tested"
  - "The rider who does hip and glute work but has never considered that their ankles might be the weak link"
  - "The masters cyclist noticing increasing stiffness in the lower leg and wanting a practical self-assessment"
  - "The bike fit client who was told to move their cleats back but does not understand why ankle mobility matters"
roadmanView:
  - "I've lost count of the riders I've spoken to who do hip mobility work, foam roll religiously, and have never once checked their ankles. Meanwhile, the ankle is the joint where every watt meets the pedal. If it's restricted, everything above compensates — and that's where injuries start."
  - "Here's where it gets interesting — cycling itself makes this worse. A stiff shoe, a fixed circular path, 80-100 revs per minute in a narrow range. Your ankles are slowly losing mobility every ride and you don't feel it until something else hurts."
  - "The good news is it's fixable. Three exercises, two sets each, three times a week. The wall-knee test takes 30 seconds and tells you if you need it. That's the whole prescription."
---
