...
roadmanView:
  - "Your ankles get no attention. Meanwhile, they are the joint where every watt you produce meets the pedal. If they are restricted, everything above compensates — and compensation patterns are where injuries start."
  - "Cycling itself makes this worse. A stiff shoe, a fixed circular path, and 80-100 revolutions per minute in a narrow range — your ankles are slowly losing mobility every ride."
  - "Three exercises, two sets each, three times a week. That is the whole prescription. The wall-knee test takes 30 seconds and tells you whether you need it."
---
