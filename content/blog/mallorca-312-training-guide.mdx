...
keyTakeaways:
  - "3.0 W/kg with disciplined fuelling finishes the 312 under 14 hours; 3.4-3.8 W/kg targets sub-12; 4.0+ W/kg with a trained gut makes sub-10 realistic."
  - "The Tramuntana climbs are the easy part — the Pla central plain after km 200 is where riders without endurance training crack."
  - "Fuel at 80-100g carbs per hour from the gun; a 12-hour finish demands 1,000g+ of carbohydrate on the bike, which most amateurs have never eaten in motion."
  - "At least three back-to-back long-ride weekends (Saturday 5-6 hours climbing, Sunday 3-4 hours tempo on tired legs) are required before taper."
  - "One 8-hour training ride is the non-negotiable bar — riders who skip it show up guessing about what hours 7-12 feel like, and the guess is almost always wrong."
faq:
...
whoFor:
  - "Riders entered for the Mallorca 312 who want a 16-week training plan built around the specific demands of 312km and 5,000m of climbing"
  - "Cyclists who have completed standard gran fondos and want to understand why the 312 is a different category of event entirely"
  - "Anyone who has ridden in Mallorca on a training camp and fancies the 312 without appreciating what the Pla section does to riders after 200km"
  - "Experienced sportive riders targeting a sub-11-hour or sub-10-hour finish who need W/kg benchmarks, fuelling targets, and a structured taper"
roadmanView:
  - "I've spoken to dozens of riders who've done the 312, and the thing that surprises every single one of them is that the Tramuntana climbs are the easy part. The central plain after kilometre 200 is where riders without endurance training crack — I always say, learn that lesson in training, not on the day."
  - "I'm really clear on this with anyone I coach for the 312: if you haven't done an 8-hour training ride before the event, you're guessing about what hours 7 through 12 feel like. I've seen that guess go wrong too many times. One long ride is the non-negotiable bar."
  - "When I spoke to Dan Lorang on the podcast about pacing ultra-distance events, the message was the same one I give every 312 rider: this is fuelling and pacing before it is FTP. I've watched 3.0 W/kg riders who eat properly finish ahead of 3.8 W/kg riders who race the first 100km and blow up on the Pla."
---

The Mallorca 312 is not a long sportive. It is an ultra-distance event with a mountain stage stuck on the front and 200km of rolling tempo bolted onto the back. That distinction is the one most riders miss, and it is the reason riders who finished a [Marmotte](/blog/la-marmotte-training-guide) feeling strong arrive at kilometre 220 in the Pla central plain wondering what happened.
...
**Heat tolerance.** Late April Mallorca may still be materially warmer than a
British or Irish spring. Use progressive exposure and rehearse pacing, cooling and
fluid access if that gap exists. Do not rely on a universal closed-window indoor
protocol.
...
The weekends want real climbing in real terrain — the Tramuntana doesn't reward turbo legs alone. But the two midweek quality sessions are a different matter. Drop the week into [TrainingPeaks Virtual](https://www.trainingpeaks.com/virtual/) and the threshold and sustained-tempo efforts are already programmed and waiting, so a wet evening or a 9pm finish doesn't cost you the session. For time-poor riders chasing a 312 build through a British or Irish spring, that's how the weekday work actually gets done.
...
For the underlying science, the [carbs-per-hour guide](/blog/carbohydrate-per-hour-cyclists) covers the gut-training and absorption side. For race-day specifics, the [race-day nutrition guide](/blog/cycling-nutrition-race-day-guide) walks through the timing.
