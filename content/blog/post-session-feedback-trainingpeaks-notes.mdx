...
whoFor:
  - "TrainingPeaks users who leave the comment field blank after every session and want to know what they are missing"
  - "Self-coached cyclists relying on power data alone who need a framework for capturing subjective feedback"
  - "Riders working with a coach who want to provide better-quality session notes"
  - "Athletes tracking fatigue through TSS and CTL who want an early-warning system that catches what power misses"
roadmanView:
  - "Power tells you what you did. RPE tells you what it cost. The gap between those two numbers is the earliest warning sign of fatigue, illness, or accumulated stress — and it lives in the note you are not writing."
  - "A good note takes ten seconds: RPE, legs, sleep, stress, fuelling. Over weeks it becomes a record no power file can replace, and it is the first thing I look at when reviewing an NDY athlete's week."
  - "The same 250 watts can be RPE 5 when you are fresh or RPE 8 when you are buried. If you only record the watts, you are flying half blind."
---
