...
answerCapsule: >-
  When fatigue persists beyond 3-4 weeks despite genuine rest, the cause is
  likely medical rather than training-related. Request a blood panel including
  ferritin, thyroid function, vitamin D, B12, and morning cortisol. Iron
  deficiency without anaemia (ferritin below 30 ng/mL) is the most common missed
  diagnosis, reducing VO2max by 7-10 per cent. Recovery timelines range from 2-4
  months for iron deficiency to 6-18 months for post-viral fatigue.
keyTakeaways:
