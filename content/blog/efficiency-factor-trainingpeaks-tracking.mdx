...
seoDescription: "What Efficiency Factor tells you, how to track it across a season in TrainingPeaks, and when a declining EF is a warning worth acting on."
description: >-
...
answerCapsule: >-
  ...
  steady aerobic rides, a rising EF means your aerobic base is improving, while a steady or falling EF at the same effort flags fatigue,
...
whoFor:
  - "TrainingPeaks users who want a practical walkthrough of how to read and track Efficiency Factor across a season"
  - "Cyclists whose FTP has plateaued and want to understand whether their aerobic base is actually growing underneath it"
  - "Masters riders building a long base block who need a metric that shows adaptation before FTP moves"
  - "Anyone who has heard EF mentioned on a podcast and wants to know what it means and how to use it"
roadmanView:
  - "EF is the metric I wish someone had shown me five years earlier. It sits right there in TrainingPeaks and most people scroll past it. One number that tells you whether the easy miles are building anything."
  - "A falling EF on your benchmark ride is the earliest warning system in cycling. It shows up weeks before your power drops or your legs feel heavy. If you are only watching FTP, you are watching the lagging indicator."
  - "The trick is consistency. Compare EF on the same route, same conditions, same effort. One data point tells you nothing. A trend across six weeks tells you everything."
---
...
## Heart rate is noisy — read the trend, not the day
