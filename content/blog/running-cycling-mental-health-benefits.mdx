...
whoFor:
  - Cyclists feeling stale or burnt out after a long season
  - Riders whose entire identity is wrapped up in cycling performance
  - Anyone looking for a training stimulus that has nothing to do with watts
  - Cyclists who suspect they need a mental reset but do not want to stop training
roadmanView:
  - By October I have spent eight months staring at numbers. Running is the one place where I do not care one bit about performance, and that is exactly why it works.
  - If your mood drops every time you miss a power target, your relationship with cycling has a problem. Running can loosen the grip.
  - This is not a training article. It is a permission slip to do something for your head, not your FTP.
---
