...
This is where the model becomes genuinely practical for racing. Phil Skiba developed the W'bal (W-prime balance) concept, and it does exactly what the name suggests: it tracks your remaining anaerobic capacity in real time, second by second, throughout a ride.
