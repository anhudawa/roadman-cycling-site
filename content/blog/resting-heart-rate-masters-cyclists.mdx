...
roadmanView:
  - "Three beats up over your baseline for two or three mornings running — that is the signal. Not one bad reading after a late night. The trend across consecutive days is what tells the story, and it costs you nothing to track."
  - "Resting heart rate is the cheapest, most reliable readiness metric in cycling. No app subscription, no chest strap, no morning routine beyond lying still for 30 seconds before you get out of bed. If you are not tracking it, you are leaving free information on the table."
  - "The absolute number matters far less than your personal baseline. A 56 bpm resting heart rate is perfectly normal for one rider and a warning sign for another whose baseline sits at 48. Know your own number first, then watch what moves it."
---
