...
whoFor:
  - "Runners sidelined with knee, shin, Achilles, IT band, or plantar fascia injuries who have been told to cross-train but given no detail on how"
  - "Athletes terrified of losing their aerobic base during a running layoff and needing evidence that cycling preserves VO2max"
  - "Comeback runners ready to return but wanting a staged run/walk protocol with cycling filling the gaps between sessions"
  - "Dual-sport athletes who run and ride and want to understand which injuries tolerate the bike and which require a different approach"
roadmanView:
  - "I hear from injured runners constantly, and the story is always the same — your physio says 'cross-train while you heal' and hands you nothing more specific. This is the detail that conversation is missing, broken down injury by injury."
  - "I find the Menges 2026 meta-analysis reassuring, and it should put your mind at ease: your engine is safe. VO2max does not care which sport maintains it. The bike keeps the cardiovascular fitness ticking over while the tissue heals."
  - "The bike removes any fitness excuse for rushing the return to running. And rushing is exactly how re-injury happens — I've watched it play out so many times. Come back in stages, trade bike time for run time gradually, and trust that your engine is intact."
---
...
One practical calibration note: your heart rate runs 5-10 beats lower on the bike than running for equivalent effort, because less total muscle is working. Don't chase your running heart rate numbers on the bike — you'll overcook every session. The [run-ride converter](/tools/run-ride-converter) translates your running sessions into equivalent bike sessions so you know what duration and effort to aim for. Effort level and duration are the better guides in the first weeks.
...
The logic is arithmetic. Your aerobic engine responds to total training hours; your injury risk tracks total impact volume. Running delivers both together, inseparably. The bike splits them apart. A runner doing four hours of running plus three hours of riding gets seven hours of aerobic development for four hours of impact — a bigger engine than running alone could safely provide, at a fraction of the structural cost. The [calorie calculator](/tools/calories) shows you exactly how much fuel each session demands so you can match intake to the combined load. That's the entire argument of our guide to [structuring a combined running and cycling week](/blog/cycling-running-weekly-schedule).
