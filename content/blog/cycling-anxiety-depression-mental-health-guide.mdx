...
roadmanView:
  - "The best thing cycling ever did for a lot of people in this community had nothing to do with watts. It gave them structure, social contact, and a reason to get out the door. That matters more than any FTP number."
  - "There is a point where the bike becomes part of the problem. Training through injury because stopping feels unbearable, missing family events for rides that do not matter — that is not dedication. That needs examining."
  - "Seeking professional help is not a failure. Cyclists are comfortable with suffering, and that tolerance can lead to normalising mental distress that deserves treatment. A GP is a resource, not a last resort."
---
