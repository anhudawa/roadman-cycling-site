...
roadmanView:
  - "The five-cause framework here — intensity distribution, recovery, fuelling, measurement error, and life stress — comes from patterns across hundreds of NDY coaching conversations. Most stuck riders have cause one or two, not five."
  - "Joe Friel has said on the Roadman Podcast that the most common amateur plateau is 'too-hard easy rides' — which is cause one here. Stephen Seiler's polarisation data supports the same diagnosis from the research side."
  - "Our FTP Zone Calculator and Training Load Calculator let you audit causes one and two with your own data before changing anything."
---
