...
whoFor:
  - "Riders whose FTP has sat in the same 10-watt window for 12 months or more despite consistent training"
  - "Self-coached cyclists who have already tried adding more intervals or more volume without result"
  - "Masters cyclists unsure whether their FTP plateau is age-related decline or a training and recovery problem"
  - "Athletes who suspect fuelling, sleep, or life stress is involved but have no framework for diagnosing which"
roadmanView:
  - "I built this five-cause framework — intensity distribution, recovery, fuelling, measurement error, and life stress — from patterns across hundreds of NDY coaching conversations. Most stuck riders I work with have cause one or two, not all five."
  - "When I had Joe Friel on the podcast he said the most common amateur plateau is too-hard easy rides, which is cause one here. I hear the same thing from Stephen Seiler — his polarisation data supports the exact same diagnosis from the research side."
  - "I built the FTP Zone Calculator and Training Load Calculator so riders can audit causes one and two with their own data before changing anything. Start with the numbers, not the guesswork."
---
...
**The fix.** Cap intensity on easy days at 70% of max heart rate or RPE 4. If you cannot have a full conversation, you are riding too hard for the easy day. Move two sessions a week to deliberate hard — sweet spot, threshold, or VO2 — and let the rest sit clearly easy. Use the [FTP Zone Calculator](/tools/ftp-zones) to see exactly where each zone boundary sits so you can tell the difference between genuine Zone 2 and accidental Zone 3. The week starts to look polarised. The fitness usually starts moving in 6-8 weeks. If part of the grey-zone problem is that you're not sure what each prescribed session is actually asking for, [how to read your TrainingPeaks workout](/blog/how-to-read-your-trainingpeaks-workout) shows you how to interpret the targets so the easy days stay easy and the hard days hit the right intensity.
...
**The diagnostic question.** Has anything outside training changed in the last six months? Job stress, sleep duration, kids' schedule, alcohol intake, travel? If the answer is yes and the [FTP plateau](/blog/ftp-plateau-breakthrough) coincided, you found the cause.
...
**The fix.** Standardise. Run the same test, on the same trainer or the same loop, with calibrated equipment, at the same time of day, well-rested, after the same warm-up. The [FTP Test Calculator](/tools/ftp-test) lets you compare results across different protocols — 20-minute, ramp, 8-minute, 60-minute — so you can spot when a "plateau" is actually a protocol mismatch. Most riders find that two of the last four "stalled" tests were actually fine, and one of the apparent improvements wasn't real. The signal becomes interpretable.
