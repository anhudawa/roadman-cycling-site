...
roadmanView:
  - "The worst advice you can get with an OA diagnosis is to stop moving. Cartilage needs loading to stay healthy. Cycling provides exactly that loading without the impact forces of running. But your setup has to be right."
  - "Keith Baar's collagen protocol — 15g of hydrolysed collagen with vitamin C before exercise — has stronger evidence than glucosamine for connective tissue support. It is straightforward, cheap, and worth trying."
  - "Higher cadence, lower gears, correct saddle height. Those three changes reduce the peak force going through your knee on every single pedal stroke. For most riders with OA, that is the difference between riding comfortably and dreading every climb."
---
