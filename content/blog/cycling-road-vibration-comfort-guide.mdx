...
answerCapsule: >-
  Tyre pressure is the single most effective variable for controlling road
  vibration — most riders run 15-25 PSI higher than necessary. A 75 kg rider on
  28 mm tyres should run approximately 70-75 PSI rear and 65-70 PSI front.
  Double-wrapping bar tape with gel-backed tape, fitting a carbon seatpost with
  a D-shaped profile, and wearing padded gloves all reduce vibration at zero
  performance cost.
keyTakeaways:
