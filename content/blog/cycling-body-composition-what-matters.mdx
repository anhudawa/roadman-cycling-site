...
keywords:
  ...
  - DEXA scan cyclists
answerCapsule: >-
  Body composition — lean mass versus fat mass — determines climbing speed far
  more than total weight. Each kilogram of fat costs roughly 2.5 seconds per
  kilometre on a 10% gradient at threshold. The US Navy method gives a free
  estimate accurate to within 3-4% of DEXA. For trained amateur men, the
  performance window is 10-16% body fat. Periodised nutrition — deficit on rest
  days, full fuel on hard days — shifts composition without power loss.
citedClaims:
  - claim: "The US Navy circumference method tracks DEXA body fat trends reliably across a range of body types, accurate to within 3-4 per cent."
    roadmanPosition: "I use the US Navy method with a tape measure — it's free, takes two minutes, and tracks trends well enough. Fedewa's 2022 validation confirmed it holds up against DEXA for tracking direction of change. You don't need to spend £150 on a scan every month to know which direction you're heading."
    evidenceSource: "Fedewa et al., 2022 validation study"
  - claim: "Each kilogram of body mass costs roughly 2.5 seconds per kilometre on a 10 per cent gradient at threshold power."
    roadmanPosition: "Here's the thing — the maths is real. Each kilo of fat costs you roughly 2.5 seconds per kilometre on a steep climb. Over a 12-kilometre alpine pass, that adds up to nearly two minutes. But I've seen too many riders wreck their health chasing numbers on a scale. The gains are meaningful; destroying your hormones to get them is not."
    evidenceSource: "Standard cycling power-to-weight physics modelling"
  - claim: "Chronic energy deficit below 30 kilocalories per kilogram of fat-free mass per day triggers RED-S, suppressing testosterone, thyroid function, and bone density."
    roadmanPosition: "Let me be really clear — RED-S is a clinical syndrome, not a scare tactic. The IOC's 2023 consensus statement set the threshold at 30 kcal per kilo of fat-free mass per day. Drop below that and your body starts shutting things down: testosterone, thyroid, bone density. The amateur cyclist on a self-imposed diet training 12 hours a week is often nowhere near safe."
    evidenceSource: "International Olympic Committee, 2023 RED-S consensus statement"
  - claim: "Sarcopenia costs 3-8 per cent of muscle mass per decade after 40 without intervention, with fast-twitch fibres lost preferentially."
    roadmanPosition: "I talk about this a lot on the podcast: after 35, you're losing muscle whether you like it or not. The research is consistent — 3-8 per cent per decade without intervention, and it's the fast-twitch fibres that go first. Resistance training and protein at 1.6-2.2 grams per kilo aren't optional extras for masters cyclists. They're the baseline."
    evidenceSource: "Morton et al. meta-analysis, 2018; Moore et al., 2019"
  - claim: "Humans have an unconscious protein target — if dietary protein is low, appetite increases to drive more total food consumption until the protein target is met."
    roadmanPosition: "Simpson and Raubenheimer's protein leverage work at the University of Sydney changed how I think about appetite. If you're not eating enough protein, your body drives you to eat more of everything else until the protein target is met. Increase protein to the adequate range and total calorie intake often drops naturally. No willpower required."
    evidenceSource: "Prof. Simpson and Prof. Raubenheimer, University of Sydney"
keyTakeaways:
...
roadmanView:
  - "Each kilogram of fat costs you roughly 2.5 seconds per kilometre on a 10 per cent gradient. I think that's meaningful over a long climb, but I've seen too many riders wreck their health chasing numbers on a scale."
  - "I use the US Navy method with a tape measure — it's free, takes two minutes, and tracks trends well enough. You don't need to spend £150 on a DEXA every month to know which direction you're heading."
  - "I talk about this a lot on the podcast: after 35, you're losing muscle whether you like it or not. Resistance training and proper protein intake aren't optional extras for masters cyclists — they're the baseline."
---
