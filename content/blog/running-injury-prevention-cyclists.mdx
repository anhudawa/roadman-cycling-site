...
keyTakeaways:
  - "Cyclists are uniquely vulnerable to running injuries because their cardiovascular fitness enables running volumes their musculoskeletal system has never been trained to absorb — the aerobic system gives no early warning."
  - "The four most common injuries — Achilles tendinopathy, shin splints, runner's knee, and plantar fasciitis — all trace back to tissues that have been conditioned only for cycling's concentric, non-impact loading."
  - "The 10% rule (never increase weekly running volume by more than 10%) is the single most evidence-supported injury prevention guideline, because tendons and bone adapt more slowly than muscles or the cardiovascular system."
  - "Hip and glute strengthening — clamshells, side-lying hip abduction, single-leg glute bridges, lateral band walks, step-downs — started two to three weeks before the first run addresses the weak stabilisers that cause knee and IT band problems."
  - "Soft surfaces reduce peak ground reaction forces by 10-15% versus pavement, and running at a conversational pace (typically 6:00-6:30/km for a cyclist in the first eight weeks) keeps loading within what connective tissue can tolerate."
faq:
...
whoFor:
  - Cyclists about to start running for the first time
  - Riders who tried running before and got injured within weeks
  - Anyone with strong lungs and untested tendons
  - Cyclists who want a clear, no-guesswork injury prevention checklist
roadmanView:
  - Every cyclist I know who got hurt running made the same mistake — they ran at the intensity their lungs could handle, not at the intensity their tendons could tolerate.
  - Your Achilles tendon has never absorbed a ground reaction force in its life. Respect that or it will make you respect it.
  - I have put this checklist in front of dozens of cyclists. The ones who follow it run. The ones who skip it end up at the physio.
---
...
**Achilles tendinopathy.** The most frequent running injury for transitioning cyclists. Cycling develops the quadriceps and hip flexors as the primary movers while the calf complex and Achilles tendon play a minor supporting role. In running, the calf-Achilles unit is the primary force absorber and generator during every stride. The transition from "supporting cast" to "lead role" is abrupt, and the tendon is not ready for it. Symptoms: stiffness in the morning, pain at the start of a run that may ease with warming up (this is an early warning, not a sign that everything is fine), tenderness 2-6 cm above the heel bone. If it has already flared up, the [Achilles tendinopathy cycling guide](/blog/achilles-tendinopathy-cycling-guide) covers training through it.

**Shin splints (medial tibial stress syndrome).** The second most common injury for cyclist-runners. The tibial periosteum becomes inflamed from repetitive loading it has not been conditioned for. Cyclists who run on hard surfaces (pavement, concrete) are at higher risk. Symptoms: diffuse aching along the inner edge of the shin bone during and after running, tenderness when pressing along the tibial border. The [shin splints cross-training guide](/blog/shin-splints-cycling-cross-training) covers holding fitness while the bone settles.
...
**Plantar fasciitis.** The plantar fascia supports the arch during foot strike. Cyclists' feet spend hours locked in rigid shoes that eliminate arch loading. When those same feet suddenly begin absorbing running impacts, the fascia is not prepared. Symptoms: sharp pain in the heel, worst with the first steps in the morning. The [plantar fasciitis guide](/blog/plantar-fasciitis-cycling-alternative) covers riding through the recovery.
