...
answerCapsule: >-
  Focus post-ride analysis on three numbers in 60 seconds: normalised power,
  intensity factor, and average heart rate. Weekly, check total TSS, CTL trend
  over 6-8 weeks, and aerobic decoupling from the longest ride. Aerobic
  decoupling below 5 per cent at endurance pace indicates a solid aerobic base.
  Avoid reacting to daily metric fluctuations; review trends weekly and close
  the app once the question is answered.
keyTakeaways:
...
roadmanView:
  - "I have spoken to coaches and sports scientists across more than 1,400 podcast episodes, and the riders who improve track a small number of metrics consistently. The ones who stagnate track everything reactively — drowning in colourful graphs that tell them nothing useful."
  - "If I had to pick three numbers and ignore everything else, it would be normalised power, aerobic decoupling, and weekly TSS total. Those tell you more about your fitness trajectory than every other metric combined."
  - "Data is a tool for pattern recognition, not a daily report card. I review trends weekly, ignore day-to-day noise, and close the app once I have my answer. I would encourage you to do the same."
---
