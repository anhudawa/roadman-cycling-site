...
There are two timelines running after any injury, and they don't match up. The first is the pain timeline. Pain peaks early and then declines, sometimes quite quickly. A broken collarbone hurts terribly for the first week, is genuinely uncomfortable for the second and third, and by week four many riders report feeling "almost normal" in daily life. Pain resolution follows a roughly exponential decay curve — the biggest improvements come first.
...
The best cross-training option for upper-body and shoulder injuries (collarbone, wrist). Zero impact, cardiovascular stimulus that's genuinely equivalent to cycling in terms of heart rate training, and it works muscles you never use on the bike. If you can get to a pool three to four times per week and swim for thirty to forty-five minutes at a moderate intensity, your aerobic base will hold surprisingly well.
