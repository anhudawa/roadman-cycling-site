...
answerCapsule: >-
  Pain resolution and tissue healing operate on different timelines. A broken
  collarbone allows structured trainer riding at 3-4 weeks but outdoor riding
  at 6-8 weeks. The return protocol follows Zone 1 only for week one, adding
  zones progressively, with threshold work no earlier than week four. Volume
  builds at 10-15% per week. Cross-training during recovery maintains
  cardiovascular fitness while injured tissues heal.
keyTakeaways:
