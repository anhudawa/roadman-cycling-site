...
seoDescription: "Your gut is the bottleneck, not your legs. The science of training your gut to absorb 90-120g of carbohydrate per hour, the protocol, and the common mistakes."
excerpt: >-
...
Worth being clear about one thing: training the gut to absorb carbohydrate is a separate problem from the long-term health of your gut microbiome. The transporter density you're building here is about race-day fuel delivery, not the bacterial ecosystem that affects how you process food day to day — [Prof Tim Spector on the gut, cycling and why most riders get it wrong](/blog/tim-spector-gut-microbiome-cycling-weight-loss) covers that side, and it's a different conversation worth having once the fuelling is sorted.
