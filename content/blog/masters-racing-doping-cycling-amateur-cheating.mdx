...
seoTitle: 'Doping in Masters Cycling: The Cases and the Fix'
seoDescription: >-
  The documented doping cases in masters cycling, why middle-aged riders chase a pharmaceutical edge, and how clean clubs can actually push back on it.
description: >-
...
faq:
  - question: How common is doping in masters cycling?
    answer: >-
      The blunt answer is that the data is incomplete because most
      ...
      data point. The realistic position is that the problem is more
  ...
  - question: Is testosterone replacement therapy doping?
    answer: >-
      ...
      race results.
whoFor:
  - Clean amateur racers who suspect the field is not clean
  - Club riders and event organisers who want to understand the scale of the problem
  - Anyone who thinks doping is a pro-only issue
  - Masters cyclists who care about fairness at the level they actually race at
roadmanView:
  - "This is the episode that generated more messages than any other. Half the peloton vanishing when testers arrive is not anecdote. It happened. And pretending it is only a pro problem is how amateur cycling lets it continue."
  - "I have no interest in moralising. I have an interest in clean riders lining up against other clean riders. The documented cases here are not rumour. They are bans, sanctions, and admissions."
  - "If you race masters, you deserve to know what you are racing against. And if you organise events, you have a responsibility to make testing visible, not optional."
---
...
For the clinical evidence and the current racing distinction, see the reviewed [cycling, testosterone and TRT guide](/blog/cycling-testosterone-and-training-over-40-guide). It preserves the Dr Gordon podcast context while separating a legitimate medical diagnosis, strict TUE criteria and self-prescribed enhancement.
...
For more on the broader culture issues in cycling, see [the British Cycling toxic culture piece](/blog/british-cycling-toxic-culture-win-at-all-costs) and the [Trek-LeMond doping dispute companion piece](/blog/trek-lemond-doping-dispute-cycling-history).
