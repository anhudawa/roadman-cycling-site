---
title: "Race Day Checklist for Cyclists: Night Before to Start Line"
seoTitle: "Race Day Checklist for Cyclists: Night Before to the Start Line"
seoDescription: "A complete race day checklist covering the night before, breakfast timing, equipment, warmup and start-line strategy. From a cyclist who learned the hard way."
excerpt: >-
  Most race-day problems happen before you clip in. This is the full
  chronological checklist — from the night before through to the first fifteen
  minutes of racing — covering equipment, nutrition, warmup and the mistakes
  that cost you time before a pedal is turned.
pillar: coaching
...
keywords:
  ...
  - pre-race warmup cycling
  - cycling race day nutrition
  - sportive race day preparation
  - race day equipment checklist
  - cycling start line strategy
relatedPosts:
...
faq:
  - question: How many hours before a race should a cyclist eat breakfast?
    answer: >-
      Three hours before your start time is the widely accepted window. That
      gives your body enough time to digest and top off glycogen without leaving
      you bloated or sluggish on the line. Dr. Asker Jeukendrup recommends a
      meal of around 2-3g of carbohydrate per kilogram of bodyweight — think
      porridge, a banana, and some white toast with jam. The key is that you've
      rehearsed this exact meal in training so there are no surprises.
  - question: What warmup should I do before a cycling race?
    answer: >-
      Fifteen to twenty minutes on the turbo or road is enough. Start very easy
      for ten minutes, then do two or three short efforts of 30 seconds near
      your threshold to open the legs, with easy spinning between each. The
      goal is to raise your core temperature and prime your neuromuscular
      system without burning matches. Finish the warmup about five minutes
      before you need to be on the start line.
  - question: What equipment should I check the morning of a race?
    answer: >-
      Tyre pressure is number one — check it the morning of, not just the night
      before, because tyres lose pressure overnight. Beyond that, confirm your
      gears shift cleanly, your brakes work, your bottles are filled, and your
      nutrition is attached or pocketed. Carry a spare tube, a CO2 inflator,
      and a mini tool. Have your emergency contact details written on a piece
      of tape on your top tube or stem.
  - question: Where should I position myself at the start of a bike race?
    answer: >-
      It depends on your ability and your goal. If you're competitive and
      expecting to race at the front, start in the first two rows. If you're
      mid-pack, start mid-pack. If you start too far forward and get swamped
      early, you'll burn energy fighting for position. If you start too far
      back in a large field, you'll waste energy weaving through slower
      riders and risk getting caught behind any crashes or splits.
  - question: Should I use a turbo trainer to warm up before a race?
    answer: >-
      If you have access to one, yes. A turbo gives you a controlled,
      repeatable warmup regardless of the roads around the venue. Tim Kerrison's
      Team Sky protocols relied heavily on turbo warmups because they removed
      variables — no junctions, no traffic, no cold descents undoing the
      warmup. A 15-minute turbo warmup with a couple of short openers is more
      effective than 30 minutes of aimless riding around the car park.
answerCapsule: >-
...
keyTakeaways:
  - >-
    Prepare everything the night before — bike, kit, nutrition, race numbers —
    so race morning is calm execution, not panicked problem-solving.
  - >-
    Eat breakfast three hours before the start, stick to foods you've tested,
    and aim for 2-3g of carbs per kilogram of bodyweight.
  - >-
    Check tyre pressure the morning of, not just the night before, and carry
    spares, CO2, and emergency contact details.
  - >-
    Warm up for 15-20 minutes with a couple of short efforts near threshold to
    prime the legs without burning energy.
  - >-
    Start conservatively and ride the first fifteen minutes below race effort —
    the riders who go out too hard are the ones you'll pass later.
---

## Why Most Race Days Go Wrong Before You Clip In

Here's the thing nobody tells you about race day. The biggest performance killer isn't fitness. It isn't your FTP. It isn't even your nutrition plan. It's the chaos of the morning itself. The scramble for a safety pin. The realisation that your front tyre is soft and you can't find a pump. The breakfast you ate too late because you hit snooze.
...
Now, the first fifteen minutes. Let me break this down because this is where most amateur races are won and lost.
