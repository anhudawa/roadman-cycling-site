...
roadmanView:
  - "Every Tour de France winner before 2005 trained without a power meter. Indurain built the most dominant aerobic engine in history using heart rate and feel. The power meter is brilliant — it is not essential."
  - "Heart rate lag is real, but it only matters for short intervals. For Zone 2 rides, tempo sessions, and threshold efforts over eight minutes, heart rate does the job properly."
  - "If you are riding six to ten hours a week without racing, the money you would spend on a power meter might be better spent on coaching or a bike fit."
---
