...
seoDescription: >-
  An hour-by-hour race-day nutrition timeline. Pre-race meal, top-up, warm-up, in-ride carb targets and the recovery feed, built for 4-8 hour amateur events.
excerpt: >-
...
whoFor:
  - Riders targeting a 4-8 hour amateur event who want an hour-by-hour fuelling plan
  - Amateurs who bonk regularly and suspect timing rather than volume is the problem
  - Cyclists unsure when to eat breakfast relative to their start time
  - Anyone who wants a structured caffeine and carbohydrate timeline they can follow on race morning
roadmanView:
  - "Most amateur fuelling failures are not about what the rider ate. They are about when. The timing is what falls apart, and the timing is what produces the bonk that most amateurs blame on fitness."
  - "This is the hour-by-hour timeline I use with riders inside Not Done Yet. Wake-up to finish, calibrated to the body of a rider with a job, not a professional with a chef."
  - "Front-load your fuel. The carbs you skip in hour one are the ones you cannot make up in hour four. Start eating within twenty minutes of any ride over ninety minutes. Set a timer if you have to."
---
...
This is the 24-hour race-day fuelling timeline we run with [Not Done Yet community](https://www.skool.com/roadmancycling) members for events between four and eight hours long. Calibrate the absolute amounts to your body weight; the structure is the same. For the broader periodisation that builds toward this race-week pattern, see the [base-build-race nutrition periodisation guide](/blog/nutrition-periodisation-base-build-race), and for the underlying carb-per-hour rationale the [carbs per hour guide](/blog/carbohydrate-per-hour-cyclists) has the deeper science.

## T-minus 24 hours: the day before

The day before is part of [race-week loading](/blog/cycling-carb-loading-protocol-race-week), not a separate problem. Carbohydrate is at 8-10g/kg/day for the final 48 hours, weighted toward low-fibre, easily-digested sources. White rice, white pasta, cereal, fruit. The aim is full glycogen at the start line, and 600-750g of carbohydrate (for a 75kg rider) demands low-fibre delivery if the gut is to handle it without distress.
...
What works for one rider may not for another. The [pre-race meal](/blog/pre-ride-breakfast-cyclists-guide) is the part of the timeline you absolutely must rehearse in training before the event — at least three times, on the morning of a long ride that resembles the event in duration and intensity.
...
**Hydration.** Sweat rate varies wildly. The working starting point is 500-750ml of fluid per hour, with sodium at 500-800mg per litre for most riders, higher for heavy sweaters or hot conditions. Calibrate from at least three long training rides where you weigh yourself before and after. The [Roadman in-ride fuelling calculator](/tools/fuelling) handles the per-hour carb maths in seconds if you'd rather plug in numbers than memorise the ratios.
...
Three things you must practise before [race day](/blog/cycling-nutrition-race-day-guide):
...
[Race-day fuelling](/topics/cycling-nutrition) is not complicated. It is timed. The riders who execute the timeline finish strong. The riders who treat it as a guideline find out in hour four why the timing matters.
