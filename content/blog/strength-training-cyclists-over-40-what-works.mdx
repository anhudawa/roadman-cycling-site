...
whoFor:
  - "Masters cyclists who know they should lift but are doing bodyweight circuits or light dumbbell work that changes nothing"
  - "Riders over 40 losing sprint power and top-end kick without understanding why"
  - "Athletes with recurring knee pain, lower back issues, or IT-band problems linked to insufficient off-bike strength"
  - "Cyclists who tried a generic gym programme and found it did not transfer to the bike"
roadmanView:
  - "When I had Derek Teel and Dan Lorang on the podcast, they were both clear: movement competency before load, and cycling-specific patterns over generic gym work. I prescribe split squats, hip hinges, single-leg hip thrusts, and step-ups rather than barbell squats or conventional deadlifts — the adaptations are the same, the injury exposure is lower for the 40-plus rider."
  - "I've been banging this drum for a while: the 2024 PLOS ONE study confirmed what coaches have said for years. Twelve weeks of heavy lifting produced larger 5-minute power gains than the equivalent time on the bike. I think this is one of the highest-return changes a masters cyclist can make."
  - "I tell every rider the same thing: two sessions a week, 35-40 minutes each, built around the bike schedule. That is the dose. More is not better."
citedClaims:
  - claim: "Type II muscle fibres atrophy faster than slow-twitch fibres with age, and endurance riding does nothing to defend them — only heavy, intentful contraction recruits those fibres"
    source: "Prof. Andy Galpin"
    year: 2024
    evidenceLevel: "expert-opinion"
    context: "Galpin's podcast appearance on the physiology of getting faster after 40, explaining why fast-twitch loss is the primary limiter for masters cyclists"
  - claim: "Rate of force development declines earlier and faster than maximum strength after 40"
    source: "Prof. Andy Galpin"
    year: 2024
    evidenceLevel: "cohort"
    context: "Cited as the reason masters cyclists lose sprint power and top-end kick before they lose absolute strength — and why light, slow circuits do not address the deficit"
  - claim: "Twelve weeks of heavy resistance training produced larger five-minute power gains than the equivalent time spent on the bike"
    source: "PLOS ONE cycling-specific strength study"
    year: 2024
    evidenceLevel: "RCT"
    context: "Referenced in the Roadman View as the clearest evidence that strength training is a higher-leverage intervention than additional riding for masters cyclists"
  - claim: "Build movement competency first, then add load — skipping that step builds strength on top of dysfunction"
    source: "Derek Teel"
    year: 2025
    evidenceLevel: "expert-opinion"
    context: "Teel's coaching principle from the podcast, applied to cyclists from recreational to WorldTour level, as the entry point before progressive loading"
  - claim: "Strength is the foundation that lets a rider absorb a long, demanding season without falling apart — durability is downstream of it"
    source: "Dan Lorang"
    year: 2025
    evidenceLevel: "expert-opinion"
    context: "Lorang's framework from coaching Grand Tour and Ironman athletes, treating strength as a prerequisite for sustained endurance performance rather than a bolt-on"
---
...
Three sets of five or six, full recovery between sets — two to three minutes, because this is a neural quality and a fatigued nervous system can't produce it. This is the work that puts the gym onto your power meter — and you can track where your FTP sits relative to age and weight with the [masters FTP benchmark tool](/tools/masters-ftp-benchmark). It's also the work that age erases first, which is exactly why it earns its place after 40. The broader question of [what strength training actually transfers to the bike](/blog/cycling-strength-training-what-transfers-guide) is worth understanding before you load up a programme — not every gym adaptation shows up on the road.
