...
| Vuelta a España | 3 weeks | Aug 15 - Sep 6 2026 | +10% (Tier 2) |
...
- If Step 1 was a duration: `base_rate × (1 - discount) × months`
- If Step 1 was an event block: `base_rate × event_premium × number_of_episodes_in_block`

Example: Sponsor picks "3 months" then hovers over "Mid-roll":
→ Shows: "Mid-roll × 3 months (39 episodes) — £1,080/ep (10% off) = £42,120"

Example: Sponsor picks "Tour de France" then hovers over "Mid-roll":
→ Shows: "Mid-roll × Tour de France (9 episodes) — £1,380/ep (+15%) = £12,420"
...
- Grand Tours (3 weeks): 9 episodes (3/week × 3 weeks)
- Gravel Season (6 months): 78 episodes (3/week × 26 weeks)
- Indoor Season (5 months): 65 episodes (3/week × ~21.7 weeks)

**Newsletter count for event blocks:**
- Grand Tours: 3 sends (1/week × 3 weeks)
- Gravel Season: 26 sends (1/week × 26 weeks)
- Indoor Season: 22 sends (1/week × ~22 weeks)
...
"Mid-roll × Tour de France — 9 episodes @ £1,380/ep = **£12,420**"
or
"Mid-roll × 3 months — 39 episodes @ £1,080/ep = **£42,120**"
...
|----------|----------|---------------------------|
| 1 month | 0% | £1,200/ep × ~13 eps = £15,600 |
| 3 months | 10% | £1,080/ep × ~39 eps = £42,120 |
| 6 months | 20% | £960/ep × ~78 eps = £74,880 |
| 12 months | 30% | £840/ep × ~156 eps = £131,040 |
| Multi-year | 35% | By conversation |

**Note:** "Per episode" pricing means the rate applies to each episode within the contract period. 3 episodes/week × 4.33 weeks/month ≈ 13 episodes/month.
...
| Vuelta a España | +10% | All slots in Aug 15-Sep 6 window |
| Gravel Season | Flat | No premium |
| Indoor Season | Flat | No premium |

### Price Calculation

**Duration path:** `total = base_rate × (1 - discount) × episodes_in_period`
**Event path:** `total = base_rate × event_premium × episodes_in_event`
