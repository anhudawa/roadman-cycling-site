...
## Profile 1: Serious racer, 9-12hrs, 280-350W, 72kg, plateaued, self-coached

**Routing:** INNER CIRCLE | 4.38 w/kg

| Question | Answer |
|----------|--------|
| Training for | race_with_date |
| Hours/week | 9_to_12 |
| FTP range | 280_to_350 |
| Plateau | over_a_year |
...
## Profile 2: High-volume racer, 12+hrs, 350W+, 68kg, had coach before

**Routing:** INNER CIRCLE | 5.51 w/kg
...
## Profile 3: Lighter rider IC via w/kg, 200-280W, 65kg (3.69 w/kg)

**Routing:** INNER CIRCLE | 3.69 w/kg

| Question | Answer |
|----------|--------|
| Training for | race_with_date |
| Hours/week | 9_to_12 |
| FTP range | 200_to_280 |
| Plateau | over_a_year |
| Frustration | plateaued_at_number |
| Weight | 65 |
| Coaching history | self_coached |
...
## Profile 4: Race goal, 9-12hrs, 200-280W, 80kg (3.0 w/kg, below IC)

**Routing:** PREMIUM | 3 w/kg
...
You're training 9 to 12 hours a week with a specific race or event in mind. That's enough time to do real work if the structure is right. This is how we make those hours count.
...
## Profile 5: Watts target, 6-9hrs, 200-280W, self-coached

**Routing:** PREMIUM

| Question | Answer |
|----------|--------|
| Training for | specific_watts_target |
| Hours/week | 6_to_9 |
| FTP range | 200_to_280 |
| Plateau | few_months |
| Frustration | plateaued_at_number |
...
You're training 6 to 9 hours a week with a watts target in mind. That's enough time to do real work if the structure is right. This is how we make those hours count.
...
## Profile 6: Group ride, 6-9hrs, under 200W, no structure, had coach

**Routing:** PREMIUM

| Question | Answer |
|----------|--------|
| Training for | group_ride_fitness |
| Hours/week | 6_to_9 |
| FTP range | under_200 |
| Plateau | not_stuck |
...
You're training 6 to 9 hours a week with not getting dropped on the group ride in mind. That's enough time to do real work if the structure is right. This is how we make those hours count.
...
## Profile 7: Race goal, 6-9hrs, 280-350W, 75kg, no structure, self-coached

**Routing:** PREMIUM | 4.2 w/kg
...
You're training 6 to 9 hours a week with a specific race or event in mind. That's enough time to do real work if the structure is right. This is how we make those hours count.
...
## Profile 8: Strong profile but never coached

**Routing:** STANDARD | 5.36 w/kg
...
## Profile 9: Race goal, 4-6hrs, never coached
...
## Profile 10: General fitness, 4-6hrs, lost motivation, never coached

**Routing:** STANDARD

| Question | Answer |
|----------|--------|
| Training for | general_fitness |
| Hours/week | 4_to_6 |
| FTP range | not_sure |
| Plateau | no_idea |
...
## Profile 11: Group ride, 4-6hrs, lost motivation, self-coached
...
## Profile 12: Other goal, 6-9hrs, FTP unknown, never coached
...
## Profile 13: IC profile but mentions cost (budget override)

**Routing:** STANDARD (budget override) | 5.43 w/kg
...
## Profile 14: IC profile, "can't afford much" (budget override)

**Routing:** STANDARD (budget override) | 4.38 w/kg
...
| Weight | 72 |
| Coaching history | had_coach_before |
| Freetext | can't afford much right now |
...
## Profile 15: Under 4hrs, general fitness, recurring injury
...
## Profile 16: Under 4hrs, recurring injury + physio in freetext

**Routing:** NOT A_FIT (injury flagged)
...
## Profile 17: Under 4hrs, general fitness, lost motivation (no goal)
...
## Profile 18: Race goal, 4-6hrs, recurring injury confirmed by doctor

**Routing:** NOT A_FIT (injury flagged) | 4.2 w/kg
...
## Profile 19: IC with current coach (currently_have_one passes IC)

**Routing:** INNER CIRCLE | 4.26 w/kg
...
## Profile 20: Premium with "other" frustration, specific watts target
