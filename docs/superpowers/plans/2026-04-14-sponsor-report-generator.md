...
- **Spec coverage:** Route ✓ (Task 14), mentions ✓ (2, 9), timestamps ✓ (3, 9), downloads ✓ (5), GA4 ✓ (7), social stats ✓ (6, 13), aliases ✓ (8, 9), UI sections ✓ (11, 12), PDF ✓ (15), error handling ✓ (empty states in 12, graceful GA4 null in 7, no-sponsor 404 in 14), month picker ✓ (10), tests ✓ (2, 3, 5, 16).
