...
Expected: `$œ“ mcp_community_stats seeded`
...
async function seedMethodology() {
  ...
  console.log("$œ“ methodology principles seeded");
}
...
async function main() {
  ...
  console.log("$œ“ MCP content tables seeded with placeholders");
}
...
Expected: all three $œ“ lines printed.
...
async function main() {
  ...
  console.log("$œ“ mcp_products seeded");
}
...
async function main() {
  ...
  console.log("$œ“ roadman_events seeded");
}
