...
src/lib/ask/
  ...
  cta.ts                          # intent × retrieval → CtaDescriptor
      ...
      {messages.map((m) => (
        <div key={m.id} className={m.role === "user" ? "text-right" : ""}>
          ...
          >
            ...
            <div className="whitespace-pre-wrap leading-relaxed">{m.content}{m.streaming ? <span className="animate-pulse"> ▌</span> : null}</div>
...
**Spec coverage:**
- ✅ Ask Roadman chat UI (Tasks 16-19)
- ✅ Chat API + streaming (Tasks 10, 12, 13, 14)
- ✅ RAG over episodes + methodology (Task 7)
- ✅ Safety pre-filter + post-filter (Task 5)
- ✅ CTA routing (Task 8)
- ✅ Rider profile store (Task 2)
- ✅ Session + message logging (Task 3)
