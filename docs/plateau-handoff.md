...
```
Wait for the $œ“ output. This creates `diagnostic_submissions` with both columns from migrations 0025 + 0026.
...
```
All $œ“ $†’ good. If anything fails, debug from the output and either the admin page (`/admin/diagnostic`) or the Vercel logs.
