...
These are intentionally short. Long outreach emails are where replies go to die.
...
- **What World Tour coaches are actually teaching age-groupers.** The methodology gap between pros and amateurs is closing fast and I've had front-row seats.
- **The bike leg of triathlon as a dedicated coaching discipline.** The single most under-served niche in endurance sport in my read.
- **What polarised training really means when you've interviewed Seiler three times.** The Twitter version is misleading and I can explain why.
...
Angle: [one-sentence angle specific to their audience]
...
### 10 target outlets + angles

| Outlet | Angle | Working title |
|---|---|---|
...
| 220 Triathlon | Bike-specific training | "The indoor-cycling framework every triathlete should be using this winter" |
| Zwift Insider | Indoor training | "The Zwift training plan I'd write if Zwift would let me" |
| TrainingPeaks blog | Coaching methodology | "Polarised vs sweet spot: what I prescribe and when" |
| Escape Collective | Opinion / culture | "Cycling content has a pro-only problem. Here's what the age-grouper needs instead." |

---

## 3. Digital-PR asset: FTP Benchmarks 2026

**Asset URL (once indexed):** `https://roadmancycling.com/blog/age-group-ftp-benchmarks-2026`

**Status:** foundational framework published 2026-04-17. Roadman community data release planned for Q4 2026 once Not Done Yet collects 300+ rider submissions.
...
I put together a benchmarking framework for age-group cycling FTP / W/kg in 2026 that's worth a look:

- Seven W/kg bands with training implications, not just category cut-offs
- Realistic progression rates by starting point
- Honest numbers on age-related decline (spoiler: much smaller than the usual 5-10%/decade)
- Worked examples across male / female / triathlete profiles

It's grounded in Coggan's reference tables, cross-checked against current Zwift category caps, and informed by what we actually see across our Not Done Yet coaching roster.

Full piece: [URL]

Happy to do a guest post / cite you / be quoted in a larger piece on whatever framing fits [publication]. Community-sourced dataset update coming in Q4.

Anthony Walsh, Roadman Cycling
anthony@roadmancycling.com / roadmancycling.com/about/press

### 10 outlets to pitch

Prioritise publications that already publish "what does X watts mean" type content:

1. Cyclist magazine (feature team)
2. Cycling Weekly (training editor)
...
10. Slowtwitch (triathlon-specific framing of the benchmarks)

### Follow-up: community data release pitch (Q4 2026)
...
Would you want to run the update, or is there an angle your team would frame differently?
